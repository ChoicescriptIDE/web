function IDEViewModel(){function __normalizePath(path){return path=path.replace(/\\/g,"/")}function CSIDEProject(projectData){var self=this,name=ko.observable(projectData.name?projectData.name:getLastDirName(projectData.path)?getLastDirName(projectData.path):"Untitled"),path=ko.observable().extend({normalizePaths:""});path(projectData.path);var scenes=ko.observableArray([]),issues=ko.observableArray([]),console_logs=ko.observableArray([]).extend({rateLimit:{timeout:100},callFunc:{func:function(){setTimeout(function(){var ul=$("#cs-console > ul")[0];ul&&(ul.scrollTop=ul.scrollHeight)},100)}}}),unreadLogs=ko.observable(0),consoleOpen=ko.observable(!1),source=projectData.source,expanded=ko.observable(!1!==projectData.expanded),locked=ko.observable(!1),readOnly=ko.observable(projectData.readOnly||!1),editing=ko.observable(!1),invalidName=ko.observable(!1);self.getName=ko.computed(function(){return name()},this),self.getPath=ko.computed(function(){return path()},this),self.getScenes=scenes,self.getIssues=ko.computed(function(){return issues()},this),self.consoleOpen=ko.computed(function(){return consoleOpen()},this),self.getLogs=ko.computed(function(){return console_logs()},this),self.getUnreadLogCount=ko.computed(function(){return unreadLogs()},this),self.issueCount=ko.computed(function(){return issues().length},this),self.getSource=function(){return source},self.isExpanded=ko.computed(function(){return expanded()},this),self.isLocked=ko.computed(function(){return locked()},this),self.isReadOnly=ko.computed(function(){return readOnly()},this),self.beingEdited=ko.computed(function(){return editing()},this),self.nameInvalid=ko.computed(function(){return invalidName()},this),self.isDirty=ko.computed(function(){for(var i=0;i<scenes().length;i++){if(scenes()[i].isDirty())return!0;if(i===scenes().length-1)return!1}}),self.getWordCount=function(exclCommandLines){exclCommandLines=exclCommandLines||!1;for(var wordCount=0,i=0;i<scenes().length;i++)wordCount+=scenes()[i].getWordCount(exclCommandLines);return wordCount},self.getCharCount=function(selected){for(var charCount=0,i=0;i<scenes().length;i++)charCount+=scenes()[i].getCharCount(selected);return charCount},self.logToConsole=function(log,type,meta){"boolean"!=typeof log&&"number"!=typeof log&&"string"!=typeof log||("string"!=typeof type&&(type=""),console_logs().length>999&&console_logs.shift(),meta?"string"==typeof meta.scene&&"number"==typeof meta.line?console_logs.push({value:log,type:type||"null",scene:meta.scene||"",line:meta.line||""}):(console.log(typeof meta.scene,typeof meta.line),console_logs.push({value:"Error: attempt to log bad meta data logged to project console!",type:"error"})):console_logs.push({value:log,type:type||"null"}),consoleOpen()||"system"==type||unreadLogs(unreadLogs()<8?unreadLogs()+1:"9+"))},self.toggleConsole=function(force){return consoleOpen("boolean"==typeof force?force:!consoleOpen()),consoleOpen()&&unreadLogs(0),consoleOpen()},self.clearConsole=function(){console_logs.removeAll()},self.dismissAllIssues=function(){for(var issueBuffer=[],issueList=issues(),o=0;o<issueList.length;o++)issueBuffer.push(issueList[o]);for(var i=0;i<issueBuffer.length;i++)issueBuffer[i].dismiss();__selectTab("game")},self.setExpand=function(boole,event){if("boolean"!=typeof boole)return void expanded(!expanded());expanded(boole)},self.nameInterface=ko.pureComputed({read:function(){return name()},write:function(newValue){validName(newValue,!0,function(valid,errMsg){invalidName(!valid),valid?name(newValue):console.log(errMsg)})},owner:this}),self.rename=function(data,event){if(!readOnly()&&("keyup"!=event.type||13==event.keyCode||27==event.keyCode)){if("dblclick"!=event.type)return invalidName()&&editing()?void 0:(editing(!1),void __updatePersistenceList());editing(!0),setTimeout(function(){$(event.target).focus().select()},10)}},self.run=function(){function execRun(){locked()||(locked(!0),__shortCompile(self,function(err,allScenes){err?(bootbox.alert("<h3>Compilation Error</h3>"+err.message),console.log(err)):(cside.allScenes=allScenes,notification("Running",name(),{timeout:2e3}),activeProject(self),__reloadTab(cside.tabs()[0],"run_index.html?restart=true"),cside.tabPanel("open"),__selectTab("game")),setTimeout(function(){locked(!1)},5e3)}))}self.isDirty()?bootbox.confirm("This project has unsaved changes, these will not appear in the test run, do you wish to continue?",function(result){result&&execRun()}):execRun()},self.openFolder=function(){__openFolder(path())},self.close=function(){__closeProject(self)},self.select=function(){for(var i=0;i<scenes().length;i++)if(scenes()[i].select())return!0;return!1},self.save=function(cb){"function"!=typeof cb&&(cb=function(){});var failed=!1,count=scenes().length;scenes().forEach(function(scene,index){failed||scene.save(null,null,function(err){if(err)return failed=!0,cb(err);0==--count&&cb(null)})})},self.addNewScene=function(project,event){readOnly()||(event&&event.stopPropagation(),addNewScene(self))},self.addScene=function(scene){scene.getProject()!==self&&!1!==scene.getProject()||scenes.push(scene)},self.removeScene=function(scene){-1!==scenes().lastIndexOf(scene)&&(scenes.remove(scene),scenes().length<1&&projects.remove(self))},self.closeScene=function(scene){function closeScene(){selectedScene()==scene&&(selectedScene(null),editor.setValue("")),self.removeScene(scene),__updatePersistenceList()}scene.isDirty()?bootbox.confirm("This scene has unsaved changes, are you sure you wish to close it?",function(result){result&&closeScene()}):closeScene()},self.exportScenes=function(){fh.selectFolder(function(newPath){newPath&&bootbox.confirm("<h3>Warning</h3><p>This will <b>overwrite</b> any files with the same name in '<i>"+newPath+"</i>'.<br>Are you sure you wish to continue?</p>",function(result){result&&__copyProjectTo(path(),newPath,function(err){if(err)return void notification("Error",err.message,{type:"error"});notification("Game Exported Successfully","All scenes exported successfully to "+newPath,{type:"success",buttons:[{addClass:"btn btn-default",text:"Show Folder",onClick:function(note){__openFolder(newPath),note.close()}}]}).setTimeout(1e4)})})})},self.compile=function(){fh.selectFolder(function(newPath){newPath&&bootbox.confirm("<h3>Warning</h3><p>This will <b>overwrite</b> any file with the same name in '<i>"+newPath+"</i>'.<br>Are you sure you wish to continue?</p>",function(result){result&&__fullCompile(self,newPath)})})},self.test=function(test){__testProject(self,test)},self.openAllScenes=function(){__openAllProjectScenes(self)},self.reloadAllScenes=function(){for(var i=0;i<scenes().length;i++)scenes()[i].load()},self.logIssue=function(err,scene){var lineNum="number"==typeof err.lineNumber?err.lineNumber-1:null,issue=new csideIssue({project:self,scene:scene,desc:err.message,lineNum:lineNum});issues.push(issue);var buttons=[{addClass:"btn btn-danger",text:"Show",onClick:function(note){note.close(),issue.getLineNum()&&issue.show(),selectedProject()==self?__selectTab("issues"):(self.select(),__selectTab("issues"))}}];notification("New Issue","New issue with project "+name(),{type:"error",buttons:buttons}).setTimeout(5e3)},self.removeIssue=function(issue){issues.remove(issue)}}function CSIDEScene(sceneData){function saveScene(callback){function finalizeSave(err){err?console.log(err):(dirty(!1),cmDoc.markClean(),fileStats.mtime?fileStats.mtime=new Date:fileStats.modifiedAt=new Date),saving(!1),"function"==typeof callback&&callback(err)}var data=cmDoc.getValue();fh.writeFile(path(),data,function(err){finalizeSave(err)})}var self=this,path=ko.observable("").extend({normalizePaths:""});path(sceneData.path);var name=ko.observable(getSceneName(path())),isImportant=name().toUpperCase().match(reservedSceneNames),source=sceneData.source||platform,loaded=ko.observable(!1),locked=ko.observable(!1),readOnly=ko.observable(sceneData.readOnly||!1),dirty=ko.observable(!1),editing=ko.observable(!1),colouring=ko.observable(!1),saving=ko.observable(!1),inErrState=ko.observable(!1),errStateMsg=ko.observable(""),cmDoc=CodeMirror.Doc(sceneData.contents||"","choicescript"),charCount=ko.observable(sceneData.contents?sceneData.contents.length:0),wordCount=ko.observable(0),selectedChars=ko.observable(0),history=cmDoc.getHistory(),fileStats=sceneData.stats||{mtime:new Date},markColour=ko.observable(sceneData.color?sceneData.color:isImportant?"rgb(119, 151, 236)":"rgb(119, 119, 119)"),issues=ko.observableArray([]),invalidName=ko.observable(!1),nameErrMsg=ko.observable();self.isLocked=ko.computed(function(){if(locked())return!0;var curScene=cside.getSelectedScene();return!(!curScene||!curScene.beingEdited()||curScene==self)},this),self.getName=ko.computed(function(){return name()},this),self.getPath=ko.computed(function(){return path()},this),self.hasLoaded=ko.computed(function(){return loaded()},this),self.isSaving=ko.computed(function(){return saving()},this),self.isDirty=ko.computed(function(){return dirty()},this),self.isReadOnly=ko.computed(function(){return readOnly()},this),self.beingEdited=ko.computed(function(){return editing()},this),self.isSelected=ko.computed(function(){return this===selectedScene()},this),self.beingColoured=ko.computed(function(){return colouring()},this),self.getSource=function(){return source},self.getProject=function(){return getProject(getProjectPath(path()))},self.getText=function(){return cmDoc.getValue()},self.getMarkColour=ko.computed(function(){return markColour()},this),self.getLineHandle=function(lineNum){return cmDoc.getLineHandle(lineNum)},self.getLineNumber=function(lineHandle){return cmDoc.getLineNumber(lineHandle)},self.nameInvalid=ko.computed(function(){return invalidName()},this),self.getNameErrorMsg=ko.computed(function(){return nameErrMsg()},this),self.getIssues=ko.computed(function(){return issues()},this),self.getContents=function(){return cmDoc.getValue()},self.getErrStateMsg=ko.computed(function(){return errStateMsg()+" - click here to close"},this),self.getErrState=ko.computed(function(){return inErrState()},this),self.getCharCountString=function(){return selectedChars()>0?selectedChars()+" ("+charCount()+")":charCount()},self.getCharCount=function(selected){return selected?selectedChars():charCount()},self.getWordCountString=function(){var suffix=editor.getOption("exclude_cmd_lines")?" [excl. cmds]":" [inc. cmds]";if(selectedChars()>0){return __wordCount(cmDoc.getSelection(),editor.getOption("exclude_cmd_lines"))+" ("+wordCount()+") "+suffix}return wordCount()+suffix},self.getWordCount=function(exclCommandLines){return __wordCount(cmDoc.getValue(),exclCommandLines)},self.getState=ko.computed(function(){return saving()?"fa fa-spinner fa-spin":loaded()?inErrState()?"fa fa-exclamation-triangle scene-unsaved":readOnly()?"fa fa-lock":dirty()?"fa fa-save scene-unsaved":"fa fa-save scene-saved":"fa fa-ban"}),self.setText=function(value){readOnly()||"string"==typeof value&&cmDoc.setValue(value)};var renameSceneFile=function(newName){function executeRename(err){saving(!1),err?bootbox.alert(err):(fileStats.mtime?fileStats.mtime=new Date:fileStats.modifiedAt=new Date,path(newPath),name(newName),__updatePersistenceList())}if(!invalidName()){saving(!0);var newPath=self.getProject().getPath()+newName+".txt";fh.renameFile(path(),newPath,function(err){executeRename(err)})}};self.nameInterface=ko.pureComputed({read:function(){return name()},write:function(newValue){validName(newValue,!1,function(valid,errMsg){invalidName(!valid),valid||nameErrMsg(errMsg)})},owner:this}),self.rename=function(data,event){if(!inErrState()&&loaded()&&!saving()&&!readOnly()&&("keyup"!=event.type||13==event.keyCode||27==event.keyCode))if("dblclick"!=event.type&&"click"!=event.type){if(invalidName()&&editing())return void $(event.target).fadeOut("fast").fadeIn("fast").focus();var newName=event.target.value.trim();newName!=name()&&sceneExists(newName,self.getProject(),function(exists){exists?(notification("Failed to Rename Scene","Scene '"+event.target.value.toLowerCase()+"' already exists in this Project",{type:"error"}),event.target.value=name()):renameSceneFile(newName)}),editing(!1)}else if(isImportant){if(isImportant)return void notification("","Reserved scene cannot be renamed",{type:"error",layout:"bottomLeft"})}else{if(self.isLocked())return;editing(!0),setTimeout(function(){$(event.target).focus().select()},10)}},self.recolour=function(data,event){if(("mouseleave"!==event.type||colouring())&&!self.isLocked()){if("string"==typeof data&&data!=markColour()){var reg=new RegExp("("+validSceneColours().join("|").replace(/\(/g,"\\(").replace(/\)/g,"\\)")+")");if(!data.match(reg))return void console.log("Scene Recolour Error: Invalid colour");markColour(data),__updatePersistenceList()}colouring(!colouring())}},self.focusLine=function(lineNum,noArrow){self!==selectedScene()&&self.select(),noArrow||(editor.clearGutter("arrow-gutter"),editor.setGutterMarker(lineNum,"arrow-gutter",document.createTextNode("→"))),editor.scrollIntoView({line:lineNum,ch:0},20)},self.addIssue=function(issue){if(issues.push(issue),"number"==typeof issue.getLineNum()){var lh=cmDoc.getLineHandle(issue.getLineNum());return lh?(cmDoc.addLineClass(lh,"background","CodeMirror-error-background"),CodeMirror.on(lh,"delete",function(lineHandle,change){issues.remove(issue)}),lh):null}},self.removeIssue=function(issue){"number"==typeof issue.getLineNum()&&cmDoc.removeLineClass(issue.getLineNum(),"background","CodeMirror-error-background"),issues.remove(issue)},self.load=function(callback){function finishLoading(err,data){err?(inErrState(!0),errStateMsg(err.message),console.log(errStateMsg()),callback(err)):(inErrState(!1),cmDoc.setValue(data),cmDoc.markClean(),cmDoc.clearHistory(),dirty(!1),__updatePersistenceList(),__testSceneIndentation(self)),loaded(!0),saving(!1),void 0!==callback&&callback(err,self)}saving()||(loaded(!1),saving(!0),"function"!=typeof callback&&(callback=function(err){err&&console.log(err.message)}),fh.stat(path(),function(err,newfileStats){err?finishLoading(err):(fileStats=newfileStats,fh.readFile(path(),function(err,data){err?finishLoading(err):finishLoading(err,data)}))}))},self.save=function(scene,event,callback){function checkDate(newfileStats){(newfileStats.mtime||newfileStats.modifiedAt).getTime()>lastModifiedAt.getTime()?bootbox.confirm("<h3>Warning</h3><p>'"+name()+".txt' of <b>"+self.getProject().getName()+"</b> has been modified by another program or process \t\t\t\t\t\tsince it was opened. Are you sure you wish to save it?",function(result){if(!result)return void saving(!1);saveScene(callback)}):saveScene(callback)}if(event&&event.stopPropagation(),!dirty()&&loaded()||inErrState()||saving()||locked()||readOnly())return void("function"==typeof callback&&callback(null));saving(!0);var lastModifiedAt=fileStats.mtime||fileStats.modifiedAt;fh.stat(path(),function(err,newfileStats){!err||404!=err.code&&"ENOENT"!=err.code?err?(console.log(err),saving(!1),bootbox.alert("<h3>Warning</h3><p>Unable to save <b>"+name()+"</b> of <b>"+self.getProject().getName()+"</b>: "+err.message+".</p> \t\t\t\t\t\t<p>Check your internet connection.</p>")):checkDate(newfileStats):saveScene(callback)})},self.select=function(){if(selectedScene()!==self)return!(inErrState()||!loaded()||saving()||self.isLocked())&&(editor.clearGutter("arrow-gutter"),selectedScene(self),editor.swapDoc(cmDoc),self.getProject().isExpanded()||self.getProject().setExpand(!0),editor.setOption("readOnly",readOnly()),!0)},self.close=function(){self.getProject().closeScene(self)},self.copyTo=function(targetProject){function executeCopy(err){if(err)bootbox.alert(err.message),console.log(err);else{var newScene=new CSIDEScene({path:newPath,source:source,contents:cmDoc.getValue()});targetProject.addScene(newScene),newScene.load()}}if("object"==typeof targetProject&&!inErrState()&&loaded()&&!saving()){if(targetProject.isReadOnly())return void notification("","Cannot Move Scene to Read-Only Project",{type:"error",closeWith:["click"]});var newPath=targetProject.getPath()+name()+".txt";fh.copyFile(path(),newPath,function(err,fileStat){executeCopy(err)})}},self.moveTo=function(targetProject){function executeMove(err){err?(bootbox.alert(err.message),console.log(err)):(currentProject.removeScene(self),path(newPath),targetProject.addScene(self),__updatePersistenceList())}if("object"==typeof targetProject&&!inErrState()&&loaded()&&!saving()&&!readOnly()){if(isImportant)return void notification("","Cannot Move Reserved Scene",{type:"error",closeWith:["click"]});if(targetProject.isReadOnly())return void notification("","Cannot Move Scene to Read-Only Project",{type:"error",closeWith:["click"]});var currentProject=self.getProject();if(targetProject!==currentProject){var newPath=targetProject.getPath()+name()+".txt";fh.renameFile(path(),newPath,function(err){executeMove(err)})}}},self.del=function(){function executeDeletion(){fh.deleteFile(path(),function(err){err?bootbox.alert(err.message):self.close()})}if(!inErrState()&&loaded()&&!saving())return isImportant?void notification("","Cannot Delete Reserved Scene",{type:"error",closeWith:["click"]}):readOnly()?void notification("","Cannot Delete Read-Only Scene",{type:"error",closeWith:["click"]}):void bootbox.confirm("<h3>Confirm</h3><p>Are you sure you want to permanently delete '"+name()+".txt'?</p><p style='font-size:12px;'>"+path()+"<p>",function(result){result&&executeDeletion()})},CodeMirror.on(cmDoc,"beforeChange",function(cm,change){saving()&&loaded()&&(change.cancel(),"undo"!=change.origin&&"redo"!=change.origin||cmDoc.setHistory(history))}),CodeMirror.on(cmDoc,"change",function(cm,change){saving()||dirty(cmDoc.isClean()?!1:!0),history=cmDoc.getHistory(),charCount(charCount()-change.removed.join("\n").length+change.text.join("\n").length),wordCount(__wordCount(cmDoc.getValue(),editor.getOption("exclude_cmd_lines")))}),CodeMirror.on(cmDoc,"cursorActivity",function(cm){var selection=cmDoc.getSelection();selectedChars(selection.length)})}function csideIssue(issueData){var self=this,scene=issueData.scene||null,project=issueData.project||null;if(null===project)return null;var date,time,desc=issueData.desc||"No description available",lineHandle=null,lineNum="number"==typeof issueData.lineNum&&issueData.lineNum>-1?issueData.lineNum:null,d=new Date;if(date=d.getDate()+"/"+(d.getMonth()+1)+"/"+d.getFullYear(),time=d.getHours()+":"+d.getMinutes(),self.getScene=function(){return scene},self.getDesc=function(){return desc},self.getDate=function(){return date},self.getTime=function(){return time},self.getLineNum=function(){return lineHandle?lineHandle.lineNo():lineNum},self.dismiss=function(){project.removeIssue(self),scene&&scene.removeIssue(self)},self.show=function(){scene&&(scene.select(),"number"==typeof self.getLineNum()&&scene.focusLine(self.getLineNum(),!0))},scene){var lh=scene.addIssue(self);lh&&(lineHandle=lh)}}function CSIDESetting(settingData){var setting=this,value=ko.observable(settingData.value),id=settingData.id,name=settingData.name,selectedOption=0,type=settingData.type||"binary",cat=settingData.cat||"app",desc=ko.observable(settingData.desc||"");if("binary"===type)var options=[{desc:"on",value:!0},{desc:"off",value:!1}];else var options=settingData.options;setting.getValue=ko.computed(function(){return value()},this),setting.getId=function(){return id},setting.getName=function(){return name},setting.getType=function(){return type},setting.getCat=function(){return cat},setting.getOptions=function(){return options},setting.getDesc=ko.computed(function(){return desc()},this),setting.setDesc=function(val){desc(val)},setting.apply=settingData.apply,setting.toggle=function(option,evt){"binary"!=type?value(option.value):selectedOption+1==options.length?(selectedOption=0,value(options[selectedOption].value)):(selectedOption+=1,value(options[selectedOption].value)),setting.apply(value()),config.settings[cat][id]=value(),__updateConfig()},setting.setValue=function(newVal){for(var i=0;i<options.length;i++)value(newVal)},setting.extAPI={getName:setting.getName,getType:setting.getType,getDesc:setting.getDesc,getValue:setting.getValue,toggle:setting.toggle,getOptions:setting.getOptions}}function __openScenes(paths,selectLast){for(var lastIndex=selectLast?paths.length-1:paths.length,i=0;i<lastIndex;i++)__openScene(paths[i],function(){});selectLast&&__openScene(paths[lastIndex],function(err,scene){err||scene.select()})}function __createImageScene(project,path){var image=new Image;image.onload=function(){var canvas=document.createElement("canvas"),fileExt=getFileExtension(path),imgSceneName=(CONST_IMG_PREFIX+getLastDirName(path).replace(fileExt,"")).replace(/\s/g,"_").toLowerCase(),scenePath=project.getPath()+imgSceneName+".txt";if(canvas.width=this.naturalWidth,canvas.height=this.naturalHeight,canvas.width<=0&&canvas.height<=0)return void notification("Image Import Failed",path,{type:"error"});canvas.getContext("2d").drawImage(image,0,0),sceneExists(imgSceneName,project,function(exists){if(exists)bootbox.prompt({title:"That Image Already Exists - Copy & Paste Code Below",value:"*gosub_scene "+imgSceneName,callback:function(result){}});else{var newScene=new CSIDEScene({path:scenePath,source:platform}),dataUrl=canvas.toDataURL();newScene.setText("*comment ENCODED IMAGE FILE - DO NOT EDIT\n*comment source: "+path+"\n*comment usage: *gosub_scene "+newScene.getName()+"\n*image "+dataUrl+"\n*return"),newScene.save(null,null,function(err){err?bootbox.alert(err.message):(notification("Image Import Successful","",{type:"success"}),bootbox.prompt({title:"Copy & Paste Code Below",value:"*gosub_scene "+newScene.getName(),callback:function(result){}}))})}})},image.onabort=image.onerror=function(){notification("Image Import Failed",path,{type:"error"})},image.src="file://"+path}function __promptForString(callback,title,placeholder){bootbox.prompt({title:title||"Please enter text",value:placeholder||"",callback:function(str){callback("string"!=typeof str?"":__trimWhitespace(str))}})}function addNewScene(project,name){function generateName(newName){sceneExists(newName,project,function(exists){if(exists){var n=newName.substring(newName.lastIndexOf("_")+1,newName.length);n=isNaN(n)?0:parseInt(n)+1,generateName("Untitled_"+n)}else{var scenePath=project.getPath()+newName+".txt",newScene=new CSIDEScene({path:scenePath,source:platform,readOnly:project.isReadOnly()});project.addScene(newScene),newScene.save(null,null,function(err){err?bootbox.alert(err.message):newScene.load(function(err,scene){err||scene.select()})})}})}if("object"==typeof project){generateName(name||"Untitled")}}function __addProject(project){if(project instanceof CSIDEProject)return void projects.unshift(project);bootbox.alert("Error: Unable to add non-CSIDE Project.")}function __createProject(projectName,cb,blank){blank=blank||!1,function(cpf_cb){var projectPath=user.path+(projectName+"/");fh.makeDir(projectPath,function(err){err&&"EEXIST"==err.code?(bootbox.alert("Error: That Project folder could not be created because it already exists."),cpf_cb(!0)):err?(bootbox.alert("Error: Unable to create the project folder, check your permissions."),cpf_cb(!0)):cpf_cb(!1,projectPath)})}(function(err,projectPath){err&&cb(err);var project=new CSIDEProject({name:projectName,path:projectPath,source:platform});__addProject(project);var startupContents="*title "+projectName+"\n*author "+user.name+"\n*comment your code goes here\n*finish";(blank?[]:[new CSIDEScene({path:projectPath+"choicescript_stats.txt",contents:"",source:platform}),new CSIDEScene({path:projectPath+"startup.txt",contents:startupContents,source:platform})]).forEach(function(scene,index){scene.save(null,null,function(err){if(err)return void bootbox.alert(err.message);project.addScene(scene),scene.load(function(err,scene){err||scene.select()})})}),cb(null,project)})}function __openScene(sceneDataOrPath,callback){if("string"!=typeof sceneDataOrPath)throw new Error("Error: Bad sceneData or scenePath - cannot be resolved into scene.");var newScene=new CSIDEScene({path:sceneDataOrPath,source:platform}),sceneProjectPath=getProjectPath(newScene.getPath()),sceneProject=projectIsOpen(sceneProjectPath);if(sceneProject){if(sceneAlreadyOpen(newScene.getName(),sceneProject))return void newScene.select()}else sceneProject=new CSIDEProject({path:sceneProjectPath,source:platform}),__addProject(sceneProject);sceneProject.addScene(newScene),newScene.load(callback)}function getSceneName(scenePath){var sceneName=getLastDirName(scenePath);return sceneName.substring(0,sceneName.length-4)}function getLastDirName(path){if(("/"==path.charAt(path.length-1)||"\\"==path.charAt(path.length-1))&&path.length>2&&(path=path.substring(0,path.length-1)),-1!=path.lastIndexOf("/"))var divider="/";else var divider="\\";return path.substring(path.lastIndexOf(divider)+1,path.length)}function getFileExtension(scenePath){return scenePath.substring(scenePath.lastIndexOf("."),scenePath.length)}function getProject(projectPath){for(var n=0;n<projects().length;n++)if(projects()[n].getPath()===projectPath)return projects()[n];return null}function getProjectPath(scenePath){return scenePath.substring(0,scenePath.lastIndexOf("/")+1)}function sceneAlreadyOpen(sceneName,project){for(var scenes=project.getScenes(),i=0;i<scenes.length;i++){if(scenes[i].getName()===sceneName)return scenes[i];if(i===scenes.length-1)return!1}}function projectIsOpen(projectPath){for(var i=0;i<projects().length;i++){if(projects()[i].getPath()===projectPath)return projects()[i];if(i===projects().length-1)return!1}}function validName(name,allowSpaces,callback){var err,valid=!1;!name||""===name||/^\s*$/.test(name)?err="Name required":!name.match(/^[\w-\s]+$/)&&allowSpaces?err="Name contains invalid characters.":name.match(/^[\w-]+$/)||allowSpaces?name.toUpperCase().match(reservedSceneNames)?err="That name is reserved":valid=!0:err="Name contains invalid characters.",callback(valid,err)}function __trimWhitespace(str){return str=str.trim(),str=str.replace(/\s{2,}/g," ")}function __wordCount(string,exclCommandLines){exclCommandLines=exclCommandLines||!1;var wordCount=0;if(exclCommandLines){var nonCommandLines=string.replace(/\*.+$/gm,"");nonCommandLines.replace(/^\s+|\s+$/g,"").split(/\s+/).length,wordCount=nonCommandLines.replace(/^\s+|\s+$/g,"").split(/\s+/).length}else wordCount=string.replace(/^\s+|\s+$/g,"").split(/\s+/).length;return 1===wordCount&&""===string&&(wordCount=0),wordCount}function __copyProjectTo(oldPath,newPath,callback){fh.readDir(oldPath,function(err,filenames){if(err)return void callback(err);filenames=filenames.filter(function(file){return".txt"===getFileExtension(file)});for(var count=filenames.length,i=0;i<filenames.length;i++)fh.copyFile(oldPath+filenames[i],newPath+filenames[i],function(err,data){if(err)return void callback(err);0==--count&&callback(null)})})}function __openFolder(path){usingNode?gui.Shell.openItem(path):fileBrowser.open(path,function(selection){selection.length<1||(selection=selection.filter(function(file){return!file.isFolder()}).map(function(file){return file.path}),__openScenes(selection,!0))})}function projectExists(projectPath,callback){fh.stat(projectPath,function(err,stat){callback(err&&404==err.code?!1:"undefined"!==stat.isRemoved&&1==stat.isRemoved?!1:!0)})}function sceneExists(sceneName,project,callback){var scenePath=project.getPath()+sceneName+".txt";fh.stat(scenePath,function(err,stat){callback(err&&404==err.code?!1:"undefined"!==stat.isRemoved&&1==stat.isRemoved?!1:!0)})}function __closeProject(project,ask){project.isDirty()?bootbox.confirm("This project has unsaved scenes, are you sure you wish to close it?",function(result){result&&(project===selectedProject()&&(selectedScene(""),editor.setValue(""),self.tabs()[0].href("")),projects.remove(project),__updatePersistenceList())}):(project===selectedProject()&&(selectedScene(""),editor.setValue(""),self.tabs()[0].href("")),projects.remove(project),__updatePersistenceList())}function __testSceneIndentation(scene){for(var tabs=!1,spaces=!1,lines=scene.getText().split("\n"),i=0;i<lines.length;i++)if(lines[i].match(/^\t+/)?tabs=!0:lines[i].match(/^\s+/)&&(spaces=!0),spaces&&tabs){bootbox.confirm("<h3>Warning</h3><p><b>"+scene.getName()+".txt</b> of <b>"+scene.getProject().getName()+"</b> uses both tabs and spaces for indentation. Would you like the IDE to automatically normalize all indents to your settings preference?</p>",function(result){result&&__normalizeSceneIndentation(scene)});break}}function __normalizeSceneIndentation(scene,indentUnit){var tabSize=settings.asObject("editor").tabsize;indentUnit=indentUnit||settings.asObject("editor").tabtype;var lines=scene.getText().split("\n");if("spaces"==indentUnit)for(var i=0;i<lines.length;i++){var oldIndent=lines[i].match(/^\t+/);if(oldIndent){for(var newIndent="",c=0;c<oldIndent[0].length*tabSize;c++)newIndent+=" ";lines[i]=lines[i].replace(/^\t+/,newIndent)}}else{if("tabs"!=indentUnit)throw new Error("Scene Normalization: Bad indent unit: "+indentUnit);for(var i=0;i<lines.length;i++){var oldIndent=lines[i].match(/^\s+/);if(oldIndent){for(var newIndent="",c=0;c<oldIndent[0].length/tabSize;c++)newIndent+="\t";lines[i]=lines[i].replace(/^\s+/,newIndent)}}}scene.setText(lines.join("\n"))}function __testProject(project,test){if("random"!=test&&"quick"!=test)return void alert("Error: no such test as "+test+"test!");if(void 0===project||""===project)return void alert("Error: no project given to "+test+"test!");var path="node_modules/cside-choicescript/"+test+"test.html";activeProject(project),"web-dropbox"===platform?(project.test_win=window.open(path,"Quicktest","toolbar=0,location=0,status=0,menubar=0,scrollbars,resizable,width=500,height=400"),project.test_win.addEventListener("beforeunload",function(event){project.test_win=null}),setTimeout(function(){project.test_win.title=test.toUpperCase()+"TEST - "+project.getName()},200)):project.test_win?(project.test_win.close(),project.test_win=null,__testProject(project,test)):nw.Window.open(path,{focus:!0,width:500,height:500,title:""},function(test_win){project.test_win=test_win,test_win.on("closed",function(){project.test_win.hide(),project.test_win.close(!0),project.test_win=null})})}function __openAllProjectScenes(project){function load(err,filepaths){err?console.log(err):__openScenes(filepaths.filter(function(filepath){return".txt"===getFileExtension(filepath)&&!filepath.match(CONST_IMG_PREFIX)},!1).map(function(filepath){return projectPath+filepath}))}var projectPath=project.getPath();fh.readDir(projectPath,function(err,filepaths){load(err,filepaths)})}function __reloadTab(tab,path){var href=path||tab.href();tab.href(""),tab.href(href)}function __selectTab(id){$("#tabs").tabs("option","active",$("#"+id).index()-1)}function __shortCompile(project,cb,transpile){function addScene(fileName,data){var scene=new Scene,sceneName=getSceneName(fileName);try{scene.loadLines(data)}catch(err){return statusBox.close(),new Error(err.message+" - "+sceneName+".txt")}if(transpile){for(var changes=[],lineNum=0;lineNum<scene.lines.length;lineNum++){var command=/^\s*\*(\w+)(.*)/.exec(scene.lines[lineNum]);if(command&&cse[command[1]]){for(var block_size=1;scene.getIndent(scene.lines[lineNum+block_size])>scene.getIndent(scene.lines[lineNum]);)block_size++;changes.push({targetLine:lineNum,targetLength:block_size,change:cse[command[1]].transpile(scene,command[2],lineNum,block_size)})}}for(var c=0;c<changes.length;c++)Array.prototype.splice.apply(scene.lines,[changes[c].targetLine,changes[c].targetLength].concat(changes[c].change))}return allScenes[sceneName]={},allScenes[sceneName].crc=scene.temps.choice_crc,allScenes[sceneName].labels=scene.labels,allScenes[sceneName].lines=scene.lines,!1}var statusBox=notification("Compiling... ",project.getName(),{closeWith:!1,timeout:!1}),allScenes={},failed=!1,projectPath=project.getPath();!function(){fh.readDir(projectPath,function(err,fileNames){if(err)return statusBox.close(),cb(err);var fileNames=fileNames.filter(function(fileName){return".txt"===getFileExtension(fileName)
}),count=fileNames.length;return fileNames.forEach(function(fileName,index){fh.readFile(projectPath+fileName,function(err,data){if(!failed)return err?(failed=!0,statusBox.close(),404==err.code&&(err=new Error("File not found: "+fileName)),cb(err)):(err=addScene(fileName,data))?(statusBox.close(),cb(err)):void(0==--count&&(statusBox.close(),cb(null,allScenes)))})}),failed?(statusBox.close(),cb(err)):void 0})}()}function __fullCompile(project,path){__shortCompile(project,function(err,allScenes){fh.readFile("compile_head.txt",function(err,headContents){fh.readFile("compile_tail.txt",function(err,tailContents){fh.writeFile(path+project.getName()+".html",headContents+"<script>allScenes = "+JSON.stringify(allScenes)+"</script>"+tailContents,function(err){if(err)throw new Error("Export failed!");var buttons=[{addClass:"btn btn-default",text:"Show Folder",onClick:function(note){__openFolder(path),note.close()}}];notification("Game Exported Successfully",project.getName(),{type:"success",buttons:buttons}).setTimeout(1e4)})})})})}function __rollbackUpdate(){updater.restore(function(err){err?notification("Warning - Rollback failed: Package Corrupt",err.message,{type:"error",timeout:1e4}):notification("Rollback Succesful","The previous app package has been restored")})}function __update(channel){if(!updating){var status=notification("Downloading Update","Do not close the program",{progress:!0,closeWith:!1,timeout:!1}),eventHandlers={progress:function(val){isNaN(val)||status.setProgress(val)},error:function(title,msg){notification(title,msg,{type:"error"})}};updating=!0,updater.update(channel,eventHandlers,function(err){status.close(),updating=!1,err?(notification("Update Failed",err.message,{type:"error",timeout:1e4}),__rollbackUpdate()):notification("Update Complete","Please restart the application.",{type:"success"})})}}function __showUpdatePrompt(channel,update){var buttons=[{addClass:"btn btn-default",text:"Download",onClick:function(note){note.close(),__update(channel)}},{addClass:"btn btn-default",text:"Cancel",onClick:function(note){note.close()}}];notification("Update Available",update.desc,{closeWith:!1,timeout:!1,buttons:buttons})}function __updateConfig(){var newConfig=JSON.stringify(config,null,"\t");localStorage.setItem("CSIDE_appConfig",newConfig)}function __updatePersistenceList(){config.openProjects=[];for(var thisProject,i=0;i<projects().length;i++){thisProject={path:projects()[i].getPath(),source:projects()[i].getSource(),name:projects()[i].getName(),expanded:projects()[i].isExpanded(),openScenes:[]};for(var thisScene,n=0;n<projects()[i].getScenes().length;n++)thisScene={path:projects()[i].getScenes()[n].getPath(),source:projects()[i].getScenes()[n].getSource(),color:projects()[i].getScenes()[n].getMarkColour()},thisProject.openScenes.push(thisScene);config.openProjects.unshift(thisProject)}__updateConfig()}function dragSceneEvent(arg,event,ui){function execute(action){sceneExists(arg.item.getName(),targetProject,function(exists){exists?($(ui.sender).sortable("cancel"),arg.cancelDrop=!0,bootbox.alert("This project already has a scene by that name.")):action()})}if(console.log(arg,arg.item,arg.targetParent,arg.targetParent(),event,ui,ui.target),console.log(),arg.sourceParent!=arg.targetParent){var targetProject=ko.dataFor(event.target),movingScene=arg.item;arg.cancelDrop=!0,bootbox.dialog({message:"Would you like to <b>move</b> or <b>copy</b> this scene to this project?",title:"What would you like to do?",buttons:{copy:{label:"Copy",className:"btn-primary",callback:function(){execute(function(){movingScene.copyTo(targetProject)})}},move:{label:"Move",callback:function(){execute(function(){movingScene.moveTo(targetProject)})}},cancel:{label:"Cancel",callback:function(){}}}})}}function fileBrowser(){function fileFolderItem(data){var thisFileFolder=this;if(thisFileFolder.is_folder="folder"==data[".tag"]||data.isFolder||data.is_folder,thisFileFolder.name=data.name,thisFileFolder.path=data.path,thisFileFolder.icon=data.icon?data.icon:data.isFolder?"fa fa-folder-o fa-lg":"fa fa-file-o fa-lg",thisFileFolder.selected=ko.observable(!1),thisFileFolder.index=data.listIndex,thisFileFolder.select=function(data,event,forcedValue,skipKeyCheck){if(!skipKeyCheck){var selectedList=self.selection(),fullList=self.filesAndFolders();if(!ctrlPressed&&!shiftPressed&&selectedList.length>0){for(var s in selectedList)fullList[selectedList[s].index].selected(!1);self.selection([])}else if(shiftPressed){selectedList.sort(function(a,b){return a.index-b.index});var topToBottom=!1;if(self.selection()<1)for(var i=0;i<thisFileFolder.index;i++)fullList[i].select({},{},!0,!0);else{for(var i=0;i<thisFileFolder.index;i++)if(fullList[i].selected()){topToBottom=!0;break}if(topToBottom)for(var i=selectedList[0].index;i<thisFileFolder.index;i++)fullList[i].selected()||fullList[i].select({},{},!0,!0);else for(var i=selectedList[selectedList.length-1].index;i>thisFileFolder.index;i--)fullList[i].selected()||fullList[i].select({},{},!0,!0)}}}forcedValue?thisFileFolder.selected(forcedValue):thisFileFolder.selected()?thisFileFolder.selected(!1):thisFileFolder.selected(!0),self.selection.push(thisFileFolder)},data.isFolder&&!self.selectingFolder?thisFileFolder.open=function(){self.redraw(thisFileFolder.path)}:thisFileFolder.open=function(){"function"==typeof self.callback?(self.selection=ko.observableArray([thisFileFolder]),self.executeTask()):self.close()},thisFileFolder.dateModified=data.modifiedAt||"",""!=thisFileFolder.dateModified){var parsedDate={};parsedDate.day=data.modifiedAt.getDate(),parsedDate.month=data.modifiedAt.getMonth(),parsedDate.year=data.modifiedAt.getFullYear(),parsedDate.hours=data.modifiedAt.getHours(),parsedDate.mins=data.modifiedAt.getMinutes(),parsedDate.mins.toString().length<2&&(parsedDate.mins="0"+parsedDate.mins.toString()),thisFileFolder.dateModified=" - last modified at "+parsedDate.day+"/"+parsedDate.month+"/"+parsedDate.year+" at "+parsedDate.hours+":"+parsedDate.mins}thisFileFolder.isFolder=function(){return thisFileFolder.is_folder}}var shiftPressed=!1,ctrlPressed=!1;$(document).keydown(function(e){17==e.keyCode&&(e.preventDefault(),ctrlPressed=!0),16==e.keyCode&&(e.preventDefault(),shiftPressed=!0)}),$(document).keyup(function(e){17==e.keyCode&&(e.preventDefault(),ctrlPressed=!1),16==e.keyCode&&(e.preventDefault(),shiftPressed=!1)});var self=this,visible=ko.observable(!1),loading=ko.observable(!1),curPath=ko.observable(""),buttonText=ko.observable("Open"),browserTitle=ko.observable("Open scenes"),stateDesc=ko.observable(""),error=ko.observable(!1);self.getButtonText=ko.computed(function(){return buttonText()},this),self.getBrowserTitle=ko.computed(function(){return browserTitle()+": "+curPath()},this),self.isVisible=ko.computed(function(){return visible()},this),self.isLoading=ko.computed(function(){return loading()},this),self.getStateDesc=ko.computed(function(){return stateDesc()},this),self.hasErrored=ko.computed(function(){return error()},this),self.path=ko.computed(function(){return curPath()},this),self.selectingFolder=!1,self.filesAndFolders=ko.observableArray([]),self.selection=ko.observableArray([]),this.cancel=function(){"function"==typeof self.callback&&self.callback([]),self.close()},this.close=function(){var selectedList=self.selection(),fullList=self.filesAndFolders();for(var s in selectedList)fullList[selectedList[s].index].selected(!1);self.selection([]),self.callback=null,self.selectingFolder=!1,visible(!1)},this.open=function(path,callback){"function"==typeof path&&(callback=path,path=""),self.selectingFolder?(buttonText("Select"),browserTitle("Select a Folder")):(buttonText("Open"),browserTitle("Open scenes")),self.callback=callback,path=path||curPath(),self.redraw(path),visible(!0)},this.redraw=function(path){stateDesc("Connecting..."),loading(!0),error(!1),curPath(path),self.filesAndFolders([]),self.selection([]);var position=0;fh.readDir(path,function(err,listStats){if(err)error(!0),stateDesc("Failed to connect. Please check your internet connection.");else{if("/"!=curPath()&&""!=curPath()){var array=curPath().split("/");array.pop();var parentPath=array.join("/");self.filesAndFolders.push(new fileFolderItem({name:"Up a level",path:parentPath,isFolder:!0,icon:"fa fa-level-up fa-lg",listIndex:position})),position++}for(var i=0;i<listStats.length;i++)(listStats[i].isFolder||".txt"==getFileExtension(listStats[i].path))&&(listStats[i].listIndex=position,self.selectingFolder&&!listStats[i].isFolder||(position++,self.filesAndFolders.push(new fileFolderItem(listStats[i]))))}loading(!1)},!0)},this.selectFolders=function(callback){self.selectingFolder=!0,self.open("",callback)},this.executeTask=function(){!self.selectingFolder&&1==self.selection().length&&self.selection()[0].isFolder()?self.selection()[0].open():(self.callback(self.selection()),self.close())}}function contextMenu(newTarget,newOptions){var self=this,target=newTarget,options=newOptions;self.getTitle=function(){return title},self.getOptions=ko.computed(function(){return options()},this),self.getTarget=function(){return target}}function menuOption(newLabel,newAction,newSubMenu){var self=this,label=newLabel,action=newAction,subMenu=newSubMenu;self.getLabel=function(){return label},self.getSubMenuOptions=function(){return subMenu},self.doAction=action}function toolbarMenu(data){var menu=this,title=ko.observable(data.title||""),expanded=ko.observable(!1);menu.isActive=data.active||!0,menu.getTarget=data.target,menu.doAction=function(option){expanded(!1),option.doAction(menu)},menu.isExpanded=ko.computed(function(){return expanded()},this),menu.toggle=function(force){expanded("boolean"==typeof force?force:expanded()?!1:!0)},menu.getTitle=function(){return title()}(),menu.getOptions=ko.computed(function(){return data.options()},this)}function CSIDE_ContextMenu(){var self=this;self.isReady=function(){return!0};var menu=ko.observable();self.getContextMenu=ko.computed(function(){return menu()},this),$(function(){function Menu(cutLabel,copyLabel,pasteLabel){var menu=(require("nw.gui"),new nw.Menu),cut=new nw.MenuItem({label:cutLabel||"Cut",click:function(){document.execCommand("cut")}}),copy=new nw.MenuItem({label:copyLabel||"Copy",click:function(){document.execCommand("copy")}}),paste=new nw.MenuItem({label:pasteLabel||"Paste",click:function(){document.execCommand("paste")}}),indent=new nw.MenuItem({label:pasteLabel||"Indent",click:function(){editor.execCommand("indentMore")}}),dedent=new nw.MenuItem({label:pasteLabel||"Dedent",click:function(){editor.execCommand("indentLess")}}),select=new nw.MenuItem({label:"Select all",click:function(){editor.execCommand("selectAll")}}),comment=new nw.MenuItem({label:"Toggle block comment",click:function(){insertTextTags("*comment ","",!0)}}),dblLinebreak=new nw.MenuItem({label:"Insert double line break",click:function(){editor.replaceSelection("\n*line_break\n*line_break\n","end"),editor.focus()}});return menu.append(cut),menu.append(copy),menu.append(paste),menu.append(indent),menu.append(dedent),menu.append(select),menu.append(dblLinebreak),menu.append(comment),menu}usingNode&&($(".CodeMirror-scroll").on("contextmenu",function(e){e.preventDefault()}),$("body").on("contextmenu",".CodeMirror-code",function(e){var menu=new Menu;e.preventDefault(),menu.popup(e.originalEvent.x,e.originalEvent.y)}))}),$(function(){$("#sidebar").contextmenu({target:"#context-menu",scopes:".project-header",before:function(event,element){var project=ko.dataFor(element.parent().get(0));return menu(new contextMenu(project,projectMenuOptions)),!0}}),$("#main-project-wrap").contextmenu({target:"#context-menu",scopes:".scene",before:function(event,element){var scene=ko.dataFor(element.get(0));return!(scene.getErrState()||!scene.hasLoaded()||scene.isSaving()||scene.isLocked())&&(menu(new contextMenu(scene,sceneMenuOptions)),!0)}}),$("#file-browser-ul").contextmenu({target:"#context-menu",scopes:".file",before:function(event,element){var fileFolder=ko.dataFor(element.get(0));return menu(fileFolder.isFolder()?new contextMenu(fileFolder,folderMenuOptions):new contextMenu(fileFolder,fileMenuOptions)),!0}}),$(".CodeMirror-code").contextmenu({target:"#context-menu",scopes:".cm-spell-error",before:function(e,element){function replaceText(text,undo){editor.replaceSelection(text),undo&&editor.getDoc().undo(),editor.focus()}if(!typo.working){typo.working=!0;var menuElement=this.getMenu()[0];menu(new contextMenu(null,ko.observableArray([new menuOption("Working...",function(){})])));var pos=editor.coordsChar({left:e.originalEvent.x,top:e.originalEvent.y});editor.setCursor(pos);var wordCoords=editor.findWordAt(pos);editor.setSelection(wordCoords.anchor,wordCoords.head);var word=element.text(),menuOptions=ko.observableArray([]);return typo.suggest(word,5,function(suggestions){suggestions.length<1&&menuOptions.push(new menuOption("No suggestions for "+word,function(menu){}));for(var i=0;i<suggestions.length;i++)!function(i){var thisSuggestion=suggestions[i];menuOptions.push(new menuOption(thisSuggestion,function(menu){replaceText(thisSuggestion,!1),editor.focus()}))}(i);menuOptions.push(new menuOption("Ignore '"+word+"' this session",function(){userDictionary.add(word,"session"),editor.focus()})),menuOptions.push(new menuOption("Add '"+word+"' to user dictionary",function(){userDictionary.add(word,"persistent"),editor.focus()})),typo.working=!1,menu(new contextMenu(null,menuOptions)),window.innerHeight-menuElement.offsetTop<25*menuOptions().length&&(menuElement.style.top=menuElement.style.top.slice(0,menuElement.style.top.length-2)-18*menuOptions().length+"px")}),!0}}})})}ko.extenders.normalizePaths=function(target,option){return target.subscribe(function(path){target(__normalizePath(path))}),target},ko.extenders.callFunc=function(target,option){return target.subscribe(function(){option.func()}),target};var self=this;if(usingNode){var CSIDE_version=gui.App.manifest.version,nw_version=process.versions["node-webkit"],platform=platform="darwin"===process.platform?"mac_os":process.platform,updating=("mac_os"===platform?process.execPath.substring(0,process.execPath.lastIndexOf("/")+1):process.execPath.substring(0,process.execPath.lastIndexOf("\\")+1),!1),autoSaveFn=null,autoUpdateCheckFn=null;self.isUpdating=function(){return updating}}else var CSIDE_version="Dropbox Alpha",platform="web-dropbox";var CONST_IMG_PREFIX="csideimg_",user={name:usingNode?require("username").sync():"Dropbox User",path:"/"};user.name=user.name.charAt(0).toUpperCase()+user.name.slice(1);var projectMenuOptions=ko.observableArray([new menuOption("Add new scene",function(menu){menu.getTarget().addNewScene()}),new menuOption("Open all scenes",function(menu){menu.getTarget().openAllScenes()}),new menuOption("Reload all scenes",function(menu){menu.getTarget().reloadAllScenes()}),new menuOption("Review",function(menu){},[new menuOption("Word count",function(menu){cside.showWordCount(menu.getTarget())})]),new menuOption("Export",function(menu){},[new menuOption("All scenes to folder",function(menu){menu.getTarget().exportScenes()})]),new menuOption("Open folder in "+("mac_os"===platform?"Finder":"Explorer"),function(menu){menu.getTarget().openFolder()}),new menuOption("Show/hide project",function(menu){menu.getTarget().setExpand()}),new menuOption("Close project",function(menu){menu.getTarget().close()})]),sceneMenuOptions=ko.observableArray([new menuOption("Edit",function(menu){},[new menuOption("Convert all spaces to tabs",function(menu){__normalizeSceneIndentation(menu.getTarget(),"tabs")}),new menuOption("Convert all tabs to spaces",function(menu){__normalizeSceneIndentation(menu.getTarget(),"spaces")})]),new menuOption("Review",function(menu){},[new menuOption("Word count",function(menu){cside.showWordCount(menu.getTarget())})]),new menuOption("Reload",function(menu){menu.getTarget().load(function(err,scene){err||selectedScene()!==menu.getTarget()||scene.select()})}),new menuOption("Close",function(menu){menu.getTarget().close()}),new menuOption("Delete file",function(menu){menu.getTarget().del()})]);usingNode&&(sceneMenuOptions.push(new menuOption("Export",function(menu){},[new menuOption("Copy file to folder",function(menu){var scene=menu.getTarget();fh.selectFolder(function(newPath){newPath&&bootbox.confirm("<h3>Warning</h3><p>This will <b>overwrite</b> any file with the same name in '<i>"+newPath+"</i>'.<br>Are you sure you wish to continue?</p>",function(result){result&&fh.copyFile(scene.getPath(),newPath+scene.getName()+".txt",function(err,data){if(err)notification("Export Failed",err.message,{type:"error"});else{var note,buttons=[{addClass:"btn btn-default",text:"Show Folder",onClick:function(note){__openFolder(newPath),note.close()}}];note=notification("Export Succesful","Copied "+scene.getName()+" to "+newPath,{type:"success",buttons:buttons}),note.setTimeout(3e3)}})})})}),new menuOption("Print file",function(menu){nw.Window.open("file://"+menu.getTarget().getPath(),{focus:!0,width:800,height:600},function(win){win.window.print()})})])),projectMenuOptions.splice(4,0,new menuOption("Import",function(menu){},[new menuOption("Image (as scene)",function(menu){menu.getTarget().isReadOnly()||fh.selectImage(function(path){path&&__createImageScene(menu.getTarget(),path)})})])),projectMenuOptions.splice(6,0,new menuOption("Test Project",function(menu){},[new menuOption("Quicktest",function(menu){menu.getTarget().test("quick")}),new menuOption("Randomtest",function(menu){"web-dropbox"!=platform?menu.getTarget().test("random"):bootbox.alert("<h3>Apologies...</h3><p>But due to technical limitations randomtest can only be run in the Desktop version of the Choicescript IDE.</p></h3>")})])),projectMenuOptions()[5].getSubMenuOptions().push(new menuOption("Compiled game",function(menu){menu.getTarget().compile()})));var projects=ko.observableArray([]),selectedScene=ko.observable(null),selectedProject=ko.computed(function(){return selectedScene()?selectedScene().getProject():null});if(self.getSelectedProject=ko.computed(function(){return selectedProject()},this),"mac_os"===platform){var nativeMenuBar=new nw.Menu({type:"menubar"});"darwin"===process.platform&&nativeMenuBar.createMacBuiltin("CSIDE"),win.menu=nativeMenuBar,function(){var projectMenu=new nw.Menu;projectMenu.getTarget=selectedProject;for(var subMenu,options=projectMenuOptions(),i=0;i<options.length;i++)if(options[i].getSubMenuOptions()){subMenu=new nw.Menu;for(var o=0;o<options[i].getSubMenuOptions().length;o++)subMenu.append(new nw.MenuItem({label:options[i].getSubMenuOptions()[o].getLabel(),click:options[i].getSubMenuOptions()[o].doAction.bind(null,projectMenu)}));projectMenu.append(new nw.MenuItem({label:options[i].getLabel(),click:options[i].doAction.bind(null,projectMenu),submenu:subMenu}))}else projectMenu.append(new nw.MenuItem({label:options[i].getLabel(),click:options[i].doAction.bind(null,projectMenu)}));var index="mac_os"===platform?3:1;win.menu.insert(new nw.MenuItem({label:"Project",submenu:projectMenu}),index)}(),function(){var sceneMenu=new nw.Menu;sceneMenu.getTarget=selectedScene;for(var subMenu,options=sceneMenuOptions(),i=0;i<options.length;i++)if(options[i].getSubMenuOptions()){subMenu=new nw.Menu;for(var o=0;o<options[i].getSubMenuOptions().length;o++)subMenu.append(new nw.MenuItem({label:options[i].getSubMenuOptions()[o].getLabel(),click:options[i].getSubMenuOptions()[o].doAction.bind(null,sceneMenu)}));sceneMenu.append(new nw.MenuItem({label:options[i].getLabel(),click:options[i].doAction.bind(null,sceneMenu),submenu:subMenu}))}else sceneMenu.append(new nw.MenuItem({label:options[i].getLabel(),click:options[i].doAction.bind(null,sceneMenu)}));var index="mac_os"===platform?4:2;win.menu.insert(new nw.MenuItem({label:"Scene",submenu:sceneMenu}),index)}(),"mac_os"!=platform?nw.Window.get().menu=win.menu:(ko.extenders.updateMenuBarStates=function(target,option){return target.subscribe(function(scene){var b=!!scene,projectIndex="mac_os"===platform?3:1,sceneIndex="mac_os"===platform?4:2;win.menu=nw.Window.get().menu;for(var index=projectIndex;index<=sceneIndex;index++)for(var item=0;item<win.menu.items[index].submenu.items.length;item++)win.menu.items[index].submenu.items[item].enabled=b;nw.Window.get().menu=win.menu}),target},selectedScene.extend({updateMenuBarStates:""}),selectedScene.valueHasMutated())}var reservedSceneNames="(STARTUP|CHOICESCRIPT_STATS)",validSceneColours=ko.observableArray(["rgb(125, 186, 125)","rgb(172, 209, 240)","rgb(228, 144, 150)","rgb(237, 216, 161)","rgb(161, 165, 237)","rgb(224, 161, 237)","rgb(163, 163, 163)","rgb(230, 230, 230)"]);validSceneColours=ko.observableArray(["rgb(114, 195, 116)","rgb(119, 151, 236)","rgb(217, 83, 79)","rgb(165, 147, 122)","rgb(255, 141, 43)","rgb(224, 121, 245)","rgb(0, 168, 195)","rgb(119, 119, 119)"]);var config,uiColour=ko.observable("90,90,90"),activeProject=(ko.observable(!1),ko.observable("")),projects=ko.observableArray([]),wordCountOn=ko.observable(!0),defaultConfig={settings:{editor:{tabtype:"spaces",smartindent:!0,tabsize:"4",linewrap:!0,fontsize:"12px",spell_dic:"en_US",theme:"cs-dark",spellcheck:!0,autosuggest:!1,"word-count":2,"visible-tabs":!1},app:{persist:!0,autosave:!0,cmdhelp:!1,"update-channel":"stable","ui-colour":"90,90,90","project-path":"default"}},openProjects:[],userDictionary:{}};try{config=JSON.parse(localStorage.getItem("CSIDE_appConfig"))||defaultConfig}catch(err){bootbox.alert("Sorry, there was a problem parsing your configuration settings.<br> \t\tThey have been repaired and reset to the defaults.<br><br> \t\t<b>Error:</b> "+err.message),localStorage.setItem("CSIDE_appConfig",JSON.stringify(defaultConfig)),config=defaultConfig}var userDictionary={},fh={writeFile:function(path,data,callback){switch(platform){case"web-dropbox":db.filesUpload({path:path,contents:data,mode:{".tag":"overwrite"},autorename:!1}).then(function(response){callback(null)}).catch(function(err){callback(normalizeError(err))});break;default:mkdirp(getDirName(path),function(err){err?callback(normalizeError(err)):fs.writeFile(path,data,{encoding:"utf8"},function(err){callback(normalizeError(err))})})}},readFile:function(path,callback){switch(platform){case"web-dropbox":db.filesDownload({path:path}).then(function(fileData){var reader=new FileReader;reader.addEventListener("loadend",function(){reader.result?callback(null,new TextDecoder("utf-8").decode(reader.result)):callback({})}),reader.readAsArrayBuffer(fileData.fileBlob)}).catch(function(err){callback(normalizeError(err))});break;default:fs.readFile(path,{encoding:"utf8"},function(err,data){callback(normalizeError(err),data)})}},copyFile:function(oldPath,newPath,callback){switch(platform){case"web-dropbox":db.filesCopy({from_path:oldPath,to_path:newPath}).then(function(response){callback(null)}).catch(function(err){callback(normalizeError(err))});break;default:fs.readFile(oldPath,{encoding:"utf8"},function(err,data){err?callback(normalizeError(err)):fs.writeFile(newPath,data,function(err){callback(normalizeError(err))})})}},renameFile:function(oldPath,newPath,callback){switch(platform){case"web-dropbox":db.filesMove({from_path:oldPath,to_path:newPath}).then(function(response){callback(null)}).catch(function(err){callback(normalizeError(err))});break;default:fs.rename(oldPath,newPath,function(err){callback(normalizeError(err))})}},deleteFile:function(path,callback){switch(platform){case"web-dropbox":db.filesDelete({path:path}).then(function(response){callback(null)}).catch(function(err){callback(normalizeError(err))});break;default:trash([path],function(err){callback(normalizeError(err))})}},readDir:function(path,callback,dbMetaData){switch(platform){case"web-dropbox":path="/"==path?"":path,db.filesListFolder({path:path}).then(function(response){void 0!==dbMetaData&&1==dbMetaData?callback(null,response.entries.map(function(item){return item.path=item.path_lower,item.isFolder="folder"==item[".tag"],item})):callback(null,response.entries.map(function(item){return getLastDirName(item.path_lower)}))}).catch(function(err){callback(normalizeError(err))});break;default:fs.readdir(path,function(err,filePathArray){callback(normalizeError(err),filePathArray)})}},makeDir:function(path,callback){switch(platform){case"web-dropbox":"/"==path.slice(-1,path.length)&&(path=path.slice(0,-1)),db.filesCreateFolder({path:path}).then(function(response){callback(null)}).catch(function(error){err&&403==err.status&&(delete err.status,err.code="EEXIST"),callback(normalizeError(err))});break;default:mkdirp(path,function(err){callback(normalizeError(err))})}},stat:function(path,callback){switch(platform){case"web-dropbox":db.filesGetMetadata({path:path}).then(function(response){callback(null,{mtime:new Date(response.client_modified)})}).catch(function(err){callback(normalizeError(err))});break;default:fs.stat(path,function(err,fileStats){callback(normalizeError(err),fileStats)})}},selectFolder:function(callback){switch(platform){case"web-dropbox":fileBrowser.selectFolders(function(selection){callback(selection.length>0?selection[0].path+"/":null)});break;default:var chooser=$("#selectFolder");chooser.off().change(function(evt){callback($(this).val()+"/"),$(this).val("")}),setTimeout(function(){chooser.trigger("click")},200)}},selectImage:function(callback){switch(platform){case"web-dropbox":bootbox.alert("TODO: Image scene import not yet implemented on the web-version.");break;default:var chooser=$("#getImagePaths");chooser.off().change(function(evt){callback($(this).val()),$(this).val("")}),setTimeout(function(){chooser.trigger("click")},200)}}},normalizeError=function(err){if(!err)return null;if(void 0===err.message)try{err.message=JSON.parse(err.responseText).error}catch(e){err.message="Unable to get an error description"}if(void 0===err.code&&(err.code=err.status||"Unknown Error Code"),409==err.code||429==err.code)try{err.error=JSON.parse(err.error),err.code=err.error.error[err.error.error[".tag"]][".tag"],err.message="Dropbox: "+err.error.error_summary}catch(e){}switch(err.code){case"not_found":case"ENOENT":case 404:err.code=404}return err},notification=function(title,message,options){var options=options||{};options.theme="cside_noty",options.layout=options.layout||"bottomRight",options.type=options.type||"default",options.timeout=!1!==options.timeout&&(options.timeout||5e3),options.closeWith=!1!==options.closeWith&&(options.closeWith||["click"]),options.buttons=options.buttons||null,options.animation={open:{opacity:"toggle"},close:{opacity:"toggle"},easing:"swing",speed:250},options.text=function(title,msg){return"<h5>"+title+"</h5>\t\t\t\t\t <p>"+msg+"</p>"}(title,message),options.progress&&(options.text+="<progress value='0' max='100'></progress>");var n=noty(options);return options.progress&&(n.setProgress=function(val){n.$message.find(".noty_text").find("progress").val(val)}),n};if(self.notification=function(title,message,options){notification(title,message,options)},"web-dropbox"==platform){if(utils.parseQueryString(window.location.hash).access_token){var db=new Dropbox({accessToken:utils.parseQueryString(window.location.hash).access_token});db.setClientId("hnzfrguwoejpwbj")}else{var db=new Dropbox({clientId:"hnzfrguwoejpwbj"}),authUrl=db.getAuthenticationUrl(window.location);window.location=authUrl}db.usersGetCurrentAccount().then(function(acc){user.name=acc.name.display_name}).catch(function(err){})}window.db=db;var dropboxAuthorised=ko.observable(!1),typo=new Typo("","","",{platform:"any"});if(self.dbAuth=ko.computed(function(){return dropboxAuthorised()},this),self.getProjects=projects,self.getSelectedScene=ko.computed(function(){return selectedScene()},this),self.getActiveProject=ko.computed(function(){return activeProject()},this),self.getValidSceneColours=ko.computed(function(){return validSceneColours()},this),self.getPlatform=function(){return platform},self.wordCountOn=ko.computed(function(){return wordCountOn()}),self.getUIColour=function(delta){delta=delta||0;for(var val,rgb=uiColour().split(","),i=0;i<rgb.length;i++)val=parseInt(rgb[i])+delta,val<0?val=0:val>255&&(val=255),rgb[i]=val;return"rgb("+rgb.join(",")+")"},self.selectTab=function(tab){for(var tabs=self.tabs(),i=0;i<tabs.length;i++)if(tab===tabs[i].id){__selectTab(tab);break}},self.readFile=function(url,callback){fh.readFile(url,callback)},self.selectScene=function(scene){scene.select()},self.session={save:function(cb){var failed=!1,count=projects().length;if(count<1)return void cb(null);projects().forEach(function(project,index){project.save(function(err){if(err){if(failed)return;return failed=!0,cb(err)}0==--count&&cb(null)})})},isDirty:ko.computed(function(){for(var i=0;i<projects().length;i++)if(projects()[i].isDirty())return!0;return!1})},self.session.win=function(){var fullScreen=ko.observable(!0);return{isFullscreen:ko.computed(function(){return fullScreen()},this),toggleMaximize:function(){fullScreen()?win.restore():"mac_os"===platform?win.enterFullscreen():win.maximize(),fullScreen(!fullScreen())}}}(),"mac_os"==platform||"web-dropbox"==platform&&"MacIntel"==window.navigator.platform)var keymap={"Cmd-S":function(ed){selectedScene().save()},"Cmd-W":function(ed){selectedScene().close()},"Cmd-N":function(ed){selectedProject().addNewScene()},"Cmd-Q":function(ed){usingNode&&win.close()},"Shift-Cmd-S":function(ed){selectedProject().save()},"Shift-Cmd-W":function(ed){selectedProject().close()},"Shift-Cmd-N":function(ed){self.createProject()},"Shift-Cmd-,":function(ed){self.scenePanel()},"Shift-Cmd-.":function(ed){self.tabPanel()},"Shift-Cmd-O":function(ed){selectedProject().openAllScenes()},"Shift-Tab":function(ed){ed.indentSelection("subtract")},"Cmd-O":function(ed){self.openFileBrowser()},"Cmd-D":function(ed){insertTextTags("${","}")},"Cmd-B":function(ed){insertTextTags("[b]","[/b]")},"Cmd-I":function(ed){insertTextTags("[i]","[/i]")},"Cmd-T":function(ed){selectedProject().test("quick")},"Shift-Cmd-T":function(ed){selectedProject().test("random")},"Shift-Cmd-Enter":function(ed){selectedProject().run()},"Shift-Cmd-C":function(ed){selectedProject().toggleConsole()&&$("#cs-console > input").focus()},"Cmd-Alt-Down":function(ed){self.moveSelection("down")},"Cmd-Alt-Up":function(ed){self.moveSelection("up")},F11:function(ed){ed.setOption("fullScreen",!ed.getOption("fullScreen"))},Esc:function(ed){ed.setOption("fullScreen",!ed.getOption("fullScreen"))}};else var keymap={"Ctrl-S":function(ed){selectedScene().save()},"Ctrl-W":function(ed){selectedScene().close()},"Ctrl-N":function(ed){selectedProject().addNewScene()},"Ctrl-O":function(ed){self.openFileBrowser()},"Shift-Ctrl-O":function(ed){selectedProject().openAllScenes()},"Shift-Ctrl-S":function(ed){selectedProject().save()},"Shift-Ctrl-W":function(ed){selectedProject().close()},"Shift-Ctrl-N":function(ed){self.createProject()},"Shift-Ctrl-,":function(ed){self.scenePanel()},"Shift-Ctrl-.":function(ed){self.tabPanel()},"Shift-Ctrl-Q":function(ed){usingNode&&win.close()},"Shift-Tab":function(ed){ed.indentSelection("subtract")},"Ctrl-D":function(ed){insertTextTags("${","}")},"Ctrl-B":function(ed){insertTextTags("[b]","[/b]")},"Ctrl-I":function(ed){insertTextTags("[i]","[/i]")},"Ctrl-T":function(ed){selectedProject().test("quick")},"Shift-Ctrl-T":function(ed){selectedProject().test("random")},"Shift-Ctrl-Enter":function(ed){selectedProject().run()},"Shift-Ctrl-C":function(ed){selectedProject().toggleConsole()&&$("#cs-console > input").focus()},"Shift-Ctrl-Down":function(ed){self.moveSelection("down")},"Shift-Ctrl-Up":function(ed){self.moveSelection("up")},F11:function(ed){ed.setOption("fullScreen",!ed.getOption("fullScreen"))},Esc:function(ed){ed.setOption("fullScreen",!ed.getOption("fullScreen"))}};var editor=CodeMirror.fromTextArea(document.getElementById("code-textarea"),{mode:{name:"choicescript",version:2,singleLineStringErrors:!1},lineNumbers:!0,lineWrapping:!0,tabSize:4,indentUnit:4,indentWithTabs:!0,matchBrackets:!0,extraKeys:keymap,gutters:["arrow-gutter","CodeMirror-linenumbers"]});self.moveSelection=function(direction){
if("up"===direction||"down"===direction)for(var selections=editor.listSelections(),i=0;i<selections.length;i++){var top=selections[i].from(),bottom=selections[i].to(),alpha="down"===direction?1:-1;if(void 0===editor.getLine(top.line+alpha)||void 0===editor.getLine(bottom.line+alpha))return;0===bottom.ch&&(bottom.line--,bottom.ch=editor.getLine(bottom.line).length);var storeLine="down"===direction?editor.getLine(bottom.line+alpha):editor.getLine(top.line+alpha),movingLines=editor.getRange({line:top.line,ch:0},{line:bottom.line,ch:editor.getLine(bottom.line).length});editor.replaceRange(movingLines,{line:top.line+alpha,ch:0},{line:bottom.line+alpha,ch:editor.getLine(bottom.line+alpha).length}),"down"===direction?editor.replaceRange(storeLine,{line:top.line,ch:0},{line:top.line,ch:editor.getLine(top.line).length}):editor.replaceRange(storeLine,{line:bottom.line,ch:0},{line:bottom.line,ch:editor.getLine(bottom.line).length}),editor.setSelection({line:top.line+alpha,ch:0},{line:bottom.line+alpha,ch:editor.getLine(bottom.line+alpha).length})}};editor.addOverlay(function(){var word=new RegExp(/\b([A-Za-z]+'[A-Za-z]+|[A-Za-z]{2,}|[AaI]'?)\b/g),cmd=new RegExp(/^\s*\*[A-Za-z_]+\b/);new RegExp(/\{.*\}/g);return{token:function(stream){if(0===stream.pos){var cmd_match=cmd.exec(stream.string);cmd_match&&(stream.pos+=cmd_match[0].length||1)}word.lastIndex=stream.pos;var word_match=word.exec(stream.string);if(word_match&&word_match.index==stream.pos)return stream.pos+=word_match[0].length||1,cside.spellCheck(word_match[0])?style="null":style="spell-error";word_match?stream.pos++:stream.skipToEnd()}}}()),editor.on("dragover",function(cm,e){$(".CodeMirror-cursors .CodeMirror-cursor").css("visibility","visible");var xy={left:e.x,top:e.y},newPos=editor.coordsChar(xy);editor.setCursor(newPos)}),editor.on("dragstart",function(cm,e){e.dataTransfer.setData("Text",editor.getSelection())}),editor.on("renderLine",function(cm,line,elt){var charWidth=editor.defaultCharWidth(),off=CodeMirror.countColumn(line.text,null,cm.getOption("tabSize"))*charWidth,pixelTabSize=8*editor.options.tabSize,indentLevel=off/pixelTabSize,leftMargin=pixelTabSize*indentLevel;elt.style.paddingLeft=leftMargin+"px",elt.style.textIndent="-"+leftMargin/(indentLevel+1)+"px"}),editor.refresh(),editor.forceSyntaxRedraw=function(){editor.setOption("mode","choicescript")};var insertTextTags=function(tagStart,tagEnd,allowSpecialLines){var text=editor.getSelection(),cursorLoc="around";if(text){var line,whitespace;text=text.split("\n");for(var i=0;i<text.length;i++)""!==(line=text[i])&&(allowSpecialLines||!line.match(/^\s*\*[A-Za-z_]+\b/)&&!line.match(/^\s*#/))&&((whitespace=line.match(/^\s+/g))&&(line=line.replace(/^\s+/g,"")),line=line.substring(0,tagStart.length)===tagStart&&line.substring(line.length-tagEnd.length,line.length)===tagEnd?line.substring(tagStart.length,line.length-tagEnd.length):tagStart+line+tagEnd,whitespace=whitespace||"",text[i]=whitespace+line);text=text.join("\n")}else text=tagStart+tagEnd,cursorLoc="start";editor.replaceSelection(text,cursorLoc),"start"===cursorLoc&&editor.setCursor(editor.getCursor().line,editor.getCursor().ch+tagStart.length)};self.tabs=ko.observableArray([{id:"game",title:"Game",showTitle:!0,iconClass:"fa fa-cube",href:ko.observable(""),content:"",visible:ko.observable(!0),getHeaderTitle:ko.computed(function(){return activeProject()?activeProject().getName():"Run a Project"},this)},{id:"issues",title:"Issues",showTitle:!0,iconClass:"fa fa-exclamation-triangle",href:"",content:"",visible:ko.observable(!0),getHeaderTitle:ko.computed(function(){return selectedProject()?"Issues with "+selectedProject().getName():"Select a Project"},this)},{id:"settings",title:"Settings",showTitle:!1,iconClass:"fa fa-cog",href:"",content:"",visible:ko.observable(!0),getHeaderTitle:""},{id:"help",title:"Help & Information",showTitle:!0,iconClass:"fa fa-question-circle",href:"help/index.html",content:"",visible:ko.observable(!0),getHeaderTitle:"Help & Information"},{id:"dictionary",title:"User Dictionary",showTitle:!0,iconClass:"fa fa-book",href:"",content:"",visible:ko.observable(!0),getHeaderTitle:"User Dictionary"}]),usingNode&&(self.tabs.push({id:"examples",title:"Example Projects & Templates",showTitle:!0,iconClass:"fa fa-lightbulb-o",href:"",content:"",visible:ko.observable(!0),getHeaderTitle:"Example Projects & Templates"}),self.cs_examples=[{title:"Interactive CSIDE Tutorial",desc:"A great starting point tutorial - developed by Vendetta. Useful for those new to both Choicescript and the Choicescript IDE.",path:"cs_examples/CSIDE Tutorial/"},{title:"ChoiceScript Basics Tutorial",desc:"A simple tutorial template by FairyGodfeather. This example project is designed to get you started with handling name, gender and relationship stats in your ChoiceScript games. A great starting point for any new project!",path:"cs_examples/Basics Tutorial/"},{title:"Pronouns with Gender-Neutral Options Template",desc:'A template for including gender neutral pronouns in your game (they/them), created by Lynnea Glasser. This includes a variable system to make sure your verbs and pronouns will match ("They go on ahead"/"She goes on ahead").',path:"cs_examples/GNO Pronoun Template/"}],self.cloneExample=function(data){self.createProject("",function(err,project){if(err)return void notification("Error",err.message,{type:"error"});__copyProjectTo(data.path,project.getPath(),function(err){if(err)return void notification("Error",err.message,{type:"error"});project.openAllScenes(),notification("Import Successful",data.title+" imported to "+project.getPath(),{type:"success"})})},!0)});var settings={editor:ko.observableArray([new CSIDESetting({id:"smartindent",name:"Smart Indentation",value:!0,type:"binary",cat:"editor",desc:"Automatically indent (or dedent) the cursor after flow-control commands",apply:function(val){val?editor.setOption("smartIndent",!0):editor.setOption("smartIndent",!1)}}),new CSIDESetting({id:"linewrap",name:"Line Wrapping",value:!0,type:"binary",cat:"editor",desc:"Wrap lines that exceed the editor's width (no horizontal scrolling)",apply:function(val){val?(editor.setOption("lineWrapping",!0),editor.on("renderLine",function(cm,line,elt){var off=CodeMirror.countColumn(line.text,null,cm.getOption("tabSize"))*editor.defaultCharWidth(),pixelTabSize=8*editor.options.tabSize,indentLevel=off/pixelTabSize,leftMargin=pixelTabSize*indentLevel;elt.style.paddingLeft=leftMargin+"px",elt.style.textIndent="-"+leftMargin/(indentLevel+1)+"px"}),editor.refresh()):(delete editor._handlers.renderLine,editor.setOption("lineWrapping",!1),editor.refresh())}}),new CSIDESetting({id:"autosuggest",name:"Auto Suggest",value:!0,type:"binary",cat:"editor",desc:"Prompt quick-complete word suggestions as you type",apply:function(val){if(val){var setting=this;setting.timeout,editor.on("inputRead",function(cm,change){setting.getValue()&&1==change.text.length&&change.text[0].match(/\w$/)&&(setting.timeout&&clearTimeout(setting.timeout),setting.timeout=setTimeout(function(){CodeMirror.showHint(cm,null,{completeSingle:!1,extraKeys:{Enter:function(){return!1}}})},150))})}}}),new CSIDESetting({id:"spellcheck",name:"Spell Check",value:!0,type:"binary",cat:"editor",desc:"Spell checks words as you type - excluding those on command and option lines",apply:function(val){editor.setOption("spellcheck",val),editor.forceSyntaxRedraw()}}),new CSIDESetting({id:"spell_dic",name:"Spell Check Dictionary",value:"en_US",type:"variable",cat:"editor",options:[{desc:"US",value:"en_US"},{desc:"GB",value:"en_GB"}],desc:"The dictionary to spellcheck against",apply:function(val){typo=new Typo(val,typo._readFile("lib/typo/dictionaries/"+val+"/"+val+".aff"),typo._readFile("lib/typo/dictionaries/"+val+"/"+val+".dic"),{platform:"any"}),editor.forceSyntaxRedraw()}}),new CSIDESetting({id:"visible-tabs",name:"Visible Tabs",value:!1,type:"binary",cat:"editor",desc:"Provides visible indentation levels when using Tabs as the indentation unit",apply:function(val){val?document.getElementById("editor-wrap").classList.add("visible-tabs"):document.getElementById("editor-wrap").classList.remove("visible-tabs")}}),new CSIDESetting({id:"word-count",name:"Word Count",value:2,type:"variable",cat:"editor",desc:"Display the current scene's word and character counts at the bottom of the editor window",options:[{desc:"Exclude cmd lines",value:2},{desc:"Include cmd lines",value:1},{desc:"Off",value:0}],apply:function(val){wordCountOn(val>0),editor.setOption("word_count",val>0),editor.setOption("exclude_cmd_lines",val>1)}}),new CSIDESetting({id:"tabtype",name:"Tab Type",value:"tabs",type:"variable",cat:"editor",desc:"",options:[{desc:"Tabs",value:"tabs"},{desc:"Spaces",value:"spaces"}],desc:"Sets the indentation unit (used by smart indent)",apply:function(val){"spaces"==val?(editor.setOption("indentWithTabs",!1),keymap.Tab=function(cm){if(cm.somethingSelected())cm.indentSelection("add");else{var spaces=Array(cm.getOption("indentUnit")+1).join(" ");cm.replaceSelection(spaces)}}):(editor.setOption("indentWithTabs",!0),keymap.Tab=function(){editor.execCommand("defaultTab")})}}),new CSIDESetting({id:"tabsize",name:"Tab/Indent Block Size",value:"4",type:"variable",cat:"editor",options:[{desc:"2",value:"2"},{desc:"4",value:"4"},{desc:"6",value:"6"},{desc:"8",value:"8"}],desc:"The number of spaces to indent by, or the visual size of tabs (used by smart indent)",apply:function(val){var intVal=parseInt(val,10);editor.setOption("indentUnit",intVal),editor.setOption("tabSize",intVal)}}),new CSIDESetting({id:"fontsize",name:"Font Size (px)",value:"12px",type:"variable",cat:"editor",options:[{desc:"10",value:"10px"},{desc:"12",value:"12px"},{desc:"14",value:"14px"},{desc:"16",value:"16px"}],desc:"The size of the font in the editor window",apply:function(val){$("#editor-wrap").css("font-size",val),editor.refresh()}}),new CSIDESetting({id:"theme",name:"Editor Theme",value:"cs-light",type:"variable",cat:"editor",options:[{desc:"Dark",value:"cs-dark"},{desc:"Light",value:"cs-light"},{desc:"Dichromatic",value:"cs-dichromatic"}],desc:"Sets the colour and style of the editor window and its text",apply:function(val){"lesser-dark"!=val&&"choicescript"!=val&&"erlang-dark"!=val||(val="cs-light"),editor.setOption("theme",val)}})]),app:ko.observableArray([new CSIDESetting({id:"version",name:"Version: "+CSIDE_version,value:"",type:"variable",options:[],desc:"",apply:function(val){}}),new CSIDESetting({id:"autosave",name:"Autosave Scenes & Projects",value:!1,type:"binary",desc:"Save all unsaved changes automatically (every 5 minutes)",apply:function(val){void 0!==autoSaveFn&&autoSaveFn&&clearInterval(autoSaveFn),val&&(autoSaveFn=setInterval(function(){self.session.save(function(err){err&&bootbox.alert("<h3>Save Error</h3>"+err.message)})},3e5))}}),new CSIDESetting({id:"persist",name:"Persistent Session",value:!1,type:"binary",desc:"Retain open scenes & project data between sessions",apply:function(val){}}),new CSIDESetting({id:"cmdhelp",name:"Command Help (prompts & links)",value:!1,type:"binary",desc:"Commands in the editor window will link to their appropriate choicescriptdev.wikia page when double-clicked",apply:function(val){val?$(".CodeMirror").off().on("mouseover",".cm-builtin, .cm-keyword",function(){$(this).css("cursor","pointer"),$(this).attr("title","Double-Click for help with this command")}).on("mouseout",".cm-builtin, .cm-keyword",function(){$(this).css("cursor",""),$(this).removeAttr("title")}).on("dblclick",".cm-builtin, .cm-keyword",function(e){e.preventDefault(),e.stopPropagation();var cmdEle=$(this).parent().children(":first-child"),text=cmdEle.text().trim(),commandName=text.match(/^\*[\w_]+/);if(commandName){commandName=commandName[0].substring(1,text.length),__selectTab("help");var url="http://www.choicescriptdev.wikia.com/"+commandName;usingNode?gui.Shell.openExternal(url):window.open(url)}}):$(".CodeMirror").off()}}),new CSIDESetting({id:"project-path",name:"Project Folder",value:"default",type:"custom",options:[{desc:"Select",value:"select"},{desc:"Default",value:"default"}],desc:"",apply:function(val){var self=this;if("default"==val){if(usingNode)var userDir=process.env["win32"==process.platform?"USERPROFILE":"HOME"];var path=usingNode?userDir+"/Documents/Choicescript Projects/":"/Choicescript Projects/";self.setDesc(path),user.path=path}else"select"==val?(fh.selectFolder(function(path){path&&(path=__normalizePath(path),self.setValue(path),self.setDesc(path),user.path=path,config.settings[self.getCat()][self.getId()]=path,__updateConfig())}),self.setValue(user.path),config.settings[self.getCat()][self.getId()]=user.path,__updateConfig()):(self.setDesc(val),user.path=val)}}),new CSIDESetting({id:"update-channel",name:"Update Channel",value:"stable",type:"variable",options:[{desc:"Stable",value:"stable"},{desc:"Latest",value:"latest"},{desc:"None",value:"none"}],desc:"",apply:function(channel){if(void 0!==autoUpdateCheckFn&&autoUpdateCheckFn&&clearInterval(autoUpdateCheckFn),"none"!=channel&&usingNode){var autoUpdate=function(){var n=notification("","<i class='fa fa-refresh fa-spin'></i> Checking for updates...",{closeWith:!1,timeout:!1});updater.checkForUpdates({cside:CSIDE_version,nw:nw_version},channel,function(err,update){n.close(),err?notification("Connection Error","Failed to obtain update data from server. "+err.message,{type:"error"}):update&&__showUpdatePrompt(channel,update)})};autoUpdateCheckFn=setInterval(autoUpdate,36e5),autoUpdate()}}}),new CSIDESetting({id:"ui-colour",name:"Colour Scheme",value:"rgb(90, 90, 90)",type:"variable",desc:"",options:[{desc:"<div class='setting-colour-swatch' style='background-color: rgb(90, 90, 90)'></div>",value:"granite"},{desc:"<div class='setting-colour-swatch' style='background-color: rgb(175, 93, 111)'></div>",value:"garnet"},{desc:"<div class='setting-colour-swatch' style='background-color: rgb(147, 122, 175)'></div>",value:"amethyst"},{desc:"<div class='setting-colour-swatch' style='background-color: rgb(107, 166, 125)'></div>",value:"emerald"},{desc:"<div class='setting-colour-swatch' style='background-color: rgb(94,104,121)'></div>",value:"slate"},{desc:"<div class='setting-colour-swatch' style='background-color: rgb(129,127,122)'></div>",value:"sandstone"},{desc:"<div class='setting-colour-swatch' style='background-color: rgb(51, 164, 164)'></div>",value:"jade"},{desc:"<div class='setting-colour-swatch' style='background-color: rgb(76,91,152)'></div>",value:"sapphire"}],apply:function(val){var colour;switch(val){case"granite":colour="90,90,90";break;case"amethyst":colour="147,122,175";break;case"garnet":colour="175,93,111";break;case"emerald":colour="60,100,80";break;case"slate":colour="94,104,121";break;case"sandstone":colour="129,127,122";break;case"jade":colour="51,164,164";break;case"sapphire":colour="76,91,152";break;default:colour="90,90,90"}uiColour(colour)}})]),asObject:function(settingType){if(void 0!==settings[settingType]){for(var arr=settings[settingType](),obj={},i=0;i<arr.length;i++)obj[arr[i].getId()]=arr[i].getValue();return obj}console.log("Invalid settings type passed to settings.asObject function.")}};self.getEditorSettings=ko.computed(function(){return settings.editor().map(function(setting){return setting.extAPI})}),self.getAppSettings=ko.computed(function(){return settings.app().map(function(setting){return setting.extAPI})}),self.scenePanel=function(action){if(!$("#page-content-wrapper").is(":animated")&&!$("#sidebar").is(":animated")){var sidebarLeft=$("#sidebar").css("left");parseInt(sidebarLeft.slice(0,sidebarLeft.length-2))<0?($("#page-content-wrapper").animate({left:230},300,function(){}),$("#sidebar").animate({left:0},300,function(){})):($("#page-content-wrapper").animate({left:0},300,function(){}),$("#sidebar").animate({left:-230},300,function(){}))}};var consoleCmdBuf=[],consoleCmdBufPtr=0;ko.observable(0);self.consoleInput=function(data,evt){if(evt){var element=evt.originalEvent.target,input=element.value;if(38===evt.keyCode){if(consoleCmdBuf.length<=0)return;--consoleCmdBufPtr<0&&(consoleCmdBufPtr=consoleCmdBuf.length-1),element.value=consoleCmdBuf[consoleCmdBufPtr]}else if(40===evt.keyCode){if(consoleCmdBuf.length<=0)return;++consoleCmdBufPtr>consoleCmdBuf.length-1&&(consoleCmdBufPtr=0),element.value=consoleCmdBuf[consoleCmdBufPtr]}if(input&&13===evt.keyCode){if(consoleCmdBuf.length>9&&consoleCmdBuf.shift(),consoleCmdBuf.push(input),consoleCmdBufPtr=consoleCmdBuf.length,selectedProject().logToConsole("> "+input,"null"),"undefined"==typeof frames||void 0===frames[0]||void 0===frames[0].window.stats)return selectedProject().logToConsole("Error: no choicescript game running","error"),void(element.value="");if(selectedProject()!=activeProject())return selectedProject().logToConsole("Error: this project is not the one running","error"),void(element.value="");try{var toks;if(input.match(/^\*/))(toks=input.match(/^\*(?:set|temp|rand|print|achieve|restart|setref|goto|goto_scene)/))||(toks=input.match(/^\*(console_)?(clear|track|untrack|untrack_all|track_all|track_list|help)/))?(toks.length>1&&"console_"!==toks[1]&&(input="*console_"+input.substring(1,input.length)),input.match(/^\*goto/)?input.match(/^\*goto\s+/)?(input=input.replace(/^\*goto\s+/,""),frames[0].window.stats.scene.CSIDEConsole_goto(input)):(input=input.replace(/^\*goto_scene\s+/,""),frames[0].window.stats.scene.CSIDEConsole_goto_scene(input)):frames[0].window.stats.scene.runCommand(input)||selectedProject().logToConsole("Error: an unknown error occured whilst attempting to execute that command","error")):selectedProject().logToConsole("Error: invalid console command","error");else{var stack=frames[0].window.stats.scene.tokenizeExpr(input),result=frames[0].window.stats.scene.evaluateExpr(stack);"string"==typeof result?result='"'+result+'"':result||(result="false"),selectedProject().logToConsole(result,"output")}}catch(e){e.message=e.message.replace(/line [0-9]+ of\s\w+: /,""),selectedProject().logToConsole("Error: "+e.message,"error")}element.value=""}}},self.tabPanel=function(action){if(!$(".left-wrap").is(":animated")&&!$(".right-wrap").is(":animated")){var isOpen=!0;if(function(ele){return 100*ele.width()/ele.offsetParent().width()}($(".left-wrap"))>60&&(isOpen=!1),"close"==action&&isOpen||!action&&isOpen)$(".right-wrap").animate({right:"-50%"},500),$(".left-wrap").animate({width:"100%"},500,function(){editor.refresh()}),$("#expand-collapse-bar").addClass("collapsed");else{if(("open"!=action||isOpen)&&(action||isOpen))return isOpen;$(".left-wrap").animate({width:"50%"},500),$(".right-wrap").animate({right:"0%"},500,function(){editor.refresh()}),$("#expand-collapse-bar").removeClass("collapsed")}}},self.openScene=function(path,callback){__openScene(path,callback)},self.openFileBrowser=function(){if(usingNode){var chooser=$("#getFilePaths");chooser.off().change(function(evt){var selection=$(this).val().split(";");1===selection.length&&""===selection[0]||__openScenes(selection,!0)}),chooser.trigger("click")}else fileBrowser.open(function(selection){selection.length<1||(selection=selection.filter(function(file){return!file.isFolder()}).map(function(file){return file.path}),__openScenes(selection,!0))})},self.spellCheck=function(word){return!editor.options.spellcheck||(typo.check(word)||userDictionary.check(word.toLowerCase())||word.match(/^\d+$/))},userDictionary={persistentList:{},persistentListArray:ko.observableArray([]),sessionList:{},add:function(word,list){userDictionary[list+"List"][word.toLowerCase()]=!0,userDictionary.update(list)},remove:function(word,list){userDictionary[list+"List"]&&delete userDictionary[list+"List"][word],userDictionary.update(list)},check:function(word){var pList=this.persistentList;return!(!this.sessionList[word]&&!pList[word])},load:function(){try{userDictionary.persistentList=JSON.parse(localStorage.getItem("userDictionary"))||{};for(var i in userDictionary.persistentList)userDictionary.persistentList.hasOwnProperty(i)&&userDictionary.persistentListArray.push(i)}catch(err){err?userDictionary.update():bootbox.alert("Sorry, there was a problem loading or parsing your user dictionary data.<br>If you're seeing this message frequently please file a bug report.")}},update:function(list){if(void 0===list||"persistent"==list){var newDictionary=JSON.stringify(userDictionary.persistentList,null,"\t");localStorage.setItem("userDictionary",newDictionary),userDictionary.persistentListArray.removeAll();for(var i in userDictionary.persistentList)userDictionary.persistentList.hasOwnProperty(i)&&userDictionary.persistentListArray.push(i)}editor.forceSyntaxRedraw()}},self.dictWord=ko.observable(""),self.addToDictionary=function(obj,e){if("click"==e.type||"keyup"==e.type&&13==e.keyCode){if(!self.dictWord().match(/^[\w\u00C0-\u017F\u0027]+$/))return void bootbox.alert("<h3>Error</h3>Unable to add to user dictionary: not a word!");userDictionary.add(self.dictWord(),"persistent"),self.dictWord("")}},self.removeFromDictionary=function(word){userDictionary.persistentList.hasOwnProperty(word)&&userDictionary.remove(word,"persistent")},self.getDictionaryArray=ko.computed(function(){return userDictionary.persistentListArray().sort()},this),self.init=function(){if(usingNode||(user.name="dropbox-user"),config.settings.app.persist)for(var thisProjectData=[],i=0;i<config.openProjects.length;i++){thisProjectData=config.openProjects[i];var project=new CSIDEProject(thisProjectData);__addProject(project);for(var n=0;n<thisProjectData.openScenes.length;n++){var scene=new CSIDEScene(thisProjectData.openScenes[n]);project.addScene(scene),scene.load()}}for(var scope=settings.editor(),i=0;i<scope.length;i++){var val=void 0!==config.settings.editor[scope[i].getId()]?config.settings.editor[scope[i].getId()]:defaultConfig.settings.editor[scope[i].getId()];scope[i].apply(val),scope[i].setValue(val)}scope=settings.app();for(var i=0;i<scope.length;i++){var val=void 0!==config.settings.app[scope[i].getId()]?config.settings.app[scope[i].getId()]:defaultConfig.settings.app[scope[i].getId()];scope[i].apply(val),scope[i].setValue(val)}userDictionary.load(),__selectTab("help")},self.slideUpAndOut=function(elem){$(elem).parent().find("ul").remove(),$(elem).animate({minHeight:0,height:0,padding:0},400,function(){$(elem).remove()})},self.slideDownAndIn=function(elem){$(elem).hide().slideDown(400)},self.fadeIn=function(elem){$(elem).hide().fadeIn("fast")},self.fadeOutAndUp=function(elem){$(elem).animate({opacity:0,height:0,padding:0},400,function(){$(elem).remove()})},self.showWordCount=function(sceneOrProject){var incWordCount=sceneOrProject.getWordCount(),exWordCount=sceneOrProject.getWordCount(!0),msg=(sceneOrProject.getCharCount(),"<h3>"+sceneOrProject.getName()+"</h3><br><h4>Word Count</h4> \t\t    Including command lines: "+sceneOrProject.getWordCount()+"<br>Excluding command lines: "+sceneOrProject.getWordCount(!0));if(msg+="<br><br><h4>Character count</h4>Character count: "+sceneOrProject.getCharCount(),"CSIDEScene"===sceneOrProject.constructor.name&&selectedScene()===sceneOrProject){var selection=editor.getSelection();selection.length>0&&(incWordCount=__wordCount(selection,!1),exWordCount=__wordCount(selection,!0),sceneOrProject.getCharCount(!0),msg+="<br><br><h4>Current Selection</h4>                     Words including command lines: "+incWordCount+"<br>Words excluding command lines: "+exWordCount+"<br>Characters: "+sceneOrProject.getCharCount(!0))}msg+="<br><br>Please note that these figures are only approximations.<br>Project word counts only include those of open scenes.",bootbox.alert(msg)},self.createProject=function(projectName,cb,blank){function __create(projectName){validName(projectName,!0,function(valid,err){valid?projectExists(user.path+projectName,function(exists){exists?notification("Project Naming Error","A Project with that name already exists in the project directory",{type:"error"}):__createProject(projectName,cb,blank)}):notification("Project Naming Error",err,{type:"error"})})}blank=blank||!1,"function"!=typeof cb&&(cb=function(err,project){err||notification("Project created",project.getPath(),{type:"success",layout:"bottomRight"})}),"string"!=typeof projectName||""==projectName?__promptForString(function(str){str&&__create(str)},"Name of Project?"):__create(projectName)};var cse={getFreeLabelName:function(scene,prefix){for(var i=0;i<prefix&&void 0!==scene.labels[prefix+"_"+i];i++);return prefix+"_"+i},while:{transpile:function(scene,expr,line,block_size){var lines=[],label=cse.getFreeLabelName(scene,"while_loop");return lines.push("*label "+label),lines.push("*if"+expr),lines=lines.concat(scene.lines.slice(line+1,line+block_size)),lines.push("\t*goto "+label),lines}}};if(self.updatePersistenceList=function(){__updatePersistenceList()},self.makeSortable=function(data){__makeSortable(data)},self.dragSceneEvent=dragSceneEvent,ko.bindingHandlers.bindIframe={init:function(element,valueAccessor){function bindIframe(){try{var iframeInit=element.contentWindow.initChildFrame,iframedoc=element.contentDocument.body}catch(e){}iframeInit?iframeInit(ko,valueAccessor()):iframedoc&&ko.applyBindings(valueAccessor(),iframedoc)}bindIframe(),ko.utils.registerEventHandler(element,"load",bindIframe)}},ko.bindingHandlers.enableTextInput={init:function(element,valueAccessor){$(element).prop("readOnly",!0)},update:function(element,valueAccessor){$(element).prop("readOnly",!ko.utils.unwrapObservable(valueAccessor()))}},ko.bindingHandlers.fadeVisible={init:function(element,valueAccessor){var value=valueAccessor();$(element).toggle(ko.utils.unwrapObservable(value))},update:function(element,valueAccessor){var value=valueAccessor();ko.utils.unwrapObservable(value)?$(element).show().animate({opacity:1},250):$(element).animate({opacity:0},250,function(){$(this).hide()})}},ko.bindingHandlers.fadeAndSlideVisible={init:function(element,valueAccessor){var value=valueAccessor();$(element).toggle(ko.unwrap(value))},update:function(element,valueAccessor){var value=valueAccessor();ko.unwrap(value)?$(element).slideDown(500).animate({opacity:1},{queue:!1,duration:350}):$(element).slideUp(500).animate({opacity:0},{queue:!1,duration:350})}},ko.bindingHandlers.initFiles={init:function(element,valueAccessor){$(element).draggable({cursor:"move",cursorAt:{left:5,top:5},scroll:!0,start:function(event,ui){ui.helper.appendTo($("body"))},helper:function(){var newElement=$("<div></div>");return newElement.addClass("helper"),newElement.text($("folder.selected").length),$(newElement)}})},update:function(element,valueAccessor,allBindings){}},ko.bindingHandlers.initFolders={init:function(element,valueAccessor){$(element).droppable({accept:".file, .folder-ul",over:function(event,ui){$(this).css("background-color","#F7F7E1")},out:function(event,ui){$(this).css("background-color","")},drop:function(event,ui){$(this).delay(100).fadeOut().fadeIn("slow");var targetFolder=$(this);$(".folder-selected").each(function(){moveDropboxItem($(this),targetFolder)})}}).draggable({cursor:"move",cursorAt:{left:5,top:5},scroll:!0,start:function(event,ui){ui.helper.appendTo($("body"))},helper:function(){var newElement=$("<div></div>");return newElement.addClass("helper"),$(newElement)}})},update:function(element,valueAccessor,allBindings){}},usingNode,!usingNode){var fileBrowser=new fileBrowser;ko.applyBindings(fileBrowser,$("#file-browser-canvas")[0]),self.webFileBrowserClosed=ko.computed(function(){return!fileBrowser.isVisible()})}var fileMenuOptions=ko.observableArray([new menuOption("Open Scene",function(menu){menu.getTarget().open()})]),folderMenuOptions=ko.observableArray([new menuOption("Open Folder",function(menu){menu.getTarget().open()})]);if("mac_os"!==platform){var toolbarMenus=ko.observableArray([new toolbarMenu({title:"<span title='Project' class='fa fa-folder-open-o '>",active:self.getSelectedProject,options:ko.computed(function(){return new contextMenu(selectedProject(),projectMenuOptions).getOptions()},this),target:ko.computed(function(){return selectedProject()},this)}),new toolbarMenu({title:"<span title='Scene' class='fa fa-file-text-o'>",active:self.getSelectedScene,options:ko.computed(function(){return new contextMenu(selectedScene(),sceneMenuOptions).getOptions()},this),target:ko.computed(function(){return selectedScene()},this)})]);self.getToolbarMenus=ko.computed(function(){return toolbarMenus()},this)}var myContextMenuViewModel=new CSIDE_ContextMenu;ko.applyBindings(myContextMenuViewModel,$("#context-menu")[0])}function Scene(name,stats,nav,options){name||(name=""),stats||(stats={}),this.name=name,this.stats=stats,this.temps={choice_reuse:"allow",choice_user_restored:!1},this.nav=nav,options=options||{},this.debugMode=options.debugMode||!1,this.secondaryMode=options.secondaryMode,this.saveSlot=options.saveSlot||"",this.lines=[],this.lineNum=0,this.rollbackLineCoverage(),this.finished=!1,this.labels={},this.indent=0,this.prevLine="empty",this.screenEmpty=!0,this.initialCommands=!0,this.stats.sceneName=name,this.stats.scene=this,this.target=null}function SceneNavigator(sceneList){this.setSceneList(sceneList),this.startingStats={}}function callIos(scheme,path){_global.isIosApp&&(path=path?encodeURIComponent(path).replace(/[!~*')(]/g,function(match){return"%"+match.charCodeAt(0).toString(16)}):"",setTimeout(function(){var iframe=document.createElement("IFRAME");iframe.setAttribute("src",scheme+"://"+path),iframe.setAttribute("style","display:none"),document.documentElement.appendChild(iframe),iframe.parentNode.removeChild(iframe),iframe=null},0))}function safeCall(obj,fn){if(fn){var isHeadless="undefined"==typeof window,debug=!isHeadless&&window.debug;if(isIE||isHeadless)"undefined"!=typeof MSApp?obj?MSApp.execUnsafeLocalFunction(function(){fn.call(obj)}):MSApp.execUnsafeLocalFunction(fn):obj?fn.call(obj):fn.call();else try{obj?fn.call(obj):fn.call()}catch(e){if(e.message?window.onerror(e.message,e.fileName,e.lineNumber,e.stack):e.stack?window.onerror(e.stack,e.fileName,e.lineNumber,e.stack):window.onerror(toJson(e,"\n")),window.console&&(window.console.error(e),e.message&&window.console.error("Message: "+e.message),e.stack&&window.console.error("Stack: "+e.stack)),debug)throw e}}}function safeCallback(callback){return function(){safeCall(null,callback)}}function safeTimeout(fn,time){setTimeout(function(){safeCall(null,fn)},time)}function isDefined(x){return void 0!==x}function jsonStringifyAscii(obj){return JSON.stringify(obj,function(key,value){if("scene"!=key)return value}).replace(/(.)/g,function(x){var code=x.charCodeAt(0);if(code>127||code<32){var outCode=code.toString(16);switch(outCode.length){case 4:return"\\u"+outCode;case 3:return"\\u0"+outCode;case 2:return"\\u00"+outCode;case 1:return"\\u000"+outCode;default:return x}}return x})}function toJson(obj,standardized){if("undefined"!=typeof JSON&&JSON.stringify)return jsonStringifyAscii(obj);switch(typeof obj){case"object":if(obj){var list=[];if(obj instanceof Array){for(var i=0;i<obj.length;i++)list.push(toJson(obj[i],standardized));return"["+list.join(",")+"]"}for(var prop in obj)"scene"!=prop&&(standardized||!/^[a-zA-Z][a-zA-Z_0-9]\w+$/.test(prop)||/\b(abstract|boolean|break|byte|case|catch|char|class|comment|const|continue|debugger|default|delete|do|double|else|enum|export|extends|false|final|finally|float|for|function|goto|if|implements|import|in|instanceof|int|interface|label|long|native|new|null|package|private|protected|public|return|short|static|super|switch|synchronized|this|throws|transient|true|try|typeof|var|void|volatile|while|with)\b/.test(prop)?list.push('"'+prop+'":'+toJson(obj[prop],standardized)):list.push(prop+":"+toJson(obj[prop],standardized)));return"{"+list.join(",")+"}"}return"null";case"string":return'"'+obj.replace(/(.)/g,function(x){if("'"==x||'"'==x||"\\"==x)return"\\"+x;var code=x.charCodeAt(0);if(code>127||code<32){var outCode=code.toString(16);switch(outCode.length){case 4:return"\\u"+outCode;case 3:return"\\u0"+outCode;case 2:return"\\u00"+outCode;case 1:return"\\u000"+outCode;default:return x}}return x})+'"';case"number":
case"boolean":return String(obj);case"function":return"badfunction";case"undefined":return"undefined";default:throw new Error("invalid type: "+typeof obj)}}function xhrAuthRequest(method,endpoint,callback){for(var paramBuilder=new Array(3*arguments.length),i=3;i<arguments.length;i+=2)i>3&&paramBuilder.push("&"),paramBuilder.push(arguments[i]),paramBuilder.push("="),paramBuilder.push(arguments[i+1]);var params=paramBuilder.join(""),xhr=findXhr();"POST"==method?(xhr.open(method,loginUrlBase+endpoint+".php",!0),xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded")):xhr.open(method,loginUrlBase+endpoint+".php?"+params,!0);var done=!1;xhr.onreadystatechange=function(){if(!done&&4==xhr.readyState){done=!0;var ok=200==xhr.status,response={};try{xhr.responseText&&(response=JSON.parse(xhr.responseText))}catch(e){ok=!1}ok||response.error||(response.error="unknown error"),callback&&safeCall(null,function(){callback(ok,response)})}},xhr.send(params)}function login(email,password,register,subscribe,callback){xhrAuthRequest("POST","login",callback,"email",encodeURIComponent(email),"password",encodeURIComponent(password),"register",register,"subscribe",subscribe)}function forgotPassword(email,callback){xhrAuthRequest("POST","forgot",callback,"email",encodeURIComponent(email))}function logout(callback){document.cookie="login=0;path=/;expires=Thu, 01 Jan 1970 00:00:01 GMT;",xhrAuthRequest("GET","logout",callback),recordLogin(!1),window.knownPurchases=null,"undefined"!=typeof FB&&FB.logout&&FB.logout(),"undefined"!=typeof gapi&&gapi.auth&&gapi.auth.signOut&&gapi.auth.signOut()}function recordLogin(registered,email,callback){initStore()?(registered&&recordEmail(email),window.store.set("login",registered,function(){safeCall(null,callback)}),window.registered=registered):safeTimeout(callback,0)}function getRemoteEmail(callback){xhrAuthRequest("GET","getuser",callback)}function saveCookie(callback,slot,stats,temps,lineNum,indent){return writeCookie(computeCookie(stats,temps,lineNum,indent),slot,callback)}function computeCookie(stats,temps,lineNum,indent){var scene=stats.scene;delete stats.scene,scene&&(stats.sceneName=scene.name);var version="UNKNOWN";"undefined"!=typeof window&&window&&window.version&&(version=window.version);var value=toJson({version:version,stats:stats,temps:temps,lineNum:lineNum,indent:indent});return stats.scene=scene,value}function writeCookie(value,slot,callback){if(window.pseudoSave||(window.pseudoSave={}),slot||(slot=""),window.pseudoSave[slot]=value,!initStore())return void(callback&&safeTimeout(callback,0));window.store.set("state"+slot,value,safeCallback(callback))}function clearCookie(callback,slot){writeCookie("",slot,safeCallback(callback))}function areSaveSlotsSupported(){return!(!initStore()||"cookie"==window.Persist.type)}function recordSave(slot,callback){if(!areSaveSlotsSupported())return void safeTimeout(callback,0);restoreObject(initStore(),"save_list",[],function(saveList){saveList.push(slot),window.store.set("save_list",toJson(saveList),safeCallback(callback))})}function recordDirtySlots(slots,callback){if(!areSaveSlotsSupported())return void safeTimeout(callback,0);restoreObject(initStore(),"dirty_save_list",[],function(saveList){saveSet={};for(var i=0;i<saveList.length;i++)saveSet[saveList[i]]=1;for(i=0;i<slots.length;i++)saveSet[slots[i]]||saveList.push(slots[i]);window.store.set("dirty_save_list",toJson(saveList),safeCallback(callback))})}function recordEmail(email,callback){initStore()?(window.recordedEmail=email,window.store.set("email",email,safeCallback(callback))):safeTimeout(callback,0)}function fetchEmail(callback){if(!initStore())return void safeTimeout(function(){callback("")},0);window.store.get("email",function(ok,value){safeCall(null,function(){if(ok&&(window.recordedEmail=value),callback){var temp=callback;callback=null,temp(ok&&value?value:"")}})}),safeTimeout(function(){if(callback){var temp=callback;callback=null,temp("")}},1e3)}function restoreObject(store,key,defaultValue,callback){if(!store)return void safeTimeout(function(){callback(defaultValue)},0);store.get(key,function(ok,value){var result=defaultValue;if(ok&&value)try{result=jsonParse(value)}catch(e){}safeCall(null,function(){callback(result)})})}function getDirtySaveList(callback){restoreObject(initStore(),"dirty_save_list",[],function(slotList){callback(slotList)})}function remoteSaveMerger(i,callback){var remoteStore=new Persist.Store(window.remoteStoreNames[i]);restoreObject(remoteStore,"save_list",[],function(remoteSlotList){fetchSavesFromSlotList(remoteStore,remoteSlotList,0,[],function(remoteSaveList){mergeRemoteSaves(remoteSaveList,0,function(){i++,i<window.remoteStoreNames.length?remoteSaveMerger(i,callback):callback.apply(null,arguments)})})})}function getSaves(callback){if(window.remoteStoreNames&&window.remoteStoreNames.length)remoteSaveMerger(0,callback);else if(window.remoteStoreName&&window.storeName!=window.remoteStoreName){var remoteStore=new Persist.Store(window.remoteStoreName);restoreObject(remoteStore,"save_list",[],function(remoteSlotList){fetchSavesFromSlotList(remoteStore,remoteSlotList,0,[],function(remoteSaveList){mergeRemoteSaves(remoteSaveList,0,callback)})})}else restoreObject(initStore(),"save_list",[],function(localSlotList){fetchSavesFromSlotList(initStore(),localSlotList,0,[],callback)})}function fetchSavesFromSlotList(store,slotList,i,saveList,callback){if(i>=slotList.length)return safeCall(null,function(){callback(saveList)});restoreObject(store,"state"+slotList[i],null,function(saveState){saveState&&(saveState.timestamp=slotList[i].substring(4),saveList.push(saveState)),fetchSavesFromSlotList(store,slotList,i+1,saveList,callback)})}function isWebSavePossible(){return!!initStore()&&(!/^http/.test(window.location.protocol)||(document.domain==window.webSaveDomain||"localhost"==document.domain))}function submitRemoteSave(slot,email,subscribe,callback){if(!isWebSavePossible())return safeTimeout(function(){callback(!1)});window.store.get("state"+slot,function(ok,value){if(ok){var timestamp=slot.substring(4),xhr=findXhr(),gameName=window.remoteStoreName||window.storeName,params="email="+email+"&game="+gameName+"&realGame="+window.storeName+"&json="+encodeURIComponent(value)+"&timestamp="+timestamp+"&subscribe="+subscribe;xhr.open("POST",webSaveUrl,!0),xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");var done=!1;xhr.onreadystatechange=function(){if(!done&&4==xhr.readyState){done=!0;200==xhr.status?safeCall(null,function(){callback(!0)}):recordDirtySlots([slot],function(){safeCall(null,function(){callback(!1)})})}},xhr.send(params)}else recordDirtySlots([slot],function(){asyncAlert("There was a problem uploading the saved game. This is probably a bug; please contact support@choiceofgames.com with code 17891.",function(){safeCall(null,function(){callback(!1)})})})})}function submitDirtySaves(dirtySaveList,email,callback){function submitDirtySave(i){dirtySaveList[i]?submitRemoteSave(dirtySaveList[i],email,!1,function(ok){ok?submitDirtySave(i+1):safeCall(null,function(){callback(!1)})}):window.store.remove("dirty_save_list",function(){safeCall(null,function(){callback(!0)})})}submitDirtySave(0)}function submitAnyDirtySaves(callback){callback||(callback=function(ok){});try{getDirtySaveList(function(dirtySaveList){if(dirtySaveList&&dirtySaveList.length)try{fetchEmail(function(email){email?submitDirtySaves(dirtySaveList,email,callback):callback(!1)})}catch(e){callback(!1)}})}catch(e){callback(!1)}}function getRemoteSaves(email,callback){if(!isWebSavePossible())return void safeTimeout(function(){callback([])},0);var xhr=findXhr(),gameName=window.remoteStoreName||window.storeName;xhr.open("GET",webSaveUrl+"?email="+email+"&game="+gameName,!0);var done=!1;xhr.onreadystatechange=function(){if(!done&&4==xhr.readyState)if(done=!0,200!=xhr.status)window.console&&console.log("Couldn't load remote saves. "+xhr.status+": "+xhr.responseText),safeCall(null,function(){callback(null)});else{var result=xhr.responseText;result=jsonParse(result);for(var remoteSaveList=[],i=0;i<result.length;i++){var save=result[i].json;save.timestamp=result[i].timestamp,remoteSaveList.push(save)}safeCall(null,function(){callback(remoteSaveList)})}},xhr.send()}function mergeRemoteSaves(remoteSaveList,recordDirty,callback){if(!isWebSavePossible())return void safeTimeout(function(){callback([],0,[])},0);restoreObject(initStore(),"save_list",[],function(localSlotList){fetchSavesFromSlotList(initStore(),localSlotList,0,[],function(localSaveList){function finale(){newRemoteSaves?window.store.set("save_list",toJson(localSlotList),function(){safeCall(null,function(){callback(localSaveList,newRemoteSaves,dirtySaveList)})}):safeCall(null,function(){callback(localSaveList,newRemoteSaves,dirtySaveList)})}for(var localSlotMap={},i=0;i<localSlotList.length;i++)localSlotMap[localSlotList[i]]=1;var remoteSlotMap={};for(i=0;i<remoteSaveList.length;i++)remoteSlotMap["save"+remoteSaveList[i].timestamp]=1;var newRemoteSaves=0;for(i=0;i<remoteSaveList.length;i++){var remoteSave=remoteSaveList[i],slot="save"+remoteSave.timestamp;localSlotMap[slot]||(saveCookie(null,slot,remoteSave.stats,remoteSave.temps,remoteSave.lineNum,remoteSave.indent),localSlotList.push(slot),localSaveList.push(remoteSave),newRemoteSaves++)}var dirtySaveList=[];for(i=0;i<localSlotList.length;i++)remoteSlotMap[localSlotList[i]]||dirtySaveList.push(localSlotList[i]);recordDirty?window.store.set("dirty_save_list",toJson(dirtySaveList),finale):finale()})})}function delayBreakStart(callback){var nowInSeconds=Math.floor((new Date).getTime()/1e3);if(!initStore())return void safeTimeout(function(){callback(nowInSeconds)},0);window.store.get("delayBreakStart",function(ok,value){var valueNum=1*value;safeCall(null,function(){ok&&value&&!isNaN(valueNum)?callback(valueNum):(window.store.set("delayBreakStart",nowInSeconds),callback(nowInSeconds))})})}function delayBreakEnd(){initStore()&&window.store.remove("delayBreakStart")}function initStore(){if(!window.storeName)return!1;if(window.store)return window.store;try{window.store=new Persist.Store(window.storeName)}catch(e){}return window.store}function loadAndRestoreGame(slot,forcedScene){function valueLoaded(ok,value){safeCall(null,function(){var state=null;if(ok&&value&&""+value)state=jsonParse(value);else if("androidStorage"==window.Persist.type&&document.cookie)return upgradeAndroidCookies(slot,forcedScene);restoreGame(state,forcedScene)})}return slot||(slot=""),window.pseudoSave&&pseudoSave[""]?valueLoaded(!0,pseudoSave[""]):initStore()?void window.store.get("state"+slot,valueLoaded):restoreGame(null,forcedScene)}function upgradeAndroidCookies(slot,forcedScene){function upgradeComponent(i){if(!components[i])return void loadAndRestoreGame(slot,forcedScene);var parts=components[i].split("="),key=parts[0],deletion=key+"=x; path=/; domain=localhost; expires=Thu, 01-Jan-1970 00:00:01 GMT";document.cookie=deletion,key=unescape(key).substring(window.storeName.length+1);var value=unescape(parts[1]);window.store.set(key,value,function(){upgradeComponent(i+1)})}var ck=document.cookie,components=ck.split("; ");safeCall(this,function(){upgradeComponent(0)})}function isStateValid(state){return!!state&&(!!state.stats&&!!state.stats.sceneName)}function restartGame(shouldPrompt){function actuallyRestart(result){result&&(submitAnyDirtySaves(),clearCookie(function(){},"temp"),clearCookie(function(){window.nav.resetStats(window.stats),clearScreen(restoreGame)},""))}if(window.blockRestart)return void asyncAlert("Please wait until the timer has run out.");shouldPrompt?asyncConfirm("Start over from the beginning?",actuallyRestart):actuallyRestart(!0)}function restoreGame(state,forcedScene,userRestored){var scene,secondaryMode=null,saveSlot="",forcedSceneLabel=null;if(/\|/.test(forcedScene)){var parts=forcedScene.split("|");forcedScene=parts[0],forcedSceneLabel=parts[1]}if("choicescript_stats"==forcedScene?(secondaryMode="stats",saveSlot="temp"):"choicescript_upgrade"==forcedScene&&(secondaryMode="upgrade",saveSlot="temp"),isStateValid(state))forcedScene&&(state.stats.sceneName=forcedScene),window.stats=state.stats,scene=new Scene(state.stats.sceneName,state.stats,window.nav,{debugMode:state.debug||window.debug,secondaryMode:secondaryMode,saveSlot:saveSlot}),forcedScene||(scene.temps=state.temps,scene.lineNum=state.lineNum,scene.indent=state.indent),userRestored&&(scene.temps.choice_user_restored=!0);else{scene=new Scene(forcedScene||window.nav.getStartupScene(),window.stats,window.nav,{debugMode:window.debug,secondaryMode:secondaryMode,saveSlot:saveSlot})}null!==forcedSceneLabel&&(scene.targetLabel={label:forcedSceneLabel,origin:"url",originLine:0}),safeCall(scene,scene.execute)}function redirectScene(sceneName,label,originLine){var scene=new Scene(sceneName,window.stats,window.nav,{debugMode:window.debug});label&&(scene.targetLabel={label:label,origin:"choicescript_stats",originLine:originLine}),clearScreen(function(){scene.execute()})}function transferTempStatWrites(){_global.isIosApp&&callIos("transferwrites",JSON.stringify(tempStatWrites))}function getCookieByName(cookieName,ck){if(ck||(ck=window.document.cookie),!ck)return null;for(var ckPairs=ck.split(/;/),i=0;i<ckPairs.length;i++){var ckPair=trim(ckPairs[i]),ckNameValue=ckPair.split(/=/);if(decodeURIComponent(ckNameValue[0])===cookieName)return decodeURIComponent(ckNameValue[1])}return null}function parseQueryString(str){if(!str)return null;for(var map={},pairs=String(str).substring(1).split("&"),i=pairs.length;i--;){var pair=pairs[i],parts=pair.split("=");map[parts[0]]=parts[1]}return map}function trim(str){return null===str||void 0===str?null:str.replace(/^\s+/g,"").replace(/\s+$/g,"")}function findOptimalDomain(docDomain){if(docDomain||(docDomain=document.domain),"localhost"==docDomain||"127.0.0.1"==docDomain)return null;if(/^\d+\.\d+\.\d+\.\d+$/.test(docDomain))return null;var result=docDomain.match(/(\w+\.\w{3}$)/);return result?result[1]:null}function num(x,line){line||(line="UNKNOWN");var x_num=parseFloat(x);if(isNaN(x_num))throw new Error("line "+line+": Not a number: "+x);return x_num}function bool(x,line){if(line||(line="UNKNOWN"),"boolean"==typeof x)return x;if("true"===x)return!0;if("false"===x)return!1;throw new Error("line "+line+": Neither true nor false: "+x)}function findXhr(){var ieFile=isIE&&isFile;if(window.XMLHttpRequest&&!ieFile)return new window.XMLHttpRequest;for(var ids=["Msxml2.XMLHTTP","Microsoft.XMLHTTP","Msxml2.XMLHTTP.4.0"],i=0;i<3;i++)try{return new ActiveXObject(ids[i])}catch(e){}throw new Error("Couldn't create XHR object")}function crc32(str,crc){crc||(crc=0);var n=0,x=0;crc^=-1;for(var i=0,iTop=str.length;i<iTop;i++)n=255&(crc^str.charCodeAt(i)),x="0x"+crcTable.substr(9*n,8),crc=crc>>>8^x;return-1^crc}function simpleDateTimeFormat(date){var day=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][date.getDay()],month=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][date.getMonth()],minutes=date.getMinutes();minutes<10&&(minutes="0"+minutes);var millisAgo=(new Date).getTime()-date.getTime(),yearString="";return millisAgo>31536e6&&(yearString=", "+date.getFullYear()),day+", "+month+" "+date.getDate()+yearString+", "+date.getHours()+":"+minutes}function jsonParse(str){if("undefined"==typeof JSON)return eval("("+str+")");try{return JSON.parse(str)}catch(e){try{return eval("("+str+")")}catch(e2){try{eval("1")}catch(e3){var str2=(str+"").replace(/([,\{])\s*(\w+)\s*\:/g,'$1"$2":');try{return JSON.parse(str2)}catch(e4){}}return JSON.parse(str)}}}function cefQuerySimple(method){cefQuery({request:method,onSuccess:function(response){console.log(method+" success")},onFailure:function(error_code,error_message){console.error(method+" error: "+error_message)}})}function parseDateStringInCurrentTimezone(YYYY_MM_DD,line){var result=/^(\d{4})-(\d{2})-(\d{2})$/.exec(YYYY_MM_DD);if(!result)throw new Error("line "+line+": invalid date string "+YYYY_MM_DD);var fullYear=result[1],oneBasedMonthNumber=parseInt(result[2],10),dayOfMonth=parseInt(result[3],10),shortMonthString=shortMonthStrings[oneBasedMonthNumber];return new Date(shortMonthString+" "+dayOfMonth+", "+fullYear)}function autotester(sceneText,nav,sceneName,extraLabels){function log(msg){"undefined"!=typeof console&&console.log(msg)}function dojoClone(o){if(!o)return o;if(o instanceof Array||"array"==typeof o){for(var r=[],i=0;i<o.length;++i)r.push(dojoClone(o[i]));return r}if("object"!=typeof o&&"function"!=typeof o)return o;if(o.nodeType&&o.cloneNode)return o.cloneNode(!0);if(o instanceof Date)return new Date(o.getTime());r=new o.constructor;for(i in o)i in r&&r[i]==o[i]||(r[i]=dojoClone(o[i]));return r}var coverage=[];printx=function(msg,parent){};var sceneList=[];Scene.prototype.oldSceneList||(Scene.prototype.oldSceneList=Scene.prototype.scene_list),Scene.prototype.scene_list=function(){if("startup"!=this.name||!this.screenEmpty||!this.initialCommands)throw new Error(this.lineMsg()+"Invalid scene_list instruction, only allowed at the top of startup.txt");for(var scenes=this.parseSceneList(),i=0;i<scenes.length;i++)this.verifySceneFile(scenes[i])},Scene.prototype.quicktest=!0,Scene.prototype.finish=function(buttonName){this.paragraph(),this.finished=!0,buttonName||(buttonName="Next Chapter"),buttonName=this.replaceVariables(buttonName),this.testFinish&&this.testFinish()},Scene.prototype.bug=function(){this.finished=!0},Scene.prototype.page_break=function(buttonName){this.replaceVariables(buttonName),this.resetCheckedPurchases()},Scene.prototype.subscribe=function(){},Scene.prototype.feedback=function(){},Scene.prototype.save=function(){},Scene.prototype.restore_purchases=function(){},Scene.prototype.purchase=function(data){var result=/^(\w+)\s+(\S+)\s+(.*)/.exec(data);if(!result)throw new Error(this.lineMsg()+"invalid line; can't parse purchaseable product: "+data);var product=result[1],label=(trim(result[2]),trim(result[3]));if(void 0===this.temps["choice_purchased_"+product])throw new Error(this.lineMsg()+"Didn't check_purchases on this page");if(!seen[label]){var scene=this.clone();scene.testPath.push(","),scene.testPath.push(this.lineNum+1),scene.testPath.push("$"),scene.lineNum=this.lineNum,scene.rollbackLineCoverage(),scene.indent=this.indent,scene.goto(label),scene.rollbackLineCoverage(),scene.resume=function(){this.lineNum=this.lineNum,scene.printLoop()},sceneList.push(scene)}},Scene.prototype.delay_break=function(){},Scene.prototype.delay_ending=function(data){var args=data.split(/ /),durationInSeconds=args[0],price=args[1];if(isNaN(1*durationInSeconds))throw new Error(this.lineMsg()+"invalid duration");if(!/^\$/.test(price))throw new Error(this.lineMsg()+"invalid price");this.paragraph(),this.finished=!0},Scene.prototype.check_purchase=function(data){for(var products=data.split(/ /),i=0;i<products.length;i++)if(this.temps["choice_purchased_"+products[i]]=!0,!this.nav.products[products[i]]&&"adfree"!=products[i])throw new Error(this.lineMsg()+"The product "+products[i]+" wasn't declared in a *product command");this.temps.choice_purchase_supported=!1,this.temps.choice_purchased_everything=!0};var inputCallback;printInput=function(target,inputType,callback,minimum){inputCallback=function(){callback("text"==inputType?"blah blah":minimum)}},Scene.prototype.oldInputText||(Scene.prototype.oldInputText=Scene.prototype.input_text),Scene.prototype.oldInputNumber||(Scene.prototype.oldInputNumber=Scene.prototype.input_number),Scene.prototype.input_text=function(data){this.oldInputText(data),this.lineNum++,inputCallback()},Scene.prototype.input_number=function(data){this.oldInputNumber(data),this.lineNum++,inputCallback()},Scene.prototype.goto_random_scene=function(data){for(var parsed=this.parseGotoRandomScene(data),i=0;i<parsed.length;i++){var name=parsed[i].name;this.verifySceneFile(name)}/\ballow_no_selection\b/.test(data)||(this.finished=!0)},Scene.prototype.save_game=function(destinationSceneName){if(!destinationSceneName)throw new Error(this.lineMsg()+"*save_game requires a destination file name, e.g. *save_game Episode2");this.verifySceneFile(destinationSceneName)},Scene.prototype.restore_game=function(data){if(this.parseRestoreGame(!1),data){var result=/^cancel=(\S+)$/.exec(data);if(!result)throw new Error(this.lineMsg()+"invalid restore_game line: "+data);cancel=result[1],this.goto(cancel)}},Scene.prototype.rollbackLineCoverage=function(lineNum){lineNum||(lineNum=this.lineNum),coverage[lineNum]--};try{Scene.prototype.__defineGetter__("lineNum",function(){return this._lineNum}),Scene.prototype.__defineSetter__("lineNum",function(val){coverage[val]?coverage[val]++:coverage[val]=1,this._lineNum=val})}catch(e){}Scene.prototype.choice=function(data,fakeChoice){function flattenOptions(list,options,flattenedOption){flattenedOption||(flattenedOption={});for(var i=0;i<options.length;i++){var option=options[i];flattenedOption[option.group]=i,option.suboptions?flattenOptions(list,option.suboptions,flattenedOption):(flattenedOption.ultimateOption=option,list.push(dojoClone(flattenedOption)))}}var groups=["choice"];if(data){groups=data.split(/ /);for(var i=0;i<groups.length;i++)if(!/^\w*$/.test(groups[i]))throw new Error(this.lineMsg()+"invalid choice group name: "+groups[i])}var choiceLine=this.lineNum,options=this.parseOptions(this.indent,groups),flattenedOptions=[];flattenOptions(flattenedOptions,options);for(var index=0;index<flattenedOptions.length;index++){var item=flattenedOptions[index];this.printLine(item.ultimateOption.name);var scene=this.clone();if(this.fakeChoice){scene.temps.fakeChoiceEnd=this.lineNum;for(var fakeChoiceLines={},i=0;i<options.length;i++)fakeChoiceLines[options[i].line-1]=1;scene.temps.fakeChoiceLines=fakeChoiceLines}scene.testOption=item,scene.testChoiceLine=choiceLine,scene.testPath.push(","),scene.testPath.push(choiceLine+1),scene.testPath.push("#"),scene.testPath.push(index+1),scene.testPath.push(" ("),scene.testPath.push(item.ultimateOption.line),scene.testPath.push(")"),scene.resume=function(){this.standardResolution(this.testOption.ultimateOption)},sceneList.push(scene)}this.finished=!0},Scene.prototype.clone=function(){this.stats.scene=null;var clonedStats=dojoClone(this.stats),scene=new Scene(this.name,clonedStats,this.nav);return scene.lines=this.lines,scene.labels=this.labels,scene.temps=dojoClone(this.temps),scene.loaded=!0,scene.testPath=dojoClone(this.testPath),scene.firstTab=this.firstTab,scene.firstSpace=this.firstSpace,this.stats.scene=this,scene},Scene.prototype.conflictingOptions=function(){},Scene.prototype.oldRunCommand||(Scene.prototype.oldRunCommand=Scene.prototype.runCommand),Scene.prototype.runCommand=function(line){return coverage[this._lineNum]>1?/^\s*\*else/i.test(line)?this.oldRunCommand(line):seenInChoice[this.lineNum]?this.oldRunCommand(line):void this.return():this.oldRunCommand(line)},Scene.prototype.oldGoto||(Scene.prototype.oldGoto=Scene.prototype.goto);var seen={};Scene.prototype.goto=function(label,inChoice){if(inChoice)return void this.oldGoto(label,!0);var key=label.toLowerCase();if(seen[key])return void this.return();seen[key]=1,this.oldGoto(label)},Scene.prototype.oldGosub||(Scene.prototype.oldGosub=Scene.prototype.gosub),Scene.prototype.gosub=function(label,inChoice){seen[label.toLowerCase()]||this.oldGosub(label)},Scene.prototype.ending=function(){this.finished=!0},Scene.prototype.restart=Scene.prototype.ending,Scene.prototype.goto_scene=function(data){var result=this.parseGotoScene(data);this.verifySceneFile(result.sceneName),this.finished=!0},Scene.prototype.gosub_scene=function(data){var result=this.parseGotoScene(data);this.verifySceneFile(result.sceneName)},Scene.prototype.return=function(){var stackFrame;this.temps.choice_substack&&this.temps.choice_substack.length?(stackFrame=this.temps.choice_substack.pop(),this.lineNum=stackFrame.lineNum,this.indent=stackFrame.indent):this.finished=!0},Scene.prototype.oldElse||(Scene.prototype.oldElse=Scene.prototype.else),Scene.prototype.else=function(data,inChoice){inChoice?this.oldIf("true"):this.oldElse()},Scene.prototype.elseif=Scene.prototype.elsif=function(data,inChoice){var stack=this.tokenizeExpr(data),result=this.evaluateExpr(stack);if("boolean"!=typeof result)throw new Error(this.lineMsg()+"Invalid boolean expression; this isn't a boolean: "+result);this.else(data,inChoice)},Scene.prototype.oldIf||(Scene.prototype.oldIf=Scene.prototype.if);var seenInChoice={};Scene.prototype.if=function(line,inChoice){var stack=this.tokenizeExpr(line),result=this.evaluateExpr(stack);if("boolean"!=typeof result)throw new Error(this.lineMsg()+"Invalid boolean expression; this isn't a boolean: "+result);if(inChoice)return seenInChoice[this.lineNum]=1,void this.oldIf("true");var scene=this.clone();scene.testPath.push(","),scene.testPath.push(this.lineNum+1),scene.testPath.push("F"),scene.lineNum=this.lineNum,scene.rollbackLineCoverage(),scene.indent=this.indent,scene.skipTrueBranch(),scene.lineNum++,scene.rollbackLineCoverage(),scene.resume=function(){this.lineNum=this.lineNum,scene.printLoop()},sceneList.push(scene),this.oldIf("true")},Scene.prototype.stat_chart=function(){this.parseStatChart()},sceneName||(sceneName="test");var startingStats={};nav||(nav={repairStats:function(){},resetStats:function(){},startingStats:{},bugLog:[]}),nav.resetStats(startingStats);var scene=new Scene(sceneName,startingStats,nav),originalScene=scene;if(scene.testPath=[sceneName],scene.loadLines(sceneText),log("executing"),scene.execute(),extraLabels)for(var i=0;i<extraLabels.length;i++){var extraLabel=extraLabels[i];scene=new Scene(sceneName,startingStats,nav),scene.loadLines(sceneText),scene.targetLabel=extraLabel,scene.testPath=[sceneName,",","goto "+extraLabel.label],log(scene.testPath.join("")),scene.execute()}for(;scene=sceneList.shift();)log(scene.testPath.join("")),scene.resume();for(var uncovered=[],startRange=null,i=0;i<coverage.length;i++)if(line=trim(originalScene.lines[i]),coverage[i])startRange==i?(uncovered.push(startRange),startRange=null):startRange&&(uncovered.push(startRange+"-"+i),startRange=null);else if(null===startRange){if(!line||/\*(comment|bug)\b/.test(line))continue;startRange=i+1}return startRange&&uncovered.push(startRange+"-"+(i-1)),uncovered.length?(log("UNCOVERED:"),log(uncovered.join("\n")),[coverage,uncovered]):[coverage]}!function(a,b){"object"==typeof module&&"object"==typeof module.exports?module.exports=a.document?b(a,!0):function(a){if(!a.document)throw new Error("jQuery requires a window with a document");return b(a)}:b(a)}("undefined"!=typeof window?window:this,function(a,b){function r(a){var b="length"in a&&a.length,c=m.type(a);return"function"!==c&&!m.isWindow(a)&&(!(1!==a.nodeType||!b)||("array"===c||0===b||"number"==typeof b&&b>0&&b-1 in a))}function w(a,b,c){if(m.isFunction(b))return m.grep(a,function(a,d){return!!b.call(a,d,a)!==c});if(b.nodeType)return m.grep(a,function(a){return a===b!==c});if("string"==typeof b){if(v.test(b))return m.filter(b,a,c);b=m.filter(b,a)}return m.grep(a,function(a){return m.inArray(a,b)>=0!==c})}function D(a,b){do{a=a[b]}while(a&&1!==a.nodeType);return a}function G(a){var b=F[a]={};return m.each(a.match(E)||[],function(a,c){b[c]=!0}),b}function I(){y.addEventListener?(y.removeEventListener("DOMContentLoaded",J,!1),a.removeEventListener("load",J,!1)):(y.detachEvent("onreadystatechange",J),a.detachEvent("onload",J))}function J(){(y.addEventListener||"load"===event.type||"complete"===y.readyState)&&(I(),m.ready())}function O(a,b,c){if(void 0===c&&1===a.nodeType){var d="data-"+b.replace(N,"-$1").toLowerCase();if("string"==typeof(c=a.getAttribute(d))){try{c="true"===c||"false"!==c&&("null"===c?null:+c+""===c?+c:M.test(c)?m.parseJSON(c):c)}catch(e){}m.data(a,b,c)}else c=void 0}return c}function P(a){var b;for(b in a)if(("data"!==b||!m.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function Q(a,b,d,e){if(m.acceptData(a)){var f,g,h=m.expando,i=a.nodeType,j=i?m.cache:a,k=i?a[h]:a[h]&&h;if(k&&j[k]&&(e||j[k].data)||void 0!==d||"string"!=typeof b)return k||(k=i?a[h]=c.pop()||m.guid++:h),j[k]||(j[k]=i?{}:{toJSON:m.noop}),("object"==typeof b||"function"==typeof b)&&(e?j[k]=m.extend(j[k],b):j[k].data=m.extend(j[k].data,b)),g=j[k],e||(g.data||(g.data={}),g=g.data),void 0!==d&&(g[m.camelCase(b)]=d),"string"==typeof b?null==(f=g[b])&&(f=g[m.camelCase(b)]):f=g,f}}function R(a,b,c){if(m.acceptData(a)){var d,e,f=a.nodeType,g=f?m.cache:a,h=f?a[m.expando]:m.expando;if(g[h]){if(b&&(d=c?g[h]:g[h].data)){m.isArray(b)?b=b.concat(m.map(b,m.camelCase)):b in d?b=[b]:(b=m.camelCase(b),b=b in d?[b]:b.split(" ")),e=b.length;for(;e--;)delete d[b[e]];if(c?!P(d):!m.isEmptyObject(d))return}(c||(delete g[h].data,P(g[h])))&&(f?m.cleanData([a],!0):k.deleteExpando||g!=g.window?delete g[h]:g[h]=null)}}}function aa(){return!0}function ba(){return!1}function ca(){try{return y.activeElement}catch(a){}}function da(a){var b=ea.split("|"),c=a.createDocumentFragment();if(c.createElement)for(;b.length;)c.createElement(b.pop());return c}function ua(a,b){var c,d,e=0,f=typeof a.getElementsByTagName!==K?a.getElementsByTagName(b||"*"):typeof a.querySelectorAll!==K?a.querySelectorAll(b||"*"):void 0;if(!f)for(f=[],c=a.childNodes||a;null!=(d=c[e]);e++)!b||m.nodeName(d,b)?f.push(d):m.merge(f,ua(d,b));return void 0===b||b&&m.nodeName(a,b)?m.merge([a],f):f}function va(a){W.test(a.type)&&(a.defaultChecked=a.checked)}function wa(a,b){return m.nodeName(a,"table")&&m.nodeName(11!==b.nodeType?b:b.firstChild,"tr")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function xa(a){return a.type=(null!==m.find.attr(a,"type"))+"/"+a.type,a}function ya(a){var b=pa.exec(a.type);return b?a.type=b[1]:a.removeAttribute("type"),a}function za(a,b){for(var c,d=0;null!=(c=a[d]);d++)m._data(c,"globalEval",!b||m._data(b[d],"globalEval"))}function Aa(a,b){if(1===b.nodeType&&m.hasData(a)){var c,d,e,f=m._data(a),g=m._data(b,f),h=f.events;if(h){delete g.handle,g.events={};for(c in h)for(d=0,e=h[c].length;e>d;d++)m.event.add(b,c,h[c][d])}g.data&&(g.data=m.extend({},g.data))}}function Ba(a,b){var c,d,e;if(1===b.nodeType){if(c=b.nodeName.toLowerCase(),!k.noCloneEvent&&b[m.expando]){e=m._data(b);for(d in e.events)m.removeEvent(b,d,e.handle);b.removeAttribute(m.expando)}"script"===c&&b.text!==a.text?(xa(b).text=a.text,ya(b)):"object"===c?(b.parentNode&&(b.outerHTML=a.outerHTML),k.html5Clone&&a.innerHTML&&!m.trim(b.innerHTML)&&(b.innerHTML=a.innerHTML)):"input"===c&&W.test(a.type)?(b.defaultChecked=b.checked=a.checked,b.value!==a.value&&(b.value=a.value)):"option"===c?b.defaultSelected=b.selected=a.defaultSelected:("input"===c||"textarea"===c)&&(b.defaultValue=a.defaultValue)}}function Ea(b,c){var d,e=m(c.createElement(b)).appendTo(c.body),f=a.getDefaultComputedStyle&&(d=a.getDefaultComputedStyle(e[0]))?d.display:m.css(e[0],"display");return e.detach(),f}function Fa(a){var b=y,c=Da[a];return c||(c=Ea(a,b),"none"!==c&&c||(Ca=(Ca||m("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement),b=(Ca[0].contentWindow||Ca[0].contentDocument).document,b.write(),b.close(),c=Ea(a,b),Ca.detach()),Da[a]=c),c}function La(a,b){return{get:function(){var c=a();if(null!=c)return c?void delete this.get:(this.get=b).apply(this,arguments)}}}function Ua(a,b){if(b in a)return b;for(var c=b.charAt(0).toUpperCase()+b.slice(1),d=b,e=Ta.length;e--;)if((b=Ta[e]+c)in a)return b;return d}function Va(a,b){for(var c,d,e,f=[],g=0,h=a.length;h>g;g++)d=a[g],d.style&&(f[g]=m._data(d,"olddisplay"),c=d.style.display,b?(f[g]||"none"!==c||(d.style.display=""),""===d.style.display&&U(d)&&(f[g]=m._data(d,"olddisplay",Fa(d.nodeName)))):(e=U(d),(c&&"none"!==c||!e)&&m._data(d,"olddisplay",e?c:m.css(d,"display"))));for(g=0;h>g;g++)d=a[g],d.style&&(b&&"none"!==d.style.display&&""!==d.style.display||(d.style.display=b?f[g]||"":"none"));return a}function Wa(a,b,c){var d=Pa.exec(b);return d?Math.max(0,d[1]-(c||0))+(d[2]||"px"):b}function Xa(a,b,c,d,e){
for(var f=c===(d?"border":"content")?4:"width"===b?1:0,g=0;4>f;f+=2)"margin"===c&&(g+=m.css(a,c+T[f],!0,e)),d?("content"===c&&(g-=m.css(a,"padding"+T[f],!0,e)),"margin"!==c&&(g-=m.css(a,"border"+T[f]+"Width",!0,e))):(g+=m.css(a,"padding"+T[f],!0,e),"padding"!==c&&(g+=m.css(a,"border"+T[f]+"Width",!0,e)));return g}function Ya(a,b,c){var d=!0,e="width"===b?a.offsetWidth:a.offsetHeight,f=Ia(a),g=k.boxSizing&&"border-box"===m.css(a,"boxSizing",!1,f);if(0>=e||null==e){if(e=Ja(a,b,f),(0>e||null==e)&&(e=a.style[b]),Ha.test(e))return e;d=g&&(k.boxSizingReliable()||e===a.style[b]),e=parseFloat(e)||0}return e+Xa(a,b,c||(g?"border":"content"),d,f)+"px"}function Za(a,b,c,d,e){return new Za.prototype.init(a,b,c,d,e)}function fb(){return setTimeout(function(){$a=void 0}),$a=m.now()}function gb(a,b){var c,d={height:a},e=0;for(b=b?1:0;4>e;e+=2-b)c=T[e],d["margin"+c]=d["padding"+c]=a;return b&&(d.opacity=d.width=a),d}function hb(a,b,c){for(var d,e=(eb[b]||[]).concat(eb["*"]),f=0,g=e.length;g>f;f++)if(d=e[f].call(c,b,a))return d}function ib(a,b,c){var d,e,f,g,h,i,j,n=this,o={},p=a.style,q=a.nodeType&&U(a),r=m._data(a,"fxshow");c.queue||(h=m._queueHooks(a,"fx"),null==h.unqueued&&(h.unqueued=0,i=h.empty.fire,h.empty.fire=function(){h.unqueued||i()}),h.unqueued++,n.always(function(){n.always(function(){h.unqueued--,m.queue(a,"fx").length||h.empty.fire()})})),1===a.nodeType&&("height"in b||"width"in b)&&(c.overflow=[p.overflow,p.overflowX,p.overflowY],j=m.css(a,"display"),"inline"===("none"===j?m._data(a,"olddisplay")||Fa(a.nodeName):j)&&"none"===m.css(a,"float")&&(k.inlineBlockNeedsLayout&&"inline"!==Fa(a.nodeName)?p.zoom=1:p.display="inline-block")),c.overflow&&(p.overflow="hidden",k.shrinkWrapBlocks()||n.always(function(){p.overflow=c.overflow[0],p.overflowX=c.overflow[1],p.overflowY=c.overflow[2]}));for(d in b)if(e=b[d],ab.exec(e)){if(delete b[d],f=f||"toggle"===e,e===(q?"hide":"show")){if("show"!==e||!r||void 0===r[d])continue;q=!0}o[d]=r&&r[d]||m.style(a,d)}else j=void 0;if(m.isEmptyObject(o))"inline"===("none"===j?Fa(a.nodeName):j)&&(p.display=j);else{r?"hidden"in r&&(q=r.hidden):r=m._data(a,"fxshow",{}),f&&(r.hidden=!q),q?m(a).show():n.done(function(){m(a).hide()}),n.done(function(){var b;m._removeData(a,"fxshow");for(b in o)m.style(a,b,o[b])});for(d in o)g=hb(q?r[d]:0,d,n),d in r||(r[d]=g.start,q&&(g.end=g.start,g.start="width"===d||"height"===d?1:0))}}function jb(a,b){var c,d,e,f,g;for(c in a)if(d=m.camelCase(c),e=b[d],f=a[c],m.isArray(f)&&(e=f[1],f=a[c]=f[0]),c!==d&&(a[d]=f,delete a[c]),(g=m.cssHooks[d])&&"expand"in g){f=g.expand(f),delete a[d];for(c in f)c in a||(a[c]=f[c],b[c]=e)}else b[d]=e}function kb(a,b,c){var d,e,f=0,g=db.length,h=m.Deferred().always(function(){delete i.elem}),i=function(){if(e)return!1;for(var b=$a||fb(),c=Math.max(0,j.startTime+j.duration-b),d=c/j.duration||0,f=1-d,g=0,i=j.tweens.length;i>g;g++)j.tweens[g].run(f);return h.notifyWith(a,[j,f,c]),1>f&&i?c:(h.resolveWith(a,[j]),!1)},j=h.promise({elem:a,props:m.extend({},b),opts:m.extend(!0,{specialEasing:{}},c),originalProperties:b,originalOptions:c,startTime:$a||fb(),duration:c.duration,tweens:[],createTween:function(b,c){var d=m.Tween(a,j.opts,b,c,j.opts.specialEasing[b]||j.opts.easing);return j.tweens.push(d),d},stop:function(b){var c=0,d=b?j.tweens.length:0;if(e)return this;for(e=!0;d>c;c++)j.tweens[c].run(1);return b?h.resolveWith(a,[j,b]):h.rejectWith(a,[j,b]),this}}),k=j.props;for(jb(k,j.opts.specialEasing);g>f;f++)if(d=db[f].call(j,a,k,j.opts))return d;return m.map(k,hb,j),m.isFunction(j.opts.start)&&j.opts.start.call(a,j),m.fx.timer(m.extend(i,{elem:a,anim:j,queue:j.opts.queue})),j.progress(j.opts.progress).done(j.opts.done,j.opts.complete).fail(j.opts.fail).always(j.opts.always)}function Lb(a){return function(b,c){"string"!=typeof b&&(c=b,b="*");var d,e=0,f=b.toLowerCase().match(E)||[];if(m.isFunction(c))for(;d=f[e++];)"+"===d.charAt(0)?(d=d.slice(1)||"*",(a[d]=a[d]||[]).unshift(c)):(a[d]=a[d]||[]).push(c)}}function Mb(a,b,c,d){function g(h){var i;return e[h]=!0,m.each(a[h]||[],function(a,h){var j=h(b,c,d);return"string"!=typeof j||f||e[j]?f?!(i=j):void 0:(b.dataTypes.unshift(j),g(j),!1)}),i}var e={},f=a===Ib;return g(b.dataTypes[0])||!e["*"]&&g("*")}function Nb(a,b){var c,d,e=m.ajaxSettings.flatOptions||{};for(d in b)void 0!==b[d]&&((e[d]?a:c||(c={}))[d]=b[d]);return c&&m.extend(!0,a,c),a}function Ob(a,b,c){for(var d,e,f,g,h=a.contents,i=a.dataTypes;"*"===i[0];)i.shift(),void 0===e&&(e=a.mimeType||b.getResponseHeader("Content-Type"));if(e)for(g in h)if(h[g]&&h[g].test(e)){i.unshift(g);break}if(i[0]in c)f=i[0];else{for(g in c){if(!i[0]||a.converters[g+" "+i[0]]){f=g;break}d||(d=g)}f=f||d}return f?(f!==i[0]&&i.unshift(f),c[f]):void 0}function Pb(a,b,c,d){var e,f,g,h,i,j={},k=a.dataTypes.slice();if(k[1])for(g in a.converters)j[g.toLowerCase()]=a.converters[g];for(f=k.shift();f;)if(a.responseFields[f]&&(c[a.responseFields[f]]=b),!i&&d&&a.dataFilter&&(b=a.dataFilter(b,a.dataType)),i=f,f=k.shift())if("*"===f)f=i;else if("*"!==i&&i!==f){if(!(g=j[i+" "+f]||j["* "+f]))for(e in j)if(h=e.split(" "),h[1]===f&&(g=j[i+" "+h[0]]||j["* "+h[0]])){!0===g?g=j[e]:!0!==j[e]&&(f=h[0],k.unshift(h[1]));break}if(!0!==g)if(g&&a.throws)b=g(b);else try{b=g(b)}catch(l){return{state:"parsererror",error:g?l:"No conversion from "+i+" to "+f}}}return{state:"success",data:b}}function Vb(a,b,c,d){var e;if(m.isArray(b))m.each(b,function(b,e){c||Rb.test(a)?d(a,e):Vb(a+"["+("object"==typeof e?b:"")+"]",e,c,d)});else if(c||"object"!==m.type(b))d(a,b);else for(e in b)Vb(a+"["+e+"]",b[e],c,d)}function Zb(){try{return new a.XMLHttpRequest}catch(b){}}function $b(){try{return new a.ActiveXObject("Microsoft.XMLHTTP")}catch(b){}}function dc(a){return m.isWindow(a)?a:9===a.nodeType&&(a.defaultView||a.parentWindow)}var c=[],d=c.slice,e=c.concat,f=c.push,g=c.indexOf,h={},i=h.toString,j=h.hasOwnProperty,k={},l="1.11.3",m=function(a,b){return new m.fn.init(a,b)},q=function(a,b){return b.toUpperCase()};m.fn=m.prototype={jquery:l,constructor:m,selector:"",length:0,toArray:function(){return d.call(this)},get:function(a){return null!=a?0>a?this[a+this.length]:this[a]:d.call(this)},pushStack:function(a){var b=m.merge(this.constructor(),a);return b.prevObject=this,b.context=this.context,b},each:function(a,b){return m.each(this,a,b)},map:function(a){return this.pushStack(m.map(this,function(b,c){return a.call(b,c,b)}))},slice:function(){return this.pushStack(d.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(a){var b=this.length,c=+a+(0>a?b:0);return this.pushStack(c>=0&&b>c?[this[c]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:f,sort:c.sort,splice:c.splice},m.extend=m.fn.extend=function(){var a,b,c,d,e,f,g=arguments[0]||{},h=1,i=arguments.length,j=!1;for("boolean"==typeof g&&(j=g,g=arguments[h]||{},h++),"object"==typeof g||m.isFunction(g)||(g={}),h===i&&(g=this,h--);i>h;h++)if(null!=(e=arguments[h]))for(d in e)a=g[d],c=e[d],g!==c&&(j&&c&&(m.isPlainObject(c)||(b=m.isArray(c)))?(b?(b=!1,f=a&&m.isArray(a)?a:[]):f=a&&m.isPlainObject(a)?a:{},g[d]=m.extend(j,f,c)):void 0!==c&&(g[d]=c));return g},m.extend({expando:"jQuery"+(l+Math.random()).replace(/\D/g,""),isReady:!0,error:function(a){throw new Error(a)},noop:function(){},isFunction:function(a){return"function"===m.type(a)},isArray:Array.isArray||function(a){return"array"===m.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!m.isArray(a)&&a-parseFloat(a)+1>=0},isEmptyObject:function(a){var b;for(b in a)return!1;return!0},isPlainObject:function(a){var b;if(!a||"object"!==m.type(a)||a.nodeType||m.isWindow(a))return!1;try{if(a.constructor&&!j.call(a,"constructor")&&!j.call(a.constructor.prototype,"isPrototypeOf"))return!1}catch(c){return!1}if(k.ownLast)for(b in a)return j.call(a,b);for(b in a);return void 0===b||j.call(a,b)},type:function(a){return null==a?a+"":"object"==typeof a||"function"==typeof a?h[i.call(a)]||"object":typeof a},globalEval:function(b){b&&m.trim(b)&&(a.execScript||function(b){a.eval.call(a,b)})(b)},camelCase:function(a){return a.replace(/^-ms-/,"ms-").replace(/-([\da-z])/gi,q)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,c){var e=0,f=a.length,g=r(a);if(c){if(g)for(;f>e&&!1!==b.apply(a[e],c);e++);else for(e in a)if(!1===b.apply(a[e],c))break}else if(g)for(;f>e&&!1!==b.call(a[e],e,a[e]);e++);else for(e in a)if(!1===b.call(a[e],e,a[e]))break;return a},trim:function(a){return null==a?"":(a+"").replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")},makeArray:function(a,b){var c=b||[];return null!=a&&(r(Object(a))?m.merge(c,"string"==typeof a?[a]:a):f.call(c,a)),c},inArray:function(a,b,c){var d;if(b){if(g)return g.call(b,a,c);for(d=b.length,c=c?0>c?Math.max(0,d+c):c:0;d>c;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){for(var c=+b.length,d=0,e=a.length;c>d;)a[e++]=b[d++];if(c!==c)for(;void 0!==b[d];)a[e++]=b[d++];return a.length=e,a},grep:function(a,b,c){for(var e=[],f=0,g=a.length,h=!c;g>f;f++)!b(a[f],f)!==h&&e.push(a[f]);return e},map:function(a,b,c){var d,f=0,g=a.length,h=r(a),i=[];if(h)for(;g>f;f++)null!=(d=b(a[f],f,c))&&i.push(d);else for(f in a)null!=(d=b(a[f],f,c))&&i.push(d);return e.apply([],i)},guid:1,proxy:function(a,b){var c,e,f;return"string"==typeof b&&(f=a[b],b=a,a=f),m.isFunction(a)?(c=d.call(arguments,2),e=function(){return a.apply(b||this,c.concat(d.call(arguments)))},e.guid=a.guid=a.guid||m.guid++,e):void 0},now:function(){return+new Date},support:k}),m.each("Boolean Number String Function Array Date RegExp Object Error".split(" "),function(a,b){h["[object "+b+"]"]=b.toLowerCase()});var s=function(a){function ga(a,b,d,e){var f,h,j,k,l,o,r,s,w,x;if((b?b.ownerDocument||b:v)!==n&&m(b),b=b||n,d=d||[],k=b.nodeType,"string"!=typeof a||!a||1!==k&&9!==k&&11!==k)return d;if(!e&&p){if(11!==k&&(f=_.exec(a)))if(j=f[1]){if(9===k){if(!(h=b.getElementById(j))||!h.parentNode)return d;if(h.id===j)return d.push(h),d}else if(b.ownerDocument&&(h=b.ownerDocument.getElementById(j))&&t(b,h)&&h.id===j)return d.push(h),d}else{if(f[2])return H.apply(d,b.getElementsByTagName(a)),d;if((j=f[3])&&c.getElementsByClassName)return H.apply(d,b.getElementsByClassName(j)),d}if(c.qsa&&(!q||!q.test(a))){if(s=r=u,w=b,x=1!==k&&a,1===k&&"object"!==b.nodeName.toLowerCase()){for(o=g(a),(r=b.getAttribute("id"))?s=r.replace(ba,"\\$&"):b.setAttribute("id",s),s="[id='"+s+"'] ",l=o.length;l--;)o[l]=s+ra(o[l]);w=aa.test(a)&&pa(b.parentNode)||b,x=o.join(",")}if(x)try{return H.apply(d,w.querySelectorAll(x)),d}catch(y){}finally{r||b.removeAttribute("id")}}}return i(a.replace(R,"$1"),b,d,e)}function ha(){function b(c,e){return a.push(c+" ")>d.cacheLength&&delete b[a.shift()],b[c+" "]=e}var a=[];return b}function ia(a){return a[u]=!0,a}function ja(a){var b=n.createElement("div");try{return!!a(b)}catch(c){return!1}finally{b.parentNode&&b.parentNode.removeChild(b),b=null}}function ka(a,b){for(var c=a.split("|"),e=a.length;e--;)d.attrHandle[c[e]]=b}function la(a,b){var c=b&&a,d=c&&1===a.nodeType&&1===b.nodeType&&(~b.sourceIndex||C)-(~a.sourceIndex||C);if(d)return d;if(c)for(;c=c.nextSibling;)if(c===b)return-1;return a?1:-1}function oa(a){return ia(function(b){return b=+b,ia(function(c,d){for(var e,f=a([],c.length,b),g=f.length;g--;)c[e=f[g]]&&(c[e]=!(d[e]=c[e]))})})}function pa(a){return a&&void 0!==a.getElementsByTagName&&a}function qa(){}function ra(a){for(var b=0,c=a.length,d="";c>b;b++)d+=a[b].value;return d}function sa(a,b,c){var d=b.dir,e=c&&"parentNode"===d,f=x++;return b.first?function(b,c,f){for(;b=b[d];)if(1===b.nodeType||e)return a(b,c,f)}:function(b,c,g){var h,i,j=[w,f];if(g){for(;b=b[d];)if((1===b.nodeType||e)&&a(b,c,g))return!0}else for(;b=b[d];)if(1===b.nodeType||e){if(i=b[u]||(b[u]={}),(h=i[d])&&h[0]===w&&h[1]===f)return j[2]=h[2];if(i[d]=j,j[2]=a(b,c,g))return!0}}}function ta(a){return a.length>1?function(b,c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]}function ua(a,b,c){for(var d=0,e=b.length;e>d;d++)ga(a,b[d],c);return c}function va(a,b,c,d,e){for(var f,g=[],h=0,i=a.length,j=null!=b;i>h;h++)(f=a[h])&&(!c||c(f,d,e))&&(g.push(f),j&&b.push(h));return g}function wa(a,b,c,d,e,f){return d&&!d[u]&&(d=wa(d)),e&&!e[u]&&(e=wa(e,f)),ia(function(f,g,h,i){var j,k,l,m=[],n=[],o=g.length,p=f||ua(b||"*",h.nodeType?[h]:h,[]),q=!a||!f&&b?p:va(p,m,a,h,i),r=c?e||(f?a:o||d)?[]:g:q;if(c&&c(q,r,h,i),d)for(j=va(r,n),d(j,[],h,i),k=j.length;k--;)(l=j[k])&&(r[n[k]]=!(q[n[k]]=l));if(f){if(e||a){if(e){for(j=[],k=r.length;k--;)(l=r[k])&&j.push(q[k]=l);e(null,r=[],j,i)}for(k=r.length;k--;)(l=r[k])&&(j=e?J(f,l):m[k])>-1&&(f[j]=!(g[j]=l))}}else r=va(r===g?r.splice(o,r.length):r),e?e(null,g,r,i):H.apply(g,r)})}function xa(a){for(var b,c,e,f=a.length,g=d.relative[a[0].type],h=g||d.relative[" "],i=g?1:0,k=sa(function(a){return a===b},h,!0),l=sa(function(a){return J(b,a)>-1},h,!0),m=[function(a,c,d){var e=!g&&(d||c!==j)||((b=c).nodeType?k(a,c,d):l(a,c,d));return b=null,e}];f>i;i++)if(c=d.relative[a[i].type])m=[sa(ta(m),c)];else{if(c=d.filter[a[i].type].apply(null,a[i].matches),c[u]){for(e=++i;f>e&&!d.relative[a[e].type];e++);return wa(i>1&&ta(m),i>1&&ra(a.slice(0,i-1).concat({value:" "===a[i-2].type?"*":""})).replace(R,"$1"),c,e>i&&xa(a.slice(i,e)),f>e&&xa(a=a.slice(e)),f>e&&ra(a))}m.push(c)}return ta(m)}function ya(a,b){var c=b.length>0,e=a.length>0,f=function(f,g,h,i,k){var l,m,o,p=0,q="0",r=f&&[],s=[],t=j,u=f||e&&d.find.TAG("*",k),v=w+=null==t?1:Math.random()||.1,x=u.length;for(k&&(j=g!==n&&g);q!==x&&null!=(l=u[q]);q++){if(e&&l){for(m=0;o=a[m++];)if(o(l,g,h)){i.push(l);break}k&&(w=v)}c&&((l=!o&&l)&&p--,f&&r.push(l))}if(p+=q,c&&q!==p){for(m=0;o=b[m++];)o(r,s,g,h);if(f){if(p>0)for(;q--;)r[q]||s[q]||(s[q]=F.call(i));s=va(s)}H.apply(i,s),k&&!f&&s.length>0&&p+b.length>1&&ga.uniqueSort(i)}return k&&(w=v,j=t),r};return c?ia(f):f}var b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u="sizzle"+1*new Date,v=a.document,w=0,x=0,y=ha(),z=ha(),A=ha(),B=function(a,b){return a===b&&(l=!0),0},C=1<<31,D={}.hasOwnProperty,E=[],F=E.pop,G=E.push,H=E.push,I=E.slice,J=function(a,b){for(var c=0,d=a.length;d>c;c++)if(a[c]===b)return c;return-1},K="checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",L="[\\x20\\t\\r\\n\\f]",M="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",N=M.replace("w","w#"),O="\\["+L+"*("+M+")(?:"+L+"*([*^$|!~]?=)"+L+"*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+N+"))|)"+L+"*\\]",P=":("+M+")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+O+")*)|.*)\\)|)",Q=new RegExp(L+"+","g"),R=new RegExp("^"+L+"+|((?:^|[^\\\\])(?:\\\\.)*)"+L+"+$","g"),S=new RegExp("^"+L+"*,"+L+"*"),T=new RegExp("^"+L+"*([>+~]|"+L+")"+L+"*"),U=new RegExp("="+L+"*([^\\]'\"]*?)"+L+"*\\]","g"),V=new RegExp(P),W=new RegExp("^"+N+"$"),X={ID:new RegExp("^#("+M+")"),CLASS:new RegExp("^\\.("+M+")"),TAG:new RegExp("^("+M.replace("w","w*")+")"),ATTR:new RegExp("^"+O),PSEUDO:new RegExp("^"+P),CHILD:new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("+L+"*(even|odd|(([+-]|)(\\d*)n|)"+L+"*(?:([+-]|)"+L+"*(\\d+)|))"+L+"*\\)|)","i"),bool:new RegExp("^(?:"+K+")$","i"),needsContext:new RegExp("^"+L+"*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\("+L+"*((?:-\\d)?\\d*)"+L+"*\\)|)(?=[^-]|$)","i")},Y=/^(?:input|select|textarea|button)$/i,Z=/^h\d$/i,$=/^[^{]+\{\s*\[native \w/,_=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,aa=/[+~]/,ba=/'|\\/g,ca=new RegExp("\\\\([\\da-f]{1,6}"+L+"?|("+L+")|.)","ig"),da=function(a,b,c){var d="0x"+b-65536;return d!==d||c?b:0>d?String.fromCharCode(d+65536):String.fromCharCode(d>>10|55296,1023&d|56320)},ea=function(){m()};try{H.apply(E=I.call(v.childNodes),v.childNodes),E[v.childNodes.length].nodeType}catch(fa){H={apply:E.length?function(a,b){G.apply(a,I.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}c=ga.support={},f=ga.isXML=function(a){var b=a&&(a.ownerDocument||a).documentElement;return!!b&&"HTML"!==b.nodeName},m=ga.setDocument=function(a){var b,e,g=a?a.ownerDocument||a:v;return g!==n&&9===g.nodeType&&g.documentElement?(n=g,o=g.documentElement,e=g.defaultView,e&&e!==e.top&&(e.addEventListener?e.addEventListener("unload",ea,!1):e.attachEvent&&e.attachEvent("onunload",ea)),p=!f(g),c.attributes=ja(function(a){return a.className="i",!a.getAttribute("className")}),c.getElementsByTagName=ja(function(a){return a.appendChild(g.createComment("")),!a.getElementsByTagName("*").length}),c.getElementsByClassName=$.test(g.getElementsByClassName),c.getById=ja(function(a){return o.appendChild(a).id=u,!g.getElementsByName||!g.getElementsByName(u).length}),c.getById?(d.find.ID=function(a,b){if(void 0!==b.getElementById&&p){var c=b.getElementById(a);return c&&c.parentNode?[c]:[]}},d.filter.ID=function(a){var b=a.replace(ca,da);return function(a){return a.getAttribute("id")===b}}):(delete d.find.ID,d.filter.ID=function(a){var b=a.replace(ca,da);return function(a){var c=void 0!==a.getAttributeNode&&a.getAttributeNode("id");return c&&c.value===b}}),d.find.TAG=c.getElementsByTagName?function(a,b){return void 0!==b.getElementsByTagName?b.getElementsByTagName(a):c.qsa?b.querySelectorAll(a):void 0}:function(a,b){var c,d=[],e=0,f=b.getElementsByTagName(a);if("*"===a){for(;c=f[e++];)1===c.nodeType&&d.push(c);return d}return f},d.find.CLASS=c.getElementsByClassName&&function(a,b){return p?b.getElementsByClassName(a):void 0},r=[],q=[],(c.qsa=$.test(g.querySelectorAll))&&(ja(function(a){o.appendChild(a).innerHTML="<a id='"+u+"'></a><select id='"+u+"-\f]' msallowcapture=''><option selected=''></option></select>",a.querySelectorAll("[msallowcapture^='']").length&&q.push("[*^$]="+L+"*(?:''|\"\")"),a.querySelectorAll("[selected]").length||q.push("\\["+L+"*(?:value|"+K+")"),a.querySelectorAll("[id~="+u+"-]").length||q.push("~="),a.querySelectorAll(":checked").length||q.push(":checked"),a.querySelectorAll("a#"+u+"+*").length||q.push(".#.+[+~]")}),ja(function(a){var b=g.createElement("input");b.setAttribute("type","hidden"),a.appendChild(b).setAttribute("name","D"),a.querySelectorAll("[name=d]").length&&q.push("name"+L+"*[*^$|!~]?="),a.querySelectorAll(":enabled").length||q.push(":enabled",":disabled"),a.querySelectorAll("*,:x"),q.push(",.*:")})),(c.matchesSelector=$.test(s=o.matches||o.webkitMatchesSelector||o.mozMatchesSelector||o.oMatchesSelector||o.msMatchesSelector))&&ja(function(a){c.disconnectedMatch=s.call(a,"div"),s.call(a,"[s!='']:x"),r.push("!=",P)}),q=q.length&&new RegExp(q.join("|")),r=r.length&&new RegExp(r.join("|")),b=$.test(o.compareDocumentPosition),t=b||$.test(o.contains)?function(a,b){var c=9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!(!d||1!==d.nodeType||!(c.contains?c.contains(d):a.compareDocumentPosition&&16&a.compareDocumentPosition(d)))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1},B=b?function(a,b){if(a===b)return l=!0,0;var d=!a.compareDocumentPosition-!b.compareDocumentPosition;return d||(d=(a.ownerDocument||a)===(b.ownerDocument||b)?a.compareDocumentPosition(b):1,1&d||!c.sortDetached&&b.compareDocumentPosition(a)===d?a===g||a.ownerDocument===v&&t(v,a)?-1:b===g||b.ownerDocument===v&&t(v,b)?1:k?J(k,a)-J(k,b):0:4&d?-1:1)}:function(a,b){if(a===b)return l=!0,0;var c,d=0,e=a.parentNode,f=b.parentNode,h=[a],i=[b];if(!e||!f)return a===g?-1:b===g?1:e?-1:f?1:k?J(k,a)-J(k,b):0;if(e===f)return la(a,b);for(c=a;c=c.parentNode;)h.unshift(c);for(c=b;c=c.parentNode;)i.unshift(c);for(;h[d]===i[d];)d++;return d?la(h[d],i[d]):h[d]===v?-1:i[d]===v?1:0},g):n},ga.matches=function(a,b){return ga(a,null,null,b)},ga.matchesSelector=function(a,b){if((a.ownerDocument||a)!==n&&m(a),b=b.replace(U,"='$1']"),!(!c.matchesSelector||!p||r&&r.test(b)||q&&q.test(b)))try{var d=s.call(a,b);if(d||c.disconnectedMatch||a.document&&11!==a.document.nodeType)return d}catch(e){}return ga(b,n,null,[a]).length>0},ga.contains=function(a,b){return(a.ownerDocument||a)!==n&&m(a),t(a,b)},ga.attr=function(a,b){(a.ownerDocument||a)!==n&&m(a);var e=d.attrHandle[b.toLowerCase()],f=e&&D.call(d.attrHandle,b.toLowerCase())?e(a,b,!p):void 0;return void 0!==f?f:c.attributes||!p?a.getAttribute(b):(f=a.getAttributeNode(b))&&f.specified?f.value:null},ga.error=function(a){throw new Error("Syntax error, unrecognized expression: "+a)},ga.uniqueSort=function(a){var b,d=[],e=0,f=0;if(l=!c.detectDuplicates,k=!c.sortStable&&a.slice(0),a.sort(B),l){for(;b=a[f++];)b===a[f]&&(e=d.push(f));for(;e--;)a.splice(d[e],1)}return k=null,a},e=ga.getText=function(a){var b,c="",d=0,f=a.nodeType;if(f){if(1===f||9===f||11===f){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=e(a)}else if(3===f||4===f)return a.nodeValue}else for(;b=a[d++];)c+=e(b);return c},d=ga.selectors={cacheLength:50,createPseudo:ia,match:X,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){return a[1]=a[1].replace(ca,da),a[3]=(a[3]||a[4]||a[5]||"").replace(ca,da),"~="===a[2]&&(a[3]=" "+a[3]+" "),a.slice(0,4)},CHILD:function(a){return a[1]=a[1].toLowerCase(),"nth"===a[1].slice(0,3)?(a[3]||ga.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===a[3]||"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&ga.error(a[0]),a},PSEUDO:function(a){var b,c=!a[6]&&a[2];return X.CHILD.test(a[0])?null:(a[3]?a[2]=a[4]||a[5]||"":c&&V.test(c)&&(b=g(c,!0))&&(b=c.indexOf(")",c.length-b)-c.length)&&(a[0]=a[0].slice(0,b),a[2]=c.slice(0,b)),a.slice(0,3))}},filter:{TAG:function(a){var b=a.replace(ca,da).toLowerCase();return"*"===a?function(){return!0}:function(a){return a.nodeName&&a.nodeName.toLowerCase()===b}},CLASS:function(a){var b=y[a+" "];return b||(b=new RegExp("(^|"+L+")"+a+"("+L+"|$)"))&&y(a,function(a){return b.test("string"==typeof a.className&&a.className||void 0!==a.getAttribute&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(d){var e=ga.attr(d,a);return null==e?"!="===b:!b||(e+="","="===b?e===c:"!="===b?e!==c:"^="===b?c&&0===e.indexOf(c):"*="===b?c&&e.indexOf(c)>-1:"$="===b?c&&e.slice(-c.length)===c:"~="===b?(" "+e.replace(Q," ")+" ").indexOf(c)>-1:"|="===b&&(e===c||e.slice(0,c.length+1)===c+"-"))}},CHILD:function(a,b,c,d,e){var f="nth"!==a.slice(0,3),g="last"!==a.slice(-4),h="of-type"===b;return 1===d&&0===e?function(a){return!!a.parentNode}:function(b,c,i){var j,k,l,m,n,o,p=f!==g?"nextSibling":"previousSibling",q=b.parentNode,r=h&&b.nodeName.toLowerCase(),s=!i&&!h;if(q){if(f){for(;p;){for(l=b;l=l[p];)if(h?l.nodeName.toLowerCase()===r:1===l.nodeType)return!1;o=p="only"===a&&!o&&"nextSibling"}return!0}if(o=[g?q.firstChild:q.lastChild],g&&s){for(k=q[u]||(q[u]={}),j=k[a]||[],n=j[0]===w&&j[1],m=j[0]===w&&j[2],l=n&&q.childNodes[n];l=++n&&l&&l[p]||(m=n=0)||o.pop();)if(1===l.nodeType&&++m&&l===b){k[a]=[w,n,m];break}}else if(s&&(j=(b[u]||(b[u]={}))[a])&&j[0]===w)m=j[1];else for(;(l=++n&&l&&l[p]||(m=n=0)||o.pop())&&((h?l.nodeName.toLowerCase()!==r:1!==l.nodeType)||!++m||(s&&((l[u]||(l[u]={}))[a]=[w,m]),l!==b)););return(m-=e)===d||m%d==0&&m/d>=0}}},PSEUDO:function(a,b){var c,e=d.pseudos[a]||d.setFilters[a.toLowerCase()]||ga.error("unsupported pseudo: "+a);return e[u]?e(b):e.length>1?(c=[a,a,"",b],d.setFilters.hasOwnProperty(a.toLowerCase())?ia(function(a,c){for(var d,f=e(a,b),g=f.length;g--;)d=J(a,f[g]),a[d]=!(c[d]=f[g])}):function(a){return e(a,0,c)}):e}},pseudos:{not:ia(function(a){var b=[],c=[],d=h(a.replace(R,"$1"));return d[u]?ia(function(a,b,c,e){for(var f,g=d(a,null,e,[]),h=a.length;h--;)(f=g[h])&&(a[h]=!(b[h]=f))}):function(a,e,f){return b[0]=a,d(b,null,f,c),b[0]=null,!c.pop()}}),has:ia(function(a){return function(b){return ga(a,b).length>0}}),contains:ia(function(a){return a=a.replace(ca,da),function(b){return(b.textContent||b.innerText||e(b)).indexOf(a)>-1}}),lang:ia(function(a){return W.test(a||"")||ga.error("unsupported lang: "+a),a=a.replace(ca,da).toLowerCase(),function(b){var c;do{if(c=p?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return(c=c.toLowerCase())===a||0===c.indexOf(a+"-")}while((b=b.parentNode)&&1===b.nodeType);return!1}}),target:function(b){var c=a.location&&a.location.hash;return c&&c.slice(1)===b.id},root:function(a){return a===o},focus:function(a){return a===n.activeElement&&(!n.hasFocus||n.hasFocus())&&!!(a.type||a.href||~a.tabIndex)},enabled:function(a){return!1===a.disabled},disabled:function(a){return!0===a.disabled},checked:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&!!a.checked||"option"===b&&!!a.selected},selected:function(a){return a.parentNode&&a.parentNode.selectedIndex,!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if(a.nodeType<6)return!1;return!0},parent:function(a){return!d.pseudos.empty(a)},header:function(a){return Z.test(a.nodeName)},input:function(a){return Y.test(a.nodeName)},button:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&"button"===a.type||"button"===b},text:function(a){var b;return"input"===a.nodeName.toLowerCase()&&"text"===a.type&&(null==(b=a.getAttribute("type"))||"text"===b.toLowerCase())},first:oa(function(){return[0]}),last:oa(function(a,b){return[b-1]}),eq:oa(function(a,b,c){return[0>c?c+b:c]}),even:oa(function(a,b){for(var c=0;b>c;c+=2)a.push(c);return a}),odd:oa(function(a,b){for(var c=1;b>c;c+=2)a.push(c);return a}),lt:oa(function(a,b,c){for(var d=0>c?c+b:c;--d>=0;)a.push(d);return a}),gt:oa(function(a,b,c){for(var d=0>c?c+b:c;++d<b;)a.push(d);return a})}},d.pseudos.nth=d.pseudos.eq;for(b in{radio:!0,checkbox:!0,file:!0,password:!0,image:!0})d.pseudos[b]=function(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}(b);for(b in{submit:!0,reset:!0})d.pseudos[b]=function(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}}(b);return qa.prototype=d.filters=d.pseudos,d.setFilters=new qa,g=ga.tokenize=function(a,b){var c,e,f,g,h,i,j,k=z[a+" "];if(k)return b?0:k.slice(0);for(h=a,i=[],j=d.preFilter;h;){(!c||(e=S.exec(h)))&&(e&&(h=h.slice(e[0].length)||h),i.push(f=[])),c=!1,(e=T.exec(h))&&(c=e.shift(),f.push({value:c,type:e[0].replace(R," ")}),h=h.slice(c.length));for(g in d.filter)!(e=X[g].exec(h))||j[g]&&!(e=j[g](e))||(c=e.shift(),f.push({value:c,type:g,matches:e}),h=h.slice(c.length));if(!c)break}return b?h.length:h?ga.error(a):z(a,i).slice(0)},h=ga.compile=function(a,b){var c,d=[],e=[],f=A[a+" "];if(!f){for(b||(b=g(a)),c=b.length;c--;)f=xa(b[c]),f[u]?d.push(f):e.push(f);f=A(a,ya(e,d)),f.selector=a}return f},i=ga.select=function(a,b,e,f){var i,j,k,l,m,n="function"==typeof a&&a,o=!f&&g(a=n.selector||a);if(e=e||[],1===o.length){if(j=o[0]=o[0].slice(0),j.length>2&&"ID"===(k=j[0]).type&&c.getById&&9===b.nodeType&&p&&d.relative[j[1].type]){if(!(b=(d.find.ID(k.matches[0].replace(ca,da),b)||[])[0]))return e;n&&(b=b.parentNode),a=a.slice(j.shift().value.length)}for(i=X.needsContext.test(a)?0:j.length;i--&&(k=j[i],!d.relative[l=k.type]);)if((m=d.find[l])&&(f=m(k.matches[0].replace(ca,da),aa.test(j[0].type)&&pa(b.parentNode)||b))){if(j.splice(i,1),!(a=f.length&&ra(j)))return H.apply(e,f),e;break}}return(n||h(a,o))(f,b,!p,e,aa.test(a)&&pa(b.parentNode)||b),e},c.sortStable=u.split("").sort(B).join("")===u,c.detectDuplicates=!!l,m(),c.sortDetached=ja(function(a){return 1&a.compareDocumentPosition(n.createElement("div"))}),ja(function(a){return a.innerHTML="<a href='#'></a>","#"===a.firstChild.getAttribute("href")})||ka("type|href|height|width",function(a,b,c){return c?void 0:a.getAttribute(b,"type"===b.toLowerCase()?1:2)}),c.attributes&&ja(function(a){return a.innerHTML="<input/>",a.firstChild.setAttribute("value",""),""===a.firstChild.getAttribute("value")})||ka("value",function(a,b,c){return c||"input"!==a.nodeName.toLowerCase()?void 0:a.defaultValue}),ja(function(a){return null==a.getAttribute("disabled")})||ka(K,function(a,b,c){var d;return c?void 0:!0===a[b]?b.toLowerCase():(d=a.getAttributeNode(b))&&d.specified?d.value:null}),ga}(a);m.find=s,m.expr=s.selectors,m.expr[":"]=m.expr.pseudos,m.unique=s.uniqueSort,m.text=s.getText,m.isXMLDoc=s.isXML,m.contains=s.contains;var t=m.expr.match.needsContext,u=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,v=/^.[^:#\[\.,]*$/;m.filter=function(a,b,c){var d=b[0];return c&&(a=":not("+a+")"),1===b.length&&1===d.nodeType?m.find.matchesSelector(d,a)?[d]:[]:m.find.matches(a,m.grep(b,function(a){return 1===a.nodeType}))},m.fn.extend({find:function(a){var b,c=[],d=this,e=d.length;if("string"!=typeof a)return this.pushStack(m(a).filter(function(){for(b=0;e>b;b++)if(m.contains(d[b],this))return!0}));for(b=0;e>b;b++)m.find(a,d[b],c);return c=this.pushStack(e>1?m.unique(c):c),c.selector=this.selector?this.selector+" "+a:a,c},filter:function(a){return this.pushStack(w(this,a||[],!1))},not:function(a){return this.pushStack(w(this,a||[],!0))},is:function(a){return!!w(this,"string"==typeof a&&t.test(a)?m(a):a||[],!1).length}});var x,y=a.document,z=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(m.fn.init=function(a,b){var c,d;if(!a)return this;if("string"==typeof a){if(!(c="<"===a.charAt(0)&&">"===a.charAt(a.length-1)&&a.length>=3?[null,a,null]:z.exec(a))||!c[1]&&b)return!b||b.jquery?(b||x).find(a):this.constructor(b).find(a);if(c[1]){if(b=b instanceof m?b[0]:b,m.merge(this,m.parseHTML(c[1],b&&b.nodeType?b.ownerDocument||b:y,!0)),u.test(c[1])&&m.isPlainObject(b))for(c in b)m.isFunction(this[c])?this[c](b[c]):this.attr(c,b[c]);return this}if((d=y.getElementById(c[2]))&&d.parentNode){if(d.id!==c[2])return x.find(a);this.length=1,this[0]=d}return this.context=y,this.selector=a,this}return a.nodeType?(this.context=this[0]=a,this.length=1,this):m.isFunction(a)?void 0!==x.ready?x.ready(a):a(m):(void 0!==a.selector&&(this.selector=a.selector,this.context=a.context),m.makeArray(a,this))}).prototype=m.fn,x=m(y);var B=/^(?:parents|prev(?:Until|All))/,C={children:!0,contents:!0,next:!0,prev:!0};m.extend({dir:function(a,b,c){for(var d=[],e=a[b];e&&9!==e.nodeType&&(void 0===c||1!==e.nodeType||!m(e).is(c));)1===e.nodeType&&d.push(e),e=e[b];return d},sibling:function(a,b){for(var c=[];a;a=a.nextSibling)1===a.nodeType&&a!==b&&c.push(a);return c}}),m.fn.extend({has:function(a){var b,c=m(a,this),d=c.length;return this.filter(function(){for(b=0;d>b;b++)if(m.contains(this,c[b]))return!0})},closest:function(a,b){for(var c,d=0,e=this.length,f=[],g=t.test(a)||"string"!=typeof a?m(a,b||this.context):0;e>d;d++)for(c=this[d];c&&c!==b;c=c.parentNode)if(c.nodeType<11&&(g?g.index(c)>-1:1===c.nodeType&&m.find.matchesSelector(c,a))){f.push(c);break}return this.pushStack(f.length>1?m.unique(f):f)},index:function(a){return a?"string"==typeof a?m.inArray(this[0],m(a)):m.inArray(a.jquery?a[0]:a,this):this[0]&&this[0].parentNode?this.first().prevAll().length:-1},add:function(a,b){return this.pushStack(m.unique(m.merge(this.get(),m(a,b))))},addBack:function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))}}),m.each({parent:function(a){var b=a.parentNode;return b&&11!==b.nodeType?b:null},parents:function(a){return m.dir(a,"parentNode")},parentsUntil:function(a,b,c){return m.dir(a,"parentNode",c)},next:function(a){return D(a,"nextSibling")},prev:function(a){return D(a,"previousSibling")},nextAll:function(a){return m.dir(a,"nextSibling")},prevAll:function(a){return m.dir(a,"previousSibling")},nextUntil:function(a,b,c){return m.dir(a,"nextSibling",c)},prevUntil:function(a,b,c){return m.dir(a,"previousSibling",c)},siblings:function(a){return m.sibling((a.parentNode||{}).firstChild,a)},children:function(a){return m.sibling(a.firstChild)},contents:function(a){return m.nodeName(a,"iframe")?a.contentDocument||a.contentWindow.document:m.merge([],a.childNodes)}},function(a,b){m.fn[a]=function(c,d){var e=m.map(this,b,c);return"Until"!==a.slice(-5)&&(d=c),d&&"string"==typeof d&&(e=m.filter(d,e)),this.length>1&&(C[a]||(e=m.unique(e)),B.test(a)&&(e=e.reverse())),this.pushStack(e)}});var E=/\S+/g,F={};m.Callbacks=function(a){a="string"==typeof a?F[a]||G(a):m.extend({},a);var b,c,d,e,f,g,h=[],i=!a.once&&[],j=function(l){for(c=a.memory&&l,d=!0,f=g||0,g=0,e=h.length,
b=!0;h&&e>f;f++)if(!1===h[f].apply(l[0],l[1])&&a.stopOnFalse){c=!1;break}b=!1,h&&(i?i.length&&j(i.shift()):c?h=[]:k.disable())},k={add:function(){if(h){var d=h.length;!function f(b){m.each(b,function(b,c){var d=m.type(c);"function"===d?a.unique&&k.has(c)||h.push(c):c&&c.length&&"string"!==d&&f(c)})}(arguments),b?e=h.length:c&&(g=d,j(c))}return this},remove:function(){return h&&m.each(arguments,function(a,c){for(var d;(d=m.inArray(c,h,d))>-1;)h.splice(d,1),b&&(e>=d&&e--,f>=d&&f--)}),this},has:function(a){return a?m.inArray(a,h)>-1:!(!h||!h.length)},empty:function(){return h=[],e=0,this},disable:function(){return h=i=c=void 0,this},disabled:function(){return!h},lock:function(){return i=void 0,c||k.disable(),this},locked:function(){return!i},fireWith:function(a,c){return!h||d&&!i||(c=c||[],c=[a,c.slice?c.slice():c],b?i.push(c):j(c)),this},fire:function(){return k.fireWith(this,arguments),this},fired:function(){return!!d}};return k},m.extend({Deferred:function(a){var b=[["resolve","done",m.Callbacks("once memory"),"resolved"],["reject","fail",m.Callbacks("once memory"),"rejected"],["notify","progress",m.Callbacks("memory")]],c="pending",d={state:function(){return c},always:function(){return e.done(arguments).fail(arguments),this},then:function(){var a=arguments;return m.Deferred(function(c){m.each(b,function(b,f){var g=m.isFunction(a[b])&&a[b];e[f[1]](function(){var a=g&&g.apply(this,arguments);a&&m.isFunction(a.promise)?a.promise().done(c.resolve).fail(c.reject).progress(c.notify):c[f[0]+"With"](this===d?c.promise():this,g?[a]:arguments)})}),a=null}).promise()},promise:function(a){return null!=a?m.extend(a,d):d}},e={};return d.pipe=d.then,m.each(b,function(a,f){var g=f[2],h=f[3];d[f[1]]=g.add,h&&g.add(function(){c=h},b[1^a][2].disable,b[2][2].lock),e[f[0]]=function(){return e[f[0]+"With"](this===e?d:this,arguments),this},e[f[0]+"With"]=g.fireWith}),d.promise(e),a&&a.call(e,e),e},when:function(a){var i,j,k,b=0,c=d.call(arguments),e=c.length,f=1!==e||a&&m.isFunction(a.promise)?e:0,g=1===f?a:m.Deferred(),h=function(a,b,c){return function(e){b[a]=this,c[a]=arguments.length>1?d.call(arguments):e,c===i?g.notifyWith(b,c):--f||g.resolveWith(b,c)}};if(e>1)for(i=new Array(e),j=new Array(e),k=new Array(e);e>b;b++)c[b]&&m.isFunction(c[b].promise)?c[b].promise().done(h(b,k,c)).fail(g.reject).progress(h(b,j,i)):--f;return f||g.resolveWith(k,c),g.promise()}});var H;m.fn.ready=function(a){return m.ready.promise().done(a),this},m.extend({isReady:!1,readyWait:1,holdReady:function(a){a?m.readyWait++:m.ready(!0)},ready:function(a){if(!0===a?!--m.readyWait:!m.isReady){if(!y.body)return setTimeout(m.ready);m.isReady=!0,!0!==a&&--m.readyWait>0||(H.resolveWith(y,[m]),m.fn.triggerHandler&&(m(y).triggerHandler("ready"),m(y).off("ready")))}}}),m.ready.promise=function(b){if(!H)if(H=m.Deferred(),"complete"===y.readyState)setTimeout(m.ready);else if(y.addEventListener)y.addEventListener("DOMContentLoaded",J,!1),a.addEventListener("load",J,!1);else{y.attachEvent("onreadystatechange",J),a.attachEvent("onload",J);var c=!1;try{c=null==a.frameElement&&y.documentElement}catch(d){}c&&c.doScroll&&function e(){if(!m.isReady){try{c.doScroll("left")}catch(a){return setTimeout(e,50)}I(),m.ready()}}()}return H.promise(b)};var L,K="undefined";for(L in m(k))break;k.ownLast="0"!==L,k.inlineBlockNeedsLayout=!1,m(function(){var a,b,c,d;(c=y.getElementsByTagName("body")[0])&&c.style&&(b=y.createElement("div"),d=y.createElement("div"),d.style.cssText="position:absolute;border:0;width:0;height:0;top:0;left:-9999px",c.appendChild(d).appendChild(b),typeof b.style.zoom!==K&&(b.style.cssText="display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1",k.inlineBlockNeedsLayout=a=3===b.offsetWidth,a&&(c.style.zoom=1)),c.removeChild(d))}),function(){var a=y.createElement("div");if(null==k.deleteExpando){k.deleteExpando=!0;try{delete a.test}catch(b){k.deleteExpando=!1}}a=null}(),m.acceptData=function(a){var b=m.noData[(a.nodeName+" ").toLowerCase()],c=+a.nodeType||1;return(1===c||9===c)&&(!b||!0!==b&&a.getAttribute("classid")===b)};var M=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,N=/([A-Z])/g;m.extend({cache:{},noData:{"applet ":!0,"embed ":!0,"object ":"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"},hasData:function(a){return!!(a=a.nodeType?m.cache[a[m.expando]]:a[m.expando])&&!P(a)},data:function(a,b,c){return Q(a,b,c)},removeData:function(a,b){return R(a,b)},_data:function(a,b,c){return Q(a,b,c,!0)},_removeData:function(a,b){return R(a,b,!0)}}),m.fn.extend({data:function(a,b){var c,d,e,f=this[0],g=f&&f.attributes;if(void 0===a){if(this.length&&(e=m.data(f),1===f.nodeType&&!m._data(f,"parsedAttrs"))){for(c=g.length;c--;)g[c]&&(d=g[c].name,0===d.indexOf("data-")&&(d=m.camelCase(d.slice(5)),O(f,d,e[d])));m._data(f,"parsedAttrs",!0)}return e}return"object"==typeof a?this.each(function(){m.data(this,a)}):arguments.length>1?this.each(function(){m.data(this,a,b)}):f?O(f,a,m.data(f,a)):void 0},removeData:function(a){return this.each(function(){m.removeData(this,a)})}}),m.extend({queue:function(a,b,c){var d;return a?(b=(b||"fx")+"queue",d=m._data(a,b),c&&(!d||m.isArray(c)?d=m._data(a,b,m.makeArray(c)):d.push(c)),d||[]):void 0},dequeue:function(a,b){b=b||"fx";var c=m.queue(a,b),d=c.length,e=c.shift(),f=m._queueHooks(a,b),g=function(){m.dequeue(a,b)};"inprogress"===e&&(e=c.shift(),d--),e&&("fx"===b&&c.unshift("inprogress"),delete f.stop,e.call(a,g,f)),!d&&f&&f.empty.fire()},_queueHooks:function(a,b){var c=b+"queueHooks";return m._data(a,c)||m._data(a,c,{empty:m.Callbacks("once memory").add(function(){m._removeData(a,b+"queue"),m._removeData(a,c)})})}}),m.fn.extend({queue:function(a,b){var c=2;return"string"!=typeof a&&(b=a,a="fx",c--),arguments.length<c?m.queue(this[0],a):void 0===b?this:this.each(function(){var c=m.queue(this,a,b);m._queueHooks(this,a),"fx"===a&&"inprogress"!==c[0]&&m.dequeue(this,a)})},dequeue:function(a){return this.each(function(){m.dequeue(this,a)})},clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){var c,d=1,e=m.Deferred(),f=this,g=this.length,h=function(){--d||e.resolveWith(f,[f])};for("string"!=typeof a&&(b=a,a=void 0),a=a||"fx";g--;)(c=m._data(f[g],a+"queueHooks"))&&c.empty&&(d++,c.empty.add(h));return h(),e.promise(b)}});var S=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,T=["Top","Right","Bottom","Left"],U=function(a,b){return a=b||a,"none"===m.css(a,"display")||!m.contains(a.ownerDocument,a)},V=m.access=function(a,b,c,d,e,f,g){var h=0,i=a.length,j=null==c;if("object"===m.type(c)){e=!0;for(h in c)m.access(a,b,h,c[h],!0,f,g)}else if(void 0!==d&&(e=!0,m.isFunction(d)||(g=!0),j&&(g?(b.call(a,d),b=null):(j=b,b=function(a,b,c){return j.call(m(a),c)})),b))for(;i>h;h++)b(a[h],c,g?d:d.call(a[h],h,b(a[h],c)));return e?a:j?b.call(a):i?b(a[0],c):f},W=/^(?:checkbox|radio)$/i;!function(){var a=y.createElement("input"),b=y.createElement("div"),c=y.createDocumentFragment();if(b.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",k.leadingWhitespace=3===b.firstChild.nodeType,k.tbody=!b.getElementsByTagName("tbody").length,k.htmlSerialize=!!b.getElementsByTagName("link").length,k.html5Clone="<:nav></:nav>"!==y.createElement("nav").cloneNode(!0).outerHTML,a.type="checkbox",a.checked=!0,c.appendChild(a),k.appendChecked=a.checked,b.innerHTML="<textarea>x</textarea>",k.noCloneChecked=!!b.cloneNode(!0).lastChild.defaultValue,c.appendChild(b),b.innerHTML="<input type='radio' checked='checked' name='t'/>",k.checkClone=b.cloneNode(!0).cloneNode(!0).lastChild.checked,k.noCloneEvent=!0,b.attachEvent&&(b.attachEvent("onclick",function(){k.noCloneEvent=!1}),b.cloneNode(!0).click()),null==k.deleteExpando){k.deleteExpando=!0;try{delete b.test}catch(d){k.deleteExpando=!1}}}(),function(){var b,c,d=y.createElement("div");for(b in{submit:!0,change:!0,focusin:!0})c="on"+b,(k[b+"Bubbles"]=c in a)||(d.setAttribute(c,"t"),k[b+"Bubbles"]=!1===d.attributes[c].expando);d=null}();var X=/^(?:input|select|textarea)$/i,Y=/^key/,Z=/^(?:mouse|pointer|contextmenu)|click/,$=/^(?:focusinfocus|focusoutblur)$/,_=/^([^.]*)(?:\.(.+)|)$/;m.event={global:{},add:function(a,b,c,d,e){var f,g,h,i,j,k,l,n,o,p,q,r=m._data(a);if(r){for(c.handler&&(i=c,c=i.handler,e=i.selector),c.guid||(c.guid=m.guid++),(g=r.events)||(g=r.events={}),(k=r.handle)||(k=r.handle=function(a){return typeof m===K||a&&m.event.triggered===a.type?void 0:m.event.dispatch.apply(k.elem,arguments)},k.elem=a),b=(b||"").match(E)||[""],h=b.length;h--;)f=_.exec(b[h])||[],o=q=f[1],p=(f[2]||"").split(".").sort(),o&&(j=m.event.special[o]||{},o=(e?j.delegateType:j.bindType)||o,j=m.event.special[o]||{},l=m.extend({type:o,origType:q,data:d,handler:c,guid:c.guid,selector:e,needsContext:e&&m.expr.match.needsContext.test(e),namespace:p.join(".")},i),(n=g[o])||(n=g[o]=[],n.delegateCount=0,j.setup&&!1!==j.setup.call(a,d,p,k)||(a.addEventListener?a.addEventListener(o,k,!1):a.attachEvent&&a.attachEvent("on"+o,k))),j.add&&(j.add.call(a,l),l.handler.guid||(l.handler.guid=c.guid)),e?n.splice(n.delegateCount++,0,l):n.push(l),m.event.global[o]=!0);a=null}},remove:function(a,b,c,d,e){var f,g,h,i,j,k,l,n,o,p,q,r=m.hasData(a)&&m._data(a);if(r&&(k=r.events)){for(b=(b||"").match(E)||[""],j=b.length;j--;)if(h=_.exec(b[j])||[],o=q=h[1],p=(h[2]||"").split(".").sort(),o){for(l=m.event.special[o]||{},o=(d?l.delegateType:l.bindType)||o,n=k[o]||[],h=h[2]&&new RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)"),i=f=n.length;f--;)g=n[f],!e&&q!==g.origType||c&&c.guid!==g.guid||h&&!h.test(g.namespace)||d&&d!==g.selector&&("**"!==d||!g.selector)||(n.splice(f,1),g.selector&&n.delegateCount--,l.remove&&l.remove.call(a,g));i&&!n.length&&(l.teardown&&!1!==l.teardown.call(a,p,r.handle)||m.removeEvent(a,o,r.handle),delete k[o])}else for(o in k)m.event.remove(a,o+b[j],c,d,!0);m.isEmptyObject(k)&&(delete r.handle,m._removeData(a,"events"))}},trigger:function(b,c,d,e){var f,g,h,i,k,l,n,o=[d||y],p=j.call(b,"type")?b.type:b,q=j.call(b,"namespace")?b.namespace.split("."):[];if(h=l=d=d||y,3!==d.nodeType&&8!==d.nodeType&&!$.test(p+m.event.triggered)&&(p.indexOf(".")>=0&&(q=p.split("."),p=q.shift(),q.sort()),g=p.indexOf(":")<0&&"on"+p,b=b[m.expando]?b:new m.Event(p,"object"==typeof b&&b),b.isTrigger=e?2:3,b.namespace=q.join("."),b.namespace_re=b.namespace?new RegExp("(^|\\.)"+q.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,b.result=void 0,b.target||(b.target=d),c=null==c?[b]:m.makeArray(c,[b]),k=m.event.special[p]||{},e||!k.trigger||!1!==k.trigger.apply(d,c))){if(!e&&!k.noBubble&&!m.isWindow(d)){for(i=k.delegateType||p,$.test(i+p)||(h=h.parentNode);h;h=h.parentNode)o.push(h),l=h;l===(d.ownerDocument||y)&&o.push(l.defaultView||l.parentWindow||a)}for(n=0;(h=o[n++])&&!b.isPropagationStopped();)b.type=n>1?i:k.bindType||p,f=(m._data(h,"events")||{})[b.type]&&m._data(h,"handle"),f&&f.apply(h,c),(f=g&&h[g])&&f.apply&&m.acceptData(h)&&(b.result=f.apply(h,c),!1===b.result&&b.preventDefault());if(b.type=p,!e&&!b.isDefaultPrevented()&&(!k._default||!1===k._default.apply(o.pop(),c))&&m.acceptData(d)&&g&&d[p]&&!m.isWindow(d)){l=d[g],l&&(d[g]=null),m.event.triggered=p;try{d[p]()}catch(r){}m.event.triggered=void 0,l&&(d[g]=l)}return b.result}},dispatch:function(a){a=m.event.fix(a);var b,c,e,f,g,h=[],i=d.call(arguments),j=(m._data(this,"events")||{})[a.type]||[],k=m.event.special[a.type]||{};if(i[0]=a,a.delegateTarget=this,!k.preDispatch||!1!==k.preDispatch.call(this,a)){for(h=m.event.handlers.call(this,a,j),b=0;(f=h[b++])&&!a.isPropagationStopped();)for(a.currentTarget=f.elem,g=0;(e=f.handlers[g++])&&!a.isImmediatePropagationStopped();)(!a.namespace_re||a.namespace_re.test(e.namespace))&&(a.handleObj=e,a.data=e.data,void 0!==(c=((m.event.special[e.origType]||{}).handle||e.handler).apply(f.elem,i))&&!1===(a.result=c)&&(a.preventDefault(),a.stopPropagation()));return k.postDispatch&&k.postDispatch.call(this,a),a.result}},handlers:function(a,b){var c,d,e,f,g=[],h=b.delegateCount,i=a.target;if(h&&i.nodeType&&(!a.button||"click"!==a.type))for(;i!=this;i=i.parentNode||this)if(1===i.nodeType&&(!0!==i.disabled||"click"!==a.type)){for(e=[],f=0;h>f;f++)d=b[f],c=d.selector+" ",void 0===e[c]&&(e[c]=d.needsContext?m(c,this).index(i)>=0:m.find(c,this,null,[i]).length),e[c]&&e.push(d);e.length&&g.push({elem:i,handlers:e})}return h<b.length&&g.push({elem:this,handlers:b.slice(h)}),g},fix:function(a){if(a[m.expando])return a;var b,c,d,e=a.type,f=a,g=this.fixHooks[e];for(g||(this.fixHooks[e]=g=Z.test(e)?this.mouseHooks:Y.test(e)?this.keyHooks:{}),d=g.props?this.props.concat(g.props):this.props,a=new m.Event(f),b=d.length;b--;)c=d[b],a[c]=f[c];return a.target||(a.target=f.srcElement||y),3===a.target.nodeType&&(a.target=a.target.parentNode),a.metaKey=!!a.metaKey,g.filter?g.filter(a,f):a},props:"altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:"char charCode key keyCode".split(" "),filter:function(a,b){return null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode),a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),filter:function(a,b){var c,d,e,f=b.button,g=b.fromElement;return null==a.pageX&&null!=b.clientX&&(d=a.target.ownerDocument||y,e=d.documentElement,c=d.body,a.pageX=b.clientX+(e&&e.scrollLeft||c&&c.scrollLeft||0)-(e&&e.clientLeft||c&&c.clientLeft||0),a.pageY=b.clientY+(e&&e.scrollTop||c&&c.scrollTop||0)-(e&&e.clientTop||c&&c.clientTop||0)),!a.relatedTarget&&g&&(a.relatedTarget=g===a.target?b.toElement:g),a.which||void 0===f||(a.which=1&f?1:2&f?3:4&f?2:0),a}},special:{load:{noBubble:!0},focus:{trigger:function(){if(this!==ca()&&this.focus)try{return this.focus(),!1}catch(a){}},delegateType:"focusin"},blur:{trigger:function(){return this===ca()&&this.blur?(this.blur(),!1):void 0},delegateType:"focusout"},click:{trigger:function(){return m.nodeName(this,"input")&&"checkbox"===this.type&&this.click?(this.click(),!1):void 0},_default:function(a){return m.nodeName(a.target,"a")}},beforeunload:{postDispatch:function(a){void 0!==a.result&&a.originalEvent&&(a.originalEvent.returnValue=a.result)}}},simulate:function(a,b,c,d){var e=m.extend(new m.Event,c,{type:a,isSimulated:!0,originalEvent:{}});d?m.event.trigger(e,null,b):m.event.dispatch.call(b,e),e.isDefaultPrevented()&&c.preventDefault()}},m.removeEvent=y.removeEventListener?function(a,b,c){a.removeEventListener&&a.removeEventListener(b,c,!1)}:function(a,b,c){var d="on"+b;a.detachEvent&&(typeof a[d]===K&&(a[d]=null),a.detachEvent(d,c))},m.Event=function(a,b){return this instanceof m.Event?(a&&a.type?(this.originalEvent=a,this.type=a.type,this.isDefaultPrevented=a.defaultPrevented||void 0===a.defaultPrevented&&!1===a.returnValue?aa:ba):this.type=a,b&&m.extend(this,b),this.timeStamp=a&&a.timeStamp||m.now(),void(this[m.expando]=!0)):new m.Event(a,b)},m.Event.prototype={isDefaultPrevented:ba,isPropagationStopped:ba,isImmediatePropagationStopped:ba,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=aa,a&&(a.preventDefault?a.preventDefault():a.returnValue=!1)},stopPropagation:function(){var a=this.originalEvent;this.isPropagationStopped=aa,a&&(a.stopPropagation&&a.stopPropagation(),a.cancelBubble=!0)},stopImmediatePropagation:function(){var a=this.originalEvent;this.isImmediatePropagationStopped=aa,a&&a.stopImmediatePropagation&&a.stopImmediatePropagation(),this.stopPropagation()}},m.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(a,b){m.event.special[a]={delegateType:b,bindType:b,handle:function(a){var c,d=this,e=a.relatedTarget,f=a.handleObj;return(!e||e!==d&&!m.contains(d,e))&&(a.type=f.origType,c=f.handler.apply(this,arguments),a.type=b),c}}}),k.submitBubbles||(m.event.special.submit={setup:function(){return!m.nodeName(this,"form")&&void m.event.add(this,"click._submit keypress._submit",function(a){var b=a.target,c=m.nodeName(b,"input")||m.nodeName(b,"button")?b.form:void 0;c&&!m._data(c,"submitBubbles")&&(m.event.add(c,"submit._submit",function(a){a._submit_bubble=!0}),m._data(c,"submitBubbles",!0))})},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&m.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){return!m.nodeName(this,"form")&&void m.event.remove(this,"._submit")}}),k.changeBubbles||(m.event.special.change={setup:function(){return X.test(this.nodeName)?(("checkbox"===this.type||"radio"===this.type)&&(m.event.add(this,"propertychange._change",function(a){"checked"===a.originalEvent.propertyName&&(this._just_changed=!0)}),m.event.add(this,"click._change",function(a){this._just_changed&&!a.isTrigger&&(this._just_changed=!1),m.event.simulate("change",this,a,!0)})),!1):void m.event.add(this,"beforeactivate._change",function(a){var b=a.target;X.test(b.nodeName)&&!m._data(b,"changeBubbles")&&(m.event.add(b,"change._change",function(a){!this.parentNode||a.isSimulated||a.isTrigger||m.event.simulate("change",this.parentNode,a,!0)}),m._data(b,"changeBubbles",!0))})},handle:function(a){var b=a.target;return this!==b||a.isSimulated||a.isTrigger||"radio"!==b.type&&"checkbox"!==b.type?a.handleObj.handler.apply(this,arguments):void 0},teardown:function(){return m.event.remove(this,"._change"),!X.test(this.nodeName)}}),k.focusinBubbles||m.each({focus:"focusin",blur:"focusout"},function(a,b){var c=function(a){m.event.simulate(b,a.target,m.event.fix(a),!0)};m.event.special[b]={setup:function(){var d=this.ownerDocument||this,e=m._data(d,b);e||d.addEventListener(a,c,!0),m._data(d,b,(e||0)+1)},teardown:function(){var d=this.ownerDocument||this,e=m._data(d,b)-1;e?m._data(d,b,e):(d.removeEventListener(a,c,!0),m._removeData(d,b))}}}),m.fn.extend({on:function(a,b,c,d,e){var f,g;if("object"==typeof a){"string"!=typeof b&&(c=c||b,b=void 0);for(f in a)this.on(f,b,c,a[f],e);return this}if(null==c&&null==d?(d=b,c=b=void 0):null==d&&("string"==typeof b?(d=c,c=void 0):(d=c,c=b,b=void 0)),!1===d)d=ba;else if(!d)return this;return 1===e&&(g=d,d=function(a){return m().off(a),g.apply(this,arguments)},d.guid=g.guid||(g.guid=m.guid++)),this.each(function(){m.event.add(this,a,d,c,b)})},one:function(a,b,c,d){return this.on(a,b,c,d,1)},off:function(a,b,c){var d,e;if(a&&a.preventDefault&&a.handleObj)return d=a.handleObj,m(a.delegateTarget).off(d.namespace?d.origType+"."+d.namespace:d.origType,d.selector,d.handler),this;if("object"==typeof a){for(e in a)this.off(e,b,a[e]);return this}return(!1===b||"function"==typeof b)&&(c=b,b=void 0),!1===c&&(c=ba),this.each(function(){m.event.remove(this,a,c,b)})},trigger:function(a,b){return this.each(function(){m.event.trigger(a,b,this)})},triggerHandler:function(a,b){var c=this[0];return c?m.event.trigger(a,b,c,!0):void 0}});var ea="abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",ga=new RegExp("<(?:"+ea+")[\\s/>]","i"),ha=/^\s+/,ia=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,ja=/<([\w:]+)/,ka=/<tbody/i,la=/<|&#?\w+;/,ma=/<(?:script|style|link)/i,na=/checked\s*(?:[^=]|=\s*.checked.)/i,oa=/^$|\/(?:java|ecma)script/i,pa=/^true\/(.*)/,ra={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],area:[1,"<map>","</map>"],param:[1,"<object>","</object>"],thead:[1,"<table>","</table>"],tr:[2,"<table><tbody>","</tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],_default:k.htmlSerialize?[0,"",""]:[1,"X<div>","</div>"]},sa=da(y),ta=sa.appendChild(y.createElement("div"));ra.optgroup=ra.option,ra.tbody=ra.tfoot=ra.colgroup=ra.caption=ra.thead,ra.th=ra.td,m.extend({clone:function(a,b,c){var d,e,f,g,h,i=m.contains(a.ownerDocument,a);if(k.html5Clone||m.isXMLDoc(a)||!ga.test("<"+a.nodeName+">")?f=a.cloneNode(!0):(ta.innerHTML=a.outerHTML,ta.removeChild(f=ta.firstChild)),!(k.noCloneEvent&&k.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||m.isXMLDoc(a)))for(d=ua(f),h=ua(a),g=0;null!=(e=h[g]);++g)d[g]&&Ba(e,d[g]);if(b)if(c)for(h=h||ua(a),d=d||ua(f),g=0;null!=(e=h[g]);g++)Aa(e,d[g]);else Aa(a,f);return d=ua(f,"script"),d.length>0&&za(d,!i&&ua(a,"script")),d=h=e=null,f},buildFragment:function(a,b,c,d){for(var e,f,g,h,i,j,l,n=a.length,o=da(b),p=[],q=0;n>q;q++)if((f=a[q])||0===f)if("object"===m.type(f))m.merge(p,f.nodeType?[f]:f);else if(la.test(f)){for(h=h||o.appendChild(b.createElement("div")),i=(ja.exec(f)||["",""])[1].toLowerCase(),l=ra[i]||ra._default,h.innerHTML=l[1]+f.replace(ia,"<$1></$2>")+l[2],e=l[0];e--;)h=h.lastChild;if(!k.leadingWhitespace&&ha.test(f)&&p.push(b.createTextNode(ha.exec(f)[0])),!k.tbody)for(f="table"!==i||ka.test(f)?"<table>"!==l[1]||ka.test(f)?0:h:h.firstChild,e=f&&f.childNodes.length;e--;)m.nodeName(j=f.childNodes[e],"tbody")&&!j.childNodes.length&&f.removeChild(j);for(m.merge(p,h.childNodes),h.textContent="";h.firstChild;)h.removeChild(h.firstChild);h=o.lastChild}else p.push(b.createTextNode(f));for(h&&o.removeChild(h),k.appendChecked||m.grep(ua(p,"input"),va),q=0;f=p[q++];)if((!d||-1===m.inArray(f,d))&&(g=m.contains(f.ownerDocument,f),h=ua(o.appendChild(f),"script"),g&&za(h),c))for(e=0;f=h[e++];)oa.test(f.type||"")&&c.push(f);return h=null,o},cleanData:function(a,b){for(var d,e,f,g,h=0,i=m.expando,j=m.cache,l=k.deleteExpando,n=m.event.special;null!=(d=a[h]);h++)if((b||m.acceptData(d))&&(f=d[i],g=f&&j[f])){if(g.events)for(e in g.events)n[e]?m.event.remove(d,e):m.removeEvent(d,e,g.handle);j[f]&&(delete j[f],l?delete d[i]:typeof d.removeAttribute!==K?d.removeAttribute(i):d[i]=null,c.push(f))}}}),m.fn.extend({text:function(a){return V(this,function(a){return void 0===a?m.text(this):this.empty().append((this[0]&&this[0].ownerDocument||y).createTextNode(a))},null,a,arguments.length)},append:function(){return this.domManip(arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){wa(this,a).appendChild(a)}})},prepend:function(){return this.domManip(arguments,function(a){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var b=wa(this,a);b.insertBefore(a,b.firstChild)}})},before:function(){return this.domManip(arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this)})},after:function(){return this.domManip(arguments,function(a){this.parentNode&&this.parentNode.insertBefore(a,this.nextSibling)})},remove:function(a,b){for(var c,d=a?m.filter(a,this):this,e=0;null!=(c=d[e]);e++)b||1!==c.nodeType||m.cleanData(ua(c)),c.parentNode&&(b&&m.contains(c.ownerDocument,c)&&za(ua(c,"script")),c.parentNode.removeChild(c));return this},empty:function(){for(var a,b=0;null!=(a=this[b]);b++){for(1===a.nodeType&&m.cleanData(ua(a,!1));a.firstChild;)a.removeChild(a.firstChild);a.options&&m.nodeName(a,"select")&&(a.options.length=0)}return this},clone:function(a,b){return a=null!=a&&a,b=null==b?a:b,this.map(function(){return m.clone(this,a,b)})},html:function(a){return V(this,function(a){var b=this[0]||{},c=0,d=this.length;if(void 0===a)return 1===b.nodeType?b.innerHTML.replace(/ jQuery\d+="(?:null|\d+)"/g,""):void 0;if(!("string"!=typeof a||ma.test(a)||!k.htmlSerialize&&ga.test(a)||!k.leadingWhitespace&&ha.test(a)||ra[(ja.exec(a)||["",""])[1].toLowerCase()])){a=a.replace(ia,"<$1></$2>");try{for(;d>c;c++)b=this[c]||{},1===b.nodeType&&(m.cleanData(ua(b,!1)),b.innerHTML=a);b=0}catch(e){}}b&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=arguments[0];return this.domManip(arguments,function(b){a=this.parentNode,m.cleanData(ua(this)),a&&a.replaceChild(b,this)}),a&&(a.length||a.nodeType)?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b){a=e.apply([],a);var c,d,f,g,h,i,j=0,l=this.length,n=this,o=l-1,p=a[0],q=m.isFunction(p);if(q||l>1&&"string"==typeof p&&!k.checkClone&&na.test(p))return this.each(function(c){var d=n.eq(c);q&&(a[0]=p.call(this,c,d.html())),d.domManip(a,b)});if(l&&(i=m.buildFragment(a,this[0].ownerDocument,!1,this),c=i.firstChild,1===i.childNodes.length&&(i=c),c)){for(g=m.map(ua(i,"script"),xa),f=g.length;l>j;j++)d=i,j!==o&&(d=m.clone(d,!0,!0),f&&m.merge(g,ua(d,"script"))),b.call(this[j],d,j);if(f)for(h=g[g.length-1].ownerDocument,m.map(g,ya),j=0;f>j;j++)d=g[j],oa.test(d.type||"")&&!m._data(d,"globalEval")&&m.contains(h,d)&&(d.src?m._evalUrl&&m._evalUrl(d.src):m.globalEval((d.text||d.textContent||d.innerHTML||"").replace(/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,"")));i=c=null}return this}}),m.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){m.fn[a]=function(a){for(var c,d=0,e=[],g=m(a),h=g.length-1;h>=d;d++)c=d===h?this:this.clone(!0),m(g[d])[b](c),f.apply(e,c.get());return this.pushStack(e)}});var Ca,Da={};!function(){var a;k.shrinkWrapBlocks=function(){if(null!=a)return a;a=!1;var b,c,d;return c=y.getElementsByTagName("body")[0],c&&c.style?(b=y.createElement("div"),d=y.createElement("div"),d.style.cssText="position:absolute;border:0;width:0;height:0;top:0;left:-9999px",c.appendChild(d).appendChild(b),typeof b.style.zoom!==K&&(b.style.cssText="-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1",b.appendChild(y.createElement("div")).style.width="5px",a=3!==b.offsetWidth),c.removeChild(d),a):void 0}}();var Ia,Ja,Ga=/^margin/,Ha=new RegExp("^("+S+")(?!px)[a-z%]+$","i"),Ka=/^(top|right|bottom|left)$/;a.getComputedStyle?(Ia=function(b){return b.ownerDocument.defaultView.opener?b.ownerDocument.defaultView.getComputedStyle(b,null):a.getComputedStyle(b,null)},Ja=function(a,b,c){var d,e,f,g,h=a.style;return c=c||Ia(a),g=c?c.getPropertyValue(b)||c[b]:void 0,c&&(""!==g||m.contains(a.ownerDocument,a)||(g=m.style(a,b)),Ha.test(g)&&Ga.test(b)&&(d=h.width,e=h.minWidth,f=h.maxWidth,h.minWidth=h.maxWidth=h.width=g,g=c.width,h.width=d,h.minWidth=e,h.maxWidth=f)),void 0===g?g:g+""}):y.documentElement.currentStyle&&(Ia=function(a){return a.currentStyle},Ja=function(a,b,c){var d,e,f,g,h=a.style;return c=c||Ia(a),g=c?c[b]:void 0,null==g&&h&&h[b]&&(g=h[b]),Ha.test(g)&&!Ka.test(b)&&(d=h.left,e=a.runtimeStyle,f=e&&e.left,f&&(e.left=a.currentStyle.left),h.left="fontSize"===b?"1em":g,g=h.pixelLeft+"px",h.left=d,f&&(e.left=f)),void 0===g?g:g+""||"auto"}),!function(){function i(){var b,c,d,i;(c=y.getElementsByTagName("body")[0])&&c.style&&(b=y.createElement("div"),d=y.createElement("div"),d.style.cssText="position:absolute;border:0;width:0;height:0;top:0;left:-9999px",c.appendChild(d).appendChild(b),b.style.cssText="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute",e=f=!1,h=!0,a.getComputedStyle&&(e="1%"!==(a.getComputedStyle(b,null)||{}).top,f="4px"===(a.getComputedStyle(b,null)||{width:"4px"}).width,i=b.appendChild(y.createElement("div")),i.style.cssText=b.style.cssText="-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0",i.style.marginRight=i.style.width="0",b.style.width="1px",h=!parseFloat((a.getComputedStyle(i,null)||{}).marginRight),b.removeChild(i)),b.innerHTML="<table><tr><td></td><td>t</td></tr></table>",i=b.getElementsByTagName("td"),i[0].style.cssText="margin:0;border:0;padding:0;display:none",g=0===i[0].offsetHeight,g&&(i[0].style.display="",i[1].style.display="none",g=0===i[0].offsetHeight),c.removeChild(d))}var b,c,d,e,f,g,h;b=y.createElement("div"),b.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",d=b.getElementsByTagName("a")[0],(c=d&&d.style)&&(c.cssText="float:left;opacity:.5",k.opacity="0.5"===c.opacity,k.cssFloat=!!c.cssFloat,b.style.backgroundClip="content-box",b.cloneNode(!0).style.backgroundClip="",k.clearCloneStyle="content-box"===b.style.backgroundClip,k.boxSizing=""===c.boxSizing||""===c.MozBoxSizing||""===c.WebkitBoxSizing,m.extend(k,{reliableHiddenOffsets:function(){return null==g&&i(),g},boxSizingReliable:function(){return null==f&&i(),f},pixelPosition:function(){return null==e&&i(),e},reliableMarginRight:function(){return null==h&&i(),h}}))}(),m.swap=function(a,b,c,d){var e,f,g={};for(f in b)g[f]=a.style[f],a.style[f]=b[f];e=c.apply(a,d||[]);for(f in b)a.style[f]=g[f];return e};var Ma=/alpha\([^)]*\)/i,Na=/opacity\s*=\s*([^)]*)/,Oa=/^(none|table(?!-c[ea]).+)/,Pa=new RegExp("^("+S+")(.*)$","i"),Qa=new RegExp("^([+-])=("+S+")","i"),Ra={position:"absolute",visibility:"hidden",display:"block"},Sa={letterSpacing:"0",fontWeight:"400"},Ta=["Webkit","O","Moz","ms"];m.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=Ja(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{float:k.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,c,d){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var e,f,g,h=m.camelCase(b),i=a.style;if(b=m.cssProps[h]||(m.cssProps[h]=Ua(i,h)),g=m.cssHooks[b]||m.cssHooks[h],void 0===c)return g&&"get"in g&&void 0!==(e=g.get(a,!1,d))?e:i[b];if(f=typeof c,"string"===f&&(e=Qa.exec(c))&&(c=(e[1]+1)*e[2]+parseFloat(m.css(a,b)),f="number"),null!=c&&c===c&&("number"!==f||m.cssNumber[h]||(c+="px"),k.clearCloneStyle||""!==c||0!==b.indexOf("background")||(i[b]="inherit"),!(g&&"set"in g&&void 0===(c=g.set(a,c,d)))))try{i[b]=c}catch(j){}}},css:function(a,b,c,d){var e,f,g,h=m.camelCase(b);return b=m.cssProps[h]||(m.cssProps[h]=Ua(a.style,h)),g=m.cssHooks[b]||m.cssHooks[h],g&&"get"in g&&(f=g.get(a,!0,c)),void 0===f&&(f=Ja(a,b,d)),"normal"===f&&b in Sa&&(f=Sa[b]),""===c||c?(e=parseFloat(f),!0===c||m.isNumeric(e)?e||0:f):f}}),m.each(["height","width"],function(a,b){m.cssHooks[b]={get:function(a,c,d){return c?Oa.test(m.css(a,"display"))&&0===a.offsetWidth?m.swap(a,Ra,function(){return Ya(a,b,d)}):Ya(a,b,d):void 0},set:function(a,c,d){var e=d&&Ia(a);return Wa(a,c,d?Xa(a,b,d,k.boxSizing&&"border-box"===m.css(a,"boxSizing",!1,e),e):0)}}}),k.opacity||(m.cssHooks.opacity={get:function(a,b){return Na.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var c=a.style,d=a.currentStyle,e=m.isNumeric(b)?"alpha(opacity="+100*b+")":"",f=d&&d.filter||c.filter||"";c.zoom=1,(b>=1||""===b)&&""===m.trim(f.replace(Ma,""))&&c.removeAttribute&&(c.removeAttribute("filter"),""===b||d&&!d.filter)||(c.filter=Ma.test(f)?f.replace(Ma,e):f+" "+e)}}),m.cssHooks.marginRight=La(k.reliableMarginRight,function(a,b){return b?m.swap(a,{display:"inline-block"},Ja,[a,"marginRight"]):void 0}),m.each({margin:"",padding:"",border:"Width"},function(a,b){m.cssHooks[a+b]={expand:function(c){for(var d=0,e={},f="string"==typeof c?c.split(" "):[c];4>d;d++)e[a+T[d]+b]=f[d]||f[d-2]||f[0];return e}},Ga.test(a)||(m.cssHooks[a+b].set=Wa)}),m.fn.extend({css:function(a,b){return V(this,function(a,b,c){var d,e,f={},g=0;if(m.isArray(b)){for(d=Ia(a),e=b.length;e>g;g++)f[b[g]]=m.css(a,b[g],!1,d);return f}return void 0!==c?m.style(a,b,c):m.css(a,b)},a,b,arguments.length>1)},show:function(){return Va(this,!0)},hide:function(){return Va(this)},toggle:function(a){return"boolean"==typeof a?a?this.show():this.hide():this.each(function(){U(this)?m(this).show():m(this).hide()})}}),m.Tween=Za,Za.prototype={constructor:Za,init:function(a,b,c,d,e,f){this.elem=a,this.prop=c,this.easing=e||"swing",this.options=b,this.start=this.now=this.cur(),this.end=d,this.unit=f||(m.cssNumber[c]?"":"px")},cur:function(){var a=Za.propHooks[this.prop];return a&&a.get?a.get(this):Za.propHooks._default.get(this)},run:function(a){var b,c=Za.propHooks[this.prop];return this.options.duration?this.pos=b=m.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):this.pos=b=a,this.now=(this.end-this.start)*b+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),c&&c.set?c.set(this):Za.propHooks._default.set(this),this}},
Za.prototype.init.prototype=Za.prototype,Za.propHooks={_default:{get:function(a){var b;return null==a.elem[a.prop]||a.elem.style&&null!=a.elem.style[a.prop]?(b=m.css(a.elem,a.prop,""),b&&"auto"!==b?b:0):a.elem[a.prop]},set:function(a){m.fx.step[a.prop]?m.fx.step[a.prop](a):a.elem.style&&(null!=a.elem.style[m.cssProps[a.prop]]||m.cssHooks[a.prop])?m.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}},Za.propHooks.scrollTop=Za.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}},m.easing={linear:function(a){return a},swing:function(a){return.5-Math.cos(a*Math.PI)/2}},m.fx=Za.prototype.init,m.fx.step={};var $a,_a,ab=/^(?:toggle|show|hide)$/,bb=new RegExp("^(?:([+-])=|)("+S+")([a-z%]*)$","i"),cb=/queueHooks$/,db=[ib],eb={"*":[function(a,b){var c=this.createTween(a,b),d=c.cur(),e=bb.exec(b),f=e&&e[3]||(m.cssNumber[a]?"":"px"),g=(m.cssNumber[a]||"px"!==f&&+d)&&bb.exec(m.css(c.elem,a)),h=1,i=20;if(g&&g[3]!==f){f=f||g[3],e=e||[],g=+d||1;do{h=h||".5",g/=h,m.style(c.elem,a,g+f)}while(h!==(h=c.cur()/d)&&1!==h&&--i)}return e&&(g=c.start=+g||+d||0,c.unit=f,c.end=e[1]?g+(e[1]+1)*e[2]:+e[2]),c}]};m.Animation=m.extend(kb,{tweener:function(a,b){m.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,d=0,e=a.length;e>d;d++)c=a[d],eb[c]=eb[c]||[],eb[c].unshift(b)},prefilter:function(a,b){b?db.unshift(a):db.push(a)}}),m.speed=function(a,b,c){var d=a&&"object"==typeof a?m.extend({},a):{complete:c||!c&&b||m.isFunction(a)&&a,duration:a,easing:c&&b||b&&!m.isFunction(b)&&b};return d.duration=m.fx.off?0:"number"==typeof d.duration?d.duration:d.duration in m.fx.speeds?m.fx.speeds[d.duration]:m.fx.speeds._default,(null==d.queue||!0===d.queue)&&(d.queue="fx"),d.old=d.complete,d.complete=function(){m.isFunction(d.old)&&d.old.call(this),d.queue&&m.dequeue(this,d.queue)},d},m.fn.extend({fadeTo:function(a,b,c,d){return this.filter(U).css("opacity",0).show().end().animate({opacity:b},a,c,d)},animate:function(a,b,c,d){var e=m.isEmptyObject(a),f=m.speed(b,c,d),g=function(){var b=kb(this,m.extend({},a),f);(e||m._data(this,"finish"))&&b.stop(!0)};return g.finish=g,e||!1===f.queue?this.each(g):this.queue(f.queue,g)},stop:function(a,b,c){var d=function(a){var b=a.stop;delete a.stop,b(c)};return"string"!=typeof a&&(c=b,b=a,a=void 0),b&&!1!==a&&this.queue(a||"fx",[]),this.each(function(){var b=!0,e=null!=a&&a+"queueHooks",f=m.timers,g=m._data(this);if(e)g[e]&&g[e].stop&&d(g[e]);else for(e in g)g[e]&&g[e].stop&&cb.test(e)&&d(g[e]);for(e=f.length;e--;)f[e].elem!==this||null!=a&&f[e].queue!==a||(f[e].anim.stop(c),b=!1,f.splice(e,1));(b||!c)&&m.dequeue(this,a)})},finish:function(a){return!1!==a&&(a=a||"fx"),this.each(function(){var b,c=m._data(this),d=c[a+"queue"],e=c[a+"queueHooks"],f=m.timers,g=d?d.length:0;for(c.finish=!0,m.queue(this,a,[]),e&&e.stop&&e.stop.call(this,!0),b=f.length;b--;)f[b].elem===this&&f[b].queue===a&&(f[b].anim.stop(!0),f.splice(b,1));for(b=0;g>b;b++)d[b]&&d[b].finish&&d[b].finish.call(this);delete c.finish})}}),m.each(["toggle","show","hide"],function(a,b){var c=m.fn[b];m.fn[b]=function(a,d,e){return null==a||"boolean"==typeof a?c.apply(this,arguments):this.animate(gb(b,!0),a,d,e)}}),m.each({slideDown:gb("show"),slideUp:gb("hide"),slideToggle:gb("toggle"),fadeIn:{opacity:"show"},fadeOut:{opacity:"hide"},fadeToggle:{opacity:"toggle"}},function(a,b){m.fn[a]=function(a,c,d){return this.animate(b,a,c,d)}}),m.timers=[],m.fx.tick=function(){var a,b=m.timers,c=0;for($a=m.now();c<b.length;c++)(a=b[c])()||b[c]!==a||b.splice(c--,1);b.length||m.fx.stop(),$a=void 0},m.fx.timer=function(a){m.timers.push(a),a()?m.fx.start():m.timers.pop()},m.fx.interval=13,m.fx.start=function(){_a||(_a=setInterval(m.fx.tick,m.fx.interval))},m.fx.stop=function(){clearInterval(_a),_a=null},m.fx.speeds={slow:600,fast:200,_default:400},m.fn.delay=function(a,b){return a=m.fx?m.fx.speeds[a]||a:a,b=b||"fx",this.queue(b,function(b,c){var d=setTimeout(b,a);c.stop=function(){clearTimeout(d)}})},function(){var a,b,c,d,e;b=y.createElement("div"),b.setAttribute("className","t"),b.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>",d=b.getElementsByTagName("a")[0],c=y.createElement("select"),e=c.appendChild(y.createElement("option")),a=b.getElementsByTagName("input")[0],d.style.cssText="top:1px",k.getSetAttribute="t"!==b.className,k.style=/top/.test(d.getAttribute("style")),k.hrefNormalized="/a"===d.getAttribute("href"),k.checkOn=!!a.value,k.optSelected=e.selected,k.enctype=!!y.createElement("form").enctype,c.disabled=!0,k.optDisabled=!e.disabled,a=y.createElement("input"),a.setAttribute("value",""),k.input=""===a.getAttribute("value"),a.value="t",a.setAttribute("type","radio"),k.radioValue="t"===a.value}();m.fn.extend({val:function(a){var b,c,d,e=this[0];return arguments.length?(d=m.isFunction(a),this.each(function(c){var e;1===this.nodeType&&(e=d?a.call(this,c,m(this).val()):a,null==e?e="":"number"==typeof e?e+="":m.isArray(e)&&(e=m.map(e,function(a){return null==a?"":a+""})),(b=m.valHooks[this.type]||m.valHooks[this.nodeName.toLowerCase()])&&"set"in b&&void 0!==b.set(this,e,"value")||(this.value=e))})):e?(b=m.valHooks[e.type]||m.valHooks[e.nodeName.toLowerCase()],b&&"get"in b&&void 0!==(c=b.get(e,"value"))?c:(c=e.value,"string"==typeof c?c.replace(/\r/g,""):null==c?"":c)):void 0}}),m.extend({valHooks:{option:{get:function(a){var b=m.find.attr(a,"value");return null!=b?b:m.trim(m.text(a))}},select:{get:function(a){for(var b,c,d=a.options,e=a.selectedIndex,f="select-one"===a.type||0>e,g=f?null:[],h=f?e+1:d.length,i=0>e?h:f?e:0;h>i;i++)if(c=d[i],!(!c.selected&&i!==e||(k.optDisabled?c.disabled:null!==c.getAttribute("disabled"))||c.parentNode.disabled&&m.nodeName(c.parentNode,"optgroup"))){if(b=m(c).val(),f)return b;g.push(b)}return g},set:function(a,b){for(var c,d,e=a.options,f=m.makeArray(b),g=e.length;g--;)if(d=e[g],m.inArray(m.valHooks.option.get(d),f)>=0)try{d.selected=c=!0}catch(h){d.scrollHeight}else d.selected=!1;return c||(a.selectedIndex=-1),e}}}}),m.each(["radio","checkbox"],function(){m.valHooks[this]={set:function(a,b){return m.isArray(b)?a.checked=m.inArray(m(a).val(),b)>=0:void 0}},k.checkOn||(m.valHooks[this].get=function(a){return null===a.getAttribute("value")?"on":a.value})});var mb,nb,ob=m.expr.attrHandle,pb=/^(?:checked|selected)$/i,qb=k.getSetAttribute,rb=k.input;m.fn.extend({attr:function(a,b){return V(this,m.attr,a,b,arguments.length>1)},removeAttr:function(a){return this.each(function(){m.removeAttr(this,a)})}}),m.extend({attr:function(a,b,c){var d,e,f=a.nodeType;if(a&&3!==f&&8!==f&&2!==f)return typeof a.getAttribute===K?m.prop(a,b,c):(1===f&&m.isXMLDoc(a)||(b=b.toLowerCase(),d=m.attrHooks[b]||(m.expr.match.bool.test(b)?nb:mb)),void 0===c?d&&"get"in d&&null!==(e=d.get(a,b))?e:(e=m.find.attr(a,b),null==e?void 0:e):null!==c?d&&"set"in d&&void 0!==(e=d.set(a,c,b))?e:(a.setAttribute(b,c+""),c):void m.removeAttr(a,b))},removeAttr:function(a,b){var c,d,e=0,f=b&&b.match(E);if(f&&1===a.nodeType)for(;c=f[e++];)d=m.propFix[c]||c,m.expr.match.bool.test(c)?rb&&qb||!pb.test(c)?a[d]=!1:a[m.camelCase("default-"+c)]=a[d]=!1:m.attr(a,c,""),a.removeAttribute(qb?c:d)},attrHooks:{type:{set:function(a,b){if(!k.radioValue&&"radio"===b&&m.nodeName(a,"input")){var c=a.value;return a.setAttribute("type",b),c&&(a.value=c),b}}}}}),nb={set:function(a,b,c){return!1===b?m.removeAttr(a,c):rb&&qb||!pb.test(c)?a.setAttribute(!qb&&m.propFix[c]||c,c):a[m.camelCase("default-"+c)]=a[c]=!0,c}},m.each(m.expr.match.bool.source.match(/\w+/g),function(a,b){var c=ob[b]||m.find.attr;ob[b]=rb&&qb||!pb.test(b)?function(a,b,d){var e,f;return d||(f=ob[b],ob[b]=e,e=null!=c(a,b,d)?b.toLowerCase():null,ob[b]=f),e}:function(a,b,c){return c?void 0:a[m.camelCase("default-"+b)]?b.toLowerCase():null}}),rb&&qb||(m.attrHooks.value={set:function(a,b,c){return m.nodeName(a,"input")?void(a.defaultValue=b):mb&&mb.set(a,b,c)}}),qb||(mb={set:function(a,b,c){var d=a.getAttributeNode(c);return d||a.setAttributeNode(d=a.ownerDocument.createAttribute(c)),d.value=b+="","value"===c||b===a.getAttribute(c)?b:void 0}},ob.id=ob.name=ob.coords=function(a,b,c){var d;return c?void 0:(d=a.getAttributeNode(b))&&""!==d.value?d.value:null},m.valHooks.button={get:function(a,b){var c=a.getAttributeNode(b);return c&&c.specified?c.value:void 0},set:mb.set},m.attrHooks.contenteditable={set:function(a,b,c){mb.set(a,""!==b&&b,c)}},m.each(["width","height"],function(a,b){m.attrHooks[b]={set:function(a,c){return""===c?(a.setAttribute(b,"auto"),c):void 0}}})),k.style||(m.attrHooks.style={get:function(a){return a.style.cssText||void 0},set:function(a,b){return a.style.cssText=b+""}});var sb=/^(?:input|select|textarea|button|object)$/i,tb=/^(?:a|area)$/i;m.fn.extend({prop:function(a,b){return V(this,m.prop,a,b,arguments.length>1)},removeProp:function(a){return a=m.propFix[a]||a,this.each(function(){try{this[a]=void 0,delete this[a]}catch(b){}})}}),m.extend({propFix:{for:"htmlFor",class:"className"},prop:function(a,b,c){var d,e,f,g=a.nodeType;if(a&&3!==g&&8!==g&&2!==g)return f=1!==g||!m.isXMLDoc(a),f&&(b=m.propFix[b]||b,e=m.propHooks[b]),void 0!==c?e&&"set"in e&&void 0!==(d=e.set(a,c,b))?d:a[b]=c:e&&"get"in e&&null!==(d=e.get(a,b))?d:a[b]},propHooks:{tabIndex:{get:function(a){var b=m.find.attr(a,"tabindex");return b?parseInt(b,10):sb.test(a.nodeName)||tb.test(a.nodeName)&&a.href?0:-1}}}}),k.hrefNormalized||m.each(["href","src"],function(a,b){m.propHooks[b]={get:function(a){return a.getAttribute(b,4)}}}),k.optSelected||(m.propHooks.selected={get:function(a){var b=a.parentNode;return b&&(b.selectedIndex,b.parentNode&&b.parentNode.selectedIndex),null}}),m.each(["tabIndex","readOnly","maxLength","cellSpacing","cellPadding","rowSpan","colSpan","useMap","frameBorder","contentEditable"],function(){m.propFix[this.toLowerCase()]=this}),k.enctype||(m.propFix.enctype="encoding");var ub=/[\t\r\n\f]/g;m.fn.extend({addClass:function(a){var b,c,d,e,f,g,h=0,i=this.length,j="string"==typeof a&&a;if(m.isFunction(a))return this.each(function(b){m(this).addClass(a.call(this,b,this.className))});if(j)for(b=(a||"").match(E)||[];i>h;h++)if(c=this[h],d=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(ub," "):" ")){for(f=0;e=b[f++];)d.indexOf(" "+e+" ")<0&&(d+=e+" ");g=m.trim(d),c.className!==g&&(c.className=g)}return this},removeClass:function(a){var b,c,d,e,f,g,h=0,i=this.length,j=0===arguments.length||"string"==typeof a&&a;if(m.isFunction(a))return this.each(function(b){m(this).removeClass(a.call(this,b,this.className))});if(j)for(b=(a||"").match(E)||[];i>h;h++)if(c=this[h],d=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(ub," "):"")){for(f=0;e=b[f++];)for(;d.indexOf(" "+e+" ")>=0;)d=d.replace(" "+e+" "," ");g=a?m.trim(d):"",c.className!==g&&(c.className=g)}return this},toggleClass:function(a,b){var c=typeof a;return"boolean"==typeof b&&"string"===c?b?this.addClass(a):this.removeClass(a):this.each(m.isFunction(a)?function(c){m(this).toggleClass(a.call(this,c,this.className,b),b)}:function(){if("string"===c)for(var b,d=0,e=m(this),f=a.match(E)||[];b=f[d++];)e.hasClass(b)?e.removeClass(b):e.addClass(b);else(c===K||"boolean"===c)&&(this.className&&m._data(this,"__className__",this.className),this.className=this.className||!1===a?"":m._data(this,"__className__")||"")})},hasClass:function(a){for(var b=" "+a+" ",c=0,d=this.length;d>c;c++)if(1===this[c].nodeType&&(" "+this[c].className+" ").replace(ub," ").indexOf(b)>=0)return!0;return!1}}),m.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "),function(a,b){m.fn[b]=function(a,c){return arguments.length>0?this.on(b,null,a,c):this.trigger(b)}}),m.fn.extend({hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)},bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)}});var vb=m.now(),wb=/\?/;m.parseJSON=function(b){if(a.JSON&&a.JSON.parse)return a.JSON.parse(b+"");var c,d=null,e=m.trim(b+"");return e&&!m.trim(e.replace(/(,)|(\[|{)|(}|])|"(?:[^"\\\r\n]|\\["\\\/bfnrt]|\\u[\da-fA-F]{4})*"\s*:?|true|false|null|-?(?!0\d)\d+(?:\.\d+|)(?:[eE][+-]?\d+|)/g,function(a,b,e,f){return c&&b&&(d=0),0===d?a:(c=e||b,d+=!f-!e,"")}))?Function("return "+e)():m.error("Invalid JSON: "+b)},m.parseXML=function(b){var c,d;if(!b||"string"!=typeof b)return null;try{a.DOMParser?(d=new DOMParser,c=d.parseFromString(b,"text/xml")):(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(b))}catch(e){c=void 0}return c&&c.documentElement&&!c.getElementsByTagName("parsererror").length||m.error("Invalid XML: "+b),c};var yb,zb,Bb=/([?&])_=[^&]*/,Cb=/^(.*?):[ \t]*([^\r\n]*)\r?$/gm,Db=/^(?:about|app|app-storage|.+-extension|file|res|widget):$/,Eb=/^(?:GET|HEAD)$/,Gb=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,Hb={},Ib={},Jb="*/".concat("*");try{zb=location.href}catch(Kb){zb=y.createElement("a"),zb.href="",zb=zb.href}yb=Gb.exec(zb.toLowerCase())||[],m.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:zb,type:"GET",isLocal:Db.test(yb[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Jb,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":m.parseJSON,"text xml":m.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(a,b){return b?Nb(Nb(a,m.ajaxSettings),b):Nb(m.ajaxSettings,a)},ajaxPrefilter:Lb(Hb),ajaxTransport:Lb(Ib),ajax:function(a,b){function x(a,b,c,d){var j,r,s,u,w,x=b;2!==t&&(t=2,g&&clearTimeout(g),i=void 0,f=d||"",v.readyState=a>0?4:0,j=a>=200&&300>a||304===a,c&&(u=Ob(k,v,c)),u=Pb(k,u,v,j),j?(k.ifModified&&(w=v.getResponseHeader("Last-Modified"),w&&(m.lastModified[e]=w),(w=v.getResponseHeader("etag"))&&(m.etag[e]=w)),204===a||"HEAD"===k.type?x="nocontent":304===a?x="notmodified":(x=u.state,r=u.data,s=u.error,j=!s)):(s=x,(a||!x)&&(x="error",0>a&&(a=0))),v.status=a,v.statusText=(b||x)+"",j?o.resolveWith(l,[r,x,v]):o.rejectWith(l,[v,x,s]),v.statusCode(q),q=void 0,h&&n.trigger(j?"ajaxSuccess":"ajaxError",[v,k,j?r:s]),p.fireWith(l,[v,x]),h&&(n.trigger("ajaxComplete",[v,k]),--m.active||m.event.trigger("ajaxStop")))}"object"==typeof a&&(b=a,a=void 0),b=b||{};var c,d,e,f,g,h,i,j,k=m.ajaxSetup({},b),l=k.context||k,n=k.context&&(l.nodeType||l.jquery)?m(l):m.event,o=m.Deferred(),p=m.Callbacks("once memory"),q=k.statusCode||{},r={},s={},t=0,u="canceled",v={readyState:0,getResponseHeader:function(a){var b;if(2===t){if(!j)for(j={};b=Cb.exec(f);)j[b[1].toLowerCase()]=b[2];b=j[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===t?f:null},setRequestHeader:function(a,b){var c=a.toLowerCase();return t||(a=s[c]=s[c]||a,r[a]=b),this},overrideMimeType:function(a){return t||(k.mimeType=a),this},statusCode:function(a){var b;if(a)if(2>t)for(b in a)q[b]=[q[b],a[b]];else v.always(a[v.status]);return this},abort:function(a){var b=a||u;return i&&i.abort(b),x(0,b),this}};if(o.promise(v).complete=p.add,v.success=v.done,v.error=v.fail,k.url=((a||k.url||zb)+"").replace(/#.*$/,"").replace(/^\/\//,yb[1]+"//"),k.type=b.method||b.type||k.method||k.type,k.dataTypes=m.trim(k.dataType||"*").toLowerCase().match(E)||[""],null==k.crossDomain&&(c=Gb.exec(k.url.toLowerCase()),k.crossDomain=!(!c||c[1]===yb[1]&&c[2]===yb[2]&&(c[3]||("http:"===c[1]?"80":"443"))===(yb[3]||("http:"===yb[1]?"80":"443")))),k.data&&k.processData&&"string"!=typeof k.data&&(k.data=m.param(k.data,k.traditional)),Mb(Hb,k,b,v),2===t)return v;h=m.event&&k.global,h&&0==m.active++&&m.event.trigger("ajaxStart"),k.type=k.type.toUpperCase(),k.hasContent=!Eb.test(k.type),e=k.url,k.hasContent||(k.data&&(e=k.url+=(wb.test(e)?"&":"?")+k.data,delete k.data),!1===k.cache&&(k.url=Bb.test(e)?e.replace(Bb,"$1_="+vb++):e+(wb.test(e)?"&":"?")+"_="+vb++)),k.ifModified&&(m.lastModified[e]&&v.setRequestHeader("If-Modified-Since",m.lastModified[e]),m.etag[e]&&v.setRequestHeader("If-None-Match",m.etag[e])),(k.data&&k.hasContent&&!1!==k.contentType||b.contentType)&&v.setRequestHeader("Content-Type",k.contentType),v.setRequestHeader("Accept",k.dataTypes[0]&&k.accepts[k.dataTypes[0]]?k.accepts[k.dataTypes[0]]+("*"!==k.dataTypes[0]?", "+Jb+"; q=0.01":""):k.accepts["*"]);for(d in k.headers)v.setRequestHeader(d,k.headers[d]);if(k.beforeSend&&(!1===k.beforeSend.call(l,v,k)||2===t))return v.abort();u="abort";for(d in{success:1,error:1,complete:1})v[d](k[d]);if(i=Mb(Ib,k,b,v)){v.readyState=1,h&&n.trigger("ajaxSend",[v,k]),k.async&&k.timeout>0&&(g=setTimeout(function(){v.abort("timeout")},k.timeout));try{t=1,i.send(r,x)}catch(w){if(!(2>t))throw w;x(-1,w)}}else x(-1,"No Transport");return v},getJSON:function(a,b,c){return m.get(a,b,c,"json")},getScript:function(a,b){return m.get(a,void 0,b,"script")}}),m.each(["get","post"],function(a,b){m[b]=function(a,c,d,e){return m.isFunction(c)&&(e=e||d,d=c,c=void 0),m.ajax({url:a,type:b,dataType:e,data:c,success:d})}}),m._evalUrl=function(a){return m.ajax({url:a,type:"GET",dataType:"script",async:!1,global:!1,throws:!0})},m.fn.extend({wrapAll:function(a){if(m.isFunction(a))return this.each(function(b){m(this).wrapAll(a.call(this,b))});if(this[0]){var b=m(a,this[0].ownerDocument).eq(0).clone(!0);this[0].parentNode&&b.insertBefore(this[0]),b.map(function(){for(var a=this;a.firstChild&&1===a.firstChild.nodeType;)a=a.firstChild;return a}).append(this)}return this},wrapInner:function(a){return this.each(m.isFunction(a)?function(b){m(this).wrapInner(a.call(this,b))}:function(){var b=m(this),c=b.contents();c.length?c.wrapAll(a):b.append(a)})},wrap:function(a){var b=m.isFunction(a);return this.each(function(c){m(this).wrapAll(b?a.call(this,c):a)})},unwrap:function(){return this.parent().each(function(){m.nodeName(this,"body")||m(this).replaceWith(this.childNodes)}).end()}}),m.expr.filters.hidden=function(a){return a.offsetWidth<=0&&a.offsetHeight<=0||!k.reliableHiddenOffsets()&&"none"===(a.style&&a.style.display||m.css(a,"display"))},m.expr.filters.visible=function(a){return!m.expr.filters.hidden(a)};var Rb=/\[\]$/,Tb=/^(?:submit|button|image|reset|file)$/i,Ub=/^(?:input|select|textarea|keygen)/i;m.param=function(a,b){var c,d=[],e=function(a,b){b=m.isFunction(b)?b():null==b?"":b,d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};if(void 0===b&&(b=m.ajaxSettings&&m.ajaxSettings.traditional),m.isArray(a)||a.jquery&&!m.isPlainObject(a))m.each(a,function(){e(this.name,this.value)});else for(c in a)Vb(c,a[c],b,e);return d.join("&").replace(/%20/g,"+")},m.fn.extend({serialize:function(){return m.param(this.serializeArray())},serializeArray:function(){return this.map(function(){var a=m.prop(this,"elements");return a?m.makeArray(a):this}).filter(function(){var a=this.type;return this.name&&!m(this).is(":disabled")&&Ub.test(this.nodeName)&&!Tb.test(a)&&(this.checked||!W.test(a))}).map(function(a,b){var c=m(this).val();return null==c?null:m.isArray(c)?m.map(c,function(a){return{name:b.name,value:a.replace(/\r?\n/g,"\r\n")}}):{name:b.name,value:c.replace(/\r?\n/g,"\r\n")}}).get()}}),m.ajaxSettings.xhr=void 0!==a.ActiveXObject?function(){return!this.isLocal&&/^(get|post|head|put|delete|options)$/i.test(this.type)&&Zb()||$b()}:Zb;var Wb=0,Xb={},Yb=m.ajaxSettings.xhr();a.attachEvent&&a.attachEvent("onunload",function(){for(var a in Xb)Xb[a](void 0,!0)}),k.cors=!!Yb&&"withCredentials"in Yb,(Yb=k.ajax=!!Yb)&&m.ajaxTransport(function(a){if(!a.crossDomain||k.cors){var b;return{send:function(c,d){var e,f=a.xhr(),g=++Wb;if(f.open(a.type,a.url,a.async,a.username,a.password),a.xhrFields)for(e in a.xhrFields)f[e]=a.xhrFields[e];a.mimeType&&f.overrideMimeType&&f.overrideMimeType(a.mimeType),a.crossDomain||c["X-Requested-With"]||(c["X-Requested-With"]="XMLHttpRequest");for(e in c)void 0!==c[e]&&f.setRequestHeader(e,c[e]+"");f.send(a.hasContent&&a.data||null),b=function(c,e){var h,i,j;if(b&&(e||4===f.readyState))if(delete Xb[g],b=void 0,f.onreadystatechange=m.noop,e)4!==f.readyState&&f.abort();else{j={},h=f.status,"string"==typeof f.responseText&&(j.text=f.responseText);try{i=f.statusText}catch(k){i=""}h||!a.isLocal||a.crossDomain?1223===h&&(h=204):h=j.text?200:404}j&&d(h,i,j,f.getAllResponseHeaders())},a.async?4===f.readyState?setTimeout(b):f.onreadystatechange=Xb[g]=b:b()},abort:function(){b&&b(void 0,!0)}}}}),m.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/(?:java|ecma)script/},converters:{"text script":function(a){return m.globalEval(a),a}}}),m.ajaxPrefilter("script",function(a){void 0===a.cache&&(a.cache=!1),a.crossDomain&&(a.type="GET",a.global=!1)}),m.ajaxTransport("script",function(a){if(a.crossDomain){var b,c=y.head||m("head")[0]||y.documentElement;return{send:function(d,e){b=y.createElement("script"),b.async=!0,a.scriptCharset&&(b.charset=a.scriptCharset),b.src=a.url,b.onload=b.onreadystatechange=function(a,c){(c||!b.readyState||/loaded|complete/.test(b.readyState))&&(b.onload=b.onreadystatechange=null,b.parentNode&&b.parentNode.removeChild(b),b=null,c||e(200,"success"))},c.insertBefore(b,c.firstChild)},abort:function(){b&&b.onload(void 0,!0)}}}});var _b=[],ac=/(=)\?(?=&|$)|\?\?/;m.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=_b.pop()||m.expando+"_"+vb++;return this[a]=!0,a}}),m.ajaxPrefilter("json jsonp",function(b,c,d){var e,f,g,h=!1!==b.jsonp&&(ac.test(b.url)?"url":"string"==typeof b.data&&!(b.contentType||"").indexOf("application/x-www-form-urlencoded")&&ac.test(b.data)&&"data");return h||"jsonp"===b.dataTypes[0]?(e=b.jsonpCallback=m.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,h?b[h]=b[h].replace(ac,"$1"+e):!1!==b.jsonp&&(b.url+=(wb.test(b.url)?"&":"?")+b.jsonp+"="+e),b.converters["script json"]=function(){return g||m.error(e+" was not called"),g[0]},b.dataTypes[0]="json",f=a[e],a[e]=function(){g=arguments},d.always(function(){a[e]=f,b[e]&&(b.jsonpCallback=c.jsonpCallback,_b.push(e)),g&&m.isFunction(f)&&f(g[0]),g=f=void 0}),"script"):void 0}),m.parseHTML=function(a,b,c){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(c=b,b=!1),b=b||y;var d=u.exec(a),e=!c&&[];return d?[b.createElement(d[1])]:(d=m.buildFragment([a],b,e),e&&e.length&&m(e).remove(),m.merge([],d.childNodes))};var bc=m.fn.load;m.fn.load=function(a,b,c){if("string"!=typeof a&&bc)return bc.apply(this,arguments);var d,e,f,g=this,h=a.indexOf(" ");return h>=0&&(d=m.trim(a.slice(h,a.length)),a=a.slice(0,h)),m.isFunction(b)?(c=b,b=void 0):b&&"object"==typeof b&&(f="POST"),g.length>0&&m.ajax({url:a,type:f,dataType:"html",data:b}).done(function(a){e=arguments,g.html(d?m("<div>").append(m.parseHTML(a)).find(d):a)}).complete(c&&function(a,b){g.each(c,e||[a.responseText,b,a])}),this},m.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(a,b){m.fn[b]=function(a){return this.on(b,a)}}),m.expr.filters.animated=function(a){return m.grep(m.timers,function(b){return a===b.elem}).length};var cc=a.document.documentElement;m.offset={setOffset:function(a,b,c){var d,e,f,g,h,i,j,k=m.css(a,"position"),l=m(a),n={};"static"===k&&(a.style.position="relative"),h=l.offset(),f=m.css(a,"top"),i=m.css(a,"left"),j=("absolute"===k||"fixed"===k)&&m.inArray("auto",[f,i])>-1,j?(d=l.position(),g=d.top,e=d.left):(g=parseFloat(f)||0,e=parseFloat(i)||0),m.isFunction(b)&&(b=b.call(a,c,h)),null!=b.top&&(n.top=b.top-h.top+g),null!=b.left&&(n.left=b.left-h.left+e),"using"in b?b.using.call(a,n):l.css(n)}},m.fn.extend({offset:function(a){if(arguments.length)return void 0===a?this:this.each(function(b){m.offset.setOffset(this,a,b)});var b,c,d={top:0,left:0},e=this[0],f=e&&e.ownerDocument;return f?(b=f.documentElement,m.contains(b,e)?(typeof e.getBoundingClientRect!==K&&(d=e.getBoundingClientRect()),c=dc(f),{top:d.top+(c.pageYOffset||b.scrollTop)-(b.clientTop||0),left:d.left+(c.pageXOffset||b.scrollLeft)-(b.clientLeft||0)}):d):void 0},position:function(){if(this[0]){var a,b,c={top:0,left:0},d=this[0];return"fixed"===m.css(d,"position")?b=d.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),m.nodeName(a[0],"html")||(c=a.offset()),c.top+=m.css(a[0],"borderTopWidth",!0),c.left+=m.css(a[0],"borderLeftWidth",!0)),{top:b.top-c.top-m.css(d,"marginTop",!0),left:b.left-c.left-m.css(d,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||cc;a&&!m.nodeName(a,"html")&&"static"===m.css(a,"position");)a=a.offsetParent;return a||cc})}}),m.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var c=/Y/.test(b);m.fn[a]=function(d){return V(this,function(a,d,e){var f=dc(a);return void 0===e?f?b in f?f[b]:f.document.documentElement[d]:a[d]:void(f?f.scrollTo(c?m(f).scrollLeft():e,c?e:m(f).scrollTop()):a[d]=e)},a,d,arguments.length,null)}}),m.each(["top","left"],function(a,b){m.cssHooks[b]=La(k.pixelPosition,function(a,c){return c?(c=Ja(a,b),Ha.test(c)?m(a).position()[b]+"px":c):void 0})}),m.each({Height:"height",Width:"width"},function(a,b){m.each({padding:"inner"+a,content:b,"":"outer"+a},function(c,d){m.fn[d]=function(d,e){var f=arguments.length&&(c||"boolean"!=typeof d),g=c||(!0===d||!0===e?"margin":"border");return V(this,function(b,c,d){var e;return m.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(e=b.documentElement,Math.max(b.body["scroll"+a],e["scroll"+a],b.body["offset"+a],e["offset"+a],e["client"+a])):void 0===d?m.css(b,c,g):m.style(b,c,d,g)},b,f?d:void 0,f,null)}})}),m.fn.size=function(){return this.length},m.fn.andSelf=m.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return m});var ec=a.jQuery,fc=a.$;return m.noConflict=function(b){return a.$===m&&(a.$=fc),b&&a.jQuery===m&&(a.jQuery=ec),m},typeof b===K&&(a.jQuery=a.$=m),m}),function(e){"function"==typeof define&&define.amd?define(["jquery"],e):e(jQuery)}(function(e){function t(t,s){var n,a,o,r=t.nodeName.toLowerCase();return"area"===r?(n=t.parentNode,a=n.name,!(!t.href||!a||"map"!==n.nodeName.toLowerCase())&&(!!(o=e("img[usemap='#"+a+"']")[0])&&i(o))):(/^(input|select|textarea|button|object)$/.test(r)?!t.disabled:"a"===r?t.href||s:s)&&i(t)}function i(t){return e.expr.filters.visible(t)&&!e(t).parents().addBack().filter(function(){return"hidden"===e.css(this,"visibility")}).length}e.ui=e.ui||{},e.extend(e.ui,{version:"1.11.4",keyCode:{BACKSPACE:8,COMMA:188,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,LEFT:37,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SPACE:32,TAB:9,UP:38}}),e.fn.extend({scrollParent:function(t){var i=this.css("position"),s="absolute"===i,n=t?/(auto|scroll|hidden)/:/(auto|scroll)/,a=this.parents().filter(function(){var t=e(this);return(!s||"static"!==t.css("position"))&&n.test(t.css("overflow")+t.css("overflow-y")+t.css("overflow-x"))}).eq(0);return"fixed"!==i&&a.length?a:e(this[0].ownerDocument||document)},uniqueId:function(){var e=0;return function(){return this.each(function(){this.id||(this.id="ui-id-"+ ++e)})}}(),removeUniqueId:function(){return this.each(function(){/^ui-id-\d+$/.test(this.id)&&e(this).removeAttr("id")})}}),e.extend(e.expr[":"],{data:e.expr.createPseudo?e.expr.createPseudo(function(t){return function(i){return!!e.data(i,t)}}):function(t,i,s){return!!e.data(t,s[3])},focusable:function(i){return t(i,!isNaN(e.attr(i,"tabindex")))},tabbable:function(i){var s=e.attr(i,"tabindex"),n=isNaN(s);return(n||s>=0)&&t(i,!n)}}),e("<a>").outerWidth(1).jquery||e.each(["Width","Height"],function(t,i){function s(t,i,s,a){return e.each(n,function(){i-=parseFloat(e.css(t,"padding"+this))||0,s&&(i-=parseFloat(e.css(t,"border"+this+"Width"))||0),a&&(i-=parseFloat(e.css(t,"margin"+this))||0)}),i}var n="Width"===i?["Left","Right"]:["Top","Bottom"],a=i.toLowerCase(),o={innerWidth:e.fn.innerWidth,innerHeight:e.fn.innerHeight,outerWidth:e.fn.outerWidth,outerHeight:e.fn.outerHeight};e.fn["inner"+i]=function(t){return void 0===t?o["inner"+i].call(this):this.each(function(){e(this).css(a,s(this,t)+"px")})},e.fn["outer"+i]=function(t,n){return"number"!=typeof t?o["outer"+i].call(this,t):this.each(function(){e(this).css(a,s(this,t,!0,n)+"px")})}}),e.fn.addBack||(e.fn.addBack=function(e){return this.add(null==e?this.prevObject:this.prevObject.filter(e))}),e("<a>").data("a-b","a").removeData("a-b").data("a-b")&&(e.fn.removeData=function(t){return function(i){return arguments.length?t.call(this,e.camelCase(i)):t.call(this)}}(e.fn.removeData)),e.ui.ie=!!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase()),e.fn.extend({focus:function(t){return function(i,s){return"number"==typeof i?this.each(function(){var t=this;setTimeout(function(){e(t).focus(),s&&s.call(t)},i)}):t.apply(this,arguments)}}(e.fn.focus),disableSelection:function(){var e="onselectstart"in document.createElement("div")?"selectstart":"mousedown";return function(){return this.bind(e+".ui-disableSelection",function(e){e.preventDefault()})}}(),enableSelection:function(){return this.unbind(".ui-disableSelection")},zIndex:function(t){if(void 0!==t)return this.css("zIndex",t);if(this.length)for(var i,s,n=e(this[0]);n.length&&n[0]!==document;){if(("absolute"===(i=n.css("position"))||"relative"===i||"fixed"===i)&&(s=parseInt(n.css("zIndex"),10),!isNaN(s)&&0!==s))return s;n=n.parent()}return 0}}),e.ui.plugin={add:function(t,i,s){var n,a=e.ui[t].prototype;for(n in s)a.plugins[n]=a.plugins[n]||[],a.plugins[n].push([i,s[n]])},call:function(e,t,i,s){var n,a=e.plugins[t];if(a&&(s||e.element[0].parentNode&&11!==e.element[0].parentNode.nodeType))for(n=0;a.length>n;n++)e.options[a[n][0]]&&a[n][1].apply(e.element,i)}};var s=0,n=Array.prototype.slice;e.cleanData=function(t){return function(i){var s,n,a;for(a=0;null!=(n=i[a]);a++)try{(s=e._data(n,"events"))&&s.remove&&e(n).triggerHandler("remove")}catch(o){}t(i)}}(e.cleanData),e.widget=function(t,i,s){var n,a,o,r,h={},l=t.split(".")[0];return t=t.split(".")[1],n=l+"-"+t,s||(s=i,i=e.Widget),e.expr[":"][n.toLowerCase()]=function(t){return!!e.data(t,n)},e[l]=e[l]||{},a=e[l][t],o=e[l][t]=function(e,t){return this._createWidget?void(arguments.length&&this._createWidget(e,t)):new o(e,t)},e.extend(o,a,{version:s.version,_proto:e.extend({},s),_childConstructors:[]}),r=new i,r.options=e.widget.extend({},r.options),e.each(s,function(t,s){return e.isFunction(s)?void(h[t]=function(){var e=function(){return i.prototype[t].apply(this,arguments)},n=function(e){return i.prototype[t].apply(this,e)};return function(){var t,i=this._super,a=this._superApply;return this._super=e,this._superApply=n,t=s.apply(this,arguments),this._super=i,this._superApply=a,t}}()):void(h[t]=s)}),o.prototype=e.widget.extend(r,{widgetEventPrefix:a?r.widgetEventPrefix||t:t},h,{constructor:o,namespace:l,widgetName:t,widgetFullName:n}),a?(e.each(a._childConstructors,function(t,i){var s=i.prototype;e.widget(s.namespace+"."+s.widgetName,o,i._proto)}),delete a._childConstructors):i._childConstructors.push(o),e.widget.bridge(t,o),o},e.widget.extend=function(t){for(var i,s,a=n.call(arguments,1),o=0,r=a.length;r>o;o++)for(i in a[o])s=a[o][i],a[o].hasOwnProperty(i)&&void 0!==s&&(t[i]=e.isPlainObject(s)?e.isPlainObject(t[i])?e.widget.extend({},t[i],s):e.widget.extend({},s):s);return t},e.widget.bridge=function(t,i){var s=i.prototype.widgetFullName||t;e.fn[t]=function(a){var o="string"==typeof a,r=n.call(arguments,1),h=this;return o?this.each(function(){var i,n=e.data(this,s);return"instance"===a?(h=n,!1):n?e.isFunction(n[a])&&"_"!==a.charAt(0)?(i=n[a].apply(n,r),i!==n&&void 0!==i?(h=i&&i.jquery?h.pushStack(i.get()):i,!1):void 0):e.error("no such method '"+a+"' for "+t+" widget instance"):e.error("cannot call methods on "+t+" prior to initialization; attempted to call method '"+a+"'")}):(r.length&&(a=e.widget.extend.apply(null,[a].concat(r))),this.each(function(){var t=e.data(this,s)

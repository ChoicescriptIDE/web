function initWindowState() {
    ("function" == typeof win.isDevToolsOpen && !win.isDevToolsOpen() || void 0 === win.isDevToolsOpen) && (winState = JSON.parse(localStorage.windowState || "null"), 
    winState ? (currWinMode = winState.mode, restoreWindowState(), "maximized" === currWinMode && ("darwin" === process.platform ? win.enterFullscreen() : win.maximize())) : (currWinMode = "normal", 
    win.setPosition("center")));
}

function dumpWindowState() {
    winState || (winState = {}), winState.mode = "maximized" === currWinMode ? "maximized" : "normal", 

function getDropboxScope() {
    return (window.opener ? window.opener.parent : parent).window.cside;
}

window.alreadyLoaded = !0, nav = new SceneNavigator([ "startup" ]), stats = {}, 
isHeadless = !0;

var scope = getDropboxScope(), cside = scope || {
    project: {},
    getPlatform: () => {},
    popout: {
        is: window.opener,

...
var moduleExports=(()=>{var ia=Object.create;var pt=Object.defineProperty;var aa=Object.getOwnPropertyDescriptor;var oa=Object.getOwnPropertyNames;var sa=Object.getPrototypeOf,la=Object.prototype.hasOwnProperty;var ca=(t=>typeof require!="undefined"?require:typeof Proxy!="undefined"?new Proxy(t,{get:(e,n)=>(typeof require!="undefined"?require:e)[n]}):t)(function(t){if(typeof require!="undefined")return require.apply(this,arguments);throw new Error('Dynamic require of "'+t+'" is not supported')});var U=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),da=(t,e)=>{for(var n in e)pt(t,n,{get:e[n],enumerable:!0})},On=(t,e,n,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of oa(e))!la.call(t,i)&&i!==n&&pt(t,i,{get:()=>e[i],enumerable:!(r=aa(e,i))||r.enumerable});return t};var pa=(t,e,n)=>(n=t!=null?ia(sa(t)):{},On(e||!t||!t.__esModule?pt(n,"default",{value:t,enumerable:!0}):n,t)),ha=t=>On(pt({},"__esModule",{value:!0}),t);var oi=U((bl,ai)=>{ai.exports=function(e){return e!=null&&e.constructor!=null&&typeof e.constructor.isBuffer=="function"&&e.constructor.isBuffer(e)}});var En=U((vl,si)=>{"use strict";si.exports=qa;var Va=[];function qa(t,e){var n=0,r;if(!e)return Va;if(t.FLAG==="long"){for(r=new Array(Math.ceil(e.length/2));n<e.length;)r[n/2]=e.slice(n,n+2),n+=2;return r}return e.split(t.FLAG==="num"?",":"")}});var di=U((yl,ci)=>{"use strict";var Ga=En();ci.exports=Ha;var Ja=[].push,Nt="etaoinshrdlcumwfgypbvkjxqz".split(""),lt=/\s+/,Ya=["qwertzuop","yxcvbnm","qaw","say","wse","dsx","sy","edr","fdc","dx","rft","gfv","fc","tgz","hgb","gv","zhu","jhn","hb","uji","kjm","jn","iko","lkm"];function Ha(t){var e=Object.create(null),n=Object.create(null),r=Object.create(null),i=[],a={in:[],out:[]},o=[],s=t.toString("utf8"),l=[],p=0,d=s.indexOf(`
`),f,b,u,y,k,E,z,D,M,R,P,I,_;for(r.KEY=[];d>-1;)T(s.slice(p,d)),p=d+1,d=s.indexOf(`
`,p);for(T(s.slice(p)),d=-1;++d<l.length;)if(b=l[d],f=b.split(lt),u=f[0],u==="REP"){for(y=d+parseInt(f[1],10);++d<=y;)f=l[d].split(lt),i.push([f[1],f[2]]);d--}else if(u==="ICONV"||u==="OCONV"){for(y=d+parseInt(f[1],10),D=a[u==="ICONV"?"in":"out"];++d<=y;)f=l[d].split(lt),D.push([new RegExp(f[1],"g"),f[2]]);d--}else if(u==="COMPOUNDRULE"){for(y=d+parseInt(f[1],10);++d<=y;)for(R=l[d].split(lt)[1],M=-1,o.push(R);++M<R.length;)n[R.charAt(M)]=[];d--}else if(u==="PFX"||u==="SFX"){for(y=d+parseInt(f[3],10),R={type:u,combineable:f[2]==="Y",entries:[]},e[f[1]]=R;++d<=y;){f=l[d].split(lt),k=f[2],E=f[3].split("/"),z=f[4],D={add:"",remove:"",match:"",continuation:Ga(r,E[1])},E&&E[0]!=="0"&&(D.add=E[0]);try{k!=="0"&&(D.remove=u==="SFX"?li(k):k),z&&z!=="."&&(D.match=u==="SFX"?li(z):Ka(z))}catch{D=null}D&&R.entries.push(D)}d--}else if(u==="TRY"){for(z=f[1],I=-1,P=[];++I<z.length;)_=z.charAt(I),_.toLowerCase()===_&&P.push(_);for(I=-1;++I<Nt.length;)z.indexOf(Nt[I])<0&&P.push(Nt[I]);r[u]=P}else u==="KEY"?Ja.apply(r[u],f[1].split("|")):u==="COMPOUNDMIN"?r[u]=Number(f[1]):u==="ONLYINCOMPOUND"?(r[u]=f[1],n[f[1]]=[]):r[u]=f[1];return isNaN(r.COMPOUNDMIN)&&(r.COMPOUNDMIN=3),r.KEY.length||(r.KEY=Ya),r.TRY||(r.TRY=Nt.concat()),r.KEEPCASE||(r.KEEPCASE=!1),{compoundRuleCodes:n,replacementTable:i,conversion:a,compoundRules:o,rules:e,flags:r};function T(W){W=W.trim(),W&&W.charCodeAt(0)!==35&&l.push(W)}}function li(t){return new RegExp(t+"$")}function Ka(t){return new RegExp("^"+t)}});var Dn=U((wl,pi)=>{"use strict";pi.exports=Xa;function Xa(t,e){for(var n=-1;++n<e.length;)t=t.replace(e[n][0],e[n][1]);return t}});var ct=U((xl,hi)=>{"use strict";hi.exports=Za;function Za(t,e,n){return n&&e in t&&n.indexOf(t[e])>-1}});var ui=U((Sl,mi)=>{"use strict";var $a=ct();mi.exports=Qa;function Qa(t,e){var n=-1;if(t.data[e])return!$a(t.flags,"ONLYINCOMPOUND",t.data[e]);if(e.length>=t.flags.COMPOUNDMIN){for(;++n<t.compoundRules.length;)if(t.compoundRules[n].test(e))return!0}return!1}});var Mt=U((Cl,gi)=>{"use strict";var eo=Dn(),Rn=ui(),In=ct();gi.exports=to;function to(t,e,n){var r=e.trim(),i;if(!r)return null;if(r=eo(r,t.conversion.in),Rn(t,r))return!n&&In(t.flags,"FORBIDDENWORD",t.data[r])?null:r;if(r.toUpperCase()===r){if(i=r.charAt(0)+r.slice(1).toLowerCase(),fi(t.flags,t.data[i],n))return null;if(Rn(t,i))return i}if(i=r.toLowerCase(),i!==r){if(fi(t.flags,t.data[i],n))return null;if(Rn(t,i))return i}return null}function fi(t,e,n){return In(t,"KEEPCASE",e)||n||In(t,"FORBIDDENWORD",e)}});var vi=U((kl,bi)=>{"use strict";var no=Mt();bi.exports=ro;function ro(t){return Boolean(no(this,t))}});var xi=U((zl,wi)=>{"use strict";wi.exports=io;function io(t){var e=yi(t.charAt(0)),n=t.slice(1);return!n||(n=yi(n),e===n)?e:e==="u"&&n==="l"?"s":null}function yi(t){return t===t.toLowerCase()?"l":t===t.toUpperCase()?"u":null}});var zi=U((Fl,ki)=>{"use strict";var Ot=xi(),Si=Dn(),ao=ct(),oo=Mt();ki.exports=lo;var so=[].push;function lo(t){var e=this,n={},r=[],i={},a,o,s=[],l,p,d,f,b,u,y,k,E,z,D,M,R,P,I,_,T,W,q,Z,Lt,Pt,dt;if(t=Si(t.trim(),e.conversion.in),!t||e.correct(t))return[];for(dt=Ot(t),p=-1;++p<e.replacementTable.length;)for(o=e.replacementTable[p],d=t.indexOf(o[0]);d>-1;)s.push(t.replace(o[0],o[1])),d=t.indexOf(o[0],d+1);for(p=-1;++p<t.length;)for(k=t.charAt(p),z=t.slice(0,p),D=t.slice(p+1),R=k.toLowerCase(),M=R!==k,n={},d=-1;++d<e.flags.KEY.length;)if(E=e.flags.KEY[d],f=E.indexOf(R),!(f<0)){for(u=-1;++u<E.length;)if(u!==f){if(y=E.charAt(u),n[y])continue;n[y]=!0,M&&(y=y.toUpperCase()),s.push(z+y+D)}}for(p=-1,T=t.charAt(0),l=[""],W=1,q=0;++p<t.length;){for(k=T,T=t.charAt(p+1),z=t.slice(0,p),o=k===T?"":k+k,d=-1,b=l.length;++d<b;)d<=W&&l.push(l[d]+o),l[d]+=k;++q<3&&(W=l.length)}for(so.apply(s,l),l=[t],o=t.toLowerCase(),(t===o||dt===null)&&l.push(t.charAt(0).toUpperCase()+o.slice(1)),o=t.toUpperCase(),t!==o&&l.push(o),a={state:{},weighted:i,suggestions:r},P=Ci(e,a,l,s),I=0,W=Math.min(P.length,Math.pow(Math.max(15-t.length,3),3)),Z=Math.max(Math.pow(10-t.length,3),1);!r.length&&I<W;)_=I+Z,Ci(e,a,P.slice(I,_)),I=_;for(r.sort(ea),l=[],Lt=[],p=-1;++p<r.length;)Pt=Si(r[p],e.conversion.out),o=Pt.toLowerCase(),Lt.indexOf(o)<0&&(l.push(Pt),Lt.push(o));return l;function ea(ie,ae){return ta(ie,ae)||na(ie,ae)||ra(ie,ae)}function ta(ie,ae){return i[ie]===i[ae]?0:i[ie]>i[ae]?-1:1}function na(ie,ae){var Nn=Ot(ie),Mn=Ot(ae);return Nn===Mn?0:Nn===dt?-1:Mn===dt?1:void 0}function ra(ie,ae){return ie.localeCompare(ae)}}function Ci(t,e,n,r){var i=t.flags.TRY,a=t.data,o=t.flags,s=[],l=-1,p,d,f,b,u,y,k,E,z,D,M,R,P;if(r)for(;++l<r.length;)I(r[l],!0);for(l=-1;++l<n.length;)for(p=n[l],d="",f="",b=p.charAt(0),u=p,y=p.slice(1),k=b.toLowerCase()!==b,E=Ot(p),z=-1;++z<=p.length;)for(d+=f,D=u,u=y,y=u.slice(1),f=b,b=p.charAt(z+1),M=k,b&&(k=b.toLowerCase()!==b),u&&M!==k&&(I(d+_(u)),I(d+_(b)+_(f)+y)),I(d+u),u&&I(d+b+f+y),P=-1;++P<i.length;)R=i[P],M&&R!==R.toUpperCase()?(E!=="s"&&(I(d+R+D),I(d+R+u)),R=R.toUpperCase(),I(d+R+D),I(d+R+u)):(I(d+R+D),I(d+R+u));return s;function I(T,W){var q=e.state[T],Z;q!==Boolean(q)&&(s.push(T),Z=oo(t,T),q=Z&&!ao(o,"NOSUGGEST",a[Z]),e.state[T]=q,q&&(e.weighted[T]=W?10:0,e.suggestions.push(T))),q&&e.weighted[T]++}function _(T){var W=T.charAt(0);return(W.toLowerCase()===W?W.toUpperCase():W.toLowerCase())+T.slice(1)}}});var Di=U((El,Ei)=>{"use strict";var co=Mt(),Fi=ct();Ei.exports=po;function po(t){var e=this,n=co(e,t,!0);return{correct:e.correct(t),forbidden:Boolean(n&&Fi(e.flags,"FORBIDDENWORD",e.data[n])),warn:Boolean(n&&Fi(e.flags,"WARN",e.data[n]))}}});var _i=U((Dl,Ii)=>{"use strict";Ii.exports=Ri;function Ri(t,e,n,r){for(var i=-1,a,o,s,l,p;++i<e.entries.length;)if(a=e.entries[i],l=a.continuation,p=-1,(!a.match||a.match.test(t))&&(o=a.remove?t.replace(a.remove,""):t,o=e.type==="SFX"?o+a.add:a.add+o,r.push(o),l&&l.length))for(;++p<l.length;)s=n[l[p]],s&&Ri(o,s,n,r);return r}});var Tn=U((Rl,Ni)=>{"use strict";var Ti=_i();Ni.exports=uo;var ho=[].push,_n=[];function mo(t,e,n){var r=t[e];e in t?r===_n?t[e]=n.concat():ho.apply(r,n):t[e]=n.concat()}function uo(t,e,n,r){var i=-1,a,o,s,l,p,d,f;for((!("NEEDAFFIX"in r.flags)||n.indexOf(r.flags.NEEDAFFIX)<0)&&mo(t,e,n);++i<n.length;)if(a=r.rules[n[i]],n[i]in r.compoundRuleCodes&&r.compoundRuleCodes[n[i]].push(e),a){for(d=Ti(e,a,r.rules,[]),o=-1;++o<d.length;)if(d[o]in t||(t[d[o]]=_n),a.combineable){for(s=i;++s<n.length;)if(p=r.rules[n[s]],p&&p.combineable&&a.type!==p.type)for(f=Ti(d[o],p,r.rules,[]),l=-1;++l<f.length;)f[l]in t||(t[f[l]]=_n)}}}});var Oi=U((Il,Mi)=>{"use strict";var fo=Tn();Mi.exports=bo;var go=[];function bo(t,e){var n=this;return fo(n.data,t,n.data[e]||go,n),n}});var Wi=U((_l,Ai)=>{"use strict";Ai.exports=vo;function vo(t){var e=this;return delete e.data[t],e}});var Pi=U((Tl,Li)=>{"use strict";Li.exports=yo;function yo(){return this.flags.WORDCHARS||null}});var Vi=U((Nl,Bi)=>{"use strict";var wo=En(),xo=Tn();Bi.exports=So;var ji=/\s/g;function So(t,e,n){for(var r=t.toString("utf8"),i=r.indexOf(`
`)+1,a=r.indexOf(`
`,i);a>-1;)r.charCodeAt(i)!==9&&Ui(r.slice(i,a),e,n),i=a+1,a=r.indexOf(`
`,i);Ui(r.slice(i),e,n)}function Ui(t,e,n){for(var r=t.indexOf("/"),i=t.indexOf("#"),a="",o,s;r>-1&&t.charCodeAt(r-1)===92;)t=t.slice(0,r-1)+t.slice(r),r=t.indexOf("/",r);i>-1?r>-1&&r<i?(o=t.slice(0,r),ji.lastIndex=r+1,s=ji.exec(t),a=t.slice(r+1,s?s.index:void 0)):o=t.slice(0,i):r>-1?(o=t.slice(0,r),a=t.slice(r+1)):o=t,o=o.trim(),o&&xo(n,o,wo(e.flags,a.trim()),e)}});var Gi=U((Ml,qi)=>{"use strict";var Co=Vi();qi.exports=ko;function ko(t){var e=this,n=-1,r,i,a,o;for(Co(t,e,e.data);++n<e.compoundRules.length;){for(r=e.compoundRules[n],i="",o=-1;++o<r.length;)a=r.charAt(o),i+=e.compoundRuleCodes[a].length?"(?:"+e.compoundRuleCodes[a].join("|")+")":a;e.compoundRules[n]=new RegExp(i,"i")}return e}});var Yi=U((Ol,Ji)=>{"use strict";Ji.exports=zo;function zo(t){var e=this,n=t.toString("utf8").split(`
`),r=-1,i,a,o,s;for(e.flags.FORBIDDENWORD===void 0&&(e.flags.FORBIDDENWORD=!1),s=e.flags.FORBIDDENWORD;++r<n.length;)i=n[r].trim(),i&&(i=i.split("/"),o=i[0],a=o.charAt(0)==="*",a&&(o=o.slice(1)),e.add(o,i[1]),a&&e.data[o].push(s));return e}});var Xi=U((Al,Ki)=>{"use strict";var Hi=oi(),Fo=di();Ki.exports=At;var we=At.prototype;we.correct=vi();we.suggest=zi();we.spell=Di();we.add=Oi();we.remove=Wi();we.wordCharacters=Pi();we.dictionary=Gi();we.personal=Yi();function At(t,e){var n=-1,r;if(!(this instanceof At))return new At(t,e);if(typeof t=="string"||Hi(t)?(typeof e=="string"||Hi(e))&&(r=[{dic:e}]):t&&("length"in t?(r=t,t=t[0]&&t[0].aff):(t.dic&&(r=[t]),t=t.aff)),!t)throw new Error("Missing `aff` in dictionary");if(t=Fo(t),this.data=Object.create(null),this.compoundRuleCodes=t.compoundRuleCodes,this.replacementTable=t.replacementTable,this.conversion=t.conversion,this.compoundRules=t.compoundRules,this.rules=t.rules,this.flags=t.flags,r)for(;++n<r.length;)r[n].dic&&this.dictionary(r[n].dic)}});var Io={};da(Io,{ChoiceScriptWorker:()=>Wt,create:()=>Ro});var De;(function(t){t[t.CommentLine=0]="CommentLine",t[t.OptionLine=1]="OptionLine",t[t.CommandLine=2]="CommandLine",t[t.TextLine=3]="TextLine"})(De||(De={}));var c;(function(t){t[t.Char=0]="Char",t[t.Ident=1]="Ident",t[t.AtKeyword=2]="AtKeyword",t[t.Asterisk=3]="Asterisk",t[t.String=4]="String",t[t.BadString=5]="BadString",t[t.UnquotedString=6]="UnquotedString",t[t.Hash=7]="Hash",t[t.Num=8]="Num",t[t.Percentage=9]="Percentage",t[t.Dimension=10]="Dimension",t[t.UnicodeRange=11]="UnicodeRange",t[t.CDO=12]="CDO",t[t.CDC=13]="CDC",t[t.Colon=14]="Colon",t[t.SemiColon=15]="SemiColon",t[t.CurlyL=16]="CurlyL",t[t.CurlyR=17]="CurlyR",t[t.ParenthesisL=18]="ParenthesisL",t[t.ParenthesisR=19]="ParenthesisR",t[t.BracketL=20]="BracketL",t[t.BracketR=21]="BracketR",t[t.Indentation=22]="Indentation",t[t.Whitespace=23]="Whitespace",t[t.Includes=24]="Includes",t[t.Dashmatch=25]="Dashmatch",t[t.SubstringOperator=26]="SubstringOperator",t[t.PrefixOperator=27]="PrefixOperator",t[t.SuffixOperator=28]="SuffixOperator",t[t.Delim=29]="Delim",t[t.EMS=30]="EMS",t[t.EXS=31]="EXS",t[t.Length=32]="Length",t[t.Angle=33]="Angle",t[t.Time=34]="Time",t[t.Freq=35]="Freq",t[t.Exclamation=36]="Exclamation",t[t.Resolution=37]="Resolution",t[t.Comma=38]="Comma",t[t.Charset=39]="Charset",t[t.EscapedJavaScript=40]="EscapedJavaScript",t[t.BadEscapedJavaScript=41]="BadEscapedJavaScript",t[t.Comment=42]="Comment",t[t.SingleLineComment=43]="SingleLineComment",t[t.EOF=44]="EOF",t[t.EOL=45]="EOL",t[t.CustomToken=46]="CustomToken",t[t.Builtin=47]="Builtin",t[t.Invalid=48]="Invalid",t[t.Word=49]="Word",t[t.Dollar=50]="Dollar",t[t.FairMathAdd=51]="FairMathAdd",t[t.FairMathSub=52]="FairMathSub"})(c||(c={}));var An=function(){function t(e){this.lineNum=0,this.linePos=0,this.source=e,this.sourceLen=e.length,this.lines=e.split(/\r?\n/)}return t.prototype.getLineText=function(e){return this.lines[e??this.lineNum]},t.prototype.gotoNextLine=function(){this.lineNum<this.lines.length&&(this.lineNum++,this.linePos=0)},t.prototype.gotoPrevLine=function(){this.lineNum>0&&(this.lineNum--,this.linePos=0)},t.prototype.substring=function(e,n){return n===void 0&&(n=this.linePos),this.lines[this.lineNum].substring(e,n)},t.prototype.eol=function(){return this.linePos===this.lines[this.lineNum].length},t.prototype.eos=function(){return this.eol()&&this.lineNum===this.lines.length-1},t.prototype.pos=function(){return{line:this.lineNum,ch:this.linePos}},t.prototype.line=function(){return this.lineNum},t.prototype.offset=function(){var e=0,n=this.lines.slice(0,this.lineNum);return n.length>0&&(e+=n.reduce(function(r,i){return r+i.length+1},0)),e+this.linePos},t.prototype.lineOffset=function(){return this.linePos},t.prototype.goBackToOffset=function(e){this.linePos=e},t.prototype.goBackToPos=function(e){this.lineNum=e.line,this.linePos=e.ch},t.prototype.goBack=function(e){this.linePos-=e},t.prototype.advance=function(e){this.linePos+=e},t.prototype.nextChar=function(){return this.lines[this.lineNum].charCodeAt(this.linePos++)||0},t.prototype.peekChar=function(e){return e===void 0&&(e=0),this.lines[this.lineNum].charCodeAt(this.linePos+e)||0},t.prototype.lookbackChar=function(e){return e===void 0&&(e=0),this.lines[this.lineNum].charCodeAt(this.linePos-e)||0},t.prototype.advanceIfChar=function(e){return e===this.lines[this.lineNum].charCodeAt(this.linePos)?(this.linePos++,!0):!1},t.prototype.onCommandLine=function(){return/^(\s*\*[a-z]+)/.test(this.lines[this.lineNum])},t.prototype.advanceIfChars=function(e){if(this.linePos+e.length>this.source.length)return!1;for(var n=0;n<e.length;n++)if(this.source.charCodeAt(this.linePos+n)!==e[n])return!1;return this.advance(n),!0},t.prototype.advanceWhileLine=function(){for(var e=this.linePos,n=this.lines[this.lineNum].length;this.linePos<n;)this.linePos++;return this.linePos-e},t.prototype.advanceWhileChar=function(e){for(var n=this.linePos,r=this.lines[this.lineNum].length;this.linePos<r&&e(this.lines[this.lineNum].charCodeAt(this.linePos));)this.linePos++;return this.linePos-n},t}();var Wn=function(){function t(e){this.source=e,this.len=e.length,this.position=0}return t.prototype.substring=function(e,n){return n===void 0&&(n=this.position),this.source.substring(e,n)},t.prototype.eos=function(){return this.len<=this.position},t.prototype.pos=function(){return this.position},t.prototype.goBackTo=function(e){this.position=e},t.prototype.goBack=function(e){this.position-=e},t.prototype.advance=function(e){this.position+=e},t.prototype.nextChar=function(){return this.source.charCodeAt(this.position++)||0},t.prototype.peekChar=function(e){return e===void 0&&(e=0),this.source.charCodeAt(this.position+e)||0},t.prototype.lookbackChar=function(e){return e===void 0&&(e=0),this.source.charCodeAt(this.position-e)||0},t.prototype.advanceIfChar=function(e){return e===this.source.charCodeAt(this.position)?(this.position++,!0):!1},t.prototype.advanceIfChars=function(e){if(this.position+e.length>this.source.length)return!1;for(var n=0;n<e.length;n++)if(this.source.charCodeAt(this.position+n)!==e[n])return!1;return this.advance(n),!0},t.prototype.advanceWhileChar=function(e){for(var n=this.position;this.position<this.len&&e(this.source.charCodeAt(this.position));)this.position++;return this.position-n},t}();var oe="a".charCodeAt(0),Pn="c".charCodeAt(0),jn="e".charCodeAt(0),Un="f".charCodeAt(0),ht="m".charCodeAt(0),Bn="n".charCodeAt(0),Vn="o".charCodeAt(0),qn="t".charCodeAt(0),ue="z".charCodeAt(0),se="A".charCodeAt(0),Gn="F".charCodeAt(0),fe="Z".charCodeAt(0),ge="0".charCodeAt(0),be="9".charCodeAt(0),To="~".charCodeAt(0),No="^".charCodeAt(0),Mo="=".charCodeAt(0),Oo="|".charCodeAt(0),qe="-".charCodeAt(0),Jn="+".charCodeAt(0),Yn="_".charCodeAt(0),jt="%".charCodeAt(0),Ut="*".charCodeAt(0),Hn="(".charCodeAt(0),Kn=")".charCodeAt(0),Ao="<".charCodeAt(0),Wo=">".charCodeAt(0),Lo="@".charCodeAt(0),Xn="#".charCodeAt(0),ma="$".charCodeAt(0),Ge="\\".charCodeAt(0),Po="/".charCodeAt(0),pe=`
`.charCodeAt(0),he="\r".charCodeAt(0),xe="\f".charCodeAt(0),Bt='"'.charCodeAt(0),Ve="'".charCodeAt(0),Je=" ".charCodeAt(0),Ye="	".charCodeAt(0),ua=";".charCodeAt(0),fa=":".charCodeAt(0),ga="{".charCodeAt(0),ba="}".charCodeAt(0),va="[".charCodeAt(0),ya="]".charCodeAt(0),wa=",".charCodeAt(0),mt=".".charCodeAt(0),jo="!".charCodeAt(0),Uo="?".charCodeAt(0),Ln="*".charCodeAt(0),te={};te[ua]=c.SemiColon;te[fa]=c.Colon;te[ga]=c.CurlyL;te[ba]=c.CurlyR;te[ya]=c.BracketR;te[va]=c.BracketL;te[Hn]=c.ParenthesisL;te[Kn]=c.ParenthesisR;te[wa]=c.Comma;te[ma]=c.Dollar;var B={};B.em=c.EMS;B.ex=c.EXS;B.px=c.Length;B.cm=c.Length;B.mm=c.Length;B.in=c.Length;B.pt=c.Length;B.pc=c.Length;B.deg=c.Angle;B.rad=c.Angle;B.grad=c.Angle;B.ms=c.Time;B.s=c.Time;B.hz=c.Freq;B.khz=c.Freq;B["%"]=c.Percentage;B.fr=c.Percentage;B.dpi=c.Resolution;B.dpcm=c.Resolution;var Bo=function(){function t(){this.stream=new An(""),this.ignoreComment=!0,this.ignoreWhitespace=!0,this.isNewLine=!0,this.currentLineType=null}return t.prototype.setSource=function(e){this.stream=new An(e)},t.prototype.finishToken=function(e,n,r){var i=this.stream.lineOffset()-e.ch;return{pos:e,len:i||1,offset:this.stream.offset()-i,type:n,text:r||this.stream.substring(e.ch)}},t.prototype.pos=function(){return this.stream.pos()},t.prototype.goBackToPos=function(e){this.stream.goBackToPos(e)},t.prototype.scan=function(){if(this.stream.eos())return this.finishToken(this.stream.pos(),c.EOF);var e=this.scanLine(this.stream.line());return e},t.prototype.scanLine=function(e){if(this.stream.eol()){var n=this.stream.pos();this.isNewLine=!0;var r=this.finishToken(n,c.EOL,`
`);return this.stream.gotoNextLine(),r}return this.scanNext(this.stream.pos())},t.prototype.scanNext=function(e){if(e.ch===0&&this._whitespace())return this.finishToken(e,c.Indentation);if(this.isNewLine){if(this.stream.advanceIfChars([Ln,Pn,Vn,ht,ht,jn,Bn,qn])){var n=this.stream.advanceWhileLine();return this.finishToken(e,c.SingleLineComment)}else this.stream.peekChar()===Ln&&/\w+/.test(String.fromCharCode(this.stream.peekChar(1)))?this.currentLineType=De.CommandLine:this.currentLineType=De.TextLine;this.isNewLine=!1}if(!this.currentLineType)throw new Error("Scanner doesn't recognize this line type.");var r=[];if(this.currentLineType===De.CommandLine){if(this.stream.advanceIfChar(Ut))return this.finishToken(e,c.Asterisk,"*");if(this.ident(r))return this.finishToken(e,c.Ident,r.join(""));if(this._string(r))return this.finishToken(e,c.String,r.join(""));if(this._fastMathOp())return this.stream.advance(1),this.finishToken(e,this.stream.advanceIfChar(qe)?c.FairMathSub:(this.stream.advance(1),c.FairMathAdd),r.join(""))}else if(this.currentLineType===De.TextLine){if(this.stream.advanceIfChar(Xn))return this.finishToken(e,c.Hash);if(this._word())return this.finishToken(e,c.Word)}if(this._whitespace())return this.finishToken(e,c.Whitespace);if(this._number())return this.finishToken(e,c.Num);var i=te[this.stream.peekChar()];return typeof i<"u"?(this.stream.advance(1),this.finishToken(e,i)):(this.stream.nextChar(),this.finishToken(e,c.Char))},t.prototype.trivia=function(){for(;;){var e=this.stream.pos();if(this._whitespace()){if(!this.ignoreWhitespace)return this.finishToken(e,c.Whitespace)}else return null}},t.prototype._stringChar=function(e,n){var r=this.stream.peekChar();return r!==0&&r!==e&&r!==Ge&&r!==he&&r!==xe&&r!==pe?(this.stream.advance(1),n.push(String.fromCharCode(r)),!0):!1},t.prototype._string=function(e){if(this.stream.peekChar()===Bt){var n=this.stream.nextChar();for(e.push(String.fromCharCode(n));this._stringChar(n,e)||this._escape(e,!0););return this.stream.peekChar()===n?(this.stream.nextChar(),e.push(String.fromCharCode(n)),c.String):c.BadString}return null},t.prototype._word=function(){var e=0,n;return n=this.stream.peekChar(e),n>=se&&n<=fe||n>=oe&&n<=ue||n>=192&&n<=383?(this.stream.advance(e+1),this.stream.advanceWhileChar(function(r){return r>=se&&r<=fe||r>=oe&&r<=ue||r>=192&&r<=383||r===Ve}),!0):!1},t.prototype._fastMathOp=function(){var e=0,n;return this.stream.peekChar()===jt?(e=1,n=this.stream.peekChar(e),n===Jn||n===qe):!1},t.prototype._number=function(){var e=0,n;return this.stream.peekChar()===mt&&(e=1),n=this.stream.peekChar(e),n>=ge&&n<=be?(this.stream.advance(e+1),this.stream.advanceWhileChar(function(r){return r>=ge&&r<=be||e===0&&r===mt}),!0):!1},t.prototype._whitespace=function(){var e=this.stream.advanceWhileChar(function(n){return n===Je||n===Ye});return e>0},t.prototype._name=function(e){for(var n=!1;this._identChar(e)||this._escape(e);)n=!0;return n},t.prototype.ident=function(e){if(this._identFirstChar(e)){for(;this._identChar(e););return!0}return!1},t.prototype._identFirstChar=function(e){var n=this.stream.peekChar();return n>=oe&&n<=ue||n>=se&&n<=fe?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t.prototype._identChar=function(e){var n=this.stream.peekChar();return n===Yn||n>=oe&&n<=ue||n>=se&&n<=fe||n>=ge&&n<=be?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t.prototype._escape=function(e,n){var r=this.stream.peekChar();if(r===Ge){this.stream.advance(1),r=this.stream.peekChar();for(var i=0;i<6&&(r>=ge&&r<=be||r>=oe&&r<=Un||r>=se&&r<=Gn);)this.stream.advance(1),r=this.stream.peekChar(),i++;if(i>0){try{var a=parseInt(this.stream.substring(this.stream.offset()-i),16);a&&e.push(String.fromCharCode(a))}catch{}return r===Je||r===Ye?this.stream.advance(1):this._newline([]),!0}if(r!==he&&r!==xe&&r!==pe)return this.stream.advance(1),e.push(String.fromCharCode(r)),!0;if(n)return this._newline(e)}return!1},t.prototype._newline=function(e){var n=this.stream.peekChar();switch(n){case he:case xe:case pe:return this.stream.advance(1),e.push(String.fromCharCode(n)),n===he&&this.stream.advanceIfChar(pe)&&e.push(`
`),!0}return!1},t}();var Zn=function(){function t(){this.stream=new Wn(""),this.ignoreComment=!0,this.ignoreWhitespace=!0,this.inURL=!1,this.newLine=!0}return t.prototype.setSource=function(e){this.stream=new Wn(e)},t.prototype.finishToken=function(e,n,r){return{offset:e,len:this.stream.pos()-e,type:n,text:r||this.stream.substring(e)}},t.prototype.substring=function(e,n){return this.stream.substring(e,e+n)},t.prototype.pos=function(){return this.stream.pos()},t.prototype.goBackTo=function(e){this.stream.goBackTo(e)},t.prototype.scanUnquotedString=function(){var e=this.stream.pos(),n=[];return this._unquotedString(n)?this.finishToken(e,c.UnquotedString,n.join("")):null},t.prototype.scan=function(){var e=this.trivia();if(e!==null)return e;var n=this.stream.pos();return this.stream.eos()?this.finishToken(n,c.EOF):this.scanNext(n)},t.prototype.scanNext=function(e){var n=[];if(this.newLine){for(;this._whitespace();)return this.finishToken(e,c.Indentation);this.newLine=!1}if(this._newline(n))return this.newLine=!0,this.finishToken(e,c.EOL,n.join(""));if(this.stream.advanceIfChars([Ut,Pn,Vn,ht,ht,jn,Bn,qn]))return this.finishToken(e,c.SingleLineComment);if(this.stream.advanceIfChar(Ut))return this.finishToken(e,c.Asterisk,"*");if(this.ident(n))return this.finishToken(e,c.Ident,n.join(""));if(this._word())return this.finishToken(e,c.Word);if(this._number())return this.finishToken(e,c.Num,n.join(""));if(n.length===1)return this.finishToken(e,c.Delim);n=[];var r=this._string(n);if(r!==null)return this.finishToken(e,r,n.join(""));if(this.stream.advanceIfChar(Xn))return this.finishToken(e,c.Hash);if(this._number()){var i=this.stream.pos();if(n=[this.stream.substring(e,i)],this.stream.advanceIfChar(jt))return this.finishToken(e,c.Percentage);if(this.ident(n)){var a=this.stream.substring(i).toLowerCase(),o=B[a];return typeof o<"u"?this.finishToken(e,o,n.join("")):this.finishToken(e,c.Dimension,n.join(""))}return this.finishToken(e,c.Num)}return this._fastMathOp()?(this.stream.advance(1),this.finishToken(e,this.stream.advanceIfChar(qe)?c.FairMathSub:(this.stream.advance(1),c.FairMathAdd),n.join(""))):(r=te[this.stream.peekChar()],typeof r<"u"?(this.stream.advance(1),this.finishToken(e,r)):(this.stream.nextChar(),this.finishToken(e,c.Delim)))},t.prototype.trivia=function(){for(;!this.newLine;){var e=this.stream.pos();if(this._whitespace()){if(!this.ignoreWhitespace)return this.finishToken(e,c.Whitespace)}else return null}return null},t.prototype._fastMathOp=function(){var e;return this.stream.peekChar()===jt?(e=this.stream.peekChar(1),e===Jn||e===qe):!1},t.prototype._number=function(){var e=0,n;return this.stream.peekChar()===mt&&(e=1),n=this.stream.peekChar(e),n>=ge&&n<=be?(this.stream.advance(e+1),this.stream.advanceWhileChar(function(r){return r>=ge&&r<=be||e===0&&r===mt}),!0):!1},t.prototype._word=function(){var e=0,n;return n=this.stream.peekChar(e),n>=se&&n<=fe||n>=oe&&n<=ue||n>=192&&n<=383?(this.stream.advance(e+1),this.stream.advanceWhileChar(function(r){return r>=se&&r<=fe||r>=oe&&r<=ue||r>=192&&r<=383||r===Ve}),!0):!1},t.prototype._newline=function(e){var n=this.stream.peekChar();switch(n){case he:case xe:case pe:return this.stream.advance(1),e.push(String.fromCharCode(n)),n===he&&this.stream.advanceIfChar(pe)&&e.push(`
`),!0}return!1},t.prototype._escape=function(e,n){var r=this.stream.peekChar();if(r===Ge){this.stream.advance(1),r=this.stream.peekChar();for(var i=0;i<6&&(r>=ge&&r<=be||r>=oe&&r<=Un||r>=se&&r<=Gn);)this.stream.advance(1),r=this.stream.peekChar(),i++;if(i>0){try{var a=parseInt(this.stream.substring(this.stream.pos()-i),16);a&&e.push(String.fromCharCode(a))}catch{}return r===Je||r===Ye?this.stream.advance(1):this._newline([]),!0}if(r!==he&&r!==xe&&r!==pe)return this.stream.advance(1),e.push(String.fromCharCode(r)),!0;if(n)return this._newline(e)}return!1},t.prototype._stringChar=function(e,n){var r=this.stream.peekChar();return r!==0&&r!==e&&r!==Ge&&r!==he&&r!==xe&&r!==pe?(this.stream.advance(1),n.push(String.fromCharCode(r)),!0):!1},t.prototype._string=function(e){return null;if(this.stream.peekChar()===Ve||this.stream.peekChar()===Bt){var n;for(e.push(String.fromCharCode(n));this._stringChar(n,e)||this._escape(e,!0););return this.stream.peekChar()===n?(this.stream.nextChar(),e.push(String.fromCharCode(n)),c.String):c.BadString}},t.prototype._unquotedChar=function(e){var n=this.stream.peekChar();return n!==0&&n!==Ge&&n!==Ve&&n!==Bt&&n!==Hn&&n!==Kn&&n!==Je&&n!==Ye&&n!==pe&&n!==xe&&n!==he?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t.prototype._unquotedString=function(e){for(var n=!1;this._unquotedChar(e)||this._escape(e);)n=!0;return n},t.prototype._whitespace=function(){var e=this.stream.advanceWhileChar(function(n){return n===Je||n===Ye});return e>0},t.prototype._name=function(e){for(var n=!1;this._identChar(e)||this._escape(e);)n=!0;return n},t.prototype.ident=function(e){var n=this.stream.pos();if(this._identFirstChar(e)){for(;this._identChar(e););var r=this.stream.peekChar();if(r>=192&&r<=383)return!1;switch(r){case Ve:return this.stream.goBackTo(n),!1;default:return!0}return!0}return!1},t.prototype._identFirstChar=function(e){var n=this.stream.peekChar();return n>=oe&&n<=ue||n>=se&&n<=fe?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t.prototype._identChar=function(e){var n=this.stream.peekChar();return n===Yn||n>=oe&&n<=ue||n>=se&&n<=fe||n>=ge&&n<=be?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t.prototype._minus=function(e){var n=this.stream.peekChar();return n===qe?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t}();var w=function(){var t=function(e,n){return t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,i){r.__proto__=i}||function(r,i){for(var a in i)Object.prototype.hasOwnProperty.call(i,a)&&(r[a]=i[a])},t(e,n)};return function(e,n){if(typeof n!="function"&&n!==null)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null");t(e,n);function r(){this.constructor=e}e.prototype=n===null?Object.create(n):(r.prototype=n.prototype,new r)}}(),G;(function(t){t[t.Number=0]="Number",t[t.String=1]="String",t[t.Boolean=2]="Boolean"})(G||(G={}));var $;(function(t){t[t.Text=0]="Text",t[t.ChoiceScript=1]="ChoiceScript",t[t.Comment=2]="Comment",t[t.ChoiceOption=3]="ChoiceOption"})($||($={}));var le;(function(t){t[t.Spaces=0]="Spaces",t[t.Tab=1]="Tab",t[t.Mixed=2]="Mixed"})(le||(le={}));var h;(function(t){t[t.Undefined=0]="Undefined",t[t.ChoiceScriptComment=1]="ChoiceScriptComment",t[t.Identifier=2]="Identifier",t[t.Scene=3]="Scene",t[t.SceneRef=4]="SceneRef",t[t.Line=5]="Line",t[t.Label=6]="Label",t[t.LabelRef=7]="LabelRef",t[t.ChoiceScriptLine=8]="ChoiceScriptLine",t[t.ChoiceScriptStatement=9]="ChoiceScriptStatement",t[t.TextLine=10]="TextLine",t[t.StringLiteral=11]="StringLiteral",t[t.Operator=12]="Operator",t[t.Expression=13]="Expression",t[t.BinaryExpression=14]="BinaryExpression",t[t.StringExpression=15]="StringExpression",t[t.Term=16]="Term",t[t.Value=17]="Value",t[t.RealWord=18]="RealWord",t[t.ChoiceCommand=19]="ChoiceCommand",t[t.ParamsCommand=20]="ParamsCommand",t[t.ChoiceOption=21]="ChoiceOption",t[t.MultiReplace=22]="MultiReplace",t[t.MultiReplaceOption=23]="MultiReplaceOption",t[t.VariableReplacement=24]="VariableReplacement",t[t.PrintVariable=25]="PrintVariable",t[t.NumericValue=26]="NumericValue",t[t.Boolean=27]="Boolean",t[t.Indentation=28]="Indentation",t[t.VariableDeclaration=29]="VariableDeclaration",t[t.LabelDeclaration=30]="LabelDeclaration",t[t.JumpCommand=31]="JumpCommand",t[t.GotoCommand=32]="GotoCommand",t[t.GosubCommand=33]="GosubCommand",t[t.Param=34]="Param",t[t.ParamList=35]="ParamList",t[t.HexColorValue=36]="HexColorValue",t[t.Variable=37]="Variable",t[t.CreateVariable=38]="CreateVariable",t[t.If=39]="If",t[t.Else=40]="Else",t[t.For=41]="For",t[t.Each=42]="Each",t[t.While=43]="While",t[t.MixinContentReference=44]="MixinContentReference",t[t.MixinContentDeclaration=45]="MixinContentDeclaration",t[t.Media=46]="Media",t[t.Keyframe=47]="Keyframe",t[t.FontFace=48]="FontFace",t[t.Import=49]="Import",t[t.Namespace=50]="Namespace",t[t.Invocation=51]="Invocation",t[t.FunctionDeclaration=52]="FunctionDeclaration",t[t.ReturnStatement=53]="ReturnStatement",t[t.MediaQuery=54]="MediaQuery",t[t.FunctionParameter=55]="FunctionParameter",t[t.FunctionArgument=56]="FunctionArgument",t[t.KeyframeSelector=57]="KeyframeSelector",t[t.ViewPort=58]="ViewPort",t[t.Document=59]="Document",t[t.AtApplyRule=60]="AtApplyRule",t[t.CustomPropertyDeclaration=61]="CustomPropertyDeclaration",t[t.CustomPropertySet=62]="CustomPropertySet",t[t.ListEntry=63]="ListEntry",t[t.Supports=64]="Supports",t[t.SupportsCondition=65]="SupportsCondition",t[t.NamespacePrefix=66]="NamespacePrefix",t[t.GridLine=67]="GridLine",t[t.Plugin=68]="Plugin",t[t.UnknownAtRule=69]="UnknownAtRule",t[t.Command=70]="Command",t[t.StandardCommand=71]="StandardCommand",t[t.InvalidBuiltin=72]="InvalidBuiltin",t[t.IfIdCommand=73]="IfIdCommand",t[t.IfId=74]="IfId"})(h||(h={}));var L;(function(t){t[t.Label=0]="Label",t[t.Variable=1]="Variable",t[t.Unknown=2]="Unknown"})(L||(L={}));function Re(t,e){var n=null;return!t||e<t.offset||e>t.end?null:(t.accept(function(r){return r.offset===-1&&r.length===-1?!0:r.offset<=e&&r.end>=e?(n?r.length<=n.length&&(n=r):n=r,!0):!1}),n)}function ut(t,e){for(var n=Re(t,e),r=[];n;)r.unshift(n),n=n.parent;return r}var F=function(){function t(e,n,r){e===void 0&&(e=-1),n===void 0&&(n=-1),this.parent=null,this.offset=e,this.length=n,r&&(this.nodeType=r)}return Object.defineProperty(t.prototype,"end",{get:function(){return this.offset+this.length},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"type",{get:function(){return this.nodeType||h.Undefined},set:function(e){this.nodeType=e},enumerable:!1,configurable:!0}),t.prototype.getTextProvider=function(){for(var e=this;e&&!e.textProvider;)e=e.parent;return e?e.textProvider:function(){return"unknown"}},t.prototype.getText=function(){return this.getTextProvider()(this.offset,this.length)},t.prototype.matches=function(e){return this.length===e.length&&this.getTextProvider()(this.offset,this.length)===e},t.prototype.startsWith=function(e){return this.length>=e.length&&this.getTextProvider()(this.offset,e.length)===e},t.prototype.endsWith=function(e){return this.length>=e.length&&this.getTextProvider()(this.end-e.length,e.length)===e},t.prototype.accept=function(e){if(e(this)&&this.children)for(var n=0,r=this.children;n<r.length;n++){var i=r[n];i.accept(e)}},t.prototype.acceptVisitor=function(e){this.accept(e.visitNode.bind(e))},t.prototype.adoptChild=function(e,n){if(n===void 0&&(n=-1),e.parent&&e.parent.children){var r=e.parent.children.indexOf(e);r>=0&&e.parent.children.splice(r,1)}e.parent=this;var i=this.children;return i||(i=this.children=[]),n!==-1?i.splice(n,0,e):i.push(e),e},t.prototype.attachTo=function(e,n){return n===void 0&&(n=-1),e&&e.adoptChild(this,n),this},t.prototype.collectIssues=function(e){this.issues&&e.push.apply(e,this.issues)},t.prototype.addIssue=function(e){this.issues||(this.issues=[]),this.issues.push(e)},t.prototype.hasIssue=function(e){return Array.isArray(this.issues)&&this.issues.some(function(n){return n.getRule()===e})},t.prototype.isErroneous=function(e){return e===void 0&&(e=!1),this.issues&&this.issues.length>0?!0:e&&Array.isArray(this.children)&&this.children.some(function(n){return n.isErroneous(!0)})},t.prototype.setNode=function(e,n,r){return r===void 0&&(r=-1),n?(n.attachTo(this,r),this[e]=n,!0):!1},t.prototype.addChild=function(e){return e?(this.children||(this.children=[]),e.attachTo(this),this.updateOffsetAndLength(e),!0):!1},t.prototype.updateOffsetAndLength=function(e){(e.offset<this.offset||this.offset===-1)&&(this.offset=e.offset);var n=e.end;(n>this.end||this.length===-1)&&(this.length=n-this.offset)},t.prototype.hasChildren=function(){return!!this.children&&this.children.length>0},t.prototype.getChildren=function(){return this.children?this.children.slice(0):[]},t.prototype.getChild=function(e){return this.children&&e<this.children.length?this.children[e]:null},t.prototype.addChildren=function(e){for(var n=0,r=e;n<r.length;n++){var i=r[n];this.addChild(i)}},t.prototype.getPrevSibling=function(){if(this.parent===null||this.parent.type!==h.Scene)return null;var e=this.parent.getChildren(),n=e.indexOf(this);return n<0?null:e[n-1]||null},t.prototype.getNextSibling=function(){if(this.parent===null||this.parent.type!==h.Scene)return null;var e=this.parent.getChildren(),n=e.indexOf(this);return n<0?null:e[n+1]||null},t.prototype.findFirstChildBeforeOffset=function(e){if(this.children){for(var n=null,r=this.children.length-1;r>=0;r--)if(n=this.children[r],n.offset<=e)return n}return null},t.prototype.findChildAtOffset=function(e,n){var r=this.findFirstChildBeforeOffset(e);return r&&r.end>=e?n&&r.findChildAtOffset(e,!0)||r:null},t.prototype.encloses=function(e){return this.offset<=e.offset&&this.offset+this.length>=e.offset+e.length},t.prototype.getParent=function(){for(var e=this.parent;e instanceof He;)e=e.parent;return e},t.prototype.findParent=function(e){for(var n=this;n&&n.type!==e;)n=n.parent;return n},t.prototype.findAParent=function(){for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n];for(var r=this;r&&!e.some(function(i){return r.type===i});)r=r.parent;return r},t.prototype.setData=function(e,n){this.options||(this.options={}),this.options[e]=n},t.prototype.getData=function(e){return!this.options||!this.options.hasOwnProperty(e)?null:this.options[e]},t}();var $n=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.iType=le.Spaces,i.depth=0,i}return e.prototype.setIndentUnit=function(n){this.iType=n},e.prototype.setIndentDepth=function(n){this.depth=n},Object.defineProperty(e.prototype,"type",{get:function(){return h.Indentation},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"indentDepth",{get:function(){return this.depth},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"indentType",{get:function(){return this.iType},enumerable:!1,configurable:!0}),e}(F);var He=function(t){w(e,t);function e(n,r){r===void 0&&(r=-1);var i=t.call(this,-1,-1)||this;return i.attachTo(n,r),i.offset=-1,i.length=-1,i}return e}(F);var Vt=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.VariableReplacement},enumerable:!1,configurable:!0}),e}(F);var qo=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.ChoiceScriptStatement},enumerable:!1,configurable:!0}),e}(F);var Qn=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.ChoiceScriptComment},enumerable:!1,configurable:!0}),e}(F);var ft=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.isCustomProperty=!1,i}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Identifier},enumerable:!1,configurable:!0}),e.prototype.containsInterpolation=function(){return this.hasChildren()},e}(F);var qt=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Scene},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"name",{get:function(){return this.sceneName},enumerable:!1,configurable:!0}),e.prototype.setUri=function(n){this.uri=n,this.sceneName=n.slice(n.lastIndexOf("/")+1,-1*4)},e.prototype.getUri=function(){return this.uri},e.prototype.isStartup=function(){return this.uri?/\/startup\.txt$/.test(this.uri):!1},e.prototype.isStats=function(){return this.uri?/\/choicescript_stats\.txt$/.test(this.uri):!1},e}(F);var er=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.SceneRef},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"name",{get:function(){return this.sceneName},enumerable:!1,configurable:!0}),e.prototype.setSceneName=function(n){this.sceneName=n},e.prototype.getUri=function(){return this.uri},e.prototype.isStartup=function(){return this.uri?/\/startup\.txt$/.test(this.uri):!1},e}(F);var j=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Command},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"name",{get:function(){var n=this.getText().match(/^\*([A-Za-z_]+\b)/);return n?n[1]:this.getText()},enumerable:!1,configurable:!0}),e}(F);var Ie=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Label},enumerable:!1,configurable:!0}),e.prototype.getValue=function(){return this.labelName||this.getText()},e}(j);var tr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.LabelRef},enumerable:!1,configurable:!0}),e.prototype.getSceneRef=function(){var n=this.findAParent(h.GosubCommand,h.GotoCommand);return n?n.getSceneRef():null},e.prototype.setLabelName=function(n){this.labelName=n},Object.defineProperty(e.prototype,"name",{get:function(){var n;return(n=this.getChild(0))&&n.type===h.Label?(n=n,n.name):this.labelName},enumerable:!1,configurable:!0}),e}(F);var Ke=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.StandardCommand},enumerable:!1,configurable:!0}),e}(j);var nr=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.IfIdCommand},enumerable:!1,configurable:!0}),e.prototype.isValid=function(){var n=this.getChild(0);if(!n||n.type!==h.IfId)return!1;var r=n;return r.isValid()},e}(j);var rr=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.IfId},enumerable:!1,configurable:!0}),e.prototype.isValid=function(){return!(!this.getText()||!/^\w{8}-\w{4}-\w{4}-\w{4}-\w{12}$/.test(this.getText())||!/^[A-F0-9\-]{36}$/i.test(this.getText()))},e}(F);var gt=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.targetScene=null,i.targetLabel=null,i}return Object.defineProperty(e.prototype,"type",{get:function(){return h.JumpCommand},enumerable:!1,configurable:!0}),e.prototype.setScene=function(n){return this.targetScene=n,this.addChild(n)},e.prototype.setLabel=function(n){return this.targetLabel=n,this.addChild(n)},e.prototype.getSceneRef=function(){return this.targetScene},e.prototype.getLabelRef=function(){return this.targetLabel},e}(j);var ir=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.paramList=null,i}return Object.defineProperty(e.prototype,"type",{get:function(){return h.GosubCommand},enumerable:!1,configurable:!0}),e.prototype.getParameterList=function(){return this.paramList},e.prototype.setParameterList=function(n){return this.paramList=n,this.addChild(this.paramList)},e.prototype.hasParameters=function(){return this.paramList!==null},e}(gt);var ar=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.GotoCommand},enumerable:!1,configurable:!0}),e}(gt);var or=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Param},enumerable:!1,configurable:!0}),e}(F);var sr=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i._params=[],i}return Object.defineProperty(e.prototype,"type",{get:function(){return h.ParamList},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"params",{get:function(){return this._params},enumerable:!1,configurable:!0}),e}(F);var lr=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Command},enumerable:!1,configurable:!0}),e}(j);var bt=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return e.prototype.getExpr=function(){return this.expr},e.prototype.getVariable=function(){return this.variable},e.prototype.setVariable=function(n){return n?(n.attachTo(this),this.variable=n,!0):!1},e.prototype.setValue=function(n){return n?(n.attachTo(this),this.expr=n,!0):!1},Object.defineProperty(e.prototype,"type",{get:function(){return h.Command},enumerable:!1,configurable:!0}),e}(j);var cr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.ChoiceCommand},enumerable:!1,configurable:!0}),e}(Ke);var vt=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.variables=[],i}return e.prototype.addVariable=function(n){return n?(n.attachTo(this),this.variables.push(n),!0):!1},Object.defineProperty(e.prototype,"type",{get:function(){return h.ParamsCommand},enumerable:!1,configurable:!0}),e.prototype.getVariable=function(n){return this.variables[n]},e.prototype.getVariableCount=function(){return this.variables.length},e}(j);var Go=function(t){w(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.condition=null,n.next=null,n.prev=null,n}return e}(Ke);var dr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.ChoiceOption},enumerable:!1,configurable:!0}),e}(F);var Jo=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.RealWord},enumerable:!1,configurable:!0}),e}(F);var _e=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.lineType=$.Text,i.indentDepth=0,i}return e.prototype.getLineNum=function(){return this.lineNumber},e.prototype.setLineNum=function(n){return n>0?(this.lineNumber=n,!0):!1},Object.defineProperty(e.prototype,"type",{get:function(){return h.Line},enumerable:!1,configurable:!0}),e.prototype.setLineType=function(n){this.lineType=n},e.prototype.getLineType=function(){return this.lineType},e.prototype.addIndent=function(n){return n?(n.attachTo(this),this.indentNode=n,this.indentDepth=n.indentDepth,!0):!1},e.prototype.getIndentNode=function(){return this.indentNode},Object.defineProperty(e.prototype,"indent",{get:function(){return this.indentDepth},enumerable:!1,configurable:!0}),e}(F);var Gt=function(t){w(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.options=[],n}return e}(F);var Yo=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.TextLine},enumerable:!1,configurable:!0}),e}(_e);var Ho=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.ChoiceScriptLine},enumerable:!1,configurable:!0}),e}(_e);var Ko=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.AtApplyRule},enumerable:!1,configurable:!0}),e.prototype.setIdentifier=function(n){return this.setNode("identifier",n,0)},e.prototype.getIdentifier=function(){return this.identifier},e.prototype.getName=function(){return this.identifier?this.identifier.getText():""},e}(F);var Xo=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Invocation},enumerable:!1,configurable:!0}),e.prototype.getArguments=function(){return this.arguments||(this.arguments=new He(this)),this.arguments},e}(F);var Zo=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.FunctionParameter},enumerable:!1,configurable:!0}),e.prototype.setIdentifier=function(n){return this.setNode("identifier",n,0)},e.prototype.getIdentifier=function(){return this.identifier},e.prototype.getName=function(){return this.identifier?this.identifier.getText():""},e.prototype.setDefaultValue=function(n){return this.setNode("defaultValue",n,0)},e.prototype.getDefaultValue=function(){return this.defaultValue},e}(F);var $o=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.FunctionArgument},enumerable:!1,configurable:!0}),e.prototype.setIdentifier=function(n){return this.setNode("identifier",n,0)},e.prototype.getIdentifier=function(){return this.identifier},e.prototype.getName=function(){return this.identifier?this.identifier.getText():""},e.prototype.setValue=function(n){return this.setNode("value",n,0)},e.prototype.getValue=function(){return this.value},e}(F);var Qo=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Import},enumerable:!1,configurable:!0}),e.prototype.setMedialist=function(n){return n?(n.attachTo(this),!0):!1},e}(F);var es=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Namespace},enumerable:!1,configurable:!0}),e}(F);var ts=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.MediaQuery},enumerable:!1,configurable:!0}),e}(F);var ns=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.SupportsCondition},enumerable:!1,configurable:!0}),e}(F);var pr=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.MultiReplaceOption},enumerable:!1,configurable:!0}),e}(F);var hr=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.variants=[],i}return Object.defineProperty(e.prototype,"type",{get:function(){return h.MultiReplace},enumerable:!1,configurable:!0}),e.prototype.addVariant=function(n){return n&&(this.variants.push(n),this.addChild(n)),this.variants.length},e.prototype.setExpression=function(n){return this.setNode("expression",n)},e.prototype.getExpression=function(){return this.expression},e.prototype.getOptions=function(){return this.variants},e}(Vt);var Te=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Expression},enumerable:!1,configurable:!0}),e.prototype.setLeft=function(n){return this.setNode("left",n)},e.prototype.getLeft=function(){return this.left},e.prototype.setRight=function(n){return this.setNode("right",n)},e.prototype.getRight=function(){return this.right},e.prototype.setOperator=function(n){var r=this.setNode("operator",n);return r&&(this.exprType=n.csType),r},e.prototype.getOperator=function(){return this.operator},e.prototype.isSingleValue=function(){return typeof this.getLeft()<"u"&&!this.getRight()&&!this.getOperator()},Object.defineProperty(e.prototype,"csType",{get:function(){if(this.getLeft()&&!this.getRight()){switch(this.getLeft().type){case h.NumericValue:return G.Number;case h.StringLiteral:return G.String;case h.BinaryExpression:case h.Boolean:return G.Boolean;case h.Identifier:return;default:return}var n=this.getLeft();return n.csType}return this.exprType},enumerable:!1,configurable:!0}),e}(F);var mr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.BinaryExpression},enumerable:!1,configurable:!0}),e}(Te);var ur=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.StringExpression},enumerable:!1,configurable:!0}),e}(Te);var rs=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.Term},enumerable:!1,configurable:!0}),e.prototype.setValue=function(n){if(!this.addChild(n))return!1;switch(n?.type){case h.StringExpression:case h.BinaryExpression:case h.Expression:var r=n;this.valueType=r.csType;break;case h.NumericValue:this.valueType=G.Number;break;case h.StringLiteral:this.valueType=G.String;break;case h.Boolean:this.valueType=G.Boolean;break;case h.Identifier:this.valueType=void 0;break}return!0},Object.defineProperty(e.prototype,"csType",{get:function(){return this.valueType},enumerable:!1,configurable:!0}),e}(F);var Ne=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return e.prototype.setCSType=function(n){this.operatorType=n},Object.defineProperty(e.prototype,"type",{get:function(){return h.Operator},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"csType",{get:function(){return this.operatorType},enumerable:!1,configurable:!0}),e}(F);var xa=".".charCodeAt(0),Sa="0".charCodeAt(0),Ca="9".charCodeAt(0),fr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.NumericValue},enumerable:!1,configurable:!0}),e.prototype.getValue=function(){for(var n=this.getText(),r=0,i,a=0,o=n.length;a<o&&(i=n.charCodeAt(a),Sa<=i&&i<=Ca||i===xa);a++)r+=1;return{value:n.substring(0,r),unit:r<n.length?n.substring(r):void 0}},e}(F);var gr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.StringLiteral},enumerable:!1,configurable:!0}),e.prototype.getValue=function(){return this.getText()},e}(F);var yt=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.variable=null,i.expr=null,i}return e.prototype.setVariable=function(n){return n?(n.attachTo(this),this.variable=n,!0):!1},e.prototype.setExpr=function(n){return n?(n.attachTo(this),this.expr=n,!0):!1},Object.defineProperty(e.prototype,"csType",{get:function(){var n;return(n=this.expr)===null||n===void 0?void 0:n.csType},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"type",{get:function(){return h.VariableDeclaration},enumerable:!1,configurable:!0}),e.prototype.isConstant=function(){return this.getName()===this.getName().toUpperCase()},e.prototype.getVariable=function(){return this.variable},e.prototype.getName=function(){return this.variable?this.variable.getName():""},e.prototype.getExpr=function(){return this.expr},e}(j);var wt=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.LabelDeclaration},enumerable:!1,configurable:!0}),e.prototype.setLabel=function(n){return n?(n.attachTo(this),this.label=n,!0):!1},e.prototype.getLabel=function(){return this.label},e}(j);var Xe=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.varType=void 0,i}return e.prototype._setCSType=function(n){switch(n.type){case h.BinaryExpression:this.varType=G.Boolean;break;case h.NumericValue:this.varType=G.Number;break;case h.StringLiteral:this.varType=G.String;break;default:break}},e.prototype.setValue=function(n){return n?(n.attachTo(this),this.value=n,this._setCSType(n),!0):!1},Object.defineProperty(e.prototype,"csType",{get:function(){return this.varType},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"const",{get:function(){return/^const_[\w0-9]+/.test(this.getText())},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"type",{get:function(){return h.Variable},enumerable:!1,configurable:!0}),e.prototype.getName=function(){return this.getText()},e.prototype.getValue=function(){return this.value},e}(F);var is=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return h.ListEntry},enumerable:!1,configurable:!0}),e.prototype.setKey=function(n){return this.setNode("key",n,0)},e.prototype.setValue=function(n){return this.setNode("value",n,1)},e}(F);var as=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return e.prototype.getConditions=function(){return this.conditions||(this.conditions=new He(this)),this.conditions},e}(F);var os=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return e.prototype.setVariable=function(n){return this.setNode("variable",n)},e}(F);var V;(function(t){t[t.Ignore=0]="Ignore",t[t.Error=1]="Error",t[t.Warning=2]="Warning",t[t.Information=3]="Information",t[t.Hint=4]="Hint"})(V||(V={}));var Me=function(){function t(e,n,r,i,a,o){a===void 0&&(a=e.offset),o===void 0&&(o=e.length),this.node=e,this.rule=n,this.level=r,this.message=i||n.message,this.offset=a,this.length=o}return t.prototype.getRule=function(){return this.rule},t.prototype.getLevel=function(){return this.level},t.prototype.getOffset=function(){return this.offset},t.prototype.getLength=function(){return this.length},t.prototype.getNode=function(){return this.node},t.prototype.getMessage=function(){return this.message},t}();var br=function(){function t(){this.entries=[]}return t.entries=function(e){var n=new t;return e.acceptVisitor(n),n.entries},t.prototype.visitNode=function(e){return e.isErroneous()&&e.collectIssues(this.entries),!0},t}();function ka(t,e){let n;return e.length===0?n=t:n=t.replace(/\{(\d+)\}/g,(r,i)=>{let a=i[0];return typeof e[a]<"u"?e[a]:r}),n}function za(t,e,...n){return ka(e,n)}function ce(t){return za}var S=ce(),C=function(){function t(e,n){this.id=e,this.message=n}return t}();var x={NoLabelSpaces:new C("cs-noLabelSpaces",S("no.label.spaces","Label names must not contain spaces")),ExpectedScene:new C("cs-expectedScene",S("expected.scene","Expected a scene name or string expression")),ExpectedLabel:new C("cs-expectedLabel",S("expected.label","Expected a label name or string expression")),GenericSyntaxError:new C("cs-genericSyntaxError",S("generic.syntax.error","Syntax error")),WrongIndentationUnit:new C("cs-wrongindentunit",S("indentunit.error","Incorrect indentation unit")),IndentationError:new C("cs-indentationError",S("indentation.error","Incorrect indentation")),MixedIndentation:new C("cs-mixedIndentation",S("mixed.indentation","Mixed indentation units (spaces/tabs)")),ExpectedChoiceOption:new C("cs-expectedchoiceoption",S("expected.choice.option","Expected Choice option starting with a hash '#'")),UnknownCommand:new C("cs-unknowncommand",S("unknown.command","unknown command")),EmptySceneList:new C("cs-emptyscenelist",S("expected.scenes","Expected at least one scene in the scene list")),NoChoiceOption:new C("cs-nochoiceoption",S("no.choice.command","expected at least one choice option")),NotEnoughMultiReplaceOptions:new C("cs-notenoughmultireplaceopts",S("notenough.multi.command","there should be at least one pipe '|' to separate at least two options")),NumberExpected:new C("cs-numberexpected",S("expected.number","number expected")),ConditionExpected:new C("cs-conditionexpected",S("expected.condt","condition expected")),RuleOrSelectorExpected:new C("cs-ruleorselectorexpected",S("expected.ruleorselector","at-rule or selector expected")),InvalidVariableFormatOption:new C("cs-invalid-variable-format",S("invalid.variableformat","Valid format options are '!' or '!!'")),DotExpected:new C("cs-dotexpected",S("expected.dot","dot expected")),ColonExpected:new C("cs-colonexpected",S("expected.colon","colon expected")),NoCloseQuote:new C("cs-noclosequote",S("no.close.quote",`Invalid string, expected a closing quotation: '"'`)),SemiColonExpected:new C("cs-semicolonexpected",S("expected.semicolon","semi-colon expected")),TermExpected:new C("cs-termexpected",S("expected.term","term expected")),IndentBlockExpected:new C("cs-blockexpected",S("expected.block","Expected an indented code block")),ExpressionExpected:new C("cs-expressionexpected",S("expected.expression","expression expected")),OperatorExpected:new C("cs-operatorexpected",S("expected.operator","operator expected")),IdentifierExpected:new C("cs-identifierexpected",S("expected.ident","identifier expected")),PercentageExpected:new C("cs-percentageexpected",S("expected.percentage","percentage expected")),URIOrStringExpected:new C("cs-uriorstringexpected",S("expected.uriorstring","uri or string expected")),URIExpected:new C("cs-uriexpected",S("expected.uri","URI expected")),LabelNameExpected:new C("cs-labelnamexpected",S("expected.labelname","label name expected")),VariableNameExpected:new C("cs-varnameexpected",S("expected.varname","variable name expected")),VariableValueExpected:new C("cs-varvalueexpected",S("expected.varvalue","variable value expected")),PropertyValueExpected:new C("cs-propertyvalueexpected",S("expected.propvalue","property value expected")),LeftCurlyExpected:new C("cs-lcurlyexpected",S("expected.lcurly","{ expected")),UnbalancedBrackets:new C("cs-unbalancedbrackets",S("expected.lcurly","Unbalanced Brackets")),RightCurlyExpected:new C("cs-rcurlyexpected",S("expected.rcurly","} expected")),LeftSquareBracketExpected:new C("cs-rbracketexpected",S("expected.lsquare","[ expected")),RightSquareBracketExpected:new C("cs-lbracketexpected",S("expected.rsquare","] expected")),LeftParenthesisExpected:new C("cs-lparentexpected",S("expected.lparen","( expected")),RightParenthesisExpected:new C("cs-rparentexpected",S("expected.rparent",") expected")),CommaExpected:new C("cs-commaexpected",S("expected.comma","comma expected")),PageDirectiveOrDeclarationExpected:new C("cs-pagedirordeclexpected",S("expected.pagedirordecl","page directive or declaraton expected")),UnknownAtRule:new C("cs-unknownatrule",S("unknown.atrule","at-rule unknown")),SelectorExpected:new C("cs-selectorexpected",S("expected.selector","selector expected")),StringLiteralExpected:new C("cs-stringliteralexpected",S("expected.stringliteral","string literal expected")),WhitespaceExpected:new C("cs-whitespaceexpected",S("expected.whitespace","whitespace expected")),MediaQueryExpected:new C("cs-mediaqueryexpected",S("expected.mediaquery","media query expected")),IdentifierOrWildcardExpected:new C("cs-idorwildcardexpected",S("expected.idorwildcard","identifier or wildcard expected")),WildcardExpected:new C("cs-wildcardexpected",S("expected.wildcard","wildcard expected")),IdentifierOrVariableExpected:new C("cs-idorvarexpected",S("expected.idorvar","identifier or variable expected"))};var xt=function(){return xt=Object.assign||function(t){for(var e,n=1,r=arguments.length;n<r;n++){e=arguments[n];for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&(t[i]=e[i])}return t},xt.apply(this,arguments)},g;(function(t){t[t.Deprecated=0]="Deprecated",t[t.Normal=1]="Normal",t[t.Initial=2]="Initial"})(g||(g={}));var v=function(){function t(e,n,r){this.indent=0,this.desc=e,this.type=n??g.Normal,this.indent=r??0}return t}();var vr=["and","or","true","false","scene","scenename"],Oe={abort:new v("",g.Normal),achieve:new v("*achieve my_unique_achievement_id",g.Normal),achievement:new v(`*achievement unique_id true 100 Achievement Title
...
In order to let ::-webkit-progress-value take effect, -webkit-appearance needs to be set to none on the <progress> element.`},{name:"::grammar-error",status:"experimental",references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::grammar-error"}],description:"The ::grammar-error CSS pseudo-element represents a text segment which the user agent has flagged as grammatically incorrect."},{name:"::marker",browsers:["E86","FF68","S11.1","C86","O72"],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::marker"}],description:"The ::marker CSS pseudo-element selects the marker box of a list item, which typically contains a bullet or number. It works on any element or pseudo-element set to display: list-item, such as the <li> and <summary> elements."},{name:"::part",status:"experimental",browsers:["E79","FF72","S13.1","C73","O60"],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::part"}],description:"The ::part CSS pseudo-element represents any element within a shadow tree that has a matching part attribute."},{name:"::placeholder",browsers:["E79","FF51","S10.1","C57","O44"],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::placeholder"}],description:"The ::placeholder CSS pseudo-element represents the placeholder text of a form element."},{name:"::slotted",browsers:["E79","FF63","S10","C50","O37"],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::slotted"}],description:"The :slotted() CSS pseudo-element represents any element that has been placed into a slot inside an HTML template."},{name:"::spelling-error",status:"experimental",references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::spelling-error"}],description:"The ::spelling-error CSS pseudo-element represents a text segment which the user agent has flagged as incorrectly spelled."}]};var ks=function(){function t(e){this.dataProviders=[],this._propertySet={},this._atDirectiveSet={},this._pseudoClassSet={},this._pseudoElementSet={},this._properties=[],this._atDirectives=[],this._pseudoClasses=[],this._pseudoElements=[],this.setDataProviders(e?.useDefaultDataProvider!==!1,e?.customDataProviders||[])}return t.prototype.setDataProviders=function(e,n){var r;this.dataProviders=[],e&&this.dataProviders.push(new Er(Dr)),(r=this.dataProviders).push.apply(r,n),this.collectData()},t.prototype.collectData=function(){var e=this;this._propertySet={},this._atDirectiveSet={},this._pseudoClassSet={},this._pseudoElementSet={},this.dataProviders.forEach(function(n){n.provideProperties().forEach(function(r){e._propertySet[r.name]||(e._propertySet[r.name]=r)}),n.provideAtDirectives().forEach(function(r){e._atDirectiveSet[r.name]||(e._atDirectiveSet[r.name]=r)}),n.providePseudoClasses().forEach(function(r){e._pseudoClassSet[r.name]||(e._pseudoClassSet[r.name]=r)}),n.providePseudoElements().forEach(function(r){e._pseudoElementSet[r.name]||(e._pseudoElementSet[r.name]=r)})}),this._properties=Qe(this._propertySet),this._atDirectives=Qe(this._atDirectiveSet),this._pseudoClasses=Qe(this._pseudoClassSet),this._pseudoElements=Qe(this._pseudoElementSet)},t.prototype.getProperty=function(e){return this._propertySet[e]},t.prototype.getAtDirective=function(e){return this._atDirectiveSet[e]},t.prototype.getPseudoClass=function(e){return this._pseudoClassSet[e]},t.prototype.getPseudoElement=function(e){return this._pseudoElementSet[e]},t.prototype.getProperties=function(){return this._properties},t.prototype.getAtDirectives=function(){return this._atDirectives},t.prototype.getPseudoClasses=function(){return this._pseudoClasses},t.prototype.getPseudoElements=function(){return this._pseudoElements},t.prototype.isKnownProperty=function(e){return e.toLowerCase()in this._propertySet},t.prototype.isStandardProperty=function(e){return this.isKnownProperty(e)&&(!this._propertySet[e.toLowerCase()].status||this._propertySet[e.toLowerCase()].status==="standard")},t}();var Wa=function(){function t(e){this.data=e}return Object.defineProperty(t.prototype,"name",{get:function(){return this.data.name},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"description",{get:function(){return this.data.desc},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"restrictions",{get:function(){return this.data.restriction?this.data.restriction.split(",").map(function(e){return e.trim()}):[]},enumerable:!1,configurable:!0}),t}();var de=xr,Ct;function et(){if(!Ct){Ct=[];for(var t=0;t<de.length;t++){var e={name:de[t],desc:["**Command**: "+de[t]]};typeof Oe[de[t]]<"u"&&Oe[de[t]].desc?e.desc.push("```choicescript\n"+Oe[de[t]].desc+"\n```"):typeof Ae[de[t]]<"u"&&Ae[de[t]].desc&&e.desc.push("```choicescript\n"+Ae[de[t]].desc+"\n```"),e.desc.push("Read more on the [wiki](https://choicescriptdev.wikia.com/wiki/"+de[t]+")"),Ct.push(new Wa(e))}}return Ct}function kt(t,e){return e===void 0&&(e=!0),t?t.length<140?t:t.slice(0,140)+(e?"\u2026":""):""}var Ir;(function(t){t.MIN_VALUE=-2147483648,t.MAX_VALUE=2147483647})(Ir||(Ir={}));var Ft;(function(t){t.MIN_VALUE=0,t.MAX_VALUE=2147483647})(Ft||(Ft={}));var K;(function(t){function e(r,i){return r===Number.MAX_VALUE&&(r=Ft.MAX_VALUE),i===Number.MAX_VALUE&&(i=Ft.MAX_VALUE),{line:r,character:i}}t.create=e;function n(r){var i=r;return m.objectLiteral(i)&&m.uinteger(i.line)&&m.uinteger(i.character)}t.is=n})(K||(K={}));var O;(function(t){function e(r,i,a,o){if(m.uinteger(r)&&m.uinteger(i)&&m.uinteger(a)&&m.uinteger(o))return{start:K.create(r,i),end:K.create(a,o)};if(K.is(r)&&K.is(i))return{start:r,end:i};throw new Error("Range#create called with invalid arguments["+r+", "+i+", "+a+", "+o+"]")}t.create=e;function n(r){var i=r;return m.objectLiteral(i)&&K.is(i.start)&&K.is(i.end)}t.is=n})(O||(O={}));var ke;(function(t){function e(r,i){return{uri:r,range:i}}t.create=e;function n(r){var i=r;return m.defined(i)&&O.is(i.range)&&(m.string(i.uri)||m.undefined(i.uri))}t.is=n})(ke||(ke={}));var _r;(function(t){function e(r,i,a,o){return{targetUri:r,targetRange:i,targetSelectionRange:a,originSelectionRange:o}}t.create=e;function n(r){var i=r;return m.defined(i)&&O.is(i.targetRange)&&m.string(i.targetUri)&&(O.is(i.targetSelectionRange)||m.undefined(i.targetSelectionRange))&&(O.is(i.originSelectionRange)||m.undefined(i.originSelectionRange))}t.is=n})(_r||(_r={}));var Et;(function(t){function e(r,i,a,o){return{red:r,green:i,blue:a,alpha:o}}t.create=e;function n(r){var i=r;return m.numberRange(i.red,0,1)&&m.numberRange(i.green,0,1)&&m.numberRange(i.blue,0,1)&&m.numberRange(i.alpha,0,1)}t.is=n})(Et||(Et={}));var nn;(function(t){function e(r,i){return{range:r,color:i}}t.create=e;function n(r){var i=r;return O.is(i.range)&&Et.is(i.color)}t.is=n})(nn||(nn={}));var rn;(function(t){function e(r,i,a){return{label:r,textEdit:i,additionalTextEdits:a}}t.create=e;function n(r){var i=r;return m.string(i.label)&&(m.undefined(i.textEdit)||N.is(i))&&(m.undefined(i.additionalTextEdits)||m.typedArray(i.additionalTextEdits,N.is))}t.is=n})(rn||(rn={}));var an;(function(t){t.Comment="comment",t.Imports="imports",t.Region="region"})(an||(an={}));var on;(function(t){function e(r,i,a,o,s){var l={startLine:r,endLine:i};return m.defined(a)&&(l.startCharacter=a),m.defined(o)&&(l.endCharacter=o),m.defined(s)&&(l.kind=s),l}t.create=e;function n(r){var i=r;return m.uinteger(i.startLine)&&m.uinteger(i.startLine)&&(m.undefined(i.startCharacter)||m.uinteger(i.startCharacter))&&(m.undefined(i.endCharacter)||m.uinteger(i.endCharacter))&&(m.undefined(i.kind)||m.string(i.kind))}t.is=n})(on||(on={}));var sn;(function(t){function e(r,i){return{location:r,message:i}}t.create=e;function n(r){var i=r;return m.defined(i)&&ke.is(i.location)&&m.string(i.message)}t.is=n})(sn||(sn={}));var ln;(function(t){t.Error=1,t.Warning=2,t.Information=3,t.Hint=4})(ln||(ln={}));var Tr;(function(t){t.Unnecessary=1,t.Deprecated=2})(Tr||(Tr={}));var Nr;(function(t){function e(n){var r=n;return r!=null&&m.string(r.href)}t.is=e})(Nr||(Nr={}));var tt;(function(t){function e(r,i,a,o,s,l){var p={range:r,message:i};return m.defined(a)&&(p.severity=a),m.defined(o)&&(p.code=o),m.defined(s)&&(p.source=s),m.defined(l)&&(p.relatedInformation=l),p}t.create=e;function n(r){var i,a=r;return m.defined(a)&&O.is(a.range)&&m.string(a.message)&&(m.number(a.severity)||m.undefined(a.severity))&&(m.integer(a.code)||m.string(a.code)||m.undefined(a.code))&&(m.undefined(a.codeDescription)||m.string((i=a.codeDescription)===null||i===void 0?void 0:i.href))&&(m.string(a.source)||m.undefined(a.source))&&(m.undefined(a.relatedInformation)||m.typedArray(a.relatedInformation,sn.is))}t.is=n})(tt||(tt={}));var je;(function(t){function e(r,i){for(var a=[],o=2;o<arguments.length;o++)a[o-2]=arguments[o];var s={title:r,command:i};return m.defined(a)&&a.length>0&&(s.arguments=a),s}t.create=e;function n(r){var i=r;return m.defined(i)&&m.string(i.title)&&m.string(i.command)}t.is=n})(je||(je={}));var N;(function(t){function e(a,o){return{range:a,newText:o}}t.replace=e;function n(a,o){return{range:{start:a,end:a},newText:o}}t.insert=n;function r(a){return{range:a,newText:""}}t.del=r;function i(a){var o=a;return m.objectLiteral(o)&&m.string(o.newText)&&O.is(o.range)}t.is=i})(N||(N={}));var Pe;(function(t){function e(r,i,a){var o={label:r};return i!==void 0&&(o.needsConfirmation=i),a!==void 0&&(o.description=a),o}t.create=e;function n(r){var i=r;return i!==void 0&&m.objectLiteral(i)&&m.string(i.label)&&(m.boolean(i.needsConfirmation)||i.needsConfirmation===void 0)&&(m.string(i.description)||i.description===void 0)}t.is=n})(Pe||(Pe={}));var X;(function(t){function e(n){var r=n;return typeof r=="string"}t.is=e})(X||(X={}));var ve;(function(t){function e(a,o,s){return{range:a,newText:o,annotationId:s}}t.replace=e;function n(a,o,s){return{range:{start:a,end:a},newText:o,annotationId:s}}t.insert=n;function r(a,o){return{range:a,newText:"",annotationId:o}}t.del=r;function i(a){var o=a;return N.is(o)&&(Pe.is(o.annotationId)||X.is(o.annotationId))}t.is=i})(ve||(ve={}));var nt;(function(t){function e(r,i){return{textDocument:r,edits:i}}t.create=e;function n(r){var i=r;return m.defined(i)&&Rt.is(i.textDocument)&&Array.isArray(i.edits)}t.is=n})(nt||(nt={}));var rt;(function(t){function e(r,i,a){var o={kind:"create",uri:r};return i!==void 0&&(i.overwrite!==void 0||i.ignoreIfExists!==void 0)&&(o.options=i),a!==void 0&&(o.annotationId=a),o}t.create=e;function n(r){var i=r;return i&&i.kind==="create"&&m.string(i.uri)&&(i.options===void 0||(i.options.overwrite===void 0||m.boolean(i.options.overwrite))&&(i.options.ignoreIfExists===void 0||m.boolean(i.options.ignoreIfExists)))&&(i.annotationId===void 0||X.is(i.annotationId))}t.is=n})(rt||(rt={}));var it;(function(t){function e(r,i,a,o){var s={kind:"rename",oldUri:r,newUri:i};return a!==void 0&&(a.overwrite!==void 0||a.ignoreIfExists!==void 0)&&(s.options=a),o!==void 0&&(s.annotationId=o),s}t.create=e;function n(r){var i=r;return i&&i.kind==="rename"&&m.string(i.oldUri)&&m.string(i.newUri)&&(i.options===void 0||(i.options.overwrite===void 0||m.boolean(i.options.overwrite))&&(i.options.ignoreIfExists===void 0||m.boolean(i.options.ignoreIfExists)))&&(i.annotationId===void 0||X.is(i.annotationId))}t.is=n})(it||(it={}));var at;(function(t){function e(r,i,a){var o={kind:"delete",uri:r};return i!==void 0&&(i.recursive!==void 0||i.ignoreIfNotExists!==void 0)&&(o.options=i),a!==void 0&&(o.annotationId=a),o}t.create=e;function n(r){var i=r;return i&&i.kind==="delete"&&m.string(i.uri)&&(i.options===void 0||(i.options.recursive===void 0||m.boolean(i.options.recursive))&&(i.options.ignoreIfNotExists===void 0||m.boolean(i.options.ignoreIfNotExists)))&&(i.annotationId===void 0||X.is(i.annotationId))}t.is=n})(at||(at={}));var Dt;(function(t){function e(n){var r=n;return r&&(r.changes!==void 0||r.documentChanges!==void 0)&&(r.documentChanges===void 0||r.documentChanges.every(function(i){return m.string(i.kind)?rt.is(i)||it.is(i)||at.is(i):nt.is(i)}))}t.is=e})(Dt||(Dt={}));var zt=function(){function t(e,n){this.edits=e,this.changeAnnotations=n}return t.prototype.insert=function(e,n,r){var i,a;if(r===void 0?i=N.insert(e,n):X.is(r)?(a=r,i=ve.insert(e,n,r)):(this.assertChangeAnnotations(this.changeAnnotations),a=this.changeAnnotations.manage(r),i=ve.insert(e,n,a)),this.edits.push(i),a!==void 0)return a},t.prototype.replace=function(e,n,r){var i,a;if(r===void 0?i=N.replace(e,n):X.is(r)?(a=r,i=ve.replace(e,n,r)):(this.assertChangeAnnotations(this.changeAnnotations),a=this.changeAnnotations.manage(r),i=ve.replace(e,n,a)),this.edits.push(i),a!==void 0)return a},t.prototype.delete=function(e,n){var r,i;if(n===void 0?r=N.del(e):X.is(n)?(i=n,r=ve.del(e,n)):(this.assertChangeAnnotations(this.changeAnnotations),i=this.changeAnnotations.manage(n),r=ve.del(e,i)),this.edits.push(r),i!==void 0)return i},t.prototype.add=function(e){this.edits.push(e)},t.prototype.all=function(){return this.edits},t.prototype.clear=function(){this.edits.splice(0,this.edits.length)},t.prototype.assertChangeAnnotations=function(e){if(e===void 0)throw new Error("Text edit change is not configured to manage change annotations.")},t}(),Mr=function(){function t(e){this._annotations=e===void 0?Object.create(null):e,this._counter=0,this._size=0}return t.prototype.all=function(){return this._annotations},Object.defineProperty(t.prototype,"size",{get:function(){return this._size},enumerable:!1,configurable:!0}),t.prototype.manage=function(e,n){var r;if(X.is(e)?r=e:(r=this.nextId(),n=e),this._annotations[r]!==void 0)throw new Error("Id "+r+" is already in use.");if(n===void 0)throw new Error("No annotation provided for id "+r);return this._annotations[r]=n,this._size++,r},t.prototype.nextId=function(){return this._counter++,this._counter.toString()},t}(),_s=function(){function t(e){var n=this;this._textEditChanges=Object.create(null),e!==void 0?(this._workspaceEdit=e,e.documentChanges?(this._changeAnnotations=new Mr(e.changeAnnotations),e.changeAnnotations=this._changeAnnotations.all(),e.documentChanges.forEach(function(r){if(nt.is(r)){var i=new zt(r.edits,n._changeAnnotations);n._textEditChanges[r.textDocument.uri]=i}})):e.changes&&Object.keys(e.changes).forEach(function(r){var i=new zt(e.changes[r]);n._textEditChanges[r]=i})):this._workspaceEdit={}}return Object.defineProperty(t.prototype,"edit",{get:function(){return this.initDocumentChanges(),this._changeAnnotations!==void 0&&(this._changeAnnotations.size===0?this._workspaceEdit.changeAnnotations=void 0:this._workspaceEdit.changeAnnotations=this._changeAnnotations.all()),this._workspaceEdit},enumerable:!1,configurable:!0}),t.prototype.getTextEditChange=function(e){if(Rt.is(e)){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var n={uri:e.uri,version:e.version},r=this._textEditChanges[n.uri];if(!r){var i=[],a={textDocument:n,edits:i};this._workspaceEdit.documentChanges.push(a),r=new zt(i,this._changeAnnotations),this._textEditChanges[n.uri]=r}return r}else{if(this.initChanges(),this._workspaceEdit.changes===void 0)throw new Error("Workspace edit is not configured for normal text edit changes.");var r=this._textEditChanges[e];if(!r){var i=[];this._workspaceEdit.changes[e]=i,r=new zt(i),this._textEditChanges[e]=r}return r}},t.prototype.initDocumentChanges=function(){this._workspaceEdit.documentChanges===void 0&&this._workspaceEdit.changes===void 0&&(this._changeAnnotations=new Mr,this._workspaceEdit.documentChanges=[],this._workspaceEdit.changeAnnotations=this._changeAnnotations.all())},t.prototype.initChanges=function(){this._workspaceEdit.documentChanges===void 0&&this._workspaceEdit.changes===void 0&&(this._workspaceEdit.changes=Object.create(null))},t.prototype.createFile=function(e,n,r){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var i;Pe.is(n)||X.is(n)?i=n:r=n;var a,o;if(i===void 0?a=rt.create(e,r):(o=X.is(i)?i:this._changeAnnotations.manage(i),a=rt.create(e,r,o)),this._workspaceEdit.documentChanges.push(a),o!==void 0)return o},t.prototype.renameFile=function(e,n,r,i){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var a;Pe.is(r)||X.is(r)?a=r:i=r;var o,s;if(a===void 0?o=it.create(e,n,i):(s=X.is(a)?a:this._changeAnnotations.manage(a),o=it.create(e,n,i,s)),this._workspaceEdit.documentChanges.push(o),s!==void 0)return s},t.prototype.deleteFile=function(e,n,r){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var i;Pe.is(n)||X.is(n)?i=n:r=n;var a,o;if(i===void 0?a=at.create(e,r):(o=X.is(i)?i:this._changeAnnotations.manage(i),a=at.create(e,r,o)),this._workspaceEdit.documentChanges.push(a),o!==void 0)return o},t}();var Or;(function(t){function e(r){return{uri:r}}t.create=e;function n(r){var i=r;return m.defined(i)&&m.string(i.uri)}t.is=n})(Or||(Or={}));var cn;(function(t){function e(r,i){return{uri:r,version:i}}t.create=e;function n(r){var i=r;return m.defined(i)&&m.string(i.uri)&&m.integer(i.version)}t.is=n})(cn||(cn={}));var Rt;(function(t){function e(r,i){return{uri:r,version:i}}t.create=e;function n(r){var i=r;return m.defined(i)&&m.string(i.uri)&&(i.version===null||m.integer(i.version))}t.is=n})(Rt||(Rt={}));var Ar;(function(t){function e(r,i,a,o){return{uri:r,languageId:i,version:a,text:o}}t.create=e;function n(r){var i=r;return m.defined(i)&&m.string(i.uri)&&m.string(i.languageId)&&m.integer(i.version)&&m.string(i.text)}t.is=n})(Ar||(Ar={}));var Q;(function(t){t.PlainText="plaintext",t.Markdown="markdown"})(Q||(Q={}));(function(t){function e(n){var r=n;return r===t.PlainText||r===t.Markdown}t.is=e})(Q||(Q={}));var It;(function(t){function e(n){var r=n;return m.objectLiteral(n)&&Q.is(r.kind)&&m.string(r.value)}t.is=e})(It||(It={}));var A;(function(t){t.Text=1,t.Method=2,t.Function=3,t.Constructor=4,t.Field=5,t.Variable=6,t.Class=7,t.Interface=8,t.Module=9,t.Property=10,t.Unit=11,t.Value=12,t.Enum=13,t.Keyword=14,t.Snippet=15,t.Color=16,t.File=17,t.Reference=18,t.Folder=19,t.EnumMember=20,t.Constant=21,t.Struct=22,t.Event=23,t.Operator=24,t.TypeParameter=25})(A||(A={}));var ot;(function(t){t.PlainText=1,t.Snippet=2})(ot||(ot={}));var dn;(function(t){t.Deprecated=1})(dn||(dn={}));var Wr;(function(t){function e(r,i,a){return{newText:r,insert:i,replace:a}}t.create=e;function n(r){var i=r;return i&&m.string(i.newText)&&O.is(i.insert)&&O.is(i.replace)}t.is=n})(Wr||(Wr={}));var Lr;(function(t){t.asIs=1,t.adjustIndentation=2})(Lr||(Lr={}));var pn;(function(t){function e(n){return{label:n}}t.create=e})(pn||(pn={}));var hn;(function(t){function e(n,r){return{items:n||[],isIncomplete:!!r}}t.create=e})(hn||(hn={}));var st;(function(t){function e(r){return r.replace(/[\\`*_{}[\]()#+\-.!]/g,"\\$&")}t.fromPlainText=e;function n(r){var i=r;return m.string(i)||m.objectLiteral(i)&&m.string(i.language)&&m.string(i.value)}t.is=n})(st||(st={}));var mn;(function(t){function e(n){var r=n;return!!r&&m.objectLiteral(r)&&(It.is(r.contents)||st.is(r.contents)||m.typedArray(r.contents,st.is))&&(n.range===void 0||O.is(n.range))}t.is=e})(mn||(mn={}));var Pr;(function(t){function e(n,r){return r?{label:n,documentation:r}:{label:n}}t.create=e})(Pr||(Pr={}));var jr;(function(t){function e(n,r){for(var i=[],a=2;a<arguments.length;a++)i[a-2]=arguments[a];var o={label:n};return m.defined(r)&&(o.documentation=r),m.defined(i)?o.parameters=i:o.parameters=[],o}t.create=e})(jr||(jr={}));var un;(function(t){t.Text=1,t.Read=2,t.Write=3})(un||(un={}));var fn;(function(t){function e(n,r){var i={range:n};return m.number(r)&&(i.kind=r),i}t.create=e})(fn||(fn={}));var ye;(function(t){t.File=1,t.Module=2,t.Namespace=3,t.Package=4,t.Class=5,t.Method=6,t.Property=7,t.Field=8,t.Constructor=9,t.Enum=10,t.Interface=11,t.Function=12,t.Variable=13,t.Constant=14,t.String=15,t.Number=16,t.Boolean=17,t.Array=18,t.Object=19,t.Key=20,t.Null=21,t.EnumMember=22,t.Struct=23,t.Event=24,t.Operator=25,t.TypeParameter=26})(ye||(ye={}));var Ur;(function(t){t.Deprecated=1})(Ur||(Ur={}));var gn;(function(t){function e(n,r,i,a,o){var s={name:n,kind:r,location:{uri:a,range:i}};return o&&(s.containerName=o),s}t.create=e})(gn||(gn={}));var bn;(function(t){function e(r,i,a,o,s,l){var p={name:r,detail:i,kind:a,range:o,selectionRange:s};return l!==void 0&&(p.children=l),p}t.create=e;function n(r){var i=r;return i&&m.string(i.name)&&m.number(i.kind)&&O.is(i.range)&&O.is(i.selectionRange)&&(i.detail===void 0||m.string(i.detail))&&(i.deprecated===void 0||m.boolean(i.deprecated))&&(i.children===void 0||Array.isArray(i.children))&&(i.tags===void 0||Array.isArray(i.tags))}t.is=n})(bn||(bn={}));var vn;(function(t){t.Empty="",t.QuickFix="quickfix",t.Refactor="refactor",t.RefactorExtract="refactor.extract",t.RefactorInline="refactor.inline",t.RefactorRewrite="refactor.rewrite",t.Source="source",t.SourceOrganizeImports="source.organizeImports",t.SourceFixAll="source.fixAll"})(vn||(vn={}));var yn;(function(t){function e(r,i){var a={diagnostics:r};return i!=null&&(a.only=i),a}t.create=e;function n(r){var i=r;return m.defined(i)&&m.typedArray(i.diagnostics,tt.is)&&(i.only===void 0||m.typedArray(i.only,m.string))}t.is=n})(yn||(yn={}));var wn;(function(t){function e(r,i,a){var o={title:r},s=!0;return typeof i=="string"?(s=!1,o.kind=i):je.is(i)?o.command=i:o.edit=i,s&&a!==void 0&&(o.kind=a),o}t.create=e;function n(r){var i=r;return i&&m.string(i.title)&&(i.diagnostics===void 0||m.typedArray(i.diagnostics,tt.is))&&(i.kind===void 0||m.string(i.kind))&&(i.edit!==void 0||i.command!==void 0)&&(i.command===void 0||je.is(i.command))&&(i.isPreferred===void 0||m.boolean(i.isPreferred))&&(i.edit===void 0||Dt.is(i.edit))}t.is=n})(wn||(wn={}));var Br;(function(t){function e(r,i){var a={range:r};return m.defined(i)&&(a.data=i),a}t.create=e;function n(r){var i=r;return m.defined(i)&&O.is(i.range)&&(m.undefined(i.command)||je.is(i.command))}t.is=n})(Br||(Br={}));var Vr;(function(t){function e(r,i){return{tabSize:r,insertSpaces:i}}t.create=e;function n(r){var i=r;return m.defined(i)&&m.uinteger(i.tabSize)&&m.boolean(i.insertSpaces)}t.is=n})(Vr||(Vr={}));var xn;(function(t){function e(r,i,a){return{range:r,target:i,data:a}}t.create=e;function n(r){var i=r;return m.defined(i)&&O.is(i.range)&&(m.undefined(i.target)||m.string(i.target))}t.is=n})(xn||(xn={}));var Sn;(function(t){function e(r,i){return{range:r,parent:i}}t.create=e;function n(r){var i=r;return i!==void 0&&O.is(i.range)&&(i.parent===void 0||t.is(i.parent))}t.is=n})(Sn||(Sn={}));var qr;(function(t){function e(a,o,s,l){return new Pa(a,o,s,l)}t.create=e;function n(a){var o=a;return!!(m.defined(o)&&m.string(o.uri)&&(m.undefined(o.languageId)||m.string(o.languageId))&&m.uinteger(o.lineCount)&&m.func(o.getText)&&m.func(o.positionAt)&&m.func(o.offsetAt))}t.is=n;function r(a,o){for(var s=a.getText(),l=i(o,function(y,k){var E=y.range.start.line-k.range.start.line;return E===0?y.range.start.character-k.range.start.character:E}),p=s.length,d=l.length-1;d>=0;d--){var f=l[d],b=a.offsetAt(f.range.start),u=a.offsetAt(f.range.end);if(u<=p)s=s.substring(0,b)+f.newText+s.substring(u,s.length);else throw new Error("Overlapping edit");p=b}return s}t.applyEdits=r;function i(a,o){if(a.length<=1)return a;var s=a.length/2|0,l=a.slice(0,s),p=a.slice(s);i(l,o),i(p,o);for(var d=0,f=0,b=0;d<l.length&&f<p.length;){var u=o(l[d],p[f]);u<=0?a[b++]=l[d++]:a[b++]=p[f++]}for(;d<l.length;)a[b++]=l[d++];for(;f<p.length;)a[b++]=p[f++];return a}})(qr||(qr={}));var Pa=function(){function t(e,n,r,i){this._uri=e,this._languageId=n,this._version=r,this._content=i,this._lineOffsets=void 0}return Object.defineProperty(t.prototype,"uri",{get:function(){return this._uri},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"languageId",{get:function(){return this._languageId},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"version",{get:function(){return this._version},enumerable:!1,configurable:!0}),t.prototype.getText=function(e){if(e){var n=this.offsetAt(e.start),r=this.offsetAt(e.end);return this._content.substring(n,r)}return this._content},t.prototype.update=function(e,n){this._content=e.text,this._version=n,this._lineOffsets=void 0},t.prototype.getLineOffsets=function(){if(this._lineOffsets===void 0){for(var e=[],n=this._content,r=!0,i=0;i<n.length;i++){r&&(e.push(i),r=!1);var a=n.charAt(i);r=a==="\r"||a===`
`,a==="\r"&&i+1<n.length&&n.charAt(i+1)===`
`&&i++}r&&n.length>0&&e.push(n.length),this._lineOffsets=e}return this._lineOffsets},t.prototype.positionAt=function(e){e=Math.max(Math.min(e,this._content.length),0);var n=this.getLineOffsets(),r=0,i=n.length;if(i===0)return K.create(0,e);for(;r<i;){var a=Math.floor((r+i)/2);n[a]>e?i=a:r=a+1}var o=r-1;return K.create(o,e-n[o])},t.prototype.offsetAt=function(e){var n=this.getLineOffsets();if(e.line>=n.length)return this._content.length;if(e.line<0)return 0;var r=n[e.line],i=e.line+1<n.length?n[e.line+1]:this._content.length;return Math.max(Math.min(r+e.character,i),r)},Object.defineProperty(t.prototype,"lineCount",{get:function(){return this.getLineOffsets().length},enumerable:!1,configurable:!0}),t}(),m;(function(t){var e=Object.prototype.toString;function n(u){return typeof u<"u"}t.defined=n;function r(u){return typeof u>"u"}t.undefined=r;function i(u){return u===!0||u===!1}t.boolean=i;function a(u){return e.call(u)==="[object String]"}t.string=a;function o(u){return e.call(u)==="[object Number]"}t.number=o;function s(u,y,k){return e.call(u)==="[object Number]"&&y<=u&&u<=k}t.numberRange=s;function l(u){return e.call(u)==="[object Number]"&&-2147483648<=u&&u<=2147483647}t.integer=l;function p(u){return e.call(u)==="[object Number]"&&0<=u&&u<=2147483647}t.uinteger=p;function d(u){return e.call(u)==="[object Function]"}t.func=d;function f(u){return u!==null&&typeof u=="object"}t.objectLiteral=f;function b(u,y){return Array.isArray(u)&&u.every(y)}t.typedArray=b})(m||(m={}));var ze=class{constructor(e,n,r,i){this._uri=e,this._languageId=n,this._version=r,this._content=i,this._lineOffsets=void 0}get uri(){return this._uri}get languageId(){return this._languageId}get version(){return this._version}getText(e){if(e){let n=this.offsetAt(e.start),r=this.offsetAt(e.end);return this._content.substring(n,r)}return this._content}update(e,n){for(let r of e)if(ze.isIncremental(r)){let i=Jr(r.range),a=this.offsetAt(i.start),o=this.offsetAt(i.end);this._content=this._content.substring(0,a)+r.text+this._content.substring(o,this._content.length);let s=Math.max(i.start.line,0),l=Math.max(i.end.line,0),p=this._lineOffsets,d=Gr(r.text,!1,a);if(l-s===d.length)for(let b=0,u=d.length;b<u;b++)p[b+s+1]=d[b];else d.length<1e4?p.splice(s+1,l-s,...d):this._lineOffsets=p=p.slice(0,s+1).concat(d,p.slice(l+1));let f=r.text.length-(o-a);if(f!==0)for(let b=s+1+d.length,u=p.length;b<u;b++)p[b]=p[b]+f}else if(ze.isFull(r))this._content=r.text,this._lineOffsets=void 0;else throw new Error("Unknown change event received");this._version=n}getLineOffsets(){return this._lineOffsets===void 0&&(this._lineOffsets=Gr(this._content,!0)),this._lineOffsets}positionAt(e){e=Math.max(Math.min(e,this._content.length),0);let n=this.getLineOffsets(),r=0,i=n.length;if(i===0)return{line:0,character:e};for(;r<i;){let o=Math.floor((r+i)/2);n[o]>e?i=o:r=o+1}let a=r-1;return{line:a,character:e-n[a]}}offsetAt(e){let n=this.getLineOffsets();if(e.line>=n.length)return this._content.length;if(e.line<0)return 0;let r=n[e.line],i=e.line+1<n.length?n[e.line+1]:this._content.length;return Math.max(Math.min(r+e.character,i),r)}get lineCount(){return this.getLineOffsets().length}static isIncremental(e){let n=e;return n!=null&&typeof n.text=="string"&&n.range!==void 0&&(n.rangeLength===void 0||typeof n.rangeLength=="number")}static isFull(e){let n=e;return n!=null&&typeof n.text=="string"&&n.range===void 0&&n.rangeLength===void 0}},Fe;(function(t){function e(i,a,o,s){return new ze(i,a,o,s)}t.create=e;function n(i,a,o){if(i instanceof ze)return i.update(a,o),i;throw new Error("TextDocument.update: document must be created by TextDocument.create")}t.update=n;function r(i,a){let o=i.getText(),s=Cn(a.map(ja),(d,f)=>{let b=d.range.start.line-f.range.start.line;return b===0?d.range.start.character-f.range.start.character:b}),l=0,p=[];for(let d of s){let f=i.offsetAt(d.range.start);if(f<l)throw new Error("Overlapping edit");f>l&&p.push(o.substring(l,f)),d.newText.length&&p.push(d.newText),l=i.offsetAt(d.range.end)}return p.push(o.substr(l)),p.join("")}t.applyEdits=r})(Fe||(Fe={}));function Cn(t,e){if(t.length<=1)return t;let n=t.length/2|0,r=t.slice(0,n),i=t.slice(n);Cn(r,e),Cn(i,e);let a=0,o=0,s=0;for(;a<r.length&&o<i.length;)e(r[a],i[o])<=0?t[s++]=r[a++]:t[s++]=i[o++];for(;a<r.length;)t[s++]=r[a++];for(;o<i.length;)t[s++]=i[o++];return t}function Gr(t,e,n=0){let r=e?[n]:[];for(let i=0;i<t.length;i++){let a=t.charCodeAt(i);(a===13||a===10)&&(a===13&&i+1<t.length&&t.charCodeAt(i+1)===10&&i++,r.push(n+i+1))}return r}function Jr(t){let e=t.start,n=t.end;return e.line>n.line||e.line===n.line&&e.character>n.character?{start:n,end:e}:t}function ja(t){let e=Jr(t.range);return e!==t.range?{newText:t.newText,range:e}:t}var _t;(function(t){t.EN_US="en_US",t.EN_GB="en_GB"})(_t||(_t={}));var Yr;(function(t){t.LATEST={textDocument:{completion:{completionItem:{documentationFormat:[Q.Markdown,Q.PlainText]}},hover:{contentFormat:[Q.Markdown,Q.PlainText]}}}})(Yr||(Yr={}));var Hr;(function(t){t[t.Unknown=0]="Unknown",t[t.File=1]="File",t[t.Directory=2]="Directory",t[t.SymbolicLink=64]="SymbolicLink"})(Hr||(Hr={}));var Kr=["implict_control_flow","choice_randomtest","choice_quicktest"];var Gs=ce(),kn=ot.Snippet,ne;(function(t){t.Enums=" ",t.Normal="d",t.VendorPrefixed="x",t.Term="y",t.Label="x",t.Variable="z"})(ne||(ne={}));var Xr=function(){function t(e,n){e===void 0&&(e=null),this.variablePrefix=e,this.clientCapabilities=n,this.completionParticipants=[],this.typo=null,this.valueTypes=[h.Identifier,h.Value,h.StringLiteral,h.NumericValue,h.HexColorValue,h.PrintVariable];var r="test/dictionaries/"}return t.prototype.configure=function(e){this.settings=e},t.prototype.getSymbolContext=function(e){if(!e&&!this.symbolContext)this.symbolContext=new H(this.scene);else if(e)return new H(e);return this.symbolContext},t.prototype.setCompletionParticipants=function(e){this.completionParticipants=e||[]},t.prototype.doComplete=function(e,n,r,i){var a=this;i===void 0&&(i=!0),this.offset=e.offsetAt(n),this.position=n,this.currentWord=Ua(e,this.offset),this.defaultReplaceRange=O.create(K.create(this.position.line,this.position.character-this.currentWord.length),this.position),this.textDocument=e,this.scene=r;var o={isIncomplete:!1,items:[]};try{this.nodePath=ut(this.scene,this.offset);for(var s=this.nodePath.length-1;s>=0;s--){var l=this.nodePath[s],p=l.findParent(h.VariableDeclaration);if(p)return this.getCompletionsForVariableDeclaration(p,e.uri,o),new Promise(function(d,f){d(a.finalize(o))});if(l.type===h.LabelRef)return this.getLabelProposals(l,e.uri,o),new Promise(function(d,f){d(a.finalize(o))});if(l.type===h.SceneRef)return this.getSceneProposals(l,e.uri,o),new Promise(function(d,f){d(a.finalize(o))});if(l.type===h.Identifier)return this.getVariableProposals(l,e.uri,o),new Promise(function(d,f){d(a.finalize(o))});if(l.type===h.Variable)return this.getVariableProposals(l,e.uri,o),new Promise(function(d,f){d(a.finalize(o))});if(l.hasIssue(x.UnknownCommand))return this.getCompletionsForCommands(o),new Promise(function(d,f){d(a.finalize(o))})}}finally{this.position=null,this.currentWord=null,this.textDocument=null,this.scene=null,this.symbolContext=null,this.defaultReplaceRange=null,this.nodePath=null}return new Promise(function(d,f){d(a.finalize(o))})},t.prototype.isImportPathParent=function(e){return e===h.Import},t.prototype.finalize=function(e){var n=e.items.some(function(r){return!!r.sortText||r.label[0]==="-"});return n&&e.items.forEach(function(r,i){r.sortText?r.label[0]==="-"?r.sortText+=ne.VendorPrefixed+"_"+Tt(i):r.sortText+=ne.Normal+"_"+Tt(i):r.label[0]==="-"?r.sortText=ne.VendorPrefixed+"_"+Tt(i):r.sortText=ne.Normal+"_"+Tt(i)}),e},t.prototype.findInNodePath=function(){for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n];for(var r=this.nodePath.length-1;r>=0;r--){var i=this.nodePath[r];if(e.indexOf(i.type)!==-1)return i}return null},t.prototype.getCompletionsForIdentifier=function(e){for(var n=this,r=et().filter(function(o){return n.currentWord.slice(0,1)===o.name.slice(0,1)}),i=0,a=r;i<a.length;i++)e.items.push({label:a[i].name,detail:"(command)",documentation:"TBD",textEdit:N.replace(this.getCompletionRange(null),a[i].name),kind:A.Keyword});return e},t.prototype.getCompletionsForCommands=function(e){for(var n=this,r=et().filter(function(o){return n.currentWord.slice(0,1)===o.name.slice(0,1)}),i=0,a=r;i<a.length;i++)e.items.push({label:a[i].name,detail:"(command)",documentation:a[i].description,textEdit:N.replace(this.getCompletionRange(null),a[i].name),kind:A.Keyword});return e},t.prototype.getSuggestionsForSpellings=function(e){var n=this,r=this,i=this.currentWord,a=this.getCompletionRange(null);return new Promise(function(o,s){n.typo.working?s(e):(n.typo.working=!0,n.typo.suggest(i,5,function(l){var p={items:[],isIncomplete:!1},d={label:"Ignore '"+i+"' this session.",documentation:"",textEdit:null,filterText:i,sortText:"b",insertText:i,kind:A.Property},f={label:"Add '"+i+"' to user dictionary.",documentation:"",textEdit:null,filterText:i,sortText:"c",insertText:i,kind:A.Property,command:{command:"editor.action.triggerSuggest",title:"123"}},b={label:"No spelling suggestions for '"+i+"'.",documentation:"",textEdit:null,insertText:i,kind:A.Keyword};l.length<1?p.items.push(b):p.items=p.items.concat(l.map(function(u){return{label:u,detail:"spelling suggestion",textEdit:N.replace(a,u),filterText:i,sortText:"a",insertText:u,kind:A.Text}})),p.items.push(d,f),r.typo.working=!1,o(p)}))})},t.prototype.getCSSWideKeywordProposals=function(e,n,r){for(var i in $t)r.items.push({label:i,documentation:$t[i],textEdit:N.replace(this.getCompletionRange(n),i),kind:A.Keyword});return r},t.prototype.getLabelProposals=function(e,n,r){var i=this,a,o,s,l=[],p=e,d;if(d=p.getSceneRef()){var f=(a=J.index.getProjectIndexForScene(n))===null||a===void 0?void 0:a.getSceneNodeByName(d.name);f&&(l=(o=this.getSymbolContext(f))===null||o===void 0?void 0:o.findSymbolsAtOffset(0,L.Label))}else l=this.getSymbolContext().findSymbolsAtOffset(0,L.Label);if(l=l.filter(function(D){return D.name.indexOf(e.getText())===0}),((s=this.settings)===null||s===void 0?void 0:s.cslib)&&d&&d.name){var b=Ce[d.name];if(b){var u=Object.keys(b);r.items=r.items.concat(u.map(function(D){var M,R=(M=b[D].params)===null||M===void 0?void 0:M.length,P="(subroutine) "+d.name+(R?": "+R+" parameter(s)":"");return{label:D,documentation:b[D].lines.join(`
`),detail:P,textEdit:N.replace(i.getCompletionRange(e),D),kind:A.Function,sortText:ne.Label}}))}}for(var y=0,k=l;y<k.length;y++){var E=k[y],z={label:E.name,documentation:E.value?kt(E.value):E.value,detail:"(label)",textEdit:N.replace(this.getCompletionRange(e),E.name),kind:A.Function,sortText:ne.Label};r.items.push(z)}return r},t.prototype.getSceneProposals=function(e,n,r){var i,a,o=(i=J.index.getProjectIndexForScene(n))===null||i===void 0?void 0:i.getSceneList();if(!o)return r;!((a=this.settings)===null||a===void 0)&&a.cslib&&(o=o.concat(kr)),o=o.filter(function(f){return f.indexOf(e.getText())===0});for(var s=0,l=o;s<l.length;s++){var p=l[s],d={label:p,documentation:"",detail:/^cslib_.*$/.test(p)?"(scene) ChoiceScript Library":"(scene)",textEdit:N.replace(this.getCompletionRange(e),p),kind:A.File,sortText:ne.Normal};r.items.push(d)}return r},t.prototype.getVariableProposals=function(e,n,r){var i=this,a,o=[],s=[];s=this.getSymbolContext().findSymbolsAtOffset(0,L.Variable);var l=(a=J.index.getProjectIndexForScene(n))===null||a===void 0?void 0:a.getSceneNodeByName("startup");l&&(o=this.getSymbolContext(l).findSymbolsAtOffset(0,L.Variable));var p=Kr.filter(function(z){return z.indexOf(e.getText())===0}),d=p.map(function(z){return{label:z,detail:"(internal variable) global",textEdit:N.replace(i.getCompletionRange(e),z),kind:A.Variable,sortText:ne.Variable}});r.items=r.items.concat(d),s=s.filter(function(z){return z.name.indexOf(e.getText())===0}),o=o.filter(function(z){return z.name.indexOf(e.getText())===0});for(var f=0,b=s;f<b.length;f++){var u=b[f],y={label:u.name,documentation:u.value?kt(u.value):u.value,detail:"(variable) local",textEdit:N.replace(this.getCompletionRange(e),u.name),kind:A.Variable,sortText:ne.Variable};r.items.push(y)}for(var k=0,E=o;k<E.length;k++){var u=E[k],y={label:u.name,documentation:u.value?kt(u.value):u.value,detail:"(variable) global",textEdit:N.replace(this.getCompletionRange(e),u.name),kind:A.Variable,sortText:ne.Variable};r.items.push(y)}return r},t.prototype.getUnitProposals=function(e,n,r){var i="0";if(this.currentWord.length>0){var a=this.currentWord.match(/^-?\d[\.\d+]*/);a&&(i=a[0],r.isIncomplete=i.length===this.currentWord.length)}else this.currentWord.length===0&&(r.isIncomplete=!0);if(n&&n.parent&&n.parent.type===h.Term&&(n=n.getParent()),e.restrictions)for(var o=0,s=e.restrictions;o<s.length;o++){var l=s[o],p=Fr[l];if(p)for(var d=0,f=p;d<f.length;d++){var b=f[d],u=i+b;r.items.push({label:u,textEdit:N.replace(this.getCompletionRange(n),u),kind:A.Unit})}}return r},t.prototype.getCompletionRange=function(e){if(e&&e.offset<=this.offset&&this.offset<=e.end){var n=e.end!==-1?this.textDocument.positionAt(e.end):this.position,r=this.textDocument.positionAt(e.offset);if(r.line===n.line)return O.create(r,n)}return this.defaultReplaceRange},t.prototype.getPositionProposals=function(e,n,r){for(var i in Yt)r.items.push({label:i,documentation:Yt[i],textEdit:N.replace(this.getCompletionRange(n),i),kind:A.Value});return r},t.prototype.getRepeatStyleProposals=function(e,n,r){for(var i in Ht)r.items.push({label:i,documentation:Ht[i],textEdit:N.replace(this.getCompletionRange(n),i),kind:A.Value});return r},t.prototype.getLineStyleProposals=function(e,n,r){for(var i in Kt)r.items.push({label:i,documentation:Kt[i],textEdit:N.replace(this.getCompletionRange(n),i),kind:A.Value});return r},t.prototype.getLineWidthProposals=function(e,n,r){for(var i=0,a=zr;i<a.length;i++){var o=a[i];r.items.push({label:o,textEdit:N.replace(this.getCompletionRange(n),o),kind:A.Value})}return r},t.prototype.getGeometryBoxProposals=function(e,n,r){for(var i in Zt)r.items.push({label:i,documentation:Zt[i],textEdit:N.replace(this.getCompletionRange(n),i),kind:A.Value});return r},t.prototype.getBoxProposals=function(e,n,r){for(var i in Xt)r.items.push({label:i,documentation:Xt[i],textEdit:N.replace(this.getCompletionRange(n),i),kind:A.Value});return r},t.prototype.getImageProposals=function(e,n,r){for(var i in Qt){var a=zn(i);r.items.push({label:i,documentation:Qt[i],textEdit:N.replace(this.getCompletionRange(n),a),kind:A.Function,insertTextFormat:i!==a?kn:void 0})}return r},t.prototype.getTimingFunctionProposals=function(e,n,r){for(var i in en){var a=zn(i);r.items.push({label:i,documentation:en[i],textEdit:N.replace(this.getCompletionRange(n),a),kind:A.Function,insertTextFormat:i!==a?kn:void 0})}return r},t.prototype.getBasicShapeProposals=function(e,n,r){for(var i in tn){var a=zn(i);r.items.push({label:i,documentation:tn[i],textEdit:N.replace(this.getCompletionRange(n),a),kind:A.Function,insertTextFormat:i!==a?kn:void 0})}return r},t.prototype.getCompletionsForVariableDeclaration=function(e,n,r){return e.hasIssue(x.VariableNameExpected)&&this.getVariableProposals(e.getExpr(),n,r),r},t.prototype.getCompletionForUriLiteralValue=function(e,n){var r,i,a;if(e.hasChildren()){var s=e.getChild(0);r=s.getText(),i=this.position,a=this.getCompletionRange(s)}else{r="",i=this.position;var o=this.textDocument.positionAt(e.offset+4);a=O.create(o,o)}return this.completionParticipants.forEach(function(l){l.onCssURILiteralValue&&l.onCssURILiteralValue({uriValue:r,position:i,range:a})}),n},t.prototype.getCompletionForImportPath=function(e,n){var r=this;return this.completionParticipants.forEach(function(i){i.onCssImportPath&&i.onCssImportPath({pathValue:e.getText(),position:r.position,range:r.getCompletionRange(e)})}),n},t.prototype.doesSupportMarkdown=function(){if(!Le(this.supportsMarkdown)){if(!Le(this.clientCapabilities))return this.supportsMarkdown=!0,this.supportsMarkdown;var e=this.clientCapabilities.textDocument&&this.clientCapabilities.textDocument.completion;this.supportsMarkdown=e&&e.completionItem&&Array.isArray(e.completionItem.documentationFormat)&&e.completionItem.documentationFormat.indexOf(Q.Markdown)!==-1}return this.supportsMarkdown},t}();function Tt(t){var e=t.toString();switch(e.length){case 4:return e;case 3:return"0"+e;case 2:return"00"+e;case 1:return"000"+e;default:return"0000"}}var Js=function(){function t(){this.entries={}}return t.prototype.add=function(e){this.entries[e]=!0},t.prototype.getEntries=function(){return Object.keys(this.entries)},t}();function zn(t){return t.replace(/\(\)$/,"($1)")}function Ua(t,e){for(var n=e-1,r=t.getText();n>=0&&` 	
\r":{[()]},*>+`.indexOf(r.charAt(n))===-1;)n--;return r.substring(n+1,e)}var Zr=function(){function t(e){this.clientCapabilities=e}return t.prototype.doHover=function(e,n,r){function i(M){return O.create(e.positionAt(M.offset),e.positionAt(M.end))}for(var a=e.offsetAt(n),o=ut(r,a),s=null,l=0;l<o.length;l++){var p=o[l];if(p instanceof Ie){s={contents:["**Label**: "+p.getValue()],range:i(p)};var d=p.findAParent(h.GosubCommand,h.GotoCommand);if(d){var f=p.getValue(),b="",u=void 0,y=void 0;switch(d.name){case"gosub":case"goto":b=e.uri.slice(e.uri.lastIndexOf("/")+1,-4);break;case"gosub_scene":case"goto_scene":var k=d.getSceneRef();if(!k)return null;b=k.name||"";break;default:return null}(u=Ce[b])&&(y=u[f])&&s.contents.push(y.lines.join(`
`))}break}if(p instanceof j){var E=p.name,z=et(),D=z.map(function(M){return M.name}).indexOf(E);D!==-1&&(s={contents:z[D].description,range:i(p)});continue}}return s&&(s.contents=this.convertContents(s.contents)),s},t.prototype.convertContents=function(e){return this.doesSupportMarkdown()||typeof e=="string"?e:"kind"in e?{kind:"plaintext",value:e.value}:Array.isArray(e)?e.map(function(n){return typeof n=="string"?n:n.value}):e.value},t.prototype.doesSupportMarkdown=function(){if(!Le(this.supportsMarkdown)){if(!Le(this.clientCapabilities))return this.supportsMarkdown=!0,this.supportsMarkdown;var e=this.clientCapabilities.textDocument&&this.clientCapabilities.textDocument.hover;this.supportsMarkdown=e&&e.contentFormat&&Array.isArray(e.contentFormat)&&e.contentFormat.indexOf(Q.Markdown)!==-1}return this.supportsMarkdown},t}();var $r=function(){function t(){}return t.prototype.findSceneDefinition=function(e,n){var r=J.index.sync(e.uri),i=r?.getSceneDocByName(n.getText());return i?{uri:i.uri,range:O.create(K.create(0,0),K.create(0,0))}:null},t.prototype.getRoutineInfo=function(e,n,r){function i(I,_){var T=new H(I).findSymbol(_,L.Label,0);if(!T)return null;var W=T.node.findParent(h.Line),q=W.getNextSibling();if(!q)return null;var Z=q.getChild(0);return Z&&Z.type===h.ParamsCommand?Z:null}function a(I,_,T){var W=I.getParameterList();if(!W)return 0;var q=W.getChildren();if(q.length<1)return 0;if(!_)return q.length<T?q.length-1:T-1;var Z=q.indexOf(_);return Z<0||Z>=T?T-1:Z}function o(I){return I?typeof I.name>"u"?"":I.name:e.uri.slice(e.uri.lastIndexOf("/")+1,-4)}function s(I,_){var T;switch(_?.type){case h.Scene:_=(T=_.getChild(_.getChildren().length-1))===null||T===void 0?void 0:T.getChild(0);break;case h.Line:_=_.getChild(0);break;case null:case void 0:return null;default:_=_.findParent(h.GosubCommand);break}return!_||_.type!==h.GosubCommand?null:_}var l=J.index.getProjectIndexForScene(e.uri);if(!l)return null;var p=Re(r,n),d=p?.findAParent(h.Param),f=s(r,p);if(!f)return null;var b=f.getSceneRef();if(!b)return null;var u=f.getLabelRef();if(!u||typeof u.name>"u")return null;var y=o(b),k=u.name,E,z={activeParameter:0,activeSignature:0,parameters:[]};if(/^cslib_\w+/.test(y)&&(E=Ce[y])&&E[k].params)return z.parameters=E[k].params,z.activeParameter=a(f,d,z.parameters.length),z;if(!y||!k)return null;var D=l.getSceneNodeByName(y);if(!D)return null;var M=i(D,k);if(!M)return null;for(var R=M.getVariableCount(),P=0;P<R;P++)z.parameters.push({label:M.getVariable(P).getName()});return z.activeParameter=a(f,d,R),z},t.prototype.findParameters=function(e,n,r){var i=[],a=J.index.getProjectIndexForScene(e.uri),o=a?.getSceneNodeByName(n);if(!o)return null;var s=new H(o).findSymbol(r,L.Label,0);if(!s)return null;var l=s.node.findParent(h.Line),p=l.getNextSibling();if(!p)return null;var d=p.getChild(0);if(d?.type===h.ParamsCommand){for(var f=d,b=f.getVariableCount(),u=0;u<b;u++)i.push(f.getVariable(u).getName());return i}else return null},t.prototype.findSceneLabelDefinition=function(e,n){var r=n.parent,i=r.getSceneRef();if(i&&i.hasChildren()&&i.getChildren()[0].type===h.Scene){var a=i.getChildren()[0].getText(),o=J.index.sync(e.uri),s=o?.getSceneNodeByName(a),l=o?.getSceneDocByName(a);if(!s||!s)return null;var p=new H(s).findSymbol(n.getText(),L.Label,0);if(p)return{uri:l.uri,range:Ee(p.node,l)}}return null},t.prototype.findDefinitionGlobal=function(e,n,r){var i;function a(f){var b=J.index.sync(e.uri),u=b?.getSceneDocByName("startup"),y=b?.getSceneNodeByName("startup");if(u&&y){var k=new H(y),E=k.findSymbol(f.getText(),L.Variable,0);if(E)return{uri:u.uri,range:Ee(E.node,u)}}return null}var o=new H(r),s=e.offsetAt(n),l=Re(r,s);if(l){if(l.type===h.Scene)return this.findSceneDefinition(e,l);if(l.type===h.Label&&((i=l.parent)===null||i===void 0?void 0:i.type)===h.LabelRef){var p=this.findSceneLabelDefinition(e,l);if(p)return p}var d=o.findSymbolFromNode(l);return d?{uri:e.uri,range:Ee(d.node,e)}:a(l)}return null},t.prototype.findDefinition=function(e,n,r){var i=new H(r),a=e.offsetAt(n),o=Re(r,a);if(!o)return null;var s=i.findSymbolFromNode(o);return s?{uri:e.uri,range:Ee(s.node,e)}:null},t.prototype.findReferences=function(e,n,r){var i=[],a=J.index.sync(e.uri);if(!a)return i;var o=e.offsetAt(n),s=Re(r,o);if(!s||s.type===h.Scene||s.type===h.VariableDeclaration)return i;var l=new H(r),p=l.findSymbolFromNode(s);if(!p)return i;if(a)for(var d=function(z,D){return function(M){var R;return D.matchesSymbol(M,p)?(((R=M.parent)===null||R===void 0?void 0:R.type)===h.VariableDeclaration||i.push({uri:z.uri,range:Ee(M,z)}),!1):!0}},f=0,b=a.getSceneList();f<b.length;f++){var u=b[f],y=a.getSceneNodeByName(u),k=a.getSceneDocByName(u);if(!(!k||!y)){var E=new H(y);y.accept(d(k,E))}}return i},t.prototype.findDocumentSymbols=function(e,n,r){r===void 0&&(r=!1);var i=[],a=function(p){return function(d){var f=[];function b(R,P){return P===void 0&&(P=ye.Object),{name:R,kind:P,location:null}}if(d instanceof vt){for(var u=0,y=d.getChildren();u<y.length;u++){var k=y[u],E=k,z=b(E.getName(),ye.Variable);z.location=ke.create(p.uri,Ee(d,p)),i.push(z)}return!0}var D,M=d;return d instanceof yt?D=b(d.getName(),ye.Variable):d instanceof wt&&(D=b(d.getLabel().name,ye.Function)),D&&(D.location=ke.create(p.uri,Ee(M,p)),i.push(D)),!0}};if(r){var o=J.index.sync(e.uri),s=o?.getSceneNodeByName("startup"),l=o?.getSceneDocByName("startup");s&&l&&s.accept(a(l))}return n.accept(a(e)),i},t}();function Ee(t,e){return O.create(e.positionAt(t.offset),e.positionAt(t.end))}function Fn(t){if(typeof Window>"u"&&typeof XMLHttpRequest>"u")return ca("fs").readFileSync(t).toString();var e=new XMLHttpRequest;return e.open("GET",t,!1),e.overrideMimeType&&e.overrideMimeType("text/plain; charset=utf-8"),e.send(null),e.responseText}var ee=ce(),Ue=V.Warning,Be=V.Error,il=V.Ignore,re=function(){function t(e,n,r){this.id=e,this.message=n,this.defaultValue=r}return t}();var Qr=function(){function t(e,n,r){this.id=e,this.message=n,this.defaultValue=r}return t}();var Y={ReservedVariablePrefix:new re("reservedWord",ee("rule.reservedWord","This is a reserved word and cannot be used as a variable name."),Be),ReservedWord:new re("reservedVariablePrefix",ee("rule.reservedVariablePrefix","You cannot create variables with the reserved 'choice_' prefix."),Be),DuplicateUniqueCommand:new re("duplicateUniqueCommand",ee("rule.duplicateUniqueCommand","You only need to execute this command once."),Ue),UnusualStatsCommand:new re("unusualStats",ee("rule.unusualStatCommand","Unexpected use of a scene navigation command from within choicescript_stats.txt."),Ue),ConstError:new re("constError",ee("rule.constError","Assignment to a constant variable."),Ue),TypeError:new re("typeError",ee("rule.typeError","Assignment of a value type that does not match the definition type."),Ue),ScriptCommandUnsupported:new re("scriptCommandUnsupported",ee("rule.scriptCommandUnsupported","The *script command is not supported."),Be),InvalidInitialCommand:new re("invalidInitialCommand",ee("rule.invalidInitialCommand","This command is only allowed at the top of startup.txt."),Be),InvalidIfId:new re("invalidIfId",ee("rule.invalidIfId","An IFID should have five parts (e.g. a0a0a0a0-a0a0-a0a0-a0a0-a0a0a0a0a0a0) and consist only of the letters A-F, numbers, and dashes."),Be),DeprecatedCommand:new re("deprecatedCommand",ee("rule.deprecatedCommand","This command has been deprecated and may be removed in the future."),Ue),DeprecatedOperatorPercent:new re("DeprecatedOperatorPercent",ee("rule.deprecatedOperatorPercent","The percent '%' operator has been removed in favour of 'modulo'."),Be),BadSpelling:new re("badSpelling",ee("rule.badSpelling","Bad spelling."),Ue)},al={TypeSafety:new Qr("typeSafety",ee("setting.typeSafety","Error on type conflict"),!1),ValidProperties:new Qr("validProperties",ee("rule.validProperties","A list of properties that are not validated against the `unknownProperties` rule."),[])},ei=function(){function t(e){e===void 0&&(e={}),this.conf=e}return t.prototype.getRule=function(e){if(this.conf.hasOwnProperty(e.id)){var n=Ba(this.conf[e.id]);if(n!==null)return n}return e.defaultValue},t.prototype.getSetting=function(e){return this.conf[e.id]},t}();function Ba(t){switch(t){case"ignore":return V.Ignore;case"warning":return V.Warning;case"error":return V.Error}return null}var ti=ce(),ni=5,ll=function(){function t(){this.data={}}return t.prototype.add=function(e,n,r){var i=this.data[e];i||(i={nodes:[],names:[]},this.data[e]=i),i.names.push(n),r&&i.nodes.push(r)},t}(),ri=function(){function t(e,n,r){this.misspellings=[],this.userDics={persistent:{},session:{}},this.documentText=e.getText(),this.nspell=n,this.userDics=r||this.userDics}return t.entries=function(e,n,r,i){var a=new t(n,r,i);return e.acceptVisitor(a),a.getEntries()},t.prototype.findValueInExpression=function(e,n){var r=!1;return e.accept(function(i){return i.type===h.Identifier&&i.getText()===n&&(r=!0),!r}),r},t.prototype.getEntries=function(){return this.misspellings},t.prototype.addEntry=function(e,n,r){var i=new Me(e,n,V.Information,r,e.offset,e.length);this.misspellings.push(i)},t.prototype.getMissingNames=function(e,n){e=e.slice(0);for(var r=0;r<n.length;r++){var i=e.indexOf(n[r]);i!==-1&&(e[i]=null)}for(var a=null,r=0;r<e.length;r++){var o=e[r];o&&(a===null?a=ti("namelist.single","'{0}'",o):a=ti("namelist.concatenated","{0}, '{1}'",a,o))}return a},t.prototype.wordInUserDics=function(e){e=e.toLowerCase();for(var n in this.userDics)if(this.userDics[n][e])return!0;return!1},t.prototype.visitNode=function(e){switch(e.type){case h.Scene:return this.visitScene(e);case h.TextLine:return!0;case h.RealWord:return this.visitWord(e);case h.VariableReplacement:return!0;case h.Expression:return!0;case h.StringLiteral:return!0;case h.MultiReplace:return!0;case h.MultiReplaceOption:return!0;default:return!0}},t.prototype.visitScene=function(e){return!0},t.prototype.visitWord=function(e){var n=e.getText();return this.nspell.correct(n)||this.addEntry(e,Y.BadSpelling,"Bad spelling: "+e.getText()),!0},t.prefixes=["-ms-","-moz-","-o-","-webkit-"],t}();var fl=ce(),ii=function(){function t(e,n){var r;this.warnings=[],this.globalVars=null,this.settings=n,this.documentText=e.getText(),this.document=e,this.startupScene=(r=J.index.getProjectIndexForScene(e.uri))===null||r===void 0?void 0:r.getSceneNodeByName("startup"),this.startupScene&&(this.globalVars=new H(this.startupScene))}return t.entries=function(e,n,r,i){var a=new t(n,r);return e.acceptVisitor(a),a.completeValidations(),a.getEntries(i)},t.prototype.getEntries=function(e){return e===void 0&&(e=V.Warning|V.Error),this.warnings.filter(function(n){return(n.getLevel()&e)!==0})},t.prototype.addEntry=function(e,n,r){var i=new Me(e,n,this.settings.getRule(n),r);this.warnings.push(i)},t.prototype.visitNode=function(e){switch(e.type){case h.Scene:return this.visitScene(e);case h.VariableDeclaration:return this.visitVariableDeclaration(e);case h.StandardCommand:case h.JumpCommand:case h.GotoCommand:case h.GosubCommand:case h.IfIdCommand:case h.Command:return this.visitCommand(e);case h.Operator:return this.visitOperator(e)}return!0},t.prototype.completeValidations=function(){},t.prototype.visitScene=function(e){return this.lintInitialCommands(e),e.isStartup()&&this.lintUniqueCommands(e),e.isStats()&&this.lintChoiceScriptStats(e),!0},t.prototype.visitVariableDeclaration=function(e){var n,r=(n=e.getVariable())===null||n===void 0?void 0:n.getName();if(r)/^choice_/.test(r)?this.addEntry(e,Y.ReservedVariablePrefix):vr.indexOf(r)>=0&&this.addEntry(e,Y.ReservedWord);else return!0;return!0},t.prototype.visitCommand=function(e){var n,r;if(e.name==="script"&&this.addEntry(e,Y.ScriptCommandUnsupported),$e[e.name]&&$e[e.name].type===g.Deprecated&&this.addEntry(e,Y.DeprecatedCommand),e instanceof lr,e instanceof bt){var i=e,a=i.getVariable(),o=i.getExpr();if(a&&o){var s=J.index.getProjectIndexForScene(this.document.uri);if(s){var l=s.getSceneSymbolsByName("startup"),p=l?.findSymbol(a.getText(),L.Variable,0);if(p){var d=p.node;!((n=d.getVariable())===null||n===void 0)&&n.const&&this.addEntry(e,Y.ConstError),o?.csType!==((r=d.getExpr())===null||r===void 0?void 0:r.csType)&&this.addEntry(e,Y.TypeError)}}}}return!0},t.prototype.visitOperator=function(e){return e.getText()==="%"&&this.addEntry(e,Y.DeprecatedOperatorPercent),!1},t.prototype.lintInitialCommands=function(e){for(var n=!!e.isStartup(),r=0,i=e.getChildren();r<i.length;r++){var a=i[r];if(a.type===h.Line){{var o=a;if(o.getLineType()!==$.ChoiceScript)continue}for(var s=void 0,l=0;(s=a.getChild(l++))&&!(s instanceof j););if(s instanceof j){if(s&&s.hasIssue(x.UnknownCommand))continue;if(s&&s.name==="comment")continue}else continue;var p=$e[s.name];p.type===g.Initial&&!n?this.addEntry(s,Y.InvalidInitialCommand):p.type!==g.Initial&&(n=!1)}}},t.prototype.lintChoiceScriptStats=function(e){for(var n=0,r=e.getChildren();n<r.length;n++){var i=r[n];if(i.type===h.Line){{var a=i;if(a.getLineType()!==$.ChoiceScript)continue}for(var o=void 0,s=0;(o=i.getChild(s++))&&!(o instanceof j););if(o instanceof j){var l=o;switch(l.name){case"finish":case"goto_scene":case"ending":this.addEntry(l,Y.UnusualStatsCommand);default:break}}}}},t.prototype.lintUniqueCommands=function(e){for(var n={author:!1,scene_list:!1,title:!1,ifid:!1},r=0,i=e.getChildren();r<i.length;r++){var a=i[r];if(a.type===h.Line){{var o=a;if(o.getLineType()!==$.ChoiceScript)continue}for(var s=void 0,l=0;(s=a.getChild(l++))&&!(s instanceof j););if(s instanceof j){var p=s;if(p.name==="ifid"&&p.type===h.IfIdCommand){var d=p;d.isValid()||this.addEntry(p,Y.InvalidIfId)}if(typeof n[p.name]=="boolean"){if(!n[p.name]){n[p.name]=!0;continue}this.addEntry(p,Y.DuplicateUniqueCommand)}}}}},t.prefixes=["-ms-","-moz-","-o-","-webkit-"],t}();var Zi=pa(Xi()),$i=function(){function t(){this.settings={validate:!0,spellcheck:{paths:{affix:"",dics:[]},enabled:!1,dictionary:_t.EN_US,userDictionaries:{session:{},persistent:{}}},lint:{}},this.nspell=null}return t.prototype.configure=function(e){if(this.settings=e,this.settings.spellcheck.enabled&&this.settings.spellcheck.paths.affix){var n=this.loadDictionaryData(this.settings.spellcheck.paths);if(n){this.nspell=(0,Zi.default)(n);for(var r in this.settings.spellcheck.userDictionaries)this.nspell.personal(this.parseUserDictionary(this.settings.spellcheck.userDictionaries[r]))}}},t.prototype.parseUserDictionary=function(e){var n=[];for(var r in e)e[r]?n.push(r):n.push("*"+r);return n.join(`
`)},t.prototype.loadDictionaryData=function(e){if(!(!this.settings&&this.settings.spellcheck.enabled)){var n=Fn(e.affix),r=Fn(e.dics[0]);return{aff:n,dic:r}}},t.prototype.suggestSpelling=function(e){var n,r=this,i=[],a=((n=this.settings)===null||n===void 0?void 0:n.spellcheck.suggestLimit)||ni;if(!r.nspell)i.push(new Promise(function(d,f){d([])}));else for(var o=function(d){i.push(new Promise(function(f,b){var u=r.nspell.suggest(d).slice(0,a);f(u)}))},s=0,l=e;s<l.length;s++){var p=l[s];o(p)}return Promise.all(i)},t.prototype.addWordsToDictionary=function(e){var n=this,r=[];if(n.nspell)for(var i=function(l){r.push(new Promise(function(p,d){var f;n.nspell.add(l),p(!((f=n.nspell)===null||f===void 0)&&f.correct(l)?l:"")}))},a=0,o=e;a<o.length;a++){var s=o[a];i(s)}else return new Promise(function(l,p){l([])});return Promise.all(r)},t.prototype.removeWordsFromDictionary=function(e){var n=this,r=[];if(n.nspell)for(var i=function(l){r.push(new Promise(function(p,d){var f;n.nspell.remove(l),p(!((f=n.nspell)===null||f===void 0)&&f.correct(l)?"":l)}))},a=0,o=e;a<o.length;a++){var s=o[a];i(s)}else return new Promise(function(l,p){l([])});return Promise.all(r)},t.prototype.doValidation=function(e,n,r){r===void 0&&(r=this.settings);var i=[];if(r&&r.validate===!0&&i.push.apply(i,br.entries(n)),r&&r.spellcheck.enabled===!0&&i.push.apply(i,ri.entries(n,e,this.nspell,this.settings.spellcheck.userDictionaries)),r&&r.lint&&r.lint.enabled===!0&&i.push.apply(i,ii.entries(n,e,new ei(r&&r.lint))),r&&!r.spellcheck.enabled&&!r.validate)return[];var a=[];for(var o in Y)a.push(Y[o].id);function s(l){var p=O.create(e.positionAt(l.getOffset()),e.positionAt(l.getOffset()+l.getLength())),d=e.languageId;return{code:l.getRule().id,source:d,message:l.getMessage(),severity:l.getLevel(),range:p}}return i.filter(function(l){return l.getLevel()!==V.Ignore}).map(s)},t}();function Qi(t){return Eo(new St,new Xr(null,t&&t.clientCapabilities),new Zr(t&&t.clientCapabilities),new $r,new $i,J.index)}function Eo(t,e,n,r,i,a){return{configure:function(o){i.configure(o),e.configure(o)},updateProject:a.sync.bind(a),purgeProject:a.purge.bind(a),doValidation:i.doValidation.bind(i),parseScene:t.parseScene.bind(t),doComplete:e.doComplete.bind(e),setCompletionParticipants:e.setCompletionParticipants.bind(e),doHover:n.doHover.bind(n),findDefinition:r.findDefinitionGlobal.bind(r),findDocumentSymbols:r.findDocumentSymbols.bind(r),findReferences:r.findReferences.bind(r),findParameters:r.findParameters.bind(r),getRoutineInfo:r.getRoutineInfo.bind(r),suggestSpelling:i.suggestSpelling.bind(i),addDictWords:i.addWordsToDictionary.bind(i),removeDictWords:i.removeWordsFromDictionary.bind(i)}}var Wt=class{_ctx;_csLanguageService;_cslanguageSettings;_languageId;constructor(e,n){switch(this._ctx=e,this._cslanguageSettings=n.languageSettings,this._languageId=n.languageId,this._languageId){case"choicescript":this._csLanguageService=Qi(),this._csLanguageService.configure(this._cslanguageSettings);break;default:throw new Error("Invalid language id: "+this._languageId)}}async doHover(e,n){let r=this._getTextDocument(e);if(!r)return null;let i=this._csLanguageService.parseScene(r),a=this._csLanguageService.doHover(r,n,i);return Promise.resolve(a)}async doValidation(e){let n=this._getTextDocument(e);if(n){let r=this._csLanguageService.parseScene(n),i=this._csLanguageService.doValidation(n,r);return Promise.resolve(i)}return Promise.resolve([])}async addWords(e){return this._csLanguageService.addDictWords(e)}async removeWords(e){return this._csLanguageService.removeDictWords(e)}_getStartupTextDocument(){let e=this._ctx.getMirrorModels();for(let n of e)if(/\/startup\.txt$/.test(n.uri.toString()))return Fe.create(n.uri.toString(),this._languageId,n.version,n.getValue());return null}_getProjectPath(e){return e.slice(0,e.lastIndexOf("/")+1)}_getTextDocument(e){let n=this._ctx.getMirrorModels();for(let r of n)if(r.uri.toString()===e)return Fe.create(e,this._languageId,r.version,r.getValue())}_getAllProjectTextDocuments(e){let n=[],r=this._getProjectPath(e),i=this._ctx.getMirrorModels();for(let a of i)this._getProjectPath(a.uri.toString())===r&&n.push(Fe.create(a.uri.toString(),this._languageId,a.version,a.getValue()));return n}removeIndex(e){this._csLanguageService.purgeProject(e,[e])}updateIndex(e){let n=this._getTextDocument(e);!n||this._csLanguageService.updateProject(e,[n])}async doComplete(e,n){let r=this._getTextDocument(e);if(!r)return null;let i=this._csLanguageService.parseScene(r),a=this._csLanguageService.doComplete(r,n,i);return Promise.resolve(a)}async findDefinition(e,n){let r=this._getTextDocument(e);if(!r)return null;let i=this._csLanguageService.parseScene(r),a=this._csLanguageService.findDefinition(r,n,i);return Promise.resolve(a)}async findReferences(e,n){let r=this._getTextDocument(e);if(!r)return null;let i=this._csLanguageService.parseScene(r),a=this._csLanguageService.findReferences(r,n,i);return Promise.resolve(a)}async findDocumentSymbols(e){let n=this._getTextDocument(e);if(!n)return null;let r=this._csLanguageService.parseScene(n),i=this._csLanguageService.findDocumentSymbols(n,r,!1);return Promise.resolve(i)}async getRoutineInfo(e,n){let r=this._getTextDocument(e);if(!r)return null;let i=this._csLanguageService.parseScene(r);return this._csLanguageService.getRoutineInfo(r,n,i)}async findParameters(e,n,r){let i=this._getTextDocument(e);return i?this._csLanguageService.findParameters(i,n,r):null}async suggestSpelling(e){return this._csLanguageService.suggestSpelling(e)}configure(e){this._csLanguageService.configure(e)}};function Ro(t,e){return new Wt(t,e)}return ha(Io);})();
/*!

 ...
 *-----------------------------------------------------------------------------*/
define("vs/language/choicescript/choicescriptWorker", ["require","require"],(require)=>{
var moduleExports=(()=>{var wa=Object.create;var ht=Object.defineProperty;var xa=Object.getOwnPropertyDescriptor;var Sa=Object.getOwnPropertyNames;var Ca=Object.getPrototypeOf,ka=Object.prototype.hasOwnProperty;var za=(t=>typeof require!="undefined"?require:typeof Proxy!="undefined"?new Proxy(t,{get:(e,n)=>(typeof require!="undefined"?require:e)[n]}):t)(function(t){if(typeof require!="undefined")return require.apply(this,arguments);throw new Error('Dynamic require of "'+t+'" is not supported')});var U=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports),Fa=(t,e)=>{for(var n in e)ht(t,n,{get:e[n],enumerable:!0})},Pn=(t,e,n,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let i of Sa(e))!ka.call(t,i)&&i!==n&&ht(t,i,{get:()=>e[i],enumerable:!(r=xa(e,i))||r.enumerable});return t};var Ea=(t,e,n)=>(n=t!=null?wa(Ca(t)):{},Pn(e||!t||!t.__esModule?ht(n,"default",{value:t,enumerable:!0}):n,t)),Da=t=>Pn(ht({},"__esModule",{value:!0}),t);var Si=U((Tl,xi)=>{xi.exports=function(e){return e!=null&&e.constructor!=null&&typeof e.constructor.isBuffer=="function"&&e.constructor.isBuffer(e)}});var _n=U((Ml,Ci)=>{"use strict";Ci.exports=oo;var ao=[];function oo(t,e){var n=0,r;if(!e)return ao;if(t.FLAG==="long"){for(r=new Array(Math.ceil(e.length/2));n<e.length;)r[n/2]=e.slice(n,n+2),n+=2;return r}return e.split(t.FLAG==="num"?",":"")}});var Fi=U((Ol,zi)=>{"use strict";var so=_n();zi.exports=po;var lo=[].push,Mt="etaoinshrdlcumwfgypbvkjxqz".split(""),ct=/\s+/,co=["qwertzuop","yxcvbnm","qaw","say","wse","dsx","sy","edr","fdc","dx","rft","gfv","fc","tgz","hgb","gv","zhu","jhn","hb","uji","kjm","jn","iko","lkm"];function po(t){var e=Object.create(null),n=Object.create(null),r=Object.create(null),i=[],a={in:[],out:[]},o=[],s=t.toString("utf8"),l=[],d=0,p=s.indexOf(`
`),f,b,u,y,k,E,z,D,O,R,P,I,N;for(r.KEY=[];p>-1;)M(s.slice(d,p)),d=p+1,p=s.indexOf(`
`,d);for(M(s.slice(d)),p=-1;++p<l.length;)if(b=l[p],f=b.split(ct),u=f[0],u==="REP"){for(y=p+parseInt(f[1],10);++p<=y;)f=l[p].split(ct),i.push([f[1],f[2]]);p--}else if(u==="ICONV"||u==="OCONV"){for(y=p+parseInt(f[1],10),D=a[u==="ICONV"?"in":"out"];++p<=y;)f=l[p].split(ct),D.push([new RegExp(f[1],"g"),f[2]]);p--}else if(u==="COMPOUNDRULE"){for(y=p+parseInt(f[1],10);++p<=y;)for(R=l[p].split(ct)[1],O=-1,o.push(R);++O<R.length;)n[R.charAt(O)]=[];p--}else if(u==="PFX"||u==="SFX"){for(y=p+parseInt(f[3],10),R={type:u,combineable:f[2]==="Y",entries:[]},e[f[1]]=R;++p<=y;){f=l[p].split(ct),k=f[2],E=f[3].split("/"),z=f[4],D={add:"",remove:"",match:"",continuation:so(r,E[1])},E&&E[0]!=="0"&&(D.add=E[0]);try{k!=="0"&&(D.remove=u==="SFX"?ki(k):k),z&&z!=="."&&(D.match=u==="SFX"?ki(z):ho(z))}catch{D=null}D&&R.entries.push(D)}p--}else if(u==="TRY"){for(z=f[1],I=-1,P=[];++I<z.length;)N=z.charAt(I),N.toLowerCase()===N&&P.push(N);for(I=-1;++I<Mt.length;)z.indexOf(Mt[I])<0&&P.push(Mt[I]);r[u]=P}else u==="KEY"?lo.apply(r[u],f[1].split("|")):u==="COMPOUNDMIN"?r[u]=Number(f[1]):u==="ONLYINCOMPOUND"?(r[u]=f[1],n[f[1]]=[]):r[u]=f[1];return isNaN(r.COMPOUNDMIN)&&(r.COMPOUNDMIN=3),r.KEY.length||(r.KEY=co),r.TRY||(r.TRY=Mt.concat()),r.KEEPCASE||(r.KEEPCASE=!1),{compoundRuleCodes:n,replacementTable:i,conversion:a,compoundRules:o,rules:e,flags:r};function M(L){L=L.trim(),L&&L.charCodeAt(0)!==35&&l.push(L)}}function ki(t){return new RegExp(t+"$")}function ho(t){return new RegExp("^"+t)}});var Nn=U((Al,Ei)=>{"use strict";Ei.exports=mo;function mo(t,e){for(var n=-1;++n<e.length;)t=t.replace(e[n][0],e[n][1]);return t}});var dt=U((Ll,Di)=>{"use strict";Di.exports=uo;function uo(t,e,n){return n&&e in t&&n.indexOf(t[e])>-1}});var Ii=U((Wl,Ri)=>{"use strict";var fo=dt();Ri.exports=go;function go(t,e){var n=-1;if(t.data[e])return!fo(t.flags,"ONLYINCOMPOUND",t.data[e]);if(e.length>=t.flags.COMPOUNDMIN){for(;++n<t.compoundRules.length;)if(t.compoundRules[n].test(e))return!0}return!1}});var Ot=U((Pl,Ni)=>{"use strict";var bo=Nn(),Tn=Ii(),Mn=dt();Ni.exports=vo;function vo(t,e,n){var r=e.trim(),i;if(!r)return null;if(r=bo(r,t.conversion.in),Tn(t,r))return!n&&Mn(t.flags,"FORBIDDENWORD",t.data[r])?null:r;if(r.toUpperCase()===r){if(i=r.charAt(0)+r.slice(1).toLowerCase(),_i(t.flags,t.data[i],n))return null;if(Tn(t,i))return i}if(i=r.toLowerCase(),i!==r){if(_i(t.flags,t.data[i],n))return null;if(Tn(t,i))return i}return null}function _i(t,e,n){return Mn(t,"KEEPCASE",e)||n||Mn(t,"FORBIDDENWORD",e)}});var Mi=U((jl,Ti)=>{"use strict";var yo=Ot();Ti.exports=wo;function wo(t){return Boolean(yo(this,t))}});var Li=U((Ul,Ai)=>{"use strict";Ai.exports=xo;function xo(t){var e=Oi(t.charAt(0)),n=t.slice(1);return!n||(n=Oi(n),e===n)?e:e==="u"&&n==="l"?"s":null}function Oi(t){return t===t.toLowerCase()?"l":t===t.toUpperCase()?"u":null}});var Ui=U((Bl,ji)=>{"use strict";var At=Li(),Wi=Nn(),So=dt(),Co=Ot();ji.exports=zo;var ko=[].push;function zo(t){var e=this,n={},r=[],i={},a,o,s=[],l,d,p,f,b,u,y,k,E,z,D,O,R,P,I,N,M,L,q,Z,Pt,jt,pt;if(t=Wi(t.trim(),e.conversion.in),!t||e.correct(t))return[];for(pt=At(t),d=-1;++d<e.replacementTable.length;)for(o=e.replacementTable[d],p=t.indexOf(o[0]);p>-1;)s.push(t.replace(o[0],o[1])),p=t.indexOf(o[0],p+1);for(d=-1;++d<t.length;)for(k=t.charAt(d),z=t.slice(0,d),D=t.slice(d+1),R=k.toLowerCase(),O=R!==k,n={},p=-1;++p<e.flags.KEY.length;)if(E=e.flags.KEY[p],f=E.indexOf(R),!(f<0)){for(u=-1;++u<E.length;)if(u!==f){if(y=E.charAt(u),n[y])continue;n[y]=!0,O&&(y=y.toUpperCase()),s.push(z+y+D)}}for(d=-1,M=t.charAt(0),l=[""],L=1,q=0;++d<t.length;){for(k=M,M=t.charAt(d+1),z=t.slice(0,d),o=k===M?"":k+k,p=-1,b=l.length;++p<b;)p<=L&&l.push(l[p]+o),l[p]+=k;++q<3&&(L=l.length)}for(ko.apply(s,l),l=[t],o=t.toLowerCase(),(t===o||pt===null)&&l.push(t.charAt(0).toUpperCase()+o.slice(1)),o=t.toUpperCase(),t!==o&&l.push(o),a={state:{},weighted:i,suggestions:r},P=Pi(e,a,l,s),I=0,L=Math.min(P.length,Math.pow(Math.max(15-t.length,3),3)),Z=Math.max(Math.pow(10-t.length,3),1);!r.length&&I<L;)N=I+Z,Pi(e,a,P.slice(I,N)),I=N;for(r.sort(ga),l=[],Pt=[],d=-1;++d<r.length;)jt=Wi(r[d],e.conversion.out),o=jt.toLowerCase(),Pt.indexOf(o)<0&&(l.push(jt),Pt.push(o));return l;function ga(ie,ae){return ba(ie,ae)||va(ie,ae)||ya(ie,ae)}function ba(ie,ae){return i[ie]===i[ae]?0:i[ie]>i[ae]?-1:1}function va(ie,ae){var Ln=At(ie),Wn=At(ae);return Ln===Wn?0:Ln===pt?-1:Wn===pt?1:void 0}function ya(ie,ae){return ie.localeCompare(ae)}}function Pi(t,e,n,r){var i=t.flags.TRY,a=t.data,o=t.flags,s=[],l=-1,d,p,f,b,u,y,k,E,z,D,O,R,P;if(r)for(;++l<r.length;)I(r[l],!0);for(l=-1;++l<n.length;)for(d=n[l],p="",f="",b=d.charAt(0),u=d,y=d.slice(1),k=b.toLowerCase()!==b,E=At(d),z=-1;++z<=d.length;)for(p+=f,D=u,u=y,y=u.slice(1),f=b,b=d.charAt(z+1),O=k,b&&(k=b.toLowerCase()!==b),u&&O!==k&&(I(p+N(u)),I(p+N(b)+N(f)+y)),I(p+u),u&&I(p+b+f+y),P=-1;++P<i.length;)R=i[P],O&&R!==R.toUpperCase()?(E!=="s"&&(I(p+R+D),I(p+R+u)),R=R.toUpperCase(),I(p+R+D),I(p+R+u)):(I(p+R+D),I(p+R+u));return s;function I(M,L){var q=e.state[M],Z;q!==Boolean(q)&&(s.push(M),Z=Co(t,M),q=Z&&!So(o,"NOSUGGEST",a[Z]),e.state[M]=q,q&&(e.weighted[M]=L?10:0,e.suggestions.push(M))),q&&e.weighted[M]++}function N(M){var L=M.charAt(0);return(L.toLowerCase()===L?L.toUpperCase():L.toLowerCase())+M.slice(1)}}});var qi=U((Vl,Vi)=>{"use strict";var Fo=Ot(),Bi=dt();Vi.exports=Eo;function Eo(t){var e=this,n=Fo(e,t,!0);return{correct:e.correct(t),forbidden:Boolean(n&&Bi(e.flags,"FORBIDDENWORD",e.data[n])),warn:Boolean(n&&Bi(e.flags,"WARN",e.data[n]))}}});var Yi=U((ql,Ji)=>{"use strict";Ji.exports=Gi;function Gi(t,e,n,r){for(var i=-1,a,o,s,l,d;++i<e.entries.length;)if(a=e.entries[i],l=a.continuation,d=-1,(!a.match||a.match.test(t))&&(o=a.remove?t.replace(a.remove,""):t,o=e.type==="SFX"?o+a.add:a.add+o,r.push(o),l&&l.length))for(;++d<l.length;)s=n[l[d]],s&&Gi(o,s,n,r);return r}});var An=U((Gl,Ki)=>{"use strict";var Hi=Yi();Ki.exports=Io;var Do=[].push,On=[];function Ro(t,e,n){var r=t[e];e in t?r===On?t[e]=n.concat():Do.apply(r,n):t[e]=n.concat()}function Io(t,e,n,r){var i=-1,a,o,s,l,d,p,f;for((!("NEEDAFFIX"in r.flags)||n.indexOf(r.flags.NEEDAFFIX)<0)&&Ro(t,e,n);++i<n.length;)if(a=r.rules[n[i]],n[i]in r.compoundRuleCodes&&r.compoundRuleCodes[n[i]].push(e),a){for(p=Hi(e,a,r.rules,[]),o=-1;++o<p.length;)if(p[o]in t||(t[p[o]]=On),a.combineable){for(s=i;++s<n.length;)if(d=r.rules[n[s]],d&&d.combineable&&a.type!==d.type)for(f=Hi(p[o],d,r.rules,[]),l=-1;++l<f.length;)f[l]in t||(t[f[l]]=On)}}}});var Zi=U((Jl,Xi)=>{"use strict";var _o=An();Xi.exports=To;var No=[];function To(t,e){var n=this;return _o(n.data,t,n.data[e]||No,n),n}});var Qi=U((Yl,$i)=>{"use strict";$i.exports=Mo;function Mo(t){var e=this;return delete e.data[t],e}});var ta=U((Hl,ea)=>{"use strict";ea.exports=Oo;function Oo(){return this.flags.WORDCHARS||null}});var aa=U((Kl,ia)=>{"use strict";var Ao=_n(),Lo=An();ia.exports=Wo;var na=/\s/g;function Wo(t,e,n){for(var r=t.toString("utf8"),i=r.indexOf(`
`)+1,a=r.indexOf(`
`,i);a>-1;)r.charCodeAt(i)!==9&&ra(r.slice(i,a),e,n),i=a+1,a=r.indexOf(`
`,i);ra(r.slice(i),e,n)}function ra(t,e,n){for(var r=t.indexOf("/"),i=t.indexOf("#"),a="",o,s;r>-1&&t.charCodeAt(r-1)===92;)t=t.slice(0,r-1)+t.slice(r),r=t.indexOf("/",r);i>-1?r>-1&&r<i?(o=t.slice(0,r),na.lastIndex=r+1,s=na.exec(t),a=t.slice(r+1,s?s.index:void 0)):o=t.slice(0,i):r>-1?(o=t.slice(0,r),a=t.slice(r+1)):o=t,o=o.trim(),o&&Lo(n,o,Ao(e.flags,a.trim()),e)}});var sa=U((Xl,oa)=>{"use strict";var Po=aa();oa.exports=jo;function jo(t){var e=this,n=-1,r,i,a,o;for(Po(t,e,e.data);++n<e.compoundRules.length;){for(r=e.compoundRules[n],i="",o=-1;++o<r.length;)a=r.charAt(o),i+=e.compoundRuleCodes[a].length?"(?:"+e.compoundRuleCodes[a].join("|")+")":a;e.compoundRules[n]=new RegExp(i,"i")}return e}});var ca=U((Zl,la)=>{"use strict";la.exports=Uo;function Uo(t){var e=this,n=t.toString("utf8").split(`
`),r=-1,i,a,o,s;for(e.flags.FORBIDDENWORD===void 0&&(e.flags.FORBIDDENWORD=!1),s=e.flags.FORBIDDENWORD;++r<n.length;)i=n[r].trim(),i&&(i=i.split("/"),o=i[0],a=o.charAt(0)==="*",a&&(o=o.slice(1)),e.add(o,i[1]),a&&e.data[o].push(s));return e}});var ha=U(($l,pa)=>{"use strict";var da=Si(),Bo=Fi();pa.exports=Lt;var xe=Lt.prototype;xe.correct=Mi();xe.suggest=Ui();xe.spell=qi();xe.add=Zi();xe.remove=Qi();xe.wordCharacters=ta();xe.dictionary=sa();xe.personal=ca();function Lt(t,e){var n=-1,r;if(!(this instanceof Lt))return new Lt(t,e);if(typeof t=="string"||da(t)?(typeof e=="string"||da(e))&&(r=[{dic:e}]):t&&("length"in t?(r=t,t=t[0]&&t[0].aff):(t.dic&&(r=[t]),t=t.aff)),!t)throw new Error("Missing `aff` in dictionary");if(t=Bo(t),this.data=Object.create(null),this.compoundRuleCodes=t.compoundRuleCodes,this.replacementTable=t.replacementTable,this.conversion=t.conversion,this.compoundRules=t.compoundRules,this.rules=t.rules,this.flags=t.flags,r)for(;++n<r.length;)r[n].dic&&this.dictionary(r[n].dic)}});var Jo={};Fa(Jo,{ChoiceScriptWorker:()=>Wt,create:()=>Go});var Re;(function(t){t[t.CommentLine=0]="CommentLine",t[t.OptionLine=1]="OptionLine",t[t.CommandLine=2]="CommandLine",t[t.TextLine=3]="TextLine"})(Re||(Re={}));var c;(function(t){t[t.Char=0]="Char",t[t.Ident=1]="Ident",t[t.AtKeyword=2]="AtKeyword",t[t.Asterisk=3]="Asterisk",t[t.String=4]="String",t[t.BadString=5]="BadString",t[t.UnquotedString=6]="UnquotedString",t[t.Hash=7]="Hash",t[t.Num=8]="Num",t[t.Percentage=9]="Percentage",t[t.Dimension=10]="Dimension",t[t.UnicodeRange=11]="UnicodeRange",t[t.CDO=12]="CDO",t[t.CDC=13]="CDC",t[t.Colon=14]="Colon",t[t.SemiColon=15]="SemiColon",t[t.CurlyL=16]="CurlyL",t[t.CurlyR=17]="CurlyR",t[t.ParenthesisL=18]="ParenthesisL",t[t.ParenthesisR=19]="ParenthesisR",t[t.BracketL=20]="BracketL",t[t.BracketR=21]="BracketR",t[t.Indentation=22]="Indentation",t[t.Whitespace=23]="Whitespace",t[t.Includes=24]="Includes",t[t.Dashmatch=25]="Dashmatch",t[t.SubstringOperator=26]="SubstringOperator",t[t.PrefixOperator=27]="PrefixOperator",t[t.SuffixOperator=28]="SuffixOperator",t[t.Delim=29]="Delim",t[t.EMS=30]="EMS",t[t.EXS=31]="EXS",t[t.Length=32]="Length",t[t.Angle=33]="Angle",t[t.Time=34]="Time",t[t.Freq=35]="Freq",t[t.Exclamation=36]="Exclamation",t[t.Resolution=37]="Resolution",t[t.Comma=38]="Comma",t[t.Charset=39]="Charset",t[t.EscapedJavaScript=40]="EscapedJavaScript",t[t.BadEscapedJavaScript=41]="BadEscapedJavaScript",t[t.Comment=42]="Comment",t[t.SingleLineComment=43]="SingleLineComment",t[t.EOF=44]="EOF",t[t.EOL=45]="EOL",t[t.CustomToken=46]="CustomToken",t[t.Builtin=47]="Builtin",t[t.Invalid=48]="Invalid",t[t.Word=49]="Word",t[t.Dollar=50]="Dollar",t[t.FairMathAdd=51]="FairMathAdd",t[t.FairMathSub=52]="FairMathSub"})(c||(c={}));var jn=function(){function t(e){this.lineNum=0,this.linePos=0,this.source=e,this.sourceLen=e.length,this.lines=e.split(/\r?\n/)}return t.prototype.getLineText=function(e){return this.lines[e??this.lineNum]},t.prototype.gotoNextLine=function(){this.lineNum<this.lines.length&&(this.lineNum++,this.linePos=0)},t.prototype.gotoPrevLine=function(){this.lineNum>0&&(this.lineNum--,this.linePos=0)},t.prototype.substring=function(e,n){return n===void 0&&(n=this.linePos),this.lines[this.lineNum].substring(e,n)},t.prototype.eol=function(){return this.linePos===this.lines[this.lineNum].length},t.prototype.eos=function(){return this.eol()&&this.lineNum===this.lines.length-1},t.prototype.pos=function(){return{line:this.lineNum,ch:this.linePos}},t.prototype.line=function(){return this.lineNum},t.prototype.offset=function(){var e=0,n=this.lines.slice(0,this.lineNum);return n.length>0&&(e+=n.reduce(function(r,i){return r+i.length+1},0)),e+this.linePos},t.prototype.lineOffset=function(){return this.linePos},t.prototype.goBackToOffset=function(e){this.linePos=e},t.prototype.goBackToPos=function(e){this.lineNum=e.line,this.linePos=e.ch},t.prototype.goBack=function(e){this.linePos-=e},t.prototype.advance=function(e){this.linePos+=e},t.prototype.nextChar=function(){return this.lines[this.lineNum].charCodeAt(this.linePos++)||0},t.prototype.peekChar=function(e){return e===void 0&&(e=0),this.lines[this.lineNum].charCodeAt(this.linePos+e)||0},t.prototype.lookbackChar=function(e){return e===void 0&&(e=0),this.lines[this.lineNum].charCodeAt(this.linePos-e)||0},t.prototype.advanceIfChar=function(e){return e===this.lines[this.lineNum].charCodeAt(this.linePos)?(this.linePos++,!0):!1},t.prototype.onCommandLine=function(){return/^(\s*\*[a-z]+)/.test(this.lines[this.lineNum])},t.prototype.advanceIfChars=function(e){if(this.linePos+e.length>this.source.length)return!1;for(var n=0;n<e.length;n++)if(this.source.charCodeAt(this.linePos+n)!==e[n])return!1;return this.advance(n),!0},t.prototype.advanceWhileLine=function(){for(var e=this.linePos,n=this.lines[this.lineNum].length;this.linePos<n;)this.linePos++;return this.linePos-e},t.prototype.advanceWhileChar=function(e){for(var n=this.linePos,r=this.lines[this.lineNum].length;this.linePos<r&&e(this.lines[this.lineNum].charCodeAt(this.linePos));)this.linePos++;return this.linePos-n},t}();var Un=function(){function t(e){this.source=e,this.len=e.length,this.position=0}return t.prototype.substring=function(e,n){return n===void 0&&(n=this.position),this.source.substring(e,n)},t.prototype.eos=function(){return this.len<=this.position},t.prototype.pos=function(){return this.position},t.prototype.goBackTo=function(e){this.position=e},t.prototype.goBack=function(e){this.position-=e},t.prototype.advance=function(e){this.position+=e},t.prototype.nextChar=function(){return this.source.charCodeAt(this.position++)||0},t.prototype.peekChar=function(e){return e===void 0&&(e=0),this.source.charCodeAt(this.position+e)||0},t.prototype.lookbackChar=function(e){return e===void 0&&(e=0),this.source.charCodeAt(this.position-e)||0},t.prototype.advanceIfChar=function(e){return e===this.source.charCodeAt(this.position)?(this.position++,!0):!1},t.prototype.advanceIfChars=function(e){if(this.position+e.length>this.source.length)return!1;for(var n=0;n<e.length;n++)if(this.source.charCodeAt(this.position+n)!==e[n])return!1;return this.advance(n),!0},t.prototype.advanceWhileChar=function(e){for(var n=this.position;this.position<this.len&&e(this.source.charCodeAt(this.position));)this.position++;return this.position-n},t}();var oe="a".charCodeAt(0),Vn="c".charCodeAt(0),qn="e".charCodeAt(0),Gn="f".charCodeAt(0),mt="m".charCodeAt(0),Jn="n".charCodeAt(0),Yn="o".charCodeAt(0),Hn="t".charCodeAt(0),ue="z".charCodeAt(0),se="A".charCodeAt(0),Kn="F".charCodeAt(0),fe="Z".charCodeAt(0),ge="0".charCodeAt(0),be="9".charCodeAt(0),Ho="~".charCodeAt(0),Ko="^".charCodeAt(0),Xo="=".charCodeAt(0),Zo="|".charCodeAt(0),Ge="-".charCodeAt(0),Xn="+".charCodeAt(0),Zn="_".charCodeAt(0),Ut="%".charCodeAt(0),Bt="*".charCodeAt(0),$n="(".charCodeAt(0),Qn=")".charCodeAt(0),$o="<".charCodeAt(0),Qo=">".charCodeAt(0),es="@".charCodeAt(0),er="#".charCodeAt(0),Ra="$".charCodeAt(0),Je="\\".charCodeAt(0),ts="/".charCodeAt(0),pe=`
`.charCodeAt(0),he="\r".charCodeAt(0),Se="\f".charCodeAt(0),Vt='"'.charCodeAt(0),qe="'".charCodeAt(0),Ye=" ".charCodeAt(0),He="	".charCodeAt(0),Ia=";".charCodeAt(0),_a=":".charCodeAt(0),Na="{".charCodeAt(0),Ta="}".charCodeAt(0),Ma="[".charCodeAt(0),Oa="]".charCodeAt(0),Aa=",".charCodeAt(0),ut=".".charCodeAt(0),ns="!".charCodeAt(0),rs="?".charCodeAt(0),Bn="*".charCodeAt(0),ee={};ee[Ia]=c.SemiColon;ee[_a]=c.Colon;ee[Na]=c.CurlyL;ee[Ta]=c.CurlyR;ee[Oa]=c.BracketR;ee[Ma]=c.BracketL;ee[$n]=c.ParenthesisL;ee[Qn]=c.ParenthesisR;ee[Aa]=c.Comma;ee[Ra]=c.Dollar;var B={};B.em=c.EMS;B.ex=c.EXS;B.px=c.Length;B.cm=c.Length;B.mm=c.Length;B.in=c.Length;B.pt=c.Length;B.pc=c.Length;B.deg=c.Angle;B.rad=c.Angle;B.grad=c.Angle;B.ms=c.Time;B.s=c.Time;B.hz=c.Freq;B.khz=c.Freq;B["%"]=c.Percentage;B.fr=c.Percentage;B.dpi=c.Resolution;B.dpcm=c.Resolution;var is=function(){function t(){this.stream=new jn(""),this.ignoreComment=!0,this.ignoreWhitespace=!0,this.isNewLine=!0,this.currentLineType=null}return t.prototype.setSource=function(e){this.stream=new jn(e)},t.prototype.finishToken=function(e,n,r){var i=this.stream.lineOffset()-e.ch;return{pos:e,len:i||1,offset:this.stream.offset()-i,type:n,text:r||this.stream.substring(e.ch)}},t.prototype.pos=function(){return this.stream.pos()},t.prototype.goBackToPos=function(e){this.stream.goBackToPos(e)},t.prototype.scan=function(){if(this.stream.eos())return this.finishToken(this.stream.pos(),c.EOF);var e=this.scanLine(this.stream.line());return e},t.prototype.scanLine=function(e){if(this.stream.eol()){var n=this.stream.pos();this.isNewLine=!0;var r=this.finishToken(n,c.EOL,`
`);return this.stream.gotoNextLine(),r}return this.scanNext(this.stream.pos())},t.prototype.scanNext=function(e){if(e.ch===0&&this._whitespace())return this.finishToken(e,c.Indentation);if(this.isNewLine){if(this.stream.advanceIfChars([Bn,Vn,Yn,mt,mt,qn,Jn,Hn])){var n=this.stream.advanceWhileLine();return this.finishToken(e,c.SingleLineComment)}else this.stream.peekChar()===Bn&&/\w+/.test(String.fromCharCode(this.stream.peekChar(1)))?this.currentLineType=Re.CommandLine:this.currentLineType=Re.TextLine;this.isNewLine=!1}if(!this.currentLineType)throw new Error("Scanner doesn't recognize this line type.");var r=[];if(this.currentLineType===Re.CommandLine){if(this.stream.advanceIfChar(Bt))return this.finishToken(e,c.Asterisk,"*");if(this.ident(r))return this.finishToken(e,c.Ident,r.join(""));if(this._string(r))return this.finishToken(e,c.String,r.join(""));if(this._fastMathOp())return this.stream.advance(1),this.finishToken(e,this.stream.advanceIfChar(Ge)?c.FairMathSub:(this.stream.advance(1),c.FairMathAdd),r.join(""))}else if(this.currentLineType===Re.TextLine){if(this.stream.advanceIfChar(er))return this.finishToken(e,c.Hash);if(this._word())return this.finishToken(e,c.Word)}if(this._whitespace())return this.finishToken(e,c.Whitespace);if(this._number())return this.finishToken(e,c.Num);var i=ee[this.stream.peekChar()];return typeof i<"u"?(this.stream.advance(1),this.finishToken(e,i)):(this.stream.nextChar(),this.finishToken(e,c.Char))},t.prototype.trivia=function(){for(;;){var e=this.stream.pos();if(this._whitespace()){if(!this.ignoreWhitespace)return this.finishToken(e,c.Whitespace)}else return null}},t.prototype._stringChar=function(e,n){var r=this.stream.peekChar();return r!==0&&r!==e&&r!==Je&&r!==he&&r!==Se&&r!==pe?(this.stream.advance(1),n.push(String.fromCharCode(r)),!0):!1},t.prototype._string=function(e){if(this.stream.peekChar()===Vt){var n=this.stream.nextChar();for(e.push(String.fromCharCode(n));this._stringChar(n,e)||this._escape(e,!0););return this.stream.peekChar()===n?(this.stream.nextChar(),e.push(String.fromCharCode(n)),c.String):c.BadString}return null},t.prototype._word=function(){var e=0,n;return n=this.stream.peekChar(e),n>=se&&n<=fe||n>=oe&&n<=ue||n>=192&&n<=383?(this.stream.advance(e+1),this.stream.advanceWhileChar(function(r){return r>=se&&r<=fe||r>=oe&&r<=ue||r>=192&&r<=383||r===qe}),!0):!1},t.prototype._fastMathOp=function(){var e=0,n;return this.stream.peekChar()===Ut?(e=1,n=this.stream.peekChar(e),n===Xn||n===Ge):!1},t.prototype._number=function(){var e=0,n;return this.stream.peekChar()===ut&&(e=1),n=this.stream.peekChar(e),n>=ge&&n<=be?(this.stream.advance(e+1),this.stream.advanceWhileChar(function(r){return r>=ge&&r<=be||e===0&&r===ut}),!0):!1},t.prototype._whitespace=function(){var e=this.stream.advanceWhileChar(function(n){return n===Ye||n===He});return e>0},t.prototype._name=function(e){for(var n=!1;this._identChar(e)||this._escape(e);)n=!0;return n},t.prototype.ident=function(e){if(this._identFirstChar(e)){for(;this._identChar(e););return!0}return!1},t.prototype._identFirstChar=function(e){var n=this.stream.peekChar();return n>=oe&&n<=ue||n>=se&&n<=fe?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t.prototype._identChar=function(e){var n=this.stream.peekChar();return n===Zn||n>=oe&&n<=ue||n>=se&&n<=fe||n>=ge&&n<=be?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t.prototype._escape=function(e,n){var r=this.stream.peekChar();if(r===Je){this.stream.advance(1),r=this.stream.peekChar();for(var i=0;i<6&&(r>=ge&&r<=be||r>=oe&&r<=Gn||r>=se&&r<=Kn);)this.stream.advance(1),r=this.stream.peekChar(),i++;if(i>0){try{var a=parseInt(this.stream.substring(this.stream.offset()-i),16);a&&e.push(String.fromCharCode(a))}catch{}return r===Ye||r===He?this.stream.advance(1):this._newline([]),!0}if(r!==he&&r!==Se&&r!==pe)return this.stream.advance(1),e.push(String.fromCharCode(r)),!0;if(n)return this._newline(e)}return!1},t.prototype._newline=function(e){var n=this.stream.peekChar();switch(n){case he:case Se:case pe:return this.stream.advance(1),e.push(String.fromCharCode(n)),n===he&&this.stream.advanceIfChar(pe)&&e.push(`
`),!0}return!1},t}();var tr=function(){function t(){this.stream=new Un(""),this.ignoreComment=!0,this.ignoreWhitespace=!0,this.inURL=!1,this.newLine=!0}return t.prototype.setSource=function(e){this.stream=new Un(e)},t.prototype.finishToken=function(e,n,r){return{offset:e,len:this.stream.pos()-e,type:n,text:r||this.stream.substring(e)}},t.prototype.substring=function(e,n){return this.stream.substring(e,e+n)},t.prototype.pos=function(){return this.stream.pos()},t.prototype.goBackTo=function(e){this.stream.goBackTo(e)},t.prototype.scanUnquotedString=function(){var e=this.stream.pos(),n=[];return this._unquotedString(n)?this.finishToken(e,c.UnquotedString,n.join("")):null},t.prototype.scan=function(){var e=this.trivia();if(e!==null)return e;var n=this.stream.pos();return this.stream.eos()?this.finishToken(n,c.EOF):this.scanNext(n)},t.prototype.scanNext=function(e){var n=[];if(this.newLine){for(;this._whitespace();)return this.finishToken(e,c.Indentation);this.newLine=!1}if(this._newline(n))return this.newLine=!0,this.finishToken(e,c.EOL,n.join(""));if(this.stream.advanceIfChars([Bt,Vn,Yn,mt,mt,qn,Jn,Hn]))return this.finishToken(e,c.SingleLineComment);if(this.stream.advanceIfChar(Bt))return this.finishToken(e,c.Asterisk,"*");if(this.ident(n))return this.finishToken(e,c.Ident,n.join(""));if(this._word())return this.finishToken(e,c.Word);if(this._number())return this.finishToken(e,c.Num,n.join(""));if(n.length===1)return this.finishToken(e,c.Delim);n=[];var r=this._string(n);if(r!==null)return this.finishToken(e,r,n.join(""));if(this.stream.advanceIfChar(er))return this.finishToken(e,c.Hash);if(this._number()){var i=this.stream.pos();if(n=[this.stream.substring(e,i)],this.stream.advanceIfChar(Ut))return this.finishToken(e,c.Percentage);if(this.ident(n)){var a=this.stream.substring(i).toLowerCase(),o=B[a];return typeof o<"u"?this.finishToken(e,o,n.join("")):this.finishToken(e,c.Dimension,n.join(""))}return this.finishToken(e,c.Num)}return this._fastMathOp()?(this.stream.advance(1),this.finishToken(e,this.stream.advanceIfChar(Ge)?c.FairMathSub:(this.stream.advance(1),c.FairMathAdd),n.join(""))):(r=ee[this.stream.peekChar()],typeof r<"u"?(this.stream.advance(1),this.finishToken(e,r)):(this.stream.nextChar(),this.finishToken(e,c.Delim)))},t.prototype.trivia=function(){for(;!this.newLine;){var e=this.stream.pos();if(this._whitespace()){if(!this.ignoreWhitespace)return this.finishToken(e,c.Whitespace)}else return null}return null},t.prototype._fastMathOp=function(){var e;return this.stream.peekChar()===Ut?(e=this.stream.peekChar(1),e===Xn||e===Ge):!1},t.prototype._number=function(){var e=0,n;return this.stream.peekChar()===ut&&(e=1),n=this.stream.peekChar(e),n>=ge&&n<=be?(this.stream.advance(e+1),this.stream.advanceWhileChar(function(r){return r>=ge&&r<=be||e===0&&r===ut}),!0):!1},t.prototype._word=function(){var e=0,n;return n=this.stream.peekChar(e),n>=se&&n<=fe||n>=oe&&n<=ue||n>=192&&n<=383?(this.stream.advance(e+1),this.stream.advanceWhileChar(function(r){return r>=se&&r<=fe||r>=oe&&r<=ue||r>=192&&r<=383||r===qe}),!0):!1},t.prototype._newline=function(e){var n=this.stream.peekChar();switch(n){case he:case Se:case pe:return this.stream.advance(1),e.push(String.fromCharCode(n)),n===he&&this.stream.advanceIfChar(pe)&&e.push(`
`),!0}return!1},t.prototype._escape=function(e,n){var r=this.stream.peekChar();if(r===Je){this.stream.advance(1),r=this.stream.peekChar();for(var i=0;i<6&&(r>=ge&&r<=be||r>=oe&&r<=Gn||r>=se&&r<=Kn);)this.stream.advance(1),r=this.stream.peekChar(),i++;if(i>0){try{var a=parseInt(this.stream.substring(this.stream.pos()-i),16);a&&e.push(String.fromCharCode(a))}catch{}return r===Ye||r===He?this.stream.advance(1):this._newline([]),!0}if(r!==he&&r!==Se&&r!==pe)return this.stream.advance(1),e.push(String.fromCharCode(r)),!0;if(n)return this._newline(e)}return!1},t.prototype._stringChar=function(e,n){var r=this.stream.peekChar();return r!==0&&r!==e&&r!==Je&&r!==he&&r!==Se&&r!==pe?(this.stream.advance(1),n.push(String.fromCharCode(r)),!0):!1},t.prototype._string=function(e){return null;if(this.stream.peekChar()===qe||this.stream.peekChar()===Vt){var n;for(e.push(String.fromCharCode(n));this._stringChar(n,e)||this._escape(e,!0););return this.stream.peekChar()===n?(this.stream.nextChar(),e.push(String.fromCharCode(n)),c.String):c.BadString}},t.prototype._unquotedChar=function(e){var n=this.stream.peekChar();return n!==0&&n!==Je&&n!==qe&&n!==Vt&&n!==$n&&n!==Qn&&n!==Ye&&n!==He&&n!==pe&&n!==Se&&n!==he?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t.prototype._unquotedString=function(e){for(var n=!1;this._unquotedChar(e)||this._escape(e);)n=!0;return n},t.prototype._whitespace=function(){var e=this.stream.advanceWhileChar(function(n){return n===Ye||n===He});return e>0},t.prototype._name=function(e){for(var n=!1;this._identChar(e)||this._escape(e);)n=!0;return n},t.prototype.ident=function(e){var n=this.stream.pos();if(this._identFirstChar(e)){for(;this._identChar(e););var r=this.stream.peekChar();if(r>=192&&r<=383)return!1;switch(r){case qe:return this.stream.goBackTo(n),!1;default:return!0}return!0}return!1},t.prototype._identFirstChar=function(e){var n=this.stream.peekChar();return n>=oe&&n<=ue||n>=se&&n<=fe?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t.prototype._identChar=function(e){var n=this.stream.peekChar();return n===Zn||n>=oe&&n<=ue||n>=se&&n<=fe||n>=ge&&n<=be?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t.prototype._minus=function(e){var n=this.stream.peekChar();return n===Ge?(this.stream.advance(1),e.push(String.fromCharCode(n)),!0):!1},t}();var w=function(){var t=function(e,n){return t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,i){r.__proto__=i}||function(r,i){for(var a in i)Object.prototype.hasOwnProperty.call(i,a)&&(r[a]=i[a])},t(e,n)};return function(e,n){if(typeof n!="function"&&n!==null)throw new TypeError("Class extends value "+String(n)+" is not a constructor or null");t(e,n);function r(){this.constructor=e}e.prototype=n===null?Object.create(n):(r.prototype=n.prototype,new r)}}(),G;(function(t){t[t.Number=0]="Number",t[t.String=1]="String",t[t.Boolean=2]="Boolean"})(G||(G={}));var $;(function(t){t[t.Text=0]="Text",t[t.ChoiceScript=1]="ChoiceScript",t[t.Comment=2]="Comment",t[t.ChoiceOption=3]="ChoiceOption"})($||($={}));var le;(function(t){t[t.Spaces=0]="Spaces",t[t.Tab=1]="Tab",t[t.Mixed=2]="Mixed"})(le||(le={}));var m;(function(t){t[t.Undefined=0]="Undefined",t[t.ChoiceScriptComment=1]="ChoiceScriptComment",t[t.Identifier=2]="Identifier",t[t.Scene=3]="Scene",t[t.SceneRef=4]="SceneRef",t[t.Line=5]="Line",t[t.Label=6]="Label",t[t.LabelRef=7]="LabelRef",t[t.ChoiceScriptLine=8]="ChoiceScriptLine",t[t.ChoiceScriptStatement=9]="ChoiceScriptStatement",t[t.TextLine=10]="TextLine",t[t.StringLiteral=11]="StringLiteral",t[t.Operator=12]="Operator",t[t.Expression=13]="Expression",t[t.BinaryExpression=14]="BinaryExpression",t[t.StringExpression=15]="StringExpression",t[t.Term=16]="Term",t[t.Value=17]="Value",t[t.RealWord=18]="RealWord",t[t.ChoiceCommand=19]="ChoiceCommand",t[t.ParamsCommand=20]="ParamsCommand",t[t.ChoiceOption=21]="ChoiceOption",t[t.MultiReplace=22]="MultiReplace",t[t.MultiReplaceOption=23]="MultiReplaceOption",t[t.VariableReplacement=24]="VariableReplacement",t[t.PrintVariable=25]="PrintVariable",t[t.NumericValue=26]="NumericValue",t[t.Boolean=27]="Boolean",t[t.Indentation=28]="Indentation",t[t.VariableDeclaration=29]="VariableDeclaration",t[t.LabelDeclaration=30]="LabelDeclaration",t[t.JumpCommand=31]="JumpCommand",t[t.GotoCommand=32]="GotoCommand",t[t.GosubCommand=33]="GosubCommand",t[t.Param=34]="Param",t[t.ParamList=35]="ParamList",t[t.HexColorValue=36]="HexColorValue",t[t.Variable=37]="Variable",t[t.CreateVariable=38]="CreateVariable",t[t.If=39]="If",t[t.Else=40]="Else",t[t.For=41]="For",t[t.Each=42]="Each",t[t.While=43]="While",t[t.MixinContentReference=44]="MixinContentReference",t[t.MixinContentDeclaration=45]="MixinContentDeclaration",t[t.Media=46]="Media",t[t.Keyframe=47]="Keyframe",t[t.FontFace=48]="FontFace",t[t.Import=49]="Import",t[t.Namespace=50]="Namespace",t[t.Invocation=51]="Invocation",t[t.FunctionDeclaration=52]="FunctionDeclaration",t[t.ReturnStatement=53]="ReturnStatement",t[t.MediaQuery=54]="MediaQuery",t[t.FunctionParameter=55]="FunctionParameter",t[t.FunctionArgument=56]="FunctionArgument",t[t.KeyframeSelector=57]="KeyframeSelector",t[t.ViewPort=58]="ViewPort",t[t.Document=59]="Document",t[t.AtApplyRule=60]="AtApplyRule",t[t.CustomPropertyDeclaration=61]="CustomPropertyDeclaration",t[t.CustomPropertySet=62]="CustomPropertySet",t[t.ListEntry=63]="ListEntry",t[t.Supports=64]="Supports",t[t.SupportsCondition=65]="SupportsCondition",t[t.NamespacePrefix=66]="NamespacePrefix",t[t.GridLine=67]="GridLine",t[t.Plugin=68]="Plugin",t[t.UnknownAtRule=69]="UnknownAtRule",t[t.Command=70]="Command",t[t.StandardCommand=71]="StandardCommand",t[t.InvalidBuiltin=72]="InvalidBuiltin",t[t.IfIdCommand=73]="IfIdCommand",t[t.IfId=74]="IfId"})(m||(m={}));var W;(function(t){t[t.Label=0]="Label",t[t.Variable=1]="Variable",t[t.Unknown=2]="Unknown"})(W||(W={}));function Ie(t,e){var n=null;return!t||e<t.offset||e>t.end?null:(t.accept(function(r){return r.offset===-1&&r.length===-1?!0:r.offset<=e&&r.end>=e?(n?r.length<=n.length&&(n=r):n=r,!0):!1}),n)}function ft(t,e){for(var n=Ie(t,e),r=[];n;)r.unshift(n),n=n.parent;return r}var F=function(){function t(e,n,r){e===void 0&&(e=-1),n===void 0&&(n=-1),this.parent=null,this.offset=e,this.length=n,r&&(this.nodeType=r)}return Object.defineProperty(t.prototype,"end",{get:function(){return this.offset+this.length},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"type",{get:function(){return this.nodeType||m.Undefined},set:function(e){this.nodeType=e},enumerable:!1,configurable:!0}),t.prototype.getTextProvider=function(){for(var e=this;e&&!e.textProvider;)e=e.parent;return e?e.textProvider:function(){return"unknown"}},t.prototype.getText=function(){return this.getTextProvider()(this.offset,this.length)},t.prototype.matches=function(e){return this.length===e.length&&this.getTextProvider()(this.offset,this.length)===e},t.prototype.startsWith=function(e){return this.length>=e.length&&this.getTextProvider()(this.offset,e.length)===e},t.prototype.endsWith=function(e){return this.length>=e.length&&this.getTextProvider()(this.end-e.length,e.length)===e},t.prototype.accept=function(e){if(e(this)&&this.children)for(var n=0,r=this.children;n<r.length;n++){var i=r[n];i.accept(e)}},t.prototype.acceptVisitor=function(e){this.accept(e.visitNode.bind(e))},t.prototype.adoptChild=function(e,n){if(n===void 0&&(n=-1),e.parent&&e.parent.children){var r=e.parent.children.indexOf(e);r>=0&&e.parent.children.splice(r,1)}e.parent=this;var i=this.children;return i||(i=this.children=[]),n!==-1?i.splice(n,0,e):i.push(e),e},t.prototype.attachTo=function(e,n){return n===void 0&&(n=-1),e&&e.adoptChild(this,n),this},t.prototype.collectIssues=function(e){this.issues&&e.push.apply(e,this.issues)},t.prototype.addIssue=function(e){this.issues||(this.issues=[]),this.issues.push(e)},t.prototype.hasIssue=function(e){return Array.isArray(this.issues)&&this.issues.some(function(n){return n.getRule()===e})},t.prototype.isErroneous=function(e){return e===void 0&&(e=!1),this.issues&&this.issues.length>0?!0:e&&Array.isArray(this.children)&&this.children.some(function(n){return n.isErroneous(!0)})},t.prototype.setNode=function(e,n,r){return r===void 0&&(r=-1),n?(n.attachTo(this,r),this[e]=n,!0):!1},t.prototype.addChild=function(e){return e?(this.children||(this.children=[]),e.attachTo(this),this.updateOffsetAndLength(e),!0):!1},t.prototype.updateOffsetAndLength=function(e){(e.offset<this.offset||this.offset===-1)&&(this.offset=e.offset);var n=e.end;(n>this.end||this.length===-1)&&(this.length=n-this.offset)},t.prototype.hasChildren=function(){return!!this.children&&this.children.length>0},t.prototype.getChildren=function(){return this.children?this.children.slice(0):[]},t.prototype.getChild=function(e){return this.children&&e<this.children.length?this.children[e]:null},t.prototype.addChildren=function(e){for(var n=0,r=e;n<r.length;n++){var i=r[n];this.addChild(i)}},t.prototype.getPrevSibling=function(){if(this.parent===null||this.parent.type!==m.Scene)return null;var e=this.parent.getChildren(),n=e.indexOf(this);return n<0?null:e[n-1]||null},t.prototype.getNextSibling=function(){if(this.parent===null||this.parent.type!==m.Scene)return null;var e=this.parent.getChildren(),n=e.indexOf(this);return n<0?null:e[n+1]||null},t.prototype.findFirstChildBeforeOffset=function(e){if(this.children){for(var n=null,r=this.children.length-1;r>=0;r--)if(n=this.children[r],n.offset<=e)return n}return null},t.prototype.findChildAtOffset=function(e,n){var r=this.findFirstChildBeforeOffset(e);return r&&r.end>=e?n&&r.findChildAtOffset(e,!0)||r:null},t.prototype.encloses=function(e){return this.offset<=e.offset&&this.offset+this.length>=e.offset+e.length},t.prototype.getParent=function(){for(var e=this.parent;e instanceof Ke;)e=e.parent;return e},t.prototype.findParent=function(e){for(var n=this;n&&n.type!==e;)n=n.parent;return n},t.prototype.findAParent=function(){for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n];for(var r=this;r&&!e.some(function(i){return r.type===i});)r=r.parent;return r},t.prototype.setData=function(e,n){this.options||(this.options={}),this.options[e]=n},t.prototype.getData=function(e){return!this.options||!this.options.hasOwnProperty(e)?null:this.options[e]},t}();var nr=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.iType=le.Spaces,i.depth=0,i}return e.prototype.setIndentUnit=function(n){this.iType=n},e.prototype.setIndentDepth=function(n){this.depth=n},Object.defineProperty(e.prototype,"type",{get:function(){return m.Indentation},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"indentDepth",{get:function(){return this.depth},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"indentType",{get:function(){return this.iType},enumerable:!1,configurable:!0}),e}(F);var Ke=function(t){w(e,t);function e(n,r){r===void 0&&(r=-1);var i=t.call(this,-1,-1)||this;return i.attachTo(n,r),i.offset=-1,i.length=-1,i}return e}(F);var qt=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.VariableReplacement},enumerable:!1,configurable:!0}),e}(F);var os=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.ChoiceScriptStatement},enumerable:!1,configurable:!0}),e}(F);var rr=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.ChoiceScriptComment},enumerable:!1,configurable:!0}),e}(F);var gt=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.isCustomProperty=!1,i}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Identifier},enumerable:!1,configurable:!0}),e.prototype.containsInterpolation=function(){return this.hasChildren()},e}(F);var Gt=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Scene},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"name",{get:function(){return this.sceneName},enumerable:!1,configurable:!0}),e.prototype.setUri=function(n){this.uri=n,this.sceneName=n.slice(n.lastIndexOf("/")+1,-1*4)},e.prototype.getUri=function(){return this.uri},e.prototype.isStartup=function(){return this.uri?/\/startup\.txt$/.test(this.uri):!1},e.prototype.isStats=function(){return this.uri?/\/choicescript_stats\.txt$/.test(this.uri):!1},e}(F);var ir=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.SceneRef},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"name",{get:function(){return this.sceneName},enumerable:!1,configurable:!0}),e.prototype.setSceneName=function(n){this.sceneName=n},e.prototype.getUri=function(){return this.uri},e.prototype.isStartup=function(){return this.uri?/\/startup\.txt$/.test(this.uri):!1},e}(F);var j=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Command},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"name",{get:function(){var n=this.getText().match(/^\*([A-Za-z_]+\b)/);return n?n[1]:this.getText()},enumerable:!1,configurable:!0}),e}(F);var _e=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Label},enumerable:!1,configurable:!0}),e.prototype.getValue=function(){return this.labelName||this.getText()},e}(j);var ar=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.LabelRef},enumerable:!1,configurable:!0}),e.prototype.getSceneRef=function(){var n=this.findAParent(m.GosubCommand,m.GotoCommand);return n?n.getSceneRef():null},e.prototype.setLabelName=function(n){this.labelName=n},Object.defineProperty(e.prototype,"name",{get:function(){var n;return(n=this.getChild(0))&&n.type===m.Label?(n=n,n.name):this.labelName},enumerable:!1,configurable:!0}),e}(F);var Xe=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.StandardCommand},enumerable:!1,configurable:!0}),e}(j);var or=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.IfIdCommand},enumerable:!1,configurable:!0}),e.prototype.isValid=function(){var n=this.getChild(0);if(!n||n.type!==m.IfId)return!1;var r=n;return r.isValid()},e}(j);var sr=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.IfId},enumerable:!1,configurable:!0}),e.prototype.isValid=function(){return!(!this.getText()||!/^\w{8}-\w{4}-\w{4}-\w{4}-\w{12}$/.test(this.getText())||!/^[A-F0-9\-]{36}$/i.test(this.getText()))},e}(F);var bt=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.targetScene=null,i.targetLabel=null,i}return Object.defineProperty(e.prototype,"type",{get:function(){return m.JumpCommand},enumerable:!1,configurable:!0}),e.prototype.setScene=function(n){return this.targetScene=n,this.addChild(n)},e.prototype.setLabel=function(n){return this.targetLabel=n,this.addChild(n)},e.prototype.getSceneRef=function(){return this.targetScene},e.prototype.getLabelRef=function(){return this.targetLabel},e}(j);var lr=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.paramList=null,i}return Object.defineProperty(e.prototype,"type",{get:function(){return m.GosubCommand},enumerable:!1,configurable:!0}),e.prototype.getParameterList=function(){return this.paramList},e.prototype.setParameterList=function(n){return this.paramList=n,this.addChild(this.paramList)},e.prototype.hasParameters=function(){return this.paramList!==null},e}(bt);var cr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.GotoCommand},enumerable:!1,configurable:!0}),e}(bt);var dr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Param},enumerable:!1,configurable:!0}),e}(F);var pr=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i._params=[],i}return Object.defineProperty(e.prototype,"type",{get:function(){return m.ParamList},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"params",{get:function(){return this._params},enumerable:!1,configurable:!0}),e}(F);var hr=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Command},enumerable:!1,configurable:!0}),e}(j);var vt=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return e.prototype.getExpr=function(){return this.expr},e.prototype.getVariable=function(){return this.variable},e.prototype.setVariable=function(n){return n?(n.attachTo(this),this.variable=n,!0):!1},e.prototype.setValue=function(n){return n?(n.attachTo(this),this.expr=n,!0):!1},Object.defineProperty(e.prototype,"type",{get:function(){return m.Command},enumerable:!1,configurable:!0}),e}(j);var mr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.ChoiceCommand},enumerable:!1,configurable:!0}),e}(Xe);var yt=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.variables=[],i}return e.prototype.addVariable=function(n){return n?(n.attachTo(this),this.variables.push(n),!0):!1},Object.defineProperty(e.prototype,"type",{get:function(){return m.ParamsCommand},enumerable:!1,configurable:!0}),e.prototype.getVariable=function(n){return this.variables[n]},e.prototype.getVariableCount=function(){return this.variables.length},e}(j);var ss=function(t){w(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.condition=null,n.next=null,n.prev=null,n}return e}(Xe);var ur=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.ChoiceOption},enumerable:!1,configurable:!0}),e}(F);var ls=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.RealWord},enumerable:!1,configurable:!0}),e}(F);var Ne=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.lineType=$.Text,i.indentDepth=0,i}return e.prototype.getLineNum=function(){return this.lineNumber},e.prototype.setLineNum=function(n){return n>0?(this.lineNumber=n,!0):!1},Object.defineProperty(e.prototype,"type",{get:function(){return m.Line},enumerable:!1,configurable:!0}),e.prototype.setLineType=function(n){this.lineType=n},e.prototype.getLineType=function(){return this.lineType},e.prototype.addIndent=function(n){return n?(n.attachTo(this),this.indentNode=n,this.indentDepth=n.indentDepth,!0):!1},e.prototype.getIndentNode=function(){return this.indentNode},Object.defineProperty(e.prototype,"indent",{get:function(){return this.indentDepth},enumerable:!1,configurable:!0}),e}(F);var Jt=function(t){w(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.options=[],n}return e}(F);var cs=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.TextLine},enumerable:!1,configurable:!0}),e}(Ne);var ds=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.ChoiceScriptLine},enumerable:!1,configurable:!0}),e}(Ne);var ps=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.AtApplyRule},enumerable:!1,configurable:!0}),e.prototype.setIdentifier=function(n){return this.setNode("identifier",n,0)},e.prototype.getIdentifier=function(){return this.identifier},e.prototype.getName=function(){return this.identifier?this.identifier.getText():""},e}(F);var hs=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Invocation},enumerable:!1,configurable:!0}),e.prototype.getArguments=function(){return this.arguments||(this.arguments=new Ke(this)),this.arguments},e}(F);var ms=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.FunctionParameter},enumerable:!1,configurable:!0}),e.prototype.setIdentifier=function(n){return this.setNode("identifier",n,0)},e.prototype.getIdentifier=function(){return this.identifier},e.prototype.getName=function(){return this.identifier?this.identifier.getText():""},e.prototype.setDefaultValue=function(n){return this.setNode("defaultValue",n,0)},e.prototype.getDefaultValue=function(){return this.defaultValue},e}(F);var us=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.FunctionArgument},enumerable:!1,configurable:!0}),e.prototype.setIdentifier=function(n){return this.setNode("identifier",n,0)},e.prototype.getIdentifier=function(){return this.identifier},e.prototype.getName=function(){return this.identifier?this.identifier.getText():""},e.prototype.setValue=function(n){return this.setNode("value",n,0)},e.prototype.getValue=function(){return this.value},e}(F);var fs=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Import},enumerable:!1,configurable:!0}),e.prototype.setMedialist=function(n){return n?(n.attachTo(this),!0):!1},e}(F);var gs=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Namespace},enumerable:!1,configurable:!0}),e}(F);var bs=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.MediaQuery},enumerable:!1,configurable:!0}),e}(F);var vs=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.SupportsCondition},enumerable:!1,configurable:!0}),e}(F);var fr=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.MultiReplaceOption},enumerable:!1,configurable:!0}),e}(F);var gr=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.variants=[],i}return Object.defineProperty(e.prototype,"type",{get:function(){return m.MultiReplace},enumerable:!1,configurable:!0}),e.prototype.addVariant=function(n){return n&&(this.variants.push(n),this.addChild(n)),this.variants.length},e.prototype.setExpression=function(n){return this.setNode("expression",n)},e.prototype.getExpression=function(){return this.expression},e.prototype.getOptions=function(){return this.variants},e}(qt);var Te=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Expression},enumerable:!1,configurable:!0}),e.prototype.setLeft=function(n){return this.setNode("left",n)},e.prototype.getLeft=function(){return this.left},e.prototype.setRight=function(n){return this.setNode("right",n)},e.prototype.getRight=function(){return this.right},e.prototype.setOperator=function(n){var r=this.setNode("operator",n);return r&&(this.exprType=n.csType),r},e.prototype.getOperator=function(){return this.operator},e.prototype.isSingleValue=function(){return typeof this.getLeft()<"u"&&!this.getRight()&&!this.getOperator()},Object.defineProperty(e.prototype,"csType",{get:function(){if(this.getLeft()&&!this.getRight()){switch(this.getLeft().type){case m.NumericValue:return G.Number;case m.StringLiteral:return G.String;case m.BinaryExpression:case m.Boolean:return G.Boolean;case m.Identifier:return;default:return}var n=this.getLeft();return n.csType}return this.exprType},enumerable:!1,configurable:!0}),e}(F);var br=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.BinaryExpression},enumerable:!1,configurable:!0}),e}(Te);var vr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.StringExpression},enumerable:!1,configurable:!0}),e}(Te);var ys=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.Term},enumerable:!1,configurable:!0}),e.prototype.setValue=function(n){if(!this.addChild(n))return!1;switch(n?.type){case m.StringExpression:case m.BinaryExpression:case m.Expression:var r=n;this.valueType=r.csType;break;case m.NumericValue:this.valueType=G.Number;break;case m.StringLiteral:this.valueType=G.String;break;case m.Boolean:this.valueType=G.Boolean;break;case m.Identifier:this.valueType=void 0;break}return!0},Object.defineProperty(e.prototype,"csType",{get:function(){return this.valueType},enumerable:!1,configurable:!0}),e}(F);var Me=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return e.prototype.setCSType=function(n){this.operatorType=n},Object.defineProperty(e.prototype,"type",{get:function(){return m.Operator},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"csType",{get:function(){return this.operatorType},enumerable:!1,configurable:!0}),e}(F);var La=".".charCodeAt(0),Wa="0".charCodeAt(0),Pa="9".charCodeAt(0),yr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.NumericValue},enumerable:!1,configurable:!0}),e.prototype.getValue=function(){for(var n=this.getText(),r=0,i,a=0,o=n.length;a<o&&(i=n.charCodeAt(a),Wa<=i&&i<=Pa||i===La);a++)r+=1;return{value:n.substring(0,r),unit:r<n.length?n.substring(r):void 0}},e}(F);var wr=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.StringLiteral},enumerable:!1,configurable:!0}),e.prototype.getValue=function(){return this.getText()},e}(F);var wt=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.variable=null,i.expr=null,i}return e.prototype.setVariable=function(n){return n?(n.attachTo(this),this.variable=n,!0):!1},e.prototype.setExpr=function(n){return n?(n.attachTo(this),this.expr=n,!0):!1},Object.defineProperty(e.prototype,"csType",{get:function(){var n;return(n=this.expr)===null||n===void 0?void 0:n.csType},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"type",{get:function(){return m.VariableDeclaration},enumerable:!1,configurable:!0}),e.prototype.isConstant=function(){return this.getName()===this.getName().toUpperCase()},e.prototype.getVariable=function(){return this.variable},e.prototype.getName=function(){return this.variable?this.variable.getName():""},e.prototype.getExpr=function(){return this.expr},e}(j);var xt=function(t){w(e,t);function e(n,r){return t.call(this,n,r)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.LabelDeclaration},enumerable:!1,configurable:!0}),e.prototype.setLabel=function(n){return n?(n.attachTo(this),this.label=n,!0):!1},e.prototype.getLabel=function(){return this.label},e}(j);var Ze=function(t){w(e,t);function e(n,r){var i=t.call(this,n,r)||this;return i.varType=void 0,i}return e.prototype._setCSType=function(n){switch(n.type){case m.BinaryExpression:this.varType=G.Boolean;break;case m.NumericValue:this.varType=G.Number;break;case m.StringLiteral:this.varType=G.String;break;default:break}},e.prototype.setValue=function(n){return n?(n.attachTo(this),this.value=n,this._setCSType(n),!0):!1},Object.defineProperty(e.prototype,"csType",{get:function(){return this.varType},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"const",{get:function(){return/^const_[\w0-9]+/.test(this.getText())},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"type",{get:function(){return m.Variable},enumerable:!1,configurable:!0}),e.prototype.getName=function(){return this.getText()},e.prototype.getValue=function(){return this.value},e}(F);var ws=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return Object.defineProperty(e.prototype,"type",{get:function(){return m.ListEntry},enumerable:!1,configurable:!0}),e.prototype.setKey=function(n){return this.setNode("key",n,0)},e.prototype.setValue=function(n){return this.setNode("value",n,1)},e}(F);var xs=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return e.prototype.getConditions=function(){return this.conditions||(this.conditions=new Ke(this)),this.conditions},e}(F);var Ss=function(t){w(e,t);function e(){return t!==null&&t.apply(this,arguments)||this}return e.prototype.setVariable=function(n){return this.setNode("variable",n)},e}(F);var V;(function(t){t[t.Ignore=0]="Ignore",t[t.Error=1]="Error",t[t.Warning=2]="Warning",t[t.Information=3]="Information",t[t.Hint=4]="Hint"})(V||(V={}));var Oe=function(){function t(e,n,r,i,a,o){a===void 0&&(a=e.offset),o===void 0&&(o=e.length),this.node=e,this.rule=n,this.level=r,this.message=i||n.message,this.offset=a,this.length=o}return t.prototype.getRule=function(){return this.rule},t.prototype.getLevel=function(){return this.level},t.prototype.getOffset=function(){return this.offset},t.prototype.getLength=function(){return this.length},t.prototype.getNode=function(){return this.node},t.prototype.getMessage=function(){return this.message},t}();var xr=function(){function t(){this.entries=[]}return t.entries=function(e){var n=new t;return e.acceptVisitor(n),n.entries},t.prototype.visitNode=function(e){return e.isErroneous()&&e.collectIssues(this.entries),!0},t}();function ja(t,e){let n;return e.length===0?n=t:n=t.replace(/\{(\d+)\}/g,(r,i)=>{let a=i[0];return typeof e[a]<"u"?e[a]:r}),n}function Ua(t,e,...n){return ja(e,n)}function ce(t){return Ua}var S=ce(),C=function(){function t(e,n){this.id=e,this.message=n}return t}();var x={NoLabelSpaces:new C("cs-noLabelSpaces",S("no.label.spaces","Label names must not contain spaces")),ExpectedScene:new C("cs-expectedScene",S("expected.scene","Expected a scene name or string expression")),ExpectedLabel:new C("cs-expectedLabel",S("expected.label","Expected a label name or string expression")),GenericSyntaxError:new C("cs-genericSyntaxError",S("generic.syntax.error","Syntax error")),WrongIndentationUnit:new C("cs-wrongindentunit",S("indentunit.error","Incorrect indentation unit")),IndentationError:new C("cs-indentationError",S("indentation.error","Incorrect indentation")),MixedIndentation:new C("cs-mixedIndentation",S("mixed.indentation","Mixed indentation units (spaces/tabs)")),ExpectedChoiceOption:new C("cs-expectedchoiceoption",S("expected.choice.option","Expected Choice option starting with a hash '#'")),UnknownCommand:new C("cs-unknowncommand",S("unknown.command","unknown command")),EmptySceneList:new C("cs-emptyscenelist",S("expected.scenes","Expected at least one scene in the scene list")),NoChoiceOption:new C("cs-nochoiceoption",S("no.choice.command","expected at least one choice option")),NotEnoughMultiReplaceOptions:new C("cs-notenoughmultireplaceopts",S("notenough.multi.command","there should be at least one pipe '|' to separate at least two options")),NumberExpected:new C("cs-numberexpected",S("expected.number","number expected")),ConditionExpected:new C("cs-conditionexpected",S("expected.condt","condition expected")),RuleOrSelectorExpected:new C("cs-ruleorselectorexpected",S("expected.ruleorselector","at-rule or selector expected")),InvalidVariableFormatOption:new C("cs-invalid-variable-format",S("invalid.variableformat","Valid format options are '!' or '!!'")),DotExpected:new C("cs-dotexpected",S("expected.dot","dot expected")),ColonExpected:new C("cs-colonexpected",S("expected.colon","colon expected")),NoCloseQuote:new C("cs-noclosequote",S("no.close.quote",`Invalid string, expected a closing quotation: '"'`)),SemiColonExpected:new C("cs-semicolonexpected",S("expected.semicolon","semi-colon expected")),TermExpected:new C("cs-termexpected",S("expected.term","term expected")),IndentBlockExpected:new C("cs-blockexpected",S("expected.block","Expected an indented code block")),ExpressionExpected:new C("cs-expressionexpected",S("expected.expression","expression expected")),OperatorExpected:new C("cs-operatorexpected",S("expected.operator","operator expected")),IdentifierExpected:new C("cs-identifierexpected",S("expected.ident","identifier expected")),PercentageExpected:new C("cs-percentageexpected",S("expected.percentage","percentage expected")),URIOrStringExpected:new C("cs-uriorstringexpected",S("expected.uriorstring","uri or string expected")),URIExpected:new C("cs-uriexpected",S("expected.uri","URI expected")),LabelNameExpected:new C("cs-labelnamexpected",S("expected.labelname","label name expected")),VariableNameExpected:new C("cs-varnameexpected",S("expected.varname","variable name expected")),VariableValueExpected:new C("cs-varvalueexpected",S("expected.varvalue","variable value expected")),PropertyValueExpected:new C("cs-propertyvalueexpected",S("expected.propvalue","property value expected")),LeftCurlyExpected:new C("cs-lcurlyexpected",S("expected.lcurly","{ expected")),UnbalancedBrackets:new C("cs-unbalancedbrackets",S("expected.lcurly","Unbalanced Brackets")),RightCurlyExpected:new C("cs-rcurlyexpected",S("expected.rcurly","} expected")),LeftSquareBracketExpected:new C("cs-rbracketexpected",S("expected.lsquare","[ expected")),RightSquareBracketExpected:new C("cs-lbracketexpected",S("expected.rsquare","] expected")),LeftParenthesisExpected:new C("cs-lparentexpected",S("expected.lparen","( expected")),RightParenthesisExpected:new C("cs-rparentexpected",S("expected.rparent",") expected")),CommaExpected:new C("cs-commaexpected",S("expected.comma","comma expected")),PageDirectiveOrDeclarationExpected:new C("cs-pagedirordeclexpected",S("expected.pagedirordecl","page directive or declaraton expected")),UnknownAtRule:new C("cs-unknownatrule",S("unknown.atrule","at-rule unknown")),SelectorExpected:new C("cs-selectorexpected",S("expected.selector","selector expected")),StringLiteralExpected:new C("cs-stringliteralexpected",S("expected.stringliteral","string literal expected")),WhitespaceExpected:new C("cs-whitespaceexpected",S("expected.whitespace","whitespace expected")),MediaQueryExpected:new C("cs-mediaqueryexpected",S("expected.mediaquery","media query expected")),IdentifierOrWildcardExpected:new C("cs-idorwildcardexpected",S("expected.idorwildcard","identifier or wildcard expected")),WildcardExpected:new C("cs-wildcardexpected",S("expected.wildcard","wildcard expected")),IdentifierOrVariableExpected:new C("cs-idorvarexpected",S("expected.idorvar","identifier or variable expected"))};var St=function(){return St=Object.assign||function(t){for(var e,n=1,r=arguments.length;n<r;n++){e=arguments[n];for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&(t[i]=e[i])}return t},St.apply(this,arguments)},g;(function(t){t[t.Deprecated=0]="Deprecated",t[t.Normal=1]="Normal",t[t.Initial=2]="Initial"})(g||(g={}));var v=function(){function t(e,n,r){this.indent=0,this.desc=e,this.type=n??g.Normal,this.indent=r??0}return t}();var Sr=["and","or","true","false","scene","scenename"],Ae={abort:new v("",g.Normal),achieve:new v("*achieve my_unique_achievement_id",g.Normal),achievement:new v(`*achievement unique_id true 100 Achievement Title
	Pre-earned description.
	Post-earned description.`,g.Initial),advertisement:new v("",g.Normal),allow_reuse:new v(`*choice
	#Delete the file
		*gosub delete_file
	*allow_reuse #Log out
		*goto log_out`,g.Normal),author:new v("*author Jane Doe",g.Initial),bug:new v("*bug Oops! Something broke. Please report this bug.",g.Normal),check_achievements:new v("",g.Normal),check_purchase:new v("",g.Normal),check_registration:new v("",g.Normal),choice:new v(`*choice
	#Option 1
		*comment code here
		*goto label1
	#Option 2
		*comment code here
		*goto label2`,g.Normal,1),comment:new v("",g.Initial),config:new v("",g.Normal),create:new v('*create name "Joe"',g.Initial),delay_break:new v("",g.Normal),delay_ending:new v("",g.Normal),delete:new v("",g.Normal),disable_reuse:new v(`*choice
	*disable_reuse #Delete the file
		*gosub delete_file
	#Log out
		*goto log_out`,g.Normal),else:new v(`*if (success)
	*goto_scene victory
*else
	*goto_scene defeat`,g.Normal,1),elseif:new v(`*if (class = "wizard")
	You are a wise wizard!
*elseif (class = "warrior")
	You are a loyal warrior!
*else
	You must be a wily rouge!`,g.Normal,1),elsif:new v(`*if (class = "wizard")
	You are a wise wizard!
*elsif (class = "warrior")
	You are a loyal warrior!
*else
	You must be a wily rouge!`,g.Normal,1),end_trial:new v("",g.Normal),ending:new v(`Thanks for playing!
*ending`,g.Normal),fake_choice:new v(`What is your favorite colour?
...
In order to let ::-webkit-progress-value take effect, -webkit-appearance needs to be set to none on the <progress> element.`},{name:"::grammar-error",status:"experimental",references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::grammar-error"}],description:"The ::grammar-error CSS pseudo-element represents a text segment which the user agent has flagged as grammatically incorrect."},{name:"::marker",browsers:["E86","FF68","S11.1","C86","O72"],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::marker"}],description:"The ::marker CSS pseudo-element selects the marker box of a list item, which typically contains a bullet or number. It works on any element or pseudo-element set to display: list-item, such as the <li> and <summary> elements."},{name:"::part",status:"experimental",browsers:["E79","FF72","S13.1","C73","O60"],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::part"}],description:"The ::part CSS pseudo-element represents any element within a shadow tree that has a matching part attribute."},{name:"::placeholder",browsers:["E79","FF51","S10.1","C57","O44"],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::placeholder"}],description:"The ::placeholder CSS pseudo-element represents the placeholder text of a form element."},{name:"::slotted",browsers:["E79","FF63","S10","C50","O37"],references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::slotted"}],description:"The :slotted() CSS pseudo-element represents any element that has been placed into a slot inside an HTML template."},{name:"::spelling-error",status:"experimental",references:[{name:"MDN Reference",url:"https://developer.mozilla.org/docs/Web/CSS/::spelling-error"}],description:"The ::spelling-error CSS pseudo-element represents a text segment which the user agent has flagged as incorrectly spelled."}]};var js=function(){function t(e){this.dataProviders=[],this._propertySet={},this._atDirectiveSet={},this._pseudoClassSet={},this._pseudoElementSet={},this._properties=[],this._atDirectives=[],this._pseudoClasses=[],this._pseudoElements=[],this.setDataProviders(e?.useDefaultDataProvider!==!1,e?.customDataProviders||[])}return t.prototype.setDataProviders=function(e,n){var r;this.dataProviders=[],e&&this.dataProviders.push(new _r(Nr)),(r=this.dataProviders).push.apply(r,n),this.collectData()},t.prototype.collectData=function(){var e=this;this._propertySet={},this._atDirectiveSet={},this._pseudoClassSet={},this._pseudoElementSet={},this.dataProviders.forEach(function(n){n.provideProperties().forEach(function(r){e._propertySet[r.name]||(e._propertySet[r.name]=r)}),n.provideAtDirectives().forEach(function(r){e._atDirectiveSet[r.name]||(e._atDirectiveSet[r.name]=r)}),n.providePseudoClasses().forEach(function(r){e._pseudoClassSet[r.name]||(e._pseudoClassSet[r.name]=r)}),n.providePseudoElements().forEach(function(r){e._pseudoElementSet[r.name]||(e._pseudoElementSet[r.name]=r)})}),this._properties=et(this._propertySet),this._atDirectives=et(this._atDirectiveSet),this._pseudoClasses=et(this._pseudoClassSet),this._pseudoElements=et(this._pseudoElementSet)},t.prototype.getProperty=function(e){return this._propertySet[e]},t.prototype.getAtDirective=function(e){return this._atDirectiveSet[e]},t.prototype.getPseudoClass=function(e){return this._pseudoClassSet[e]},t.prototype.getPseudoElement=function(e){return this._pseudoElementSet[e]},t.prototype.getProperties=function(){return this._properties},t.prototype.getAtDirectives=function(){return this._atDirectives},t.prototype.getPseudoClasses=function(){return this._pseudoClasses},t.prototype.getPseudoElements=function(){return this._pseudoElements},t.prototype.isKnownProperty=function(e){return e.toLowerCase()in this._propertySet},t.prototype.isStandardProperty=function(e){return this.isKnownProperty(e)&&(!this._propertySet[e.toLowerCase()].status||this._propertySet[e.toLowerCase()].status==="standard")},t}();var Qa=function(){function t(e){this.data=e}return Object.defineProperty(t.prototype,"name",{get:function(){return this.data.name},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"description",{get:function(){return this.data.desc},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"restrictions",{get:function(){return this.data.restriction?this.data.restriction.split(",").map(function(e){return e.trim()}):[]},enumerable:!1,configurable:!0}),t}();var de=zr,kt;function tt(){if(!kt){kt=[];for(var t=0;t<de.length;t++){var e={name:de[t],desc:["**Command**: "+de[t]]};typeof Ae[de[t]]<"u"&&Ae[de[t]].desc?e.desc.push("```choicescript\n"+Ae[de[t]].desc+"\n```"):typeof Le[de[t]]<"u"&&Le[de[t]].desc&&e.desc.push("```choicescript\n"+Le[de[t]].desc+"\n```"),e.desc.push("Read more on the [wiki](https://choicescriptdev.wikia.com/wiki/"+de[t]+")"),kt.push(new Qa(e))}}return kt}function zt(t,e){return e===void 0&&(e=!0),t?t.length<140?t:t.slice(0,140)+(e?"\u2026":""):""}var Mr;(function(t){function e(n){return typeof n=="string"}t.is=e})(Mr||(Mr={}));var rn;(function(t){function e(n){return typeof n=="string"}t.is=e})(rn||(rn={}));var Or;(function(t){t.MIN_VALUE=-2147483648,t.MAX_VALUE=2147483647;function e(n){return typeof n=="number"&&t.MIN_VALUE<=n&&n<=t.MAX_VALUE}t.is=e})(Or||(Or={}));var Et;(function(t){t.MIN_VALUE=0,t.MAX_VALUE=2147483647;function e(n){return typeof n=="number"&&t.MIN_VALUE<=n&&n<=t.MAX_VALUE}t.is=e})(Et||(Et={}));var Y;(function(t){function e(r,i){return r===Number.MAX_VALUE&&(r=Et.MAX_VALUE),i===Number.MAX_VALUE&&(i=Et.MAX_VALUE),{line:r,character:i}}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&h.uinteger(i.line)&&h.uinteger(i.character)}t.is=n})(Y||(Y={}));var _;(function(t){function e(r,i,a,o){if(h.uinteger(r)&&h.uinteger(i)&&h.uinteger(a)&&h.uinteger(o))return{start:Y.create(r,i),end:Y.create(a,o)};if(Y.is(r)&&Y.is(i))return{start:r,end:i};throw new Error("Range#create called with invalid arguments[".concat(r,", ").concat(i,", ").concat(a,", ").concat(o,"]"))}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&Y.is(i.start)&&Y.is(i.end)}t.is=n})(_||(_={}));var ye;(function(t){function e(r,i){return{uri:r,range:i}}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&_.is(i.range)&&(h.string(i.uri)||h.undefined(i.uri))}t.is=n})(ye||(ye={}));var Ar;(function(t){function e(r,i,a,o){return{targetUri:r,targetRange:i,targetSelectionRange:a,originSelectionRange:o}}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&_.is(i.targetRange)&&h.string(i.targetUri)&&_.is(i.targetSelectionRange)&&(_.is(i.originSelectionRange)||h.undefined(i.originSelectionRange))}t.is=n})(Ar||(Ar={}));var Dt;(function(t){function e(r,i,a,o){return{red:r,green:i,blue:a,alpha:o}}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&h.numberRange(i.red,0,1)&&h.numberRange(i.green,0,1)&&h.numberRange(i.blue,0,1)&&h.numberRange(i.alpha,0,1)}t.is=n})(Dt||(Dt={}));var an;(function(t){function e(r,i){return{range:r,color:i}}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&_.is(i.range)&&Dt.is(i.color)}t.is=n})(an||(an={}));var on;(function(t){function e(r,i,a){return{label:r,textEdit:i,additionalTextEdits:a}}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&h.string(i.label)&&(h.undefined(i.textEdit)||T.is(i))&&(h.undefined(i.additionalTextEdits)||h.typedArray(i.additionalTextEdits,T.is))}t.is=n})(on||(on={}));var sn;(function(t){t.Comment="comment",t.Imports="imports",t.Region="region"})(sn||(sn={}));var ln;(function(t){function e(r,i,a,o,s,l){var d={startLine:r,endLine:i};return h.defined(a)&&(d.startCharacter=a),h.defined(o)&&(d.endCharacter=o),h.defined(s)&&(d.kind=s),h.defined(l)&&(d.collapsedText=l),d}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&h.uinteger(i.startLine)&&h.uinteger(i.startLine)&&(h.undefined(i.startCharacter)||h.uinteger(i.startCharacter))&&(h.undefined(i.endCharacter)||h.uinteger(i.endCharacter))&&(h.undefined(i.kind)||h.string(i.kind))}t.is=n})(ln||(ln={}));var cn;(function(t){function e(r,i){return{location:r,message:i}}t.create=e;function n(r){var i=r;return h.defined(i)&&ye.is(i.location)&&h.string(i.message)}t.is=n})(cn||(cn={}));var dn;(function(t){t.Error=1,t.Warning=2,t.Information=3,t.Hint=4})(dn||(dn={}));var Lr;(function(t){t.Unnecessary=1,t.Deprecated=2})(Lr||(Lr={}));var Wr;(function(t){function e(n){var r=n;return h.objectLiteral(r)&&h.string(r.href)}t.is=e})(Wr||(Wr={}));var nt;(function(t){function e(r,i,a,o,s,l){var d={range:r,message:i};return h.defined(a)&&(d.severity=a),h.defined(o)&&(d.code=o),h.defined(s)&&(d.source=s),h.defined(l)&&(d.relatedInformation=l),d}t.create=e;function n(r){var i,a=r;return h.defined(a)&&_.is(a.range)&&h.string(a.message)&&(h.number(a.severity)||h.undefined(a.severity))&&(h.integer(a.code)||h.string(a.code)||h.undefined(a.code))&&(h.undefined(a.codeDescription)||h.string((i=a.codeDescription)===null||i===void 0?void 0:i.href))&&(h.string(a.source)||h.undefined(a.source))&&(h.undefined(a.relatedInformation)||h.typedArray(a.relatedInformation,cn.is))}t.is=n})(nt||(nt={}));var ze;(function(t){function e(r,i){for(var a=[],o=2;o<arguments.length;o++)a[o-2]=arguments[o];var s={title:r,command:i};return h.defined(a)&&a.length>0&&(s.arguments=a),s}t.create=e;function n(r){var i=r;return h.defined(i)&&h.string(i.title)&&h.string(i.command)}t.is=n})(ze||(ze={}));var T;(function(t){function e(a,o){return{range:a,newText:o}}t.replace=e;function n(a,o){return{range:{start:a,end:a},newText:o}}t.insert=n;function r(a){return{range:a,newText:""}}t.del=r;function i(a){var o=a;return h.objectLiteral(o)&&h.string(o.newText)&&_.is(o.range)}t.is=i})(T||(T={}));var je;(function(t){function e(r,i,a){var o={label:r};return i!==void 0&&(o.needsConfirmation=i),a!==void 0&&(o.description=a),o}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&h.string(i.label)&&(h.boolean(i.needsConfirmation)||i.needsConfirmation===void 0)&&(h.string(i.description)||i.description===void 0)}t.is=n})(je||(je={}));var X;(function(t){function e(n){var r=n;return h.string(r)}t.is=e})(X||(X={}));var ve;(function(t){function e(a,o,s){return{range:a,newText:o,annotationId:s}}t.replace=e;function n(a,o,s){return{range:{start:a,end:a},newText:o,annotationId:s}}t.insert=n;function r(a,o){return{range:a,newText:"",annotationId:o}}t.del=r;function i(a){var o=a;return T.is(o)&&(je.is(o.annotationId)||X.is(o.annotationId))}t.is=i})(ve||(ve={}));var rt;(function(t){function e(r,i){return{textDocument:r,edits:i}}t.create=e;function n(r){var i=r;return h.defined(i)&&It.is(i.textDocument)&&Array.isArray(i.edits)}t.is=n})(rt||(rt={}));var it;(function(t){function e(r,i,a){var o={kind:"create",uri:r};return i!==void 0&&(i.overwrite!==void 0||i.ignoreIfExists!==void 0)&&(o.options=i),a!==void 0&&(o.annotationId=a),o}t.create=e;function n(r){var i=r;return i&&i.kind==="create"&&h.string(i.uri)&&(i.options===void 0||(i.options.overwrite===void 0||h.boolean(i.options.overwrite))&&(i.options.ignoreIfExists===void 0||h.boolean(i.options.ignoreIfExists)))&&(i.annotationId===void 0||X.is(i.annotationId))}t.is=n})(it||(it={}));var at;(function(t){function e(r,i,a,o){var s={kind:"rename",oldUri:r,newUri:i};return a!==void 0&&(a.overwrite!==void 0||a.ignoreIfExists!==void 0)&&(s.options=a),o!==void 0&&(s.annotationId=o),s}t.create=e;function n(r){var i=r;return i&&i.kind==="rename"&&h.string(i.oldUri)&&h.string(i.newUri)&&(i.options===void 0||(i.options.overwrite===void 0||h.boolean(i.options.overwrite))&&(i.options.ignoreIfExists===void 0||h.boolean(i.options.ignoreIfExists)))&&(i.annotationId===void 0||X.is(i.annotationId))}t.is=n})(at||(at={}));var ot;(function(t){function e(r,i,a){var o={kind:"delete",uri:r};return i!==void 0&&(i.recursive!==void 0||i.ignoreIfNotExists!==void 0)&&(o.options=i),a!==void 0&&(o.annotationId=a),o}t.create=e;function n(r){var i=r;return i&&i.kind==="delete"&&h.string(i.uri)&&(i.options===void 0||(i.options.recursive===void 0||h.boolean(i.options.recursive))&&(i.options.ignoreIfNotExists===void 0||h.boolean(i.options.ignoreIfNotExists)))&&(i.annotationId===void 0||X.is(i.annotationId))}t.is=n})(ot||(ot={}));var Rt;(function(t){function e(n){var r=n;return r&&(r.changes!==void 0||r.documentChanges!==void 0)&&(r.documentChanges===void 0||r.documentChanges.every(function(i){return h.string(i.kind)?it.is(i)||at.is(i)||ot.is(i):rt.is(i)}))}t.is=e})(Rt||(Rt={}));var Ft=function(){function t(e,n){this.edits=e,this.changeAnnotations=n}return t.prototype.insert=function(e,n,r){var i,a;if(r===void 0?i=T.insert(e,n):X.is(r)?(a=r,i=ve.insert(e,n,r)):(this.assertChangeAnnotations(this.changeAnnotations),a=this.changeAnnotations.manage(r),i=ve.insert(e,n,a)),this.edits.push(i),a!==void 0)return a},t.prototype.replace=function(e,n,r){var i,a;if(r===void 0?i=T.replace(e,n):X.is(r)?(a=r,i=ve.replace(e,n,r)):(this.assertChangeAnnotations(this.changeAnnotations),a=this.changeAnnotations.manage(r),i=ve.replace(e,n,a)),this.edits.push(i),a!==void 0)return a},t.prototype.delete=function(e,n){var r,i;if(n===void 0?r=T.del(e):X.is(n)?(i=n,r=ve.del(e,n)):(this.assertChangeAnnotations(this.changeAnnotations),i=this.changeAnnotations.manage(n),r=ve.del(e,i)),this.edits.push(r),i!==void 0)return i},t.prototype.add=function(e){this.edits.push(e)},t.prototype.all=function(){return this.edits},t.prototype.clear=function(){this.edits.splice(0,this.edits.length)},t.prototype.assertChangeAnnotations=function(e){if(e===void 0)throw new Error("Text edit change is not configured to manage change annotations.")},t}(),Pr=function(){function t(e){this._annotations=e===void 0?Object.create(null):e,this._counter=0,this._size=0}return t.prototype.all=function(){return this._annotations},Object.defineProperty(t.prototype,"size",{get:function(){return this._size},enumerable:!1,configurable:!0}),t.prototype.manage=function(e,n){var r;if(X.is(e)?r=e:(r=this.nextId(),n=e),this._annotations[r]!==void 0)throw new Error("Id ".concat(r," is already in use."));if(n===void 0)throw new Error("No annotation provided for id ".concat(r));return this._annotations[r]=n,this._size++,r},t.prototype.nextId=function(){return this._counter++,this._counter.toString()},t}(),Ys=function(){function t(e){var n=this;this._textEditChanges=Object.create(null),e!==void 0?(this._workspaceEdit=e,e.documentChanges?(this._changeAnnotations=new Pr(e.changeAnnotations),e.changeAnnotations=this._changeAnnotations.all(),e.documentChanges.forEach(function(r){if(rt.is(r)){var i=new Ft(r.edits,n._changeAnnotations);n._textEditChanges[r.textDocument.uri]=i}})):e.changes&&Object.keys(e.changes).forEach(function(r){var i=new Ft(e.changes[r]);n._textEditChanges[r]=i})):this._workspaceEdit={}}return Object.defineProperty(t.prototype,"edit",{get:function(){return this.initDocumentChanges(),this._changeAnnotations!==void 0&&(this._changeAnnotations.size===0?this._workspaceEdit.changeAnnotations=void 0:this._workspaceEdit.changeAnnotations=this._changeAnnotations.all()),this._workspaceEdit},enumerable:!1,configurable:!0}),t.prototype.getTextEditChange=function(e){if(It.is(e)){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var n={uri:e.uri,version:e.version},r=this._textEditChanges[n.uri];if(!r){var i=[],a={textDocument:n,edits:i};this._workspaceEdit.documentChanges.push(a),r=new Ft(i,this._changeAnnotations),this._textEditChanges[n.uri]=r}return r}else{if(this.initChanges(),this._workspaceEdit.changes===void 0)throw new Error("Workspace edit is not configured for normal text edit changes.");var r=this._textEditChanges[e];if(!r){var i=[];this._workspaceEdit.changes[e]=i,r=new Ft(i),this._textEditChanges[e]=r}return r}},t.prototype.initDocumentChanges=function(){this._workspaceEdit.documentChanges===void 0&&this._workspaceEdit.changes===void 0&&(this._changeAnnotations=new Pr,this._workspaceEdit.documentChanges=[],this._workspaceEdit.changeAnnotations=this._changeAnnotations.all())},t.prototype.initChanges=function(){this._workspaceEdit.documentChanges===void 0&&this._workspaceEdit.changes===void 0&&(this._workspaceEdit.changes=Object.create(null))},t.prototype.createFile=function(e,n,r){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var i;je.is(n)||X.is(n)?i=n:r=n;var a,o;if(i===void 0?a=it.create(e,r):(o=X.is(i)?i:this._changeAnnotations.manage(i),a=it.create(e,r,o)),this._workspaceEdit.documentChanges.push(a),o!==void 0)return o},t.prototype.renameFile=function(e,n,r,i){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var a;je.is(r)||X.is(r)?a=r:i=r;var o,s;if(a===void 0?o=at.create(e,n,i):(s=X.is(a)?a:this._changeAnnotations.manage(a),o=at.create(e,n,i,s)),this._workspaceEdit.documentChanges.push(o),s!==void 0)return s},t.prototype.deleteFile=function(e,n,r){if(this.initDocumentChanges(),this._workspaceEdit.documentChanges===void 0)throw new Error("Workspace edit is not configured for document changes.");var i;je.is(n)||X.is(n)?i=n:r=n;var a,o;if(i===void 0?a=ot.create(e,r):(o=X.is(i)?i:this._changeAnnotations.manage(i),a=ot.create(e,r,o)),this._workspaceEdit.documentChanges.push(a),o!==void 0)return o},t}();var jr;(function(t){function e(r){return{uri:r}}t.create=e;function n(r){var i=r;return h.defined(i)&&h.string(i.uri)}t.is=n})(jr||(jr={}));var pn;(function(t){function e(r,i){return{uri:r,version:i}}t.create=e;function n(r){var i=r;return h.defined(i)&&h.string(i.uri)&&h.integer(i.version)}t.is=n})(pn||(pn={}));var It;(function(t){function e(r,i){return{uri:r,version:i}}t.create=e;function n(r){var i=r;return h.defined(i)&&h.string(i.uri)&&(i.version===null||h.integer(i.version))}t.is=n})(It||(It={}));var Ur;(function(t){function e(r,i,a,o){return{uri:r,languageId:i,version:a,text:o}}t.create=e;function n(r){var i=r;return h.defined(i)&&h.string(i.uri)&&h.string(i.languageId)&&h.integer(i.version)&&h.string(i.text)}t.is=n})(Ur||(Ur={}));var te;(function(t){t.PlainText="plaintext",t.Markdown="markdown";function e(n){var r=n;return r===t.PlainText||r===t.Markdown}t.is=e})(te||(te={}));var Ue;(function(t){function e(n){var r=n;return h.objectLiteral(n)&&te.is(r.kind)&&h.string(r.value)}t.is=e})(Ue||(Ue={}));var A;(function(t){t.Text=1,t.Method=2,t.Function=3,t.Constructor=4,t.Field=5,t.Variable=6,t.Class=7,t.Interface=8,t.Module=9,t.Property=10,t.Unit=11,t.Value=12,t.Enum=13,t.Keyword=14,t.Snippet=15,t.Color=16,t.File=17,t.Reference=18,t.Folder=19,t.EnumMember=20,t.Constant=21,t.Struct=22,t.Event=23,t.Operator=24,t.TypeParameter=25})(A||(A={}));var st;(function(t){t.PlainText=1,t.Snippet=2})(st||(st={}));var hn;(function(t){t.Deprecated=1})(hn||(hn={}));var Br;(function(t){function e(r,i,a){return{newText:r,insert:i,replace:a}}t.create=e;function n(r){var i=r;return i&&h.string(i.newText)&&_.is(i.insert)&&_.is(i.replace)}t.is=n})(Br||(Br={}));var Vr;(function(t){t.asIs=1,t.adjustIndentation=2})(Vr||(Vr={}));var qr;(function(t){function e(n){var r=n;return r&&(h.string(r.detail)||r.detail===void 0)&&(h.string(r.description)||r.description===void 0)}t.is=e})(qr||(qr={}));var mn;(function(t){function e(n){return{label:n}}t.create=e})(mn||(mn={}));var un;(function(t){function e(n,r){return{items:n||[],isIncomplete:!!r}}t.create=e})(un||(un={}));var lt;(function(t){function e(r){return r.replace(/[\\`*_{}[\]()#+\-.!]/g,"\\$&")}t.fromPlainText=e;function n(r){var i=r;return h.string(i)||h.objectLiteral(i)&&h.string(i.language)&&h.string(i.value)}t.is=n})(lt||(lt={}));var fn;(function(t){function e(n){var r=n;return!!r&&h.objectLiteral(r)&&(Ue.is(r.contents)||lt.is(r.contents)||h.typedArray(r.contents,lt.is))&&(n.range===void 0||_.is(n.range))}t.is=e})(fn||(fn={}));var Gr;(function(t){function e(n,r){return r?{label:n,documentation:r}:{label:n}}t.create=e})(Gr||(Gr={}));var Jr;(function(t){function e(n,r){for(var i=[],a=2;a<arguments.length;a++)i[a-2]=arguments[a];var o={label:n};return h.defined(r)&&(o.documentation=r),h.defined(i)?o.parameters=i:o.parameters=[],o}t.create=e})(Jr||(Jr={}));var gn;(function(t){t.Text=1,t.Read=2,t.Write=3})(gn||(gn={}));var bn;(function(t){function e(n,r){var i={range:n};return h.number(r)&&(i.kind=r),i}t.create=e})(bn||(bn={}));var we;(function(t){t.File=1,t.Module=2,t.Namespace=3,t.Package=4,t.Class=5,t.Method=6,t.Property=7,t.Field=8,t.Constructor=9,t.Enum=10,t.Interface=11,t.Function=12,t.Variable=13,t.Constant=14,t.String=15,t.Number=16,t.Boolean=17,t.Array=18,t.Object=19,t.Key=20,t.Null=21,t.EnumMember=22,t.Struct=23,t.Event=24,t.Operator=25,t.TypeParameter=26})(we||(we={}));var Yr;(function(t){t.Deprecated=1})(Yr||(Yr={}));var vn;(function(t){function e(n,r,i,a,o){var s={name:n,kind:r,location:{uri:a,range:i}};return o&&(s.containerName=o),s}t.create=e})(vn||(vn={}));var Hr;(function(t){function e(n,r,i,a){return a!==void 0?{name:n,kind:r,location:{uri:i,range:a}}:{name:n,kind:r,location:{uri:i}}}t.create=e})(Hr||(Hr={}));var yn;(function(t){function e(r,i,a,o,s,l){var d={name:r,detail:i,kind:a,range:o,selectionRange:s};return l!==void 0&&(d.children=l),d}t.create=e;function n(r){var i=r;return i&&h.string(i.name)&&h.number(i.kind)&&_.is(i.range)&&_.is(i.selectionRange)&&(i.detail===void 0||h.string(i.detail))&&(i.deprecated===void 0||h.boolean(i.deprecated))&&(i.children===void 0||Array.isArray(i.children))&&(i.tags===void 0||Array.isArray(i.tags))}t.is=n})(yn||(yn={}));var wn;(function(t){t.Empty="",t.QuickFix="quickfix",t.Refactor="refactor",t.RefactorExtract="refactor.extract",t.RefactorInline="refactor.inline",t.RefactorRewrite="refactor.rewrite",t.Source="source",t.SourceOrganizeImports="source.organizeImports",t.SourceFixAll="source.fixAll"})(wn||(wn={}));var _t;(function(t){t.Invoked=1,t.Automatic=2})(_t||(_t={}));var xn;(function(t){function e(r,i,a){var o={diagnostics:r};return i!=null&&(o.only=i),a!=null&&(o.triggerKind=a),o}t.create=e;function n(r){var i=r;return h.defined(i)&&h.typedArray(i.diagnostics,nt.is)&&(i.only===void 0||h.typedArray(i.only,h.string))&&(i.triggerKind===void 0||i.triggerKind===_t.Invoked||i.triggerKind===_t.Automatic)}t.is=n})(xn||(xn={}));var Sn;(function(t){function e(r,i,a){var o={title:r},s=!0;return typeof i=="string"?(s=!1,o.kind=i):ze.is(i)?o.command=i:o.edit=i,s&&a!==void 0&&(o.kind=a),o}t.create=e;function n(r){var i=r;return i&&h.string(i.title)&&(i.diagnostics===void 0||h.typedArray(i.diagnostics,nt.is))&&(i.kind===void 0||h.string(i.kind))&&(i.edit!==void 0||i.command!==void 0)&&(i.command===void 0||ze.is(i.command))&&(i.isPreferred===void 0||h.boolean(i.isPreferred))&&(i.edit===void 0||Rt.is(i.edit))}t.is=n})(Sn||(Sn={}));var Kr;(function(t){function e(r,i){var a={range:r};return h.defined(i)&&(a.data=i),a}t.create=e;function n(r){var i=r;return h.defined(i)&&_.is(i.range)&&(h.undefined(i.command)||ze.is(i.command))}t.is=n})(Kr||(Kr={}));var Xr;(function(t){function e(r,i){return{tabSize:r,insertSpaces:i}}t.create=e;function n(r){var i=r;return h.defined(i)&&h.uinteger(i.tabSize)&&h.boolean(i.insertSpaces)}t.is=n})(Xr||(Xr={}));var Cn;(function(t){function e(r,i,a){return{range:r,target:i,data:a}}t.create=e;function n(r){var i=r;return h.defined(i)&&_.is(i.range)&&(h.undefined(i.target)||h.string(i.target))}t.is=n})(Cn||(Cn={}));var kn;(function(t){function e(r,i){return{range:r,parent:i}}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&_.is(i.range)&&(i.parent===void 0||t.is(i.parent))}t.is=n})(kn||(kn={}));var Zr;(function(t){t.namespace="namespace",t.type="type",t.class="class",t.enum="enum",t.interface="interface",t.struct="struct",t.typeParameter="typeParameter",t.parameter="parameter",t.variable="variable",t.property="property",t.enumMember="enumMember",t.event="event",t.function="function",t.method="method",t.macro="macro",t.keyword="keyword",t.modifier="modifier",t.comment="comment",t.string="string",t.number="number",t.regexp="regexp",t.operator="operator",t.decorator="decorator"})(Zr||(Zr={}));var $r;(function(t){t.declaration="declaration",t.definition="definition",t.readonly="readonly",t.static="static",t.deprecated="deprecated",t.abstract="abstract",t.async="async",t.modification="modification",t.documentation="documentation",t.defaultLibrary="defaultLibrary"})($r||($r={}));var Qr;(function(t){function e(n){var r=n;return h.objectLiteral(r)&&(r.resultId===void 0||typeof r.resultId=="string")&&Array.isArray(r.data)&&(r.data.length===0||typeof r.data[0]=="number")}t.is=e})(Qr||(Qr={}));var ei;(function(t){function e(r,i){return{range:r,text:i}}t.create=e;function n(r){var i=r;return i!=null&&_.is(i.range)&&h.string(i.text)}t.is=n})(ei||(ei={}));var ti;(function(t){function e(r,i,a){return{range:r,variableName:i,caseSensitiveLookup:a}}t.create=e;function n(r){var i=r;return i!=null&&_.is(i.range)&&h.boolean(i.caseSensitiveLookup)&&(h.string(i.variableName)||i.variableName===void 0)}t.is=n})(ti||(ti={}));var ni;(function(t){function e(r,i){return{range:r,expression:i}}t.create=e;function n(r){var i=r;return i!=null&&_.is(i.range)&&(h.string(i.expression)||i.expression===void 0)}t.is=n})(ni||(ni={}));var ri;(function(t){function e(r,i){return{frameId:r,stoppedLocation:i}}t.create=e;function n(r){var i=r;return h.defined(i)&&_.is(r.stoppedLocation)}t.is=n})(ri||(ri={}));var zn;(function(t){t.Type=1,t.Parameter=2;function e(n){return n===1||n===2}t.is=e})(zn||(zn={}));var Fn;(function(t){function e(r){return{value:r}}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&(i.tooltip===void 0||h.string(i.tooltip)||Ue.is(i.tooltip))&&(i.location===void 0||ye.is(i.location))&&(i.command===void 0||ze.is(i.command))}t.is=n})(Fn||(Fn={}));var ii;(function(t){function e(r,i,a){var o={position:r,label:i};return a!==void 0&&(o.kind=a),o}t.create=e;function n(r){var i=r;return h.objectLiteral(i)&&Y.is(i.position)&&(h.string(i.label)||h.typedArray(i.label,Fn.is))&&(i.kind===void 0||zn.is(i.kind))&&i.textEdits===void 0||h.typedArray(i.textEdits,T.is)&&(i.tooltip===void 0||h.string(i.tooltip)||Ue.is(i.tooltip))&&(i.paddingLeft===void 0||h.boolean(i.paddingLeft))&&(i.paddingRight===void 0||h.boolean(i.paddingRight))}t.is=n})(ii||(ii={}));var ai;(function(t){function e(n){var r=n;return h.objectLiteral(r)&&rn.is(r.uri)&&h.string(r.name)}t.is=e})(ai||(ai={}));var oi;(function(t){function e(a,o,s,l){return new to(a,o,s,l)}t.create=e;function n(a){var o=a;return!!(h.defined(o)&&h.string(o.uri)&&(h.undefined(o.languageId)||h.string(o.languageId))&&h.uinteger(o.lineCount)&&h.func(o.getText)&&h.func(o.positionAt)&&h.func(o.offsetAt))}t.is=n;function r(a,o){for(var s=a.getText(),l=i(o,function(y,k){var E=y.range.start.line-k.range.start.line;return E===0?y.range.start.character-k.range.start.character:E}),d=s.length,p=l.length-1;p>=0;p--){var f=l[p],b=a.offsetAt(f.range.start),u=a.offsetAt(f.range.end);if(u<=d)s=s.substring(0,b)+f.newText+s.substring(u,s.length);else throw new Error("Overlapping edit");d=b}return s}t.applyEdits=r;function i(a,o){if(a.length<=1)return a;var s=a.length/2|0,l=a.slice(0,s),d=a.slice(s);i(l,o),i(d,o);for(var p=0,f=0,b=0;p<l.length&&f<d.length;){var u=o(l[p],d[f]);u<=0?a[b++]=l[p++]:a[b++]=d[f++]}for(;p<l.length;)a[b++]=l[p++];for(;f<d.length;)a[b++]=d[f++];return a}})(oi||(oi={}));var to=function(){function t(e,n,r,i){this._uri=e,this._languageId=n,this._version=r,this._content=i,this._lineOffsets=void 0}return Object.defineProperty(t.prototype,"uri",{get:function(){return this._uri},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"languageId",{get:function(){return this._languageId},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"version",{get:function(){return this._version},enumerable:!1,configurable:!0}),t.prototype.getText=function(e){if(e){var n=this.offsetAt(e.start),r=this.offsetAt(e.end);return this._content.substring(n,r)}return this._content},t.prototype.update=function(e,n){this._content=e.text,this._version=n,this._lineOffsets=void 0},t.prototype.getLineOffsets=function(){if(this._lineOffsets===void 0){for(var e=[],n=this._content,r=!0,i=0;i<n.length;i++){r&&(e.push(i),r=!1);var a=n.charAt(i);r=a==="\r"||a===`
`,a==="\r"&&i+1<n.length&&n.charAt(i+1)===`
`&&i++}r&&n.length>0&&e.push(n.length),this._lineOffsets=e}return this._lineOffsets},t.prototype.positionAt=function(e){e=Math.max(Math.min(e,this._content.length),0);var n=this.getLineOffsets(),r=0,i=n.length;if(i===0)return Y.create(0,e);for(;r<i;){var a=Math.floor((r+i)/2);n[a]>e?i=a:r=a+1}var o=r-1;return Y.create(o,e-n[o])},t.prototype.offsetAt=function(e){var n=this.getLineOffsets();if(e.line>=n.length)return this._content.length;if(e.line<0)return 0;var r=n[e.line],i=e.line+1<n.length?n[e.line+1]:this._content.length;return Math.max(Math.min(r+e.character,i),r)},Object.defineProperty(t.prototype,"lineCount",{get:function(){return this.getLineOffsets().length},enumerable:!1,configurable:!0}),t}(),h;(function(t){var e=Object.prototype.toString;function n(u){return typeof u<"u"}t.defined=n;function r(u){return typeof u>"u"}t.undefined=r;function i(u){return u===!0||u===!1}t.boolean=i;function a(u){return e.call(u)==="[object String]"}t.string=a;function o(u){return e.call(u)==="[object Number]"}t.number=o;function s(u,y,k){return e.call(u)==="[object Number]"&&y<=u&&u<=k}t.numberRange=s;function l(u){return e.call(u)==="[object Number]"&&-2147483648<=u&&u<=2147483647}t.integer=l;function d(u){return e.call(u)==="[object Number]"&&0<=u&&u<=2147483647}t.uinteger=d;function p(u){return e.call(u)==="[object Function]"}t.func=p;function f(u){return u!==null&&typeof u=="object"}t.objectLiteral=f;function b(u,y){return Array.isArray(u)&&u.every(y)}t.typedArray=b})(h||(h={}));var Fe=class{constructor(e,n,r,i){this._uri=e,this._languageId=n,this._version=r,this._content=i,this._lineOffsets=void 0}get uri(){return this._uri}get languageId(){return this._languageId}get version(){return this._version}getText(e){if(e){let n=this.offsetAt(e.start),r=this.offsetAt(e.end);return this._content.substring(n,r)}return this._content}update(e,n){for(let r of e)if(Fe.isIncremental(r)){let i=li(r.range),a=this.offsetAt(i.start),o=this.offsetAt(i.end);this._content=this._content.substring(0,a)+r.text+this._content.substring(o,this._content.length);let s=Math.max(i.start.line,0),l=Math.max(i.end.line,0),d=this._lineOffsets,p=si(r.text,!1,a);if(l-s===p.length)for(let b=0,u=p.length;b<u;b++)d[b+s+1]=p[b];else p.length<1e4?d.splice(s+1,l-s,...p):this._lineOffsets=d=d.slice(0,s+1).concat(p,d.slice(l+1));let f=r.text.length-(o-a);if(f!==0)for(let b=s+1+p.length,u=d.length;b<u;b++)d[b]=d[b]+f}else if(Fe.isFull(r))this._content=r.text,this._lineOffsets=void 0;else throw new Error("Unknown change event received");this._version=n}getLineOffsets(){return this._lineOffsets===void 0&&(this._lineOffsets=si(this._content,!0)),this._lineOffsets}positionAt(e){e=Math.max(Math.min(e,this._content.length),0);let n=this.getLineOffsets(),r=0,i=n.length;if(i===0)return{line:0,character:e};for(;r<i;){let o=Math.floor((r+i)/2);n[o]>e?i=o:r=o+1}let a=r-1;return{line:a,character:e-n[a]}}offsetAt(e){let n=this.getLineOffsets();if(e.line>=n.length)return this._content.length;if(e.line<0)return 0;let r=n[e.line],i=e.line+1<n.length?n[e.line+1]:this._content.length;return Math.max(Math.min(r+e.character,i),r)}get lineCount(){return this.getLineOffsets().length}static isIncremental(e){let n=e;return n!=null&&typeof n.text=="string"&&n.range!==void 0&&(n.rangeLength===void 0||typeof n.rangeLength=="number")}static isFull(e){let n=e;return n!=null&&typeof n.text=="string"&&n.range===void 0&&n.rangeLength===void 0}},Ee;(function(t){function e(i,a,o,s){return new Fe(i,a,o,s)}t.create=e;function n(i,a,o){if(i instanceof Fe)return i.update(a,o),i;throw new Error("TextDocument.update: document must be created by TextDocument.create")}t.update=n;function r(i,a){let o=i.getText(),s=En(a.map(no),(p,f)=>{let b=p.range.start.line-f.range.start.line;return b===0?p.range.start.character-f.range.start.character:b}),l=0,d=[];for(let p of s){let f=i.offsetAt(p.range.start);if(f<l)throw new Error("Overlapping edit");f>l&&d.push(o.substring(l,f)),p.newText.length&&d.push(p.newText),l=i.offsetAt(p.range.end)}return d.push(o.substr(l)),d.join("")}t.applyEdits=r})(Ee||(Ee={}));function En(t,e){if(t.length<=1)return t;let n=t.length/2|0,r=t.slice(0,n),i=t.slice(n);En(r,e),En(i,e);let a=0,o=0,s=0;for(;a<r.length&&o<i.length;)e(r[a],i[o])<=0?t[s++]=r[a++]:t[s++]=i[o++];for(;a<r.length;)t[s++]=r[a++];for(;o<i.length;)t[s++]=i[o++];return t}function si(t,e,n=0){let r=e?[n]:[];for(let i=0;i<t.length;i++){let a=t.charCodeAt(i);(a===13||a===10)&&(a===13&&i+1<t.length&&t.charCodeAt(i+1)===10&&i++,r.push(n+i+1))}return r}function li(t){let e=t.start,n=t.end;return e.line>n.line||e.line===n.line&&e.character>n.character?{start:n,end:e}:t}function no(t){let e=li(t.range);return e!==t.range?{newText:t.newText,range:e}:t}var Nt;(function(t){t.EN_US="en_US",t.EN_GB="en_GB"})(Nt||(Nt={}));var ci;(function(t){t.LATEST={textDocument:{completion:{completionItem:{documentationFormat:[te.Markdown,te.PlainText]}},hover:{contentFormat:[te.Markdown,te.PlainText]}}}})(ci||(ci={}));var di;(function(t){t[t.Unknown=0]="Unknown",t[t.File=1]="File",t[t.Directory=2]="Directory",t[t.SymbolicLink=64]="SymbolicLink"})(di||(di={}));var pi=["implict_control_flow","choice_randomtest","choice_quicktest"];var sl=ce(),Dn=st.Snippet,ne;(function(t){t.Enums=" ",t.Normal="d",t.VendorPrefixed="x",t.Term="y",t.Label="x",t.Variable="z"})(ne||(ne={}));var hi=function(){function t(e,n){e===void 0&&(e=null),this.variablePrefix=e,this.clientCapabilities=n,this.completionParticipants=[],this.typo=null,this.valueTypes=[m.Identifier,m.Value,m.StringLiteral,m.NumericValue,m.HexColorValue,m.PrintVariable];var r="test/dictionaries/"}return t.prototype.configure=function(e){this.settings=e},t.prototype.getSymbolContext=function(e){if(!e&&!this.symbolContext)this.symbolContext=new K(this.scene);else if(e)return new K(e);return this.symbolContext},t.prototype.setCompletionParticipants=function(e){this.completionParticipants=e||[]},t.prototype.doComplete=function(e,n,r,i){var a=this;i===void 0&&(i=!0),this.offset=e.offsetAt(n),this.position=n,this.currentWord=ro(e,this.offset),this.defaultReplaceRange=_.create(Y.create(this.position.line,this.position.character-this.currentWord.length),this.position),this.textDocument=e,this.scene=r;var o={isIncomplete:!1,items:[]};try{this.nodePath=ft(this.scene,this.offset);for(var s=this.nodePath.length-1;s>=0;s--){var l=this.nodePath[s],d=l.findParent(m.VariableDeclaration);if(d)return this.getCompletionsForVariableDeclaration(d,e.uri,o),new Promise(function(p,f){p(a.finalize(o))});if(l.type===m.LabelRef)return this.getLabelProposals(l,e.uri,o),new Promise(function(p,f){p(a.finalize(o))});if(l.type===m.SceneRef)return this.getSceneProposals(l,e.uri,o),new Promise(function(p,f){p(a.finalize(o))});if(l.type===m.Identifier)return this.getVariableProposals(l,e.uri,o),new Promise(function(p,f){p(a.finalize(o))});if(l.type===m.Variable)return this.getVariableProposals(l,e.uri,o),new Promise(function(p,f){p(a.finalize(o))});if(l.hasIssue(x.UnknownCommand))return this.getCompletionsForCommands(o),new Promise(function(p,f){p(a.finalize(o))})}}finally{this.position=null,this.currentWord=null,this.textDocument=null,this.scene=null,this.symbolContext=null,this.defaultReplaceRange=null,this.nodePath=null}return new Promise(function(p,f){p(a.finalize(o))})},t.prototype.isImportPathParent=function(e){return e===m.Import},t.prototype.finalize=function(e){var n=e.items.some(function(r){return!!r.sortText||r.label[0]==="-"});return n&&e.items.forEach(function(r,i){r.sortText?r.label[0]==="-"?r.sortText+=ne.VendorPrefixed+"_"+Tt(i):r.sortText+=ne.Normal+"_"+Tt(i):r.label[0]==="-"?r.sortText=ne.VendorPrefixed+"_"+Tt(i):r.sortText=ne.Normal+"_"+Tt(i)}),e},t.prototype.findInNodePath=function(){for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n];for(var r=this.nodePath.length-1;r>=0;r--){var i=this.nodePath[r];if(e.indexOf(i.type)!==-1)return i}return null},t.prototype.getCompletionsForIdentifier=function(e){for(var n=this,r=tt().filter(function(o){return n.currentWord.slice(0,1)===o.name.slice(0,1)}),i=0,a=r;i<a.length;i++)e.items.push({label:a[i].name,detail:"(command)",documentation:"TBD",textEdit:T.replace(this.getCompletionRange(null),a[i].name),kind:A.Keyword});return e},t.prototype.getCompletionsForCommands=function(e){for(var n=this,r=tt().filter(function(o){return n.currentWord.slice(0,1)===o.name.slice(0,1)}),i=0,a=r;i<a.length;i++)e.items.push({label:a[i].name,detail:"(command)",documentation:a[i].description,textEdit:T.replace(this.getCompletionRange(null),a[i].name),kind:A.Keyword});return e},t.prototype.getSuggestionsForSpellings=function(e){var n=this,r=this,i=this.currentWord,a=this.getCompletionRange(null);return new Promise(function(o,s){n.typo.working?s(e):(n.typo.working=!0,n.typo.suggest(i,5,function(l){var d={items:[],isIncomplete:!1},p={label:"Ignore '"+i+"' this session.",documentation:"",textEdit:null,filterText:i,sortText:"b",insertText:i,kind:A.Property},f={label:"Add '"+i+"' to user dictionary.",documentation:"",textEdit:null,filterText:i,sortText:"c",insertText:i,kind:A.Property,command:{command:"editor.action.triggerSuggest",title:"123"}},b={label:"No spelling suggestions for '"+i+"'.",documentation:"",textEdit:null,insertText:i,kind:A.Keyword};l.length<1?d.items.push(b):d.items=d.items.concat(l.map(function(u){return{label:u,detail:"spelling suggestion",textEdit:T.replace(a,u),filterText:i,sortText:"a",insertText:u,kind:A.Text}})),d.items.push(p,f),r.typo.working=!1,o(d)}))})},t.prototype.getCSSWideKeywordProposals=function(e,n,r){for(var i in Qt)r.items.push({label:i,documentation:Qt[i],textEdit:T.replace(this.getCompletionRange(n),i),kind:A.Keyword});return r},t.prototype.getLabelProposals=function(e,n,r){var i=this,a,o,s,l=[],d=e,p;if(p=d.getSceneRef()){var f=(a=J.index.getProjectIndexForScene(n))===null||a===void 0?void 0:a.getSceneNodeByName(p.name);f&&(l=(o=this.getSymbolContext(f))===null||o===void 0?void 0:o.findSymbolsAtOffset(0,W.Label))}else l=this.getSymbolContext().findSymbolsAtOffset(0,W.Label);if(l=l.filter(function(D){return D.name.indexOf(e.getText())===0}),((s=this.settings)===null||s===void 0?void 0:s.cslib)&&p&&p.name){var b=ke[p.name];if(b){var u=Object.keys(b);r.items=r.items.concat(u.map(function(D){var O,R=(O=b[D].params)===null||O===void 0?void 0:O.length,P="(subroutine) "+p.name+(R?": "+R+" parameter(s)":"");return{label:D,documentation:b[D].lines.join(`
`),detail:P,textEdit:T.replace(i.getCompletionRange(e),D),kind:A.Function,sortText:ne.Label}}))}}for(var y=0,k=l;y<k.length;y++){var E=k[y],z={label:E.name,documentation:E.value?zt(E.value):E.value,detail:"(label)",textEdit:T.replace(this.getCompletionRange(e),E.name),kind:A.Function,sortText:ne.Label};r.items.push(z)}return r},t.prototype.getSceneProposals=function(e,n,r){var i,a,o=(i=J.index.getProjectIndexForScene(n))===null||i===void 0?void 0:i.getSceneList();if(!o)return r;!((a=this.settings)===null||a===void 0)&&a.cslib&&(o=o.concat(Dr)),o=o.filter(function(f){return f.indexOf(e.getText())===0});for(var s=0,l=o;s<l.length;s++){var d=l[s],p={label:d,documentation:"",detail:/^cslib_.*$/.test(d)?"(scene) ChoiceScript Library":"(scene)",textEdit:T.replace(this.getCompletionRange(e),d),kind:A.File,sortText:ne.Normal};r.items.push(p)}return r},t.prototype.getVariableProposals=function(e,n,r){var i=this,a,o=[],s=[];s=this.getSymbolContext().findSymbolsAtOffset(0,W.Variable);var l=(a=J.index.getProjectIndexForScene(n))===null||a===void 0?void 0:a.getSceneNodeByName("startup");l&&(o=this.getSymbolContext(l).findSymbolsAtOffset(0,W.Variable));var d=pi.filter(function(z){return z.indexOf(e.getText())===0}),p=d.map(function(z){return{label:z,detail:"(internal variable) global",textEdit:T.replace(i.getCompletionRange(e),z),kind:A.Variable,sortText:ne.Variable}});r.items=r.items.concat(p),s=s.filter(function(z){return z.name.indexOf(e.getText())===0}),o=o.filter(function(z){return z.name.indexOf(e.getText())===0});for(var f=0,b=s;f<b.length;f++){var u=b[f],y={label:u.name,documentation:u.value?zt(u.value):u.value,detail:"(variable) local",textEdit:T.replace(this.getCompletionRange(e),u.name),kind:A.Variable,sortText:ne.Variable};r.items.push(y)}for(var k=0,E=o;k<E.length;k++){var u=E[k],y={label:u.name,documentation:u.value?zt(u.value):u.value,detail:"(variable) global",textEdit:T.replace(this.getCompletionRange(e),u.name),kind:A.Variable,sortText:ne.Variable};r.items.push(y)}return r},t.prototype.getUnitProposals=function(e,n,r){var i="0";if(this.currentWord.length>0){var a=this.currentWord.match(/^-?\d[\.\d+]*/);a&&(i=a[0],r.isIncomplete=i.length===this.currentWord.length)}else this.currentWord.length===0&&(r.isIncomplete=!0);if(n&&n.parent&&n.parent.type===m.Term&&(n=n.getParent()),e.restrictions)for(var o=0,s=e.restrictions;o<s.length;o++){var l=s[o],d=Ir[l];if(d)for(var p=0,f=d;p<f.length;p++){var b=f[p],u=i+b;r.items.push({label:u,textEdit:T.replace(this.getCompletionRange(n),u),kind:A.Unit})}}return r},t.prototype.getCompletionRange=function(e){if(e&&e.offset<=this.offset&&this.offset<=e.end){var n=e.end!==-1?this.textDocument.positionAt(e.end):this.position,r=this.textDocument.positionAt(e.offset);if(r.line===n.line)return _.create(r,n)}return this.defaultReplaceRange},t.prototype.getPositionProposals=function(e,n,r){for(var i in Ht)r.items.push({label:i,documentation:Ht[i],textEdit:T.replace(this.getCompletionRange(n),i),kind:A.Value});return r},t.prototype.getRepeatStyleProposals=function(e,n,r){for(var i in Kt)r.items.push({label:i,documentation:Kt[i],textEdit:T.replace(this.getCompletionRange(n),i),kind:A.Value});return r},t.prototype.getLineStyleProposals=function(e,n,r){for(var i in Xt)r.items.push({label:i,documentation:Xt[i],textEdit:T.replace(this.getCompletionRange(n),i),kind:A.Value});return r},t.prototype.getLineWidthProposals=function(e,n,r){for(var i=0,a=Rr;i<a.length;i++){var o=a[i];r.items.push({label:o,textEdit:T.replace(this.getCompletionRange(n),o),kind:A.Value})}return r},t.prototype.getGeometryBoxProposals=function(e,n,r){for(var i in $t)r.items.push({label:i,documentation:$t[i],textEdit:T.replace(this.getCompletionRange(n),i),kind:A.Value});return r},t.prototype.getBoxProposals=function(e,n,r){for(var i in Zt)r.items.push({label:i,documentation:Zt[i],textEdit:T.replace(this.getCompletionRange(n),i),kind:A.Value});return r},t.prototype.getImageProposals=function(e,n,r){for(var i in en){var a=Rn(i);r.items.push({label:i,documentation:en[i],textEdit:T.replace(this.getCompletionRange(n),a),kind:A.Function,insertTextFormat:i!==a?Dn:void 0})}return r},t.prototype.getTimingFunctionProposals=function(e,n,r){for(var i in tn){var a=Rn(i);r.items.push({label:i,documentation:tn[i],textEdit:T.replace(this.getCompletionRange(n),a),kind:A.Function,insertTextFormat:i!==a?Dn:void 0})}return r},t.prototype.getBasicShapeProposals=function(e,n,r){for(var i in nn){var a=Rn(i);r.items.push({label:i,documentation:nn[i],textEdit:T.replace(this.getCompletionRange(n),a),kind:A.Function,insertTextFormat:i!==a?Dn:void 0})}return r},t.prototype.getCompletionsForVariableDeclaration=function(e,n,r){return e.hasIssue(x.VariableNameExpected)&&this.getVariableProposals(e.getExpr(),n,r),r},t.prototype.getCompletionForUriLiteralValue=function(e,n){var r,i,a;if(e.hasChildren()){var s=e.getChild(0);r=s.getText(),i=this.position,a=this.getCompletionRange(s)}else{r="",i=this.position;var o=this.textDocument.positionAt(e.offset+4);a=_.create(o,o)}return this.completionParticipants.forEach(function(l){l.onCssURILiteralValue&&l.onCssURILiteralValue({uriValue:r,position:i,range:a})}),n},t.prototype.getCompletionForImportPath=function(e,n){var r=this;return this.completionParticipants.forEach(function(i){i.onCssImportPath&&i.onCssImportPath({pathValue:e.getText(),position:r.position,range:r.getCompletionRange(e)})}),n},t.prototype.doesSupportMarkdown=function(){if(!Pe(this.supportsMarkdown)){if(!Pe(this.clientCapabilities))return this.supportsMarkdown=!0,this.supportsMarkdown;var e=this.clientCapabilities.textDocument&&this.clientCapabilities.textDocument.completion;this.supportsMarkdown=e&&e.completionItem&&Array.isArray(e.completionItem.documentationFormat)&&e.completionItem.documentationFormat.indexOf(te.Markdown)!==-1}return this.supportsMarkdown},t}();function Tt(t){var e=t.toString();switch(e.length){case 4:return e;case 3:return"0"+e;case 2:return"00"+e;case 1:return"000"+e;default:return"0000"}}var ll=function(){function t(){this.entries={}}return t.prototype.add=function(e){this.entries[e]=!0},t.prototype.getEntries=function(){return Object.keys(this.entries)},t}();function Rn(t){return t.replace(/\(\)$/,"($1)")}function ro(t,e){for(var n=e-1,r=t.getText();n>=0&&` 	
\r":{[()]},*>+`.indexOf(r.charAt(n))===-1;)n--;return r.substring(n+1,e)}var mi=function(){function t(e){this.clientCapabilities=e}return t.prototype.doHover=function(e,n,r){function i(O){return _.create(e.positionAt(O.offset),e.positionAt(O.end))}for(var a=e.offsetAt(n),o=ft(r,a),s=null,l=0;l<o.length;l++){var d=o[l];if(d instanceof _e){s={contents:["**Label**: "+d.getValue()],range:i(d)};var p=d.findAParent(m.GosubCommand,m.GotoCommand);if(p){var f=d.getValue(),b="",u=void 0,y=void 0;switch(p.name){case"gosub":case"goto":b=e.uri.slice(e.uri.lastIndexOf("/")+1,-4);break;case"gosub_scene":case"goto_scene":var k=p.getSceneRef();if(!k)return null;b=k.name||"";break;default:return null}(u=ke[b])&&(y=u[f])&&s.contents.push(y.lines.join(`
`))}break}if(d instanceof j){var E=d.name,z=tt(),D=z.map(function(O){return O.name}).indexOf(E);D!==-1&&(s={contents:z[D].description,range:i(d)});continue}}return s&&(s.contents=this.convertContents(s.contents)),s},t.prototype.convertContents=function(e){return this.doesSupportMarkdown()||typeof e=="string"?e:"kind"in e?{kind:"plaintext",value:e.value}:Array.isArray(e)?e.map(function(n){return typeof n=="string"?n:n.value}):e.value},t.prototype.doesSupportMarkdown=function(){if(!Pe(this.supportsMarkdown)){if(!Pe(this.clientCapabilities))return this.supportsMarkdown=!0,this.supportsMarkdown;var e=this.clientCapabilities.textDocument&&this.clientCapabilities.textDocument.hover;this.supportsMarkdown=e&&e.contentFormat&&Array.isArray(e.contentFormat)&&e.contentFormat.indexOf(te.Markdown)!==-1}return this.supportsMarkdown},t}();var ui=function(){function t(){}return t.prototype.findSceneDefinition=function(e,n){var r=J.index.sync(e.uri),i=r?.getSceneDocByName(n.getText());return i?{uri:i.uri,range:_.create(Y.create(0,0),Y.create(0,0))}:null},t.prototype.getRoutineInfo=function(e,n,r){function i(I,N){var M=new K(I).findSymbol(N,W.Label,0);if(!M)return null;var L=M.node.findParent(m.Line),q=L.getNextSibling();if(!q)return null;var Z=q.getChild(0);return Z&&Z.type===m.ParamsCommand?Z:null}function a(I,N,M){var L=I.getParameterList();if(!L)return 0;var q=L.getChildren();if(q.length<1)return 0;if(!N)return q.length<M?q.length-1:M-1;var Z=q.indexOf(N);return Z<0||Z>=M?M-1:Z}function o(I){return I?typeof I.name>"u"?"":I.name:e.uri.slice(e.uri.lastIndexOf("/")+1,-4)}function s(I,N){var M;switch(N?.type){case m.Scene:N=(M=N.getChild(N.getChildren().length-1))===null||M===void 0?void 0:M.getChild(0);break;case m.Line:N=N.getChild(0);break;case null:case void 0:return null;default:N=N.findParent(m.GosubCommand);break}return!N||N.type!==m.GosubCommand?null:N}var l=J.index.getProjectIndexForScene(e.uri);if(!l)return null;var d=Ie(r,n),p=d?.findAParent(m.Param),f=s(r,d);if(!f)return null;var b=f.getSceneRef();if(!b)return null;var u=f.getLabelRef();if(!u||typeof u.name>"u")return null;var y=o(b),k=u.name,E,z={activeParameter:0,activeSignature:0,parameters:[]};if(/^cslib_\w+/.test(y)&&(E=ke[y])&&E[k].params)return z.parameters=E[k].params,z.activeParameter=a(f,p,z.parameters.length),z;if(!y||!k)return null;var D=l.getSceneNodeByName(y);if(!D)return null;var O=i(D,k);if(!O)return null;for(var R=O.getVariableCount(),P=0;P<R;P++)z.parameters.push({label:O.getVariable(P).getName()});return z.activeParameter=a(f,p,R),z},t.prototype.findParameters=function(e,n,r){var i=[],a=J.index.getProjectIndexForScene(e.uri),o=a?.getSceneNodeByName(n);if(!o)return null;var s=new K(o).findSymbol(r,W.Label,0);if(!s)return null;var l=s.node.findParent(m.Line),d=l.getNextSibling();if(!d)return null;var p=d.getChild(0);if(p?.type===m.ParamsCommand){for(var f=p,b=f.getVariableCount(),u=0;u<b;u++)i.push(f.getVariable(u).getName());return i}else return null},t.prototype.findSceneLabelDefinition=function(e,n){var r=n.parent,i=r.getSceneRef();if(i&&i.hasChildren()&&i.getChildren()[0].type===m.Scene){var a=i.getChildren()[0].getText(),o=J.index.sync(e.uri),s=o?.getSceneNodeByName(a),l=o?.getSceneDocByName(a);if(!s||!s)return null;var d=new K(s).findSymbol(n.getText(),W.Label,0);if(d)return{uri:l.uri,range:De(d.node,l)}}return null},t.prototype.findDefinitionGlobal=function(e,n,r){var i;function a(f){var b=J.index.sync(e.uri),u=b?.getSceneDocByName("startup"),y=b?.getSceneNodeByName("startup");if(u&&y){var k=new K(y),E=k.findSymbol(f.getText(),W.Variable,0);if(E)return{uri:u.uri,range:De(E.node,u)}}return null}var o=new K(r),s=e.offsetAt(n),l=Ie(r,s);if(l){if(l.type===m.Scene)return this.findSceneDefinition(e,l);if(l.type===m.Label&&((i=l.parent)===null||i===void 0?void 0:i.type)===m.LabelRef){var d=this.findSceneLabelDefinition(e,l);if(d)return d}var p=o.findSymbolFromNode(l);return p?{uri:e.uri,range:De(p.node,e)}:a(l)}return null},t.prototype.findDefinition=function(e,n,r){var i=new K(r),a=e.offsetAt(n),o=Ie(r,a);if(!o)return null;var s=i.findSymbolFromNode(o);return s?{uri:e.uri,range:De(s.node,e)}:null},t.prototype.findReferences=function(e,n,r){var i=[],a=J.index.sync(e.uri);if(!a)return i;var o=e.offsetAt(n),s=Ie(r,o);if(!s||s.type===m.Scene||s.type===m.VariableDeclaration)return i;var l=new K(r),d=l.findSymbolFromNode(s);if(!d)return i;if(a)for(var p=function(z,D){return function(O){var R;return D.matchesSymbol(O,d)?(((R=O.parent)===null||R===void 0?void 0:R.type)===m.VariableDeclaration||i.push({uri:z.uri,range:De(O,z)}),!1):!0}},f=0,b=a.getSceneList();f<b.length;f++){var u=b[f],y=a.getSceneNodeByName(u),k=a.getSceneDocByName(u);if(!(!k||!y)){var E=new K(y);y.accept(p(k,E))}}return i},t.prototype.findDocumentSymbols=function(e,n,r){r===void 0&&(r=!1);var i=[],a=function(d){return function(p){var f=[];function b(R,P){return P===void 0&&(P=we.Object),{name:R,kind:P,location:null}}if(p instanceof yt){for(var u=0,y=p.getChildren();u<y.length;u++){var k=y[u],E=k,z=b(E.getName(),we.Variable);z.location=ye.create(d.uri,De(p,d)),i.push(z)}return!0}var D,O=p;return p instanceof wt?D=b(p.getName(),we.Variable):p instanceof xt&&(D=b(p.getLabel().name,we.Function)),D&&(D.location=ye.create(d.uri,De(O,d)),i.push(D)),!0}};if(r){var o=J.index.sync(e.uri),s=o?.getSceneNodeByName("startup"),l=o?.getSceneDocByName("startup");s&&l&&s.accept(a(l))}return n.accept(a(e)),i},t}();function De(t,e){return _.create(e.positionAt(t.offset),e.positionAt(t.end))}function In(t){if(typeof Window>"u"&&typeof XMLHttpRequest>"u")return za("fs").readFileSync(t).toString();var e=new XMLHttpRequest;return e.open("GET",t,!1),e.overrideMimeType&&e.overrideMimeType("text/plain; charset=utf-8"),e.send(null),e.responseText}var Q=ce(),Be=V.Warning,Ve=V.Error,wl=V.Ignore,re=function(){function t(e,n,r){this.id=e,this.message=n,this.defaultValue=r}return t}();var fi=function(){function t(e,n,r){this.id=e,this.message=n,this.defaultValue=r}return t}();var H={ReservedVariablePrefix:new re("reservedWord",Q("rule.reservedWord","This is a reserved word and cannot be used as a variable name."),Ve),ReservedWord:new re("reservedVariablePrefix",Q("rule.reservedVariablePrefix","You cannot create variables with the reserved 'choice_' prefix."),Ve),DuplicateUniqueCommand:new re("duplicateUniqueCommand",Q("rule.duplicateUniqueCommand","You only need to execute this command once."),Be),UnusualStatsCommand:new re("unusualStats",Q("rule.unusualStatCommand","Unexpected use of a scene navigation command from within choicescript_stats.txt."),Be),ConstError:new re("constError",Q("rule.constError","Assignment to a constant variable."),Be),TypeError:new re("typeError",Q("rule.typeError","Assignment of a value type that does not match the definition type."),Be),ScriptCommandUnsupported:new re("scriptCommandUnsupported",Q("rule.scriptCommandUnsupported","The *script command is not supported."),Ve),InvalidInitialCommand:new re("invalidInitialCommand",Q("rule.invalidInitialCommand","This command is only allowed at the top of startup.txt."),Ve),InvalidIfId:new re("invalidIfId",Q("rule.invalidIfId","An IFID should have five parts (e.g. a0a0a0a0-a0a0-a0a0-a0a0-a0a0a0a0a0a0) and consist only of the letters A-F, numbers, and dashes."),Ve),DeprecatedCommand:new re("deprecatedCommand",Q("rule.deprecatedCommand","This command has been deprecated and may be removed in the future."),Be),DeprecatedOperatorPercent:new re("DeprecatedOperatorPercent",Q("rule.deprecatedOperatorPercent","The percent '%' operator has been removed in favour of 'modulo'."),Ve),BadSpelling:new re("badSpelling",Q("rule.badSpelling","Bad spelling."),Be)},xl={TypeSafety:new fi("typeSafety",Q("setting.typeSafety","Error on type conflict"),!1),ValidProperties:new fi("validProperties",Q("rule.validProperties","A list of properties that are not validated against the `unknownProperties` rule."),[])},gi=function(){function t(e){e===void 0&&(e={}),this.conf=e}return t.prototype.getRule=function(e){if(this.conf.hasOwnProperty(e.id)){var n=io(this.conf[e.id]);if(n!==null)return n}return e.defaultValue},t.prototype.getSetting=function(e){return this.conf[e.id]},t}();function io(t){switch(t){case"ignore":return V.Ignore;case"warning":return V.Warning;case"error":return V.Error}return null}var bi=ce(),vi=5,kl=function(){function t(){this.data={}}return t.prototype.add=function(e,n,r){var i=this.data[e];i||(i={nodes:[],names:[]},this.data[e]=i),i.names.push(n),r&&i.nodes.push(r)},t}(),yi=function(){function t(e,n,r){this.misspellings=[],this.userDics={persistent:{},session:{}},this.documentText=e.getText(),this.nspell=n,this.userDics=r||this.userDics}return t.entries=function(e,n,r,i){var a=new t(n,r,i);return e.acceptVisitor(a),a.getEntries()},t.prototype.findValueInExpression=function(e,n){var r=!1;return e.accept(function(i){return i.type===m.Identifier&&i.getText()===n&&(r=!0),!r}),r},t.prototype.getEntries=function(){return this.misspellings},t.prototype.addEntry=function(e,n,r){var i=new Oe(e,n,V.Information,r,e.offset,e.length);this.misspellings.push(i)},t.prototype.getMissingNames=function(e,n){e=e.slice(0);for(var r=0;r<n.length;r++){var i=e.indexOf(n[r]);i!==-1&&(e[i]=null)}for(var a=null,r=0;r<e.length;r++){var o=e[r];o&&(a===null?a=bi("namelist.single","'{0}'",o):a=bi("namelist.concatenated","{0}, '{1}'",a,o))}return a},t.prototype.wordInUserDics=function(e){e=e.toLowerCase();for(var n in this.userDics)if(this.userDics[n][e])return!0;return!1},t.prototype.visitNode=function(e){switch(e.type){case m.Scene:return this.visitScene(e);case m.TextLine:return!0;case m.RealWord:return this.visitWord(e);case m.VariableReplacement:return!0;case m.Expression:return!0;case m.StringLiteral:return!0;case m.MultiReplace:return!0;case m.MultiReplaceOption:return!0;default:return!0}},t.prototype.visitScene=function(e){return!0},t.prototype.visitWord=function(e){var n=e.getText();return!this.nspell.correct(n)&&!this.wordInUserDics(n)&&this.addEntry(e,H.BadSpelling,"Bad spelling: "+e.getText()),!0},t.prefixes=["-ms-","-moz-","-o-","-webkit-"],t}();var _l=ce(),wi=function(){function t(e,n){var r;this.warnings=[],this.globalVars=null,this.settings=n,this.documentText=e.getText(),this.document=e,this.startupScene=(r=J.index.getProjectIndexForScene(e.uri))===null||r===void 0?void 0:r.getSceneNodeByName("startup"),this.startupScene&&(this.globalVars=new K(this.startupScene))}return t.entries=function(e,n,r,i){var a=new t(n,r);return e.acceptVisitor(a),a.completeValidations(),a.getEntries(i)},t.prototype.getEntries=function(e){return e===void 0&&(e=V.Warning|V.Error),this.warnings.filter(function(n){return(n.getLevel()&e)!==0})},t.prototype.addEntry=function(e,n,r){var i=new Oe(e,n,this.settings.getRule(n),r);this.warnings.push(i)},t.prototype.visitNode=function(e){switch(e.type){case m.Scene:return this.visitScene(e);case m.VariableDeclaration:return this.visitVariableDeclaration(e);case m.StandardCommand:case m.JumpCommand:case m.GotoCommand:case m.GosubCommand:case m.IfIdCommand:case m.Command:return this.visitCommand(e);case m.Operator:return this.visitOperator(e)}return!0},t.prototype.completeValidations=function(){},t.prototype.visitScene=function(e){return this.lintInitialCommands(e),e.isStartup()&&this.lintUniqueCommands(e),e.isStats()&&this.lintChoiceScriptStats(e),!0},t.prototype.visitVariableDeclaration=function(e){var n,r=(n=e.getVariable())===null||n===void 0?void 0:n.getName();if(r)/^choice_/.test(r)?this.addEntry(e,H.ReservedVariablePrefix):Sr.indexOf(r)>=0&&this.addEntry(e,H.ReservedWord);else return!0;return!0},t.prototype.visitCommand=function(e){var n,r;if(e.name==="script"&&this.addEntry(e,H.ScriptCommandUnsupported),Qe[e.name]&&Qe[e.name].type===g.Deprecated&&this.addEntry(e,H.DeprecatedCommand),e instanceof hr,e instanceof vt){var i=e,a=i.getVariable(),o=i.getExpr();if(a&&o){var s=J.index.getProjectIndexForScene(this.document.uri);if(s){var l=s.getSceneSymbolsByName("startup"),d=l?.findSymbol(a.getText(),W.Variable,0);if(d){var p=d.node;!((n=p.getVariable())===null||n===void 0)&&n.const&&this.addEntry(e,H.ConstError),o?.csType!==((r=p.getExpr())===null||r===void 0?void 0:r.csType)&&this.addEntry(e,H.TypeError)}}}}return!0},t.prototype.visitOperator=function(e){return e.getText()==="%"&&this.addEntry(e,H.DeprecatedOperatorPercent),!1},t.prototype.lintInitialCommands=function(e){for(var n=!!e.isStartup(),r=0,i=e.getChildren();r<i.length;r++){var a=i[r];if(a.type===m.Line){{var o=a;if(o.getLineType()!==$.ChoiceScript)continue}for(var s=void 0,l=0;(s=a.getChild(l++))&&!(s instanceof j););if(s instanceof j){if(s&&s.hasIssue(x.UnknownCommand))continue;if(s&&s.name==="comment")continue}else continue;var d=Qe[s.name];d.type===g.Initial&&!n?this.addEntry(s,H.InvalidInitialCommand):d.type!==g.Initial&&(n=!1)}}},t.prototype.lintChoiceScriptStats=function(e){for(var n=0,r=e.getChildren();n<r.length;n++){var i=r[n];if(i.type===m.Line){{var a=i;if(a.getLineType()!==$.ChoiceScript)continue}for(var o=void 0,s=0;(o=i.getChild(s++))&&!(o instanceof j););if(o instanceof j){var l=o;switch(l.name){case"finish":case"goto_scene":case"ending":this.addEntry(l,H.UnusualStatsCommand);default:break}}}}},t.prototype.lintUniqueCommands=function(e){for(var n={author:!1,scene_list:!1,title:!1,ifid:!1},r=0,i=e.getChildren();r<i.length;r++){var a=i[r];if(a.type===m.Line){{var o=a;if(o.getLineType()!==$.ChoiceScript)continue}for(var s=void 0,l=0;(s=a.getChild(l++))&&!(s instanceof j););if(s instanceof j){var d=s;if(d.name==="ifid"&&d.type===m.IfIdCommand){var p=d;p.isValid()||this.addEntry(d,H.InvalidIfId)}if(typeof n[d.name]=="boolean"){if(!n[d.name]){n[d.name]=!0;continue}this.addEntry(d,H.DuplicateUniqueCommand)}}}}},t.prefixes=["-ms-","-moz-","-o-","-webkit-"],t}();var ma=Ea(ha()),ua=function(){function t(){this.settings={validate:!0,spellcheck:{paths:{affix:"",dics:[]},enabled:!1,dictionary:Nt.EN_US,userDictionary:{session:{},persistent:{}}},lint:{}},this.nspell=null}return t.prototype.configure=function(e){this.settings=e,typeof this.settings.spellcheck<"u"&&this.settings.spellcheck.enabled&&this.settings.spellcheck.paths.affix&&(this.nspell=(0,ma.default)(this.loadDictionary(e)))},t.prototype.loadDictionary=function(e){if(!(!this.settings&&this.settings.spellcheck.enabled)){var n=e.spellcheck.dictionary,r=In(e.spellcheck.paths.affix),i=In(e.spellcheck.paths.dics[0]);return{aff:r,dic:i}}},t.prototype.suggestSpelling=function(e){var n,r=this,i=[],a=((n=this.settings)===null||n===void 0?void 0:n.spellcheck.suggestLimit)||vi;if(!r.nspell)i.push(new Promise(function(p,f){p([])}));else for(var o=function(p){i.push(new Promise(function(f,b){var u=r.nspell.suggest(p).slice(0,a);f(u)}))},s=0,l=e;s<l.length;s++){var d=l[s];o(d)}return Promise.all(i)},t.prototype.addWordsToDictionary=function(e){var n=this,r=[];if(n.nspell)for(var i=function(l){r.push(new Promise(function(d,p){var f;n.nspell.add(l),d(!((f=n.nspell)===null||f===void 0)&&f.correct(l)?l:"")}))},a=0,o=e;a<o.length;a++){var s=o[a];i(s)}else return new Promise(function(l,d){l([])});return Promise.all(r)},t.prototype.removeWordsFromDictionary=function(e){var n=this,r=[];if(n.nspell)for(var i=function(l){r.push(new Promise(function(d,p){var f;n.nspell.remove(l),d(!((f=n.nspell)===null||f===void 0)&&f.correct(l)?"":l)}))},a=0,o=e;a<o.length;a++){var s=o[a];i(s)}else return new Promise(function(l,d){l([])});return Promise.all(r)},t.prototype.doValidation=function(e,n,r){r===void 0&&(r=this.settings);var i=[];if(r&&r.validate===!0&&i.push.apply(i,xr.entries(n)),r&&r.spellcheck.enabled===!0&&i.push.apply(i,yi.entries(n,e,this.nspell,this.settings.spellcheck.userDictionary)),r&&r.lint&&r.lint.enabled===!0&&i.push.apply(i,wi.entries(n,e,new gi(r&&r.lint))),r&&!r.spellcheck.enabled&&!r.validate)return[];var a=[];for(var o in H)a.push(H[o].id);function s(l){var d=_.create(e.positionAt(l.getOffset()),e.positionAt(l.getOffset()+l.getLength())),p=e.languageId;return{code:l.getRule().id,source:p,message:l.getMessage(),severity:l.getLevel(),range:d}}return i.filter(function(l){return l.getLevel()!==V.Ignore}).map(s)},t}();function fa(t){return Vo(new Ct,new hi(null,t&&t.clientCapabilities),new mi(t&&t.clientCapabilities),new ui,new ua,J.index)}function Vo(t,e,n,r,i,a){return{configure:function(o){i.configure(o),e.configure(o)},updateProject:a.sync.bind(a),purgeProject:a.purge.bind(a),doValidation:i.doValidation.bind(i),parseScene:t.parseScene.bind(t),doComplete:e.doComplete.bind(e),setCompletionParticipants:e.setCompletionParticipants.bind(e),doHover:n.doHover.bind(n),findDefinition:r.findDefinitionGlobal.bind(r),findDocumentSymbols:r.findDocumentSymbols.bind(r),findReferences:r.findReferences.bind(r),findParameters:r.findParameters.bind(r),getRoutineInfo:r.getRoutineInfo.bind(r),suggestSpelling:i.suggestSpelling.bind(i),addDictWords:i.addWordsToDictionary.bind(i),removeDictWords:i.removeWordsFromDictionary.bind(i)}}var Wt=class{_ctx;_csLanguageService;_cslanguageSettings;_languageId;constructor(e,n){switch(this._ctx=e,this._cslanguageSettings=n.languageSettings,this._languageId=n.languageId,this._languageId){case"choicescript":this._csLanguageService=fa(),this._csLanguageService.configure(this._cslanguageSettings);break;default:throw new Error("Invalid language id: "+this._languageId)}}async doHover(e,n){let r=this._getTextDocument(e);if(!r)return null;let i=this._csLanguageService.parseScene(r),a=this._csLanguageService.doHover(r,n,i);return Promise.resolve(a)}async doValidation(e){let n=this._getTextDocument(e);if(n){let r=this._csLanguageService.parseScene(n),i=this._csLanguageService.doValidation(n,r);return Promise.resolve(i)}return Promise.resolve([])}async addWords(e){return this._csLanguageService.addDictWords(e)}async removeWords(e){return this._csLanguageService.removeDictWords(e)}_getStartupTextDocument(){let e=this._ctx.getMirrorModels();for(let n of e)if(/\/startup\.txt$/.test(n.uri.toString()))return Ee.create(n.uri.toString(),this._languageId,n.version,n.getValue());return null}_getProjectPath(e){return e.slice(0,e.lastIndexOf("/")+1)}_getTextDocument(e){let n=this._ctx.getMirrorModels();for(let r of n)if(r.uri.toString()===e)return Ee.create(e,this._languageId,r.version,r.getValue())}_getAllProjectTextDocuments(e){let n=[],r=this._getProjectPath(e),i=this._ctx.getMirrorModels();for(let a of i)this._getProjectPath(a.uri.toString())===r&&n.push(Ee.create(a.uri.toString(),this._languageId,a.version,a.getValue()));return n}removeIndex(e){this._csLanguageService.purgeProject(e,[e])}updateIndex(e){let n=this._getTextDocument(e);!n||this._csLanguageService.updateProject(e,[n])}async doComplete(e,n){let r=this._getTextDocument(e);if(!r)return null;let i=this._csLanguageService.parseScene(r),a=this._csLanguageService.doComplete(r,n,i);return Promise.resolve(a)}async findDefinition(e,n){let r=this._getTextDocument(e);if(!r)return null;let i=this._csLanguageService.parseScene(r),a=this._csLanguageService.findDefinition(r,n,i);return Promise.resolve(a)}async findReferences(e,n){let r=this._getTextDocument(e);if(!r)return null;let i=this._csLanguageService.parseScene(r),a=this._csLanguageService.findReferences(r,n,i);return Promise.resolve(a)}async findDocumentSymbols(e){let n=this._getTextDocument(e);if(!n)return null;let r=this._csLanguageService.parseScene(n),i=this._csLanguageService.findDocumentSymbols(n,r,!1);return Promise.resolve(i)}async getRoutineInfo(e,n){let r=this._getTextDocument(e);if(!r)return null;let i=this._csLanguageService.parseScene(r);return this._csLanguageService.getRoutineInfo(r,n,i)}async findParameters(e,n,r){let i=this._getTextDocument(e);return i?this._csLanguageService.findParameters(i,n,r):null}async suggestSpelling(e){return this._csLanguageService.suggestSpelling(e)}configure(e){this._csLanguageService.configure(e)}};function Go(t,e){return new Wt(t,e)}return Da(Jo);})();
/*!

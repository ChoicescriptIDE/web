...
class Repository {
    ...
    constructor(repository, pushErrorHandlerRegistry, remoteSourcePublisherRegistry, postCommitCommandsProviderRegistry, branchProtectionProviderRegistry, globalState, logger, telemetryReporter) {
        this.repository = repository;
        ...
        const actionButton = new actionButton_1.ActionButtonCommand(this, this.commitCommandCenter);
    ...
    provideOriginalResource(uri) {
        ...
        if (this.submodules.some(s => (0, util_1.isDescendant)(path.join(this.repository.root, s.path), uri.path))) {
            return undefined;
        }

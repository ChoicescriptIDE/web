...
class LinkDetector {
            ...
            try {
                switch (part.kind) {
                    ...
                    case 'path':
                        ...
                        break;
                    case 'html':
                        if (htmlHelper_1.ttPolicy && trustHtml) {
                            const span = document.createElement('span');
                            span.innerHTML = htmlHelper_1.ttPolicy.createHTML(part.value).toString();
    ...
    detectLinks(text) {
        ...
        const regexes = [WEB_LINK_REGEX, PATH_LINK_REGEX, HTML_LINK_REGEX];
        const kinds = ['web', 'path', 'html'];
        const result = [];

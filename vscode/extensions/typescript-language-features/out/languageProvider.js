...
class LanguageProvider extends dispose_1.Disposable {
    ...
    async registerProviders() {
        ...
        await Promise.all([
            ...
            Promise.resolve().then(() => require('./languageFeatures/codeLens/implementationsCodeLens')).then(provider => this._register(provider.register(selector, this.description, this.client, cachedResponse))),
            Promise.resolve().then(() => require('./languageFeatures/codeLens/referencesCodeLens')).then(provider => this._register(provider.register(selector, this.description, this.client, cachedResponse))),
            Promise.resolve().then(() => require('./languageFeatures/completions')).then(provider => this._register(provider.register(selector, this.description, this.client, this.typingsStatus, this.fileConfigurationManager, this.commandManager, this.telemetryReporter, this.onCompletionAccepted))),
            ...
            Promise.resolve().then(() => require('./languageFeatures/formatting')).then(provider => this._register(provider.register(selector, this.description, this.client, this.fileConfigurationManager))),
            ...
            Promise.resolve().then(() => require('./languageFeatures/inlayHints')).then(provider => this._register(provider.register(selector, this.description, this.client, this.fileConfigurationManager))),
            Promise.resolve().then(() => require('./languageFeatures/jsDocCompletions')).then(provider => this._register(provider.register(selector, this.description, this.client, this.fileConfigurationManager))),
            Promise.resolve().then(() => require('./languageFeatures/linkedEditing')).then(provider => this._register(provider.register(selector, this.client))),
            ...
            Promise.resolve().then(() => require('./languageFeatures/rename')).then(provider => this._register(provider.register(selector, this.description, this.client, this.fileConfigurationManager))),
            ...
            Promise.resolve().then(() => require('./languageFeatures/sourceDefinition')).then(provider => this._register(provider.register(this.client, this.commandManager))),
            Promise.resolve().then(() => require('./languageFeatures/tagClosing')).then(provider => this._register(provider.register(selector, this.description, this.client))),

 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[63/*vs/css*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
...
define(__m[29/*vs/base/common/color*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$8r = exports.$7r = exports.$6r = exports.$5r = void 0;
    ...
    class $6r {
        ...
        static toRGBA(hsla) {
            ...
            return new $5r(Math.round(r * 255), Math.round(g * 255), Math.round(b * 255), a);
        }
    }
    exports.$6r = $6r;
    class $7r {
        ...
        static fromRGBA(rgba) {
            ...
            return new $7r(Math.round(m * 60), s, cmax, rgba.a);
        }
        ...
        static toRGBA(hsva) {
            ...
            return new $5r(r, g, b, a);
        }
    }
    exports.$7r = $7r;
    class $8r {
        static fromHex(hex) {
            return $8r.Format.CSS.parseHex(hex) || $8r.red;
        }
        static equals(a, b) {
            if (!a && !b) {
                return true;
        ...
        get hsva() {
            ...
            return $7r.fromRGBA(this.rgba);
        }
        constructor(arg) {
            if (!arg) {
                throw new Error('Color needs a value');
            }
            else if (arg instanceof $5r) {
                this.rgba = arg;
            }
            else if (arg instanceof $6r) {
                this.i = arg;
                this.rgba = $6r.toRGBA(arg);
            }
            else if (arg instanceof $7r) {
                this.j = arg;
                this.rgba = $7r.toRGBA(arg);
            }
            else {
        ...
        equals(other) {
            return !!other && $5r.equals(this.rgba, other.rgba) && $6r.equals(this.hsla, other.hsla) && $7r.equals(this.hsva, other.hsva);
        }
        /**
        ...
        getRelativeLuminance() {
            const R = $8r.k(this.rgba.r);
            const G = $8r.k(this.rgba.g);
            const B = $8r.k(this.rgba.b);
        ...
        lighten(factor) {
            return new $8r(new $6r(this.hsla.h, this.hsla.s, this.hsla.l + this.hsla.l * factor, this.hsla.a));
        }
        darken(factor) {
            return new $8r(new $6r(this.hsla.h, this.hsla.s, this.hsla.l - this.hsla.l * factor, this.hsla.a));
        }
        transparent(factor) {
            ...
            return new $8r(new $5r(r, g, b, a * factor));
        }
        isTransparent() {
        ...
        opposite() {
            return new $8r(new $5r(255 - this.rgba.r, 255 - this.rgba.g, 255 - this.rgba.b, this.rgba.a));
        }
        blend(c) {
            const rgba = c.rgba;
            ...
            if (a < 1e-6) {
                return $8r.transparent;
            }
            const r = this.rgba.r * thisA / a + rgba.r * colorA * (1 - thisA) / a;
            const g = this.rgba.g * thisA / a + rgba.g * colorA * (1 - thisA) / a;
            const b = this.rgba.b * thisA / a + rgba.b * colorA * (1 - thisA) / a;
            return new $8r(new $5r(r, g, b, a));
        }
        makeOpaque(opaqueBackground) {
            ...
            return new $8r(new $5r(opaqueBackground.rgba.r - a * (opaqueBackground.rgba.r - r), opaqueBackground.rgba.g - a * (opaqueBackground.rgba.g - g), opaqueBackground.rgba.b - a * (opaqueBackground.rgba.b - b), 1));
        }
        flatten(...backgrounds) {
            const background = backgrounds.reduceRight((accumulator, color) => {
                return $8r.o(color, accumulator);
            });
            return $8r.o(this, background);
        }
        static o(foreground, background) {
            const backgroundAlpha = 1 - foreground.rgba.a;
            return new $8r(new $5r(backgroundAlpha * background.rgba.r + foreground.rgba.a * foreground.rgba.r, backgroundAlpha * background.rgba.g + foreground.rgba.a * foreground.rgba.g, backgroundAlpha * background.rgba.b + foreground.rgba.a * foreground.rgba.b));
        }
        toString() {
            if (!this.u) {
                this.u = $8r.Format.CSS.format(this);
            }
            return this.u;
        }
        ...
        static { this.white = new $8r(new $5r(255, 255, 255, 1)); }
        static { this.black = new $8r(new $5r(0, 0, 0, 1)); }
        static { this.red = new $8r(new $5r(255, 0, 0, 1)); }
        static { this.blue = new $8r(new $5r(0, 0, 255, 1)); }
        static { this.green = new $8r(new $5r(0, 255, 0, 1)); }
        static { this.cyan = new $8r(new $5r(0, 255, 255, 1)); }
        static { this.lightgrey = new $8r(new $5r(211, 211, 211, 1)); }
        static { this.transparent = new $8r(new $5r(0, 0, 0, 0)); }
    }
    exports.$8r = $8r;
    (function ($8r) {
        let Format;
        (function (Format) {
            ...
            (function (CSS) {
                function formatRGB(color) {
                    ...
                    return $8r.Format.CSS.formatRGBA(color);
                }
                ...
                function formatHSL(color) {
                    ...
                    return $8r.Format.CSS.formatHSLA(color);
                }
                ...
                function formatHexA(color, compact = false) {
                    if (compact && color.rgba.a === 1) {
                        return $8r.Format.CSS.formatHex(color);
                    }
                ...
                function parseHex(hex) {
                    ...
                    if (length === 9) {
                        ...
                        return new $8r(new $5r(r, g, b, a / 255));
                    }
                    if (length === 4) {
                        // #RGB format
                        ...
                        return new $8r(new $5r(16 * r + r, 16 * g + g, 16 * b + b));
                    }
                    if (length === 5) {
                        // #RGBA format
                        const r = _parseHexDigit(hex.charCodeAt(1));
                        ...
                        return new $8r(new $5r(16 * r + r, 16 * g + g, 16 * b + b, (16 * a + a) / 255));
                    }
                    // Invalid color
                    return null;
                }
...
define(__m[15/*vs/base/common/arrays*/], __M([0/*require*/,1/*exports*/,3/*vs/base/common/errors*/]), function (require, exports, errors_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$Sf = exports.$Rf = exports.$Qf = exports.$Pf = exports.$Of = exports.$Nf = exports.$Mf = exports.$Lf = exports.$Kf = exports.CompareResult = exports.$Jf = exports.$If = exports.$Hf = exports.$Gf = exports.$Ff = exports.$Ef = exports.$Df = exports.$Cf = exports.$Bf = exports.$Af = exports.$zf = exports.$yf = exports.$xf = exports.$wf = exports.$vf = exports.$uf = exports.$tf = exports.$sf = exports.$rf = exports.$qf = exports.$pf = exports.$of = exports.$nf = exports.$mf = exports.$lf = exports.$kf = exports.$jf = exports.$if = exports.$hf = exports.top = exports.$ff = exports.$ef = exports.$df = exports.$cf = exports.$bf = exports.$af = exports.$_e = exports.$$e = exports.$0e = exports.$9e = exports.$8e = void 0;
    /**
     * Returns the last element of an array.
     * @param array The array.
     * @param n Which element from the end (default is zero).
     */
    function $8e(array, n = 0) {
    ...
    exports.$9e = $9e;
    function $0e(one, other, itemEquals = (a, b) => a === b) {
        if (one === other) {
            return true;
        }
        if (!one || !other) {
     ...
     * @return See {@link $af}
     */
    function $_e(array, key, comparator) {
        return $af(array.length, i => comparator(array[i], key));
    }
    exports.$_e = $_e;
    /**
     ...
     */
    function $af(length, compareToKey) {
    ...
    function $cf(nth, data, compare) {
        ...
        if (nth < lower.length) {
            return $cf(nth, lower, compare);
        }
        else if (nth < lower.length + pivots.length) {
            return pivots[0];
        }
        else {
            return $cf(nth - (lower.length + pivots.length), higher, compare);
        }
    }
    exports.$cf = $cf;
    function $df(data, compare) {
        const result = [];
     ...
     */
    function $ef(before, after, compare) {
        const result = [];
     ...
     */
    function $ff(before, after, compare) {
        const splices = $ef(before, after, compare);
        const removed = [];
        const added = [];
     ...
     * @return The first n elements from array when sorted with compare.
     */
    function $hf(array, compare, n, batch, token) {
        if (n === 0) {
    ...
    function topStep(array, compare, result, i, m) {
        for (const n = result.length; i < m; i++) {
            ...
            if (compare(element, result[n - 1]) < 0) {
                result.pop();
                const j = $bf(result, e => compare(element, e) < 0);
     ...
     */
    function $nf(array, keyFn = value => value) {
        const seen = new Set();
    ...
    exports.$of = $of;
    function $pf(arr, predicate) {
        const idx = $qf(arr, predicate);
        if (idx === -1) {
            return undefined;
        }
        return arr[idx];
    ...
    exports.$qf = $qf;
    function $rf(array, notFoundValue) {
        return array.length > 0 ? array[0] : notFoundValue;
    }
    exports.$rf = $rf;
    function $sf(array, notFoundValue) {
        return array.length > 0 ? array[array.length - 1] : notFoundValue;
    }
    exports.$sf = $sf;
    function $tf(one, other, equals = (a, b) => a === b) {
        let result = 0;
    ...
    exports.$vf = $vf;
    function $wf(array, indexer, mapper) {
     ...
     */
    function $xf(array, element) {
        array.push(element);
        return () => $yf(array, element);
    }
    exports.$xf = $xf;
    /**
     ...
     */
    function $zf(target, insertIndex, insertArr) {
    ...
    exports.$Cf = $Cf;
    function $Df(arr, items) {
        for (const item of items) {
            arr.push(item);
        }
    }
    exports.$Df = $Df;
    function $Ef(items, fn) {
     ...
     */
    function $If(array, start, newItems) {
     ...
     */
    function $Jf(array, start, deleteCount, newItems) {
        const index = getActualStartIndex(array, start);
        const result = array.splice(index, deleteCount);
        $If(array, index, newItems);
        return result;
    }
    exports.$Jf = $Jf;
    /**
    ...
    function $Kf(selector, comparator) {
        return (a, b) => comparator(selector(a), selector(b));
    }
    exports.$Kf = $Kf;
    function $Lf(...comparators) {
        return (item1, item2) => {
    ...
    */
    function $Qf(items, comparator) {
        return $Of(items, (a, b) => -comparator(a, b));
    }
    exports.$Qf = $Qf;
    class $Rf {
        /**
    ...
    */
    class $Sf {
        static { this.empty = new $Sf(_callback => { }); }
        constructor(
        /**
        ...
        */
        ...
        filter(predicate) {
            return new $Sf(cb => this.iterate(item => predicate(item) ? cb(item) : true));
        }
        map(mapFn) {
            return new $Sf(cb => this.iterate(item => cb(mapFn(item))));
        }
        some(predicate) {
            let result = false;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[10/*vs/base/common/assert*/], __M([0/*require*/,1/*exports*/,3/*vs/base/common/errors*/]), function (require, exports, errors_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$qc = exports.$pc = exports.$oc = exports.$nc = exports.ok = void 0;
    /**
    ...
    exports.ok = ok;
    function $nc(value, message = 'Unreachable') {
        throw new Error(message);
    }
    exports.$nc = $nc;
    function $oc(condition) {
        if (!condition) {
            throw new errors_1.$bb('Assertion Failed');
        }
    }
    exports.$oc = $oc;
    /**
     ...
     */
    function $pc(condition) {
        if (!condition()) {
            // eslint-disable-next-line no-debugger
            debugger;
            // Reevaluate `condition` again to make debugging easier
            condition();
            (0, errors_1.$Y)(new errors_1.$bb('Assertion Failed'));
        }
    }
    exports.$pc = $pc;
    function $qc(items, predicate) {
        let i = 0;
...
define(__m[31/*vs/base/common/keyCodes*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$gq = exports.KeyMod = exports.KeyCodeUtils = exports.$fq = exports.$eq = exports.$dq = exports.$cq = exports.$bq = exports.ScanCode = exports.KeyCode = void 0;
    /**
    ...
    for (let i = 0; i <= 193 /* ScanCode.MAX_VALUE */; i++) {
        exports.$eq[i] = -1 /* KeyCode.DependsOnKbLayout */;
    }
    for (let i = 0; i <= 132 /* KeyCode.MAX_VALUE */; i++) {
        exports.$fq[i] = -1 /* ScanCode.DependsOnKbLayout */;
    }
    (function () {
        ...
        for (const mapping of mappings) {
            ...
            if (eventKeyCode) {
                exports.$bq[eventKeyCode] = keyCode;
            }
            if (vkey) {
                exports.$cq[vkey] = keyCode;
            }
        }
        // Manually added due to the exclusion above (due to duplication with NumpadEnter)
        exports.$fq[3 /* KeyCode.Enter */] = 46 /* ScanCode.Enter */;
    })();
    var KeyCodeUtils;
    ...
    function $gq(firstPart, secondPart) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[7/*vs/base/common/lifecycle*/], __M([0/*require*/,1/*exports*/,16/*vs/base/common/functional*/,17/*vs/base/common/iterator*/]), function (require, exports, functional_1, iterator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[8/*vs/base/common/event*/], __M([0/*require*/,1/*exports*/,3/*vs/base/common/errors*/,16/*vs/base/common/functional*/,7/*vs/base/common/lifecycle*/,18/*vs/base/common/linkedList*/,19/*vs/base/common/stopwatch*/]), function (require, exports, errors_1, functional_1, lifecycle_1, linkedList_1, stopwatch_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[20/*vs/base/common/cancellation*/], __M([0/*require*/,1/*exports*/,8/*vs/base/common/event*/]), function (require, exports, event_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[33/*vs/base/common/cache*/], __M([0/*require*/,1/*exports*/,20/*vs/base/common/cancellation*/]), function (require, exports, cancellation_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[5/*vs/base/common/strings*/], __M([0/*require*/,1/*exports*/,33/*vs/base/common/cache*/,32/*vs/base/common/lazy*/]), function (require, exports, cache_1, lazy_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[34/*vs/base/common/hash*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/strings*/]), function (require, exports, strings) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$fi = exports.$ei = exports.$di = exports.$ci = exports.$bi = exports.$ai = exports.$_h = void 0;
    /**
    ...
    exports.$_h = $_h;
    function $ai(obj, hashVal) {
        switch (typeof obj) {
            case 'object':
                if (obj === null) {
                    return $bi(349, hashVal);
                }
            ...
            case 'string':
                return $ci(obj, hashVal);
            case 'boolean':
                return booleanHash(obj, hashVal);
            case 'number':
                return $bi(obj, hashVal);
            case 'undefined':
                return $bi(937, hashVal);
            default:
                return $bi(617, hashVal);
        }
    }
    exports.$ai = $ai;
    function $bi(val, initialHashVal) {
        return (((initialHashVal << 5) - initialHashVal) + val) | 0; // hashVal * 31 + ch, keep as int32
    }
    exports.$bi = $bi;
    function booleanHash(b, initialHashVal) {
        return $bi(b ? 433 : 863, initialHashVal);
    }
    function $ci(s, hashVal) {
        hashVal = $bi(149417, hashVal);
        for (let i = 0, length = s.length; i < length; i++) {
            hashVal = $bi(s.charCodeAt(i), hashVal);
        }
        return hashVal;
    }
    exports.$ci = $ci;
    function arrayHash(arr, initialHashVal) {
        initialHashVal = $bi(104579, initialHashVal);
        return arr.reduce((hashVal, item) => $ai(item, hashVal), initialHashVal);
    }
    function objectHash(obj, initialHashVal) {
        initialHashVal = $bi(181387, initialHashVal);
        return Object.keys(obj).sort().reduce((hashVal, key) => {
            hashVal = $ci(key, hashVal);
            return $ai(obj[key], hashVal);
        }, initialHashVal);
    }
    class $di {
        constructor() {
    ...
    function $ei(bufferOrValue, bitsize = 32) {
    ...
    class $fi {
        ...
        update(str) {
            ...
            while (true) {
                ...
                if (strings.$Od(charCode)) {
                    if (offset + 1 < strLen) {
                        const nextCharCode = str.charCodeAt(offset + 1);
                        if (strings.$Pd(nextCharCode)) {
                            offset++;
                            codePoint = strings.$Qd(charCode, nextCharCode);
                        }
                        else {
        ...
        digest() {
            ...
            return $ei(this.h) + $ei(this.l) + $ei(this.m) + $ei(this.n) + $ei(this.o);
        }
        x() {
            this.p[this.r++] = 0x80;
            fill(this.p, this.r);
...
define(__m[21/*vs/base/common/diff/diff*/], __M([0/*require*/,1/*exports*/,30/*vs/base/common/diff/diffChange*/,34/*vs/base/common/hash*/]), function (require, exports, diffChange_1, hash_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$mu = exports.$lu = exports.$ku = void 0;
    class $ku {
        constructor(a) {
            this.a = a;
        }
    ...
    exports.$ku = $ku;
    function $lu(original, modified, pretty) {
        return new $mu(new $ku(original), new $ku(modified)).ComputeDiff(pretty).changes;
    }
    exports.$lu = $lu;
    //
    ...
    class DiffChangeHelper {
        ...
        MarkNextChange() {
            ...
            if (this.d > 0 || this.e > 0) {
                ...
                this.a.push(new diffChange_1.$ju(this.b, this.d, this.c, this.e));
            }
    ...
    class $mu {
        ...
        constructor(originalSequence, modifiedSequence, continueProcessingPredicate = null) {
            ...
            const [originalStringElements, originalElementsOrHash, originalHasStrings] = $mu.o(originalSequence);
            const [modifiedStringElements, modifiedElementsOrHash, modifiedHasStrings] = $mu.o(modifiedSequence);
        ...
        static o(sequence) {
            ...
            if ($mu.n(elements)) {
                ...
                for (let i = 0, len = elements.length; i < len; i++) {
                    hashes[i] = (0, hash_1.$ci)(elements[i], 0);
                }
        ...
        q(originalIndex, newIndex) {
            ...
            const originalElement = $mu.r(this.b, originalIndex);
            const modifiedElement = $mu.r(this.c, newIndex);
        ...
        w(originalStart, originalEnd, modifiedStart, modifiedEnd, quitEarlyArr) {
            ...
            if (originalStart > originalEnd || modifiedStart > modifiedEnd) {
                ...
                if (modifiedStart <= modifiedEnd) {
                    ...
                    // All insertions
                    changes = [
                        new diffChange_1.$ju(originalStart, 0, modifiedStart, modifiedEnd - modifiedStart + 1)
                    ];
                }
                    ...
                    // All deletions
                    changes = [
                        new diffChange_1.$ju(originalStart, originalEnd - originalStart + 1, modifiedStart, 0)
                    ];
                }
                else {
                    Debug.Assert(originalStart === originalEnd + 1, 'originalStart should only be one more than originalEnd');
            ...
            if (result !== null) {
                ...
                if (!quitEarlyArr[0]) {
                    ...
                    rightChanges = [
                        new diffChange_1.$ju(midOriginal + 1, originalEnd - (midOriginal + 1) + 1, midModified + 1, modifiedEnd - (midModified + 1) + 1)
                    ];
                }
            ...
            return [
                new diffChange_1.$ju(originalStart, originalEnd - originalStart + 1, modifiedStart, modifiedEnd - modifiedStart + 1)
            ];
        }
        x(diagonalForwardBase, diagonalForwardStart, diagonalForwardEnd, diagonalForwardOffset, diagonalReverseBase, diagonalReverseStart, diagonalReverseEnd, diagonalReverseOffset, forwardPoints, reversePoints, originalIndex, originalEnd, midOriginalArr, modifiedIndex, modifiedEnd, midModifiedArr, deltaIsEven, quitEarlyArr) {
            ...
            if (quitEarlyArr[0]) {
                ...
                reverseChanges = [
                    new diffChange_1.$ju(originalStartPoint, originalEnd - originalStartPoint + 1, modifiedStartPoint, modifiedEnd - modifiedStartPoint + 1)
                ];
            }
            else {
        ...
        I(left, right, mergedChangeArr) {
            ...
            if (left.originalStart + left.originalLength >= right.originalStart || left.modifiedStart + left.modifiedLength >= right.modifiedStart) {
                ...
                mergedChangeArr[0] = new diffChange_1.$ju(originalStart, originalLength, modifiedStart, modifiedLength);
                return true;
            }
            else {
...
define(__m[35/*vs/base/common/codicons*/], __M([0/*require*/,1/*exports*/,22/*vs/base/common/types*/]), function (require, exports, types_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$yj = exports.$xj = exports.$wj = void 0;
    const _codiconFontCharacters = Object.create(null);
    function register(id, fontCharacter) {
        if ((0, types_1.$he)(fontCharacter)) {
     ...
     */
    function $xj() {
        return Object.values(exports.$yj);
    }
    exports.$xj = $xj;
    /**
...
define(__m[23/*vs/base/common/uint*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$jd = exports.$id = exports.Constants = void 0;
    var Constants;
    (function (Constants) {
        /**
...
define(__m[24/*vs/editor/common/core/characterClassifier*/], __M([0/*require*/,1/*exports*/,23/*vs/base/common/uint*/]), function (require, exports, uint_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$2r = exports.$1r = void 0;
    /**
     * A fast character classifier that uses a compact array for ASCII values.
     */
    class $1r {
        constructor(_defaultValue) {
            const defaultValue = (0, uint_1.$id)(_defaultValue);
            this.c = defaultValue;
            this.a = $1r.d(defaultValue);
            this.b = new Map();
        }
        ...
        set(charCode, _value) {
            const value = (0, uint_1.$id)(_value);
    ...
    class $bC {
        static addRange(range, sortedRanges) {
            ...
            if (i === j) {
                ...
                sortedRanges.splice(i, j - i, new $bC(start, end));
            }
        }
        static tryCreate(start, endExclusive) {
            ...
            return new $bC(start, endExclusive);
        }
        constructor(start, endExclusive) {
            this.start = start;
            this.endExclusive = endExclusive;
            if (start > endExclusive) {
                throw new errors_1.$bb(`Invalid range: ${this.toString()}`);
            }
        }
        get isEmpty() {
        ...
        delta(offset) {
            return new $bC(this.start + offset, this.endExclusive + offset);
        }
        get length() {
         ...
         */
        join(other) {
            return new $bC(Math.min(this.start, other.start), Math.max(this.endExclusive, other.endExclusive));
        }
        /**
    ...
    class $Lr {
        ...
        with(newLineNumber = this.lineNumber, newColumn = this.column) {
            if (newLineNumber === this.lineNumber && newColumn === this.column) {
                ...
                return new $Lr(newLineNumber, newColumn);
            }
        }
        /**
        ...
        isBeforeOrEqual(other) {
            return $Lr.isBeforeOrEqual(this, other);
        }
        /**
         * Test if position `a` is before position `b`.
         * If the two positions are equal, the result will be true.
         ...
         */
        clone() {
            return new $Lr(this.lineNumber, this.column);
        }
        /**
         ...
         */
        static lift(pos) {
            return new $Lr(pos.lineNumber, pos.column);
        }
        /**
...
define(__m[2/*vs/editor/common/core/range*/], __M([0/*require*/,1/*exports*/,4/*vs/editor/common/core/position*/]), function (require, exports, position_1) {
    ...
    class $Mr {
        ...
        containsPosition(position) {
            return $Mr.containsPosition(this, position);
        }
        /**
         ...
         */
        containsRange(range) {
            return $Mr.containsRange(this, range);
        }
        /**
        ...
        strictContainsRange(range) {
            return $Mr.strictContainsRange(this, range);
        }
        /**
         ...
         */
        plusRange(range) {
            return $Mr.plusRange(this, range);
        }
        /**
         * A reunion of the two ranges.
         * The smallest position will be used as the start point, and the largest one as the end point.
        ...
        static plusRange(a, b) {
            ...
            return new $Mr(startLineNumber, startColumn, endLineNumber, endColumn);
        }
        /**
         * A intersection of the two ranges.
         */
        intersectRanges(range) {
            return $Mr.intersectRanges(this, range);
        }
        /**
         * A intersection of the two ranges.
         */
        static intersectRanges(a, b) {
            ...
            return new $Mr(resultStartLineNumber, resultStartColumn, resultEndLineNumber, resultEndColumn);
        }
        /**
         * Test if this range equals other.
         */
        equalsRange(other) {
            return $Mr.equalsRange(this, other);
        }
        /**
         ...
         */
        getEndPosition() {
            return $Mr.getEndPosition(this);
        }
        /**
         * Return the end position (which will be after or equal to the start position)
         */
        static getEndPosition(range) {
            return new position_1.$Lr(range.endLineNumber, range.endColumn);
        }
        /**
         * Return the start position (which will be before or equal to the end position)
         */
        getStartPosition() {
            return $Mr.getStartPosition(this);
        }
        /**
         * Return the start position (which will be before or equal to the end position)
         */
        static getStartPosition(range) {
            return new position_1.$Lr(range.startLineNumber, range.startColumn);
        }
        /**
        ...
        setEndPosition(endLineNumber, endColumn) {
            return new $Mr(this.startLineNumber, this.startColumn, endLineNumber, endColumn);
        }
        /**
         * Create a new range using this range's end position, and using startLineNumber and startColumn as the start position.
         */
        setStartPosition(startLineNumber, startColumn) {
            return new $Mr(startLineNumber, startColumn, this.endLineNumber, this.endColumn);
        }
        /**
         * Create a new empty range using this range's start position.
         */
        collapseToStart() {
            return $Mr.collapseToStart(this);
        }
        /**
         * Create a new empty range using this range's start position.
         */
        static collapseToStart(range) {
            return new $Mr(range.startLineNumber, range.startColumn, range.startLineNumber, range.startColumn);
        }
        /**
         * Create a new empty range using this range's end position.
         */
        collapseToEnd() {
            return $Mr.collapseToEnd(this);
        }
        /**
         * Create a new empty range using this range's end position.
         */
        static collapseToEnd(range) {
            return new $Mr(range.endLineNumber, range.endColumn, range.endLineNumber, range.endColumn);
        }
        /**
         * Moves the range by the given amount of lines.
         */
        delta(lineCount) {
            return new $Mr(this.startLineNumber + lineCount, this.startColumn, this.endLineNumber + lineCount, this.endColumn);
        }
        // ---
        static fromPositions(start, end = start) {
            return new $Mr(start.lineNumber, start.column, end.lineNumber, end.column);
        }
        static lift(range) {
            if (!range) {
                return null;
            }
            return new $Mr(range.startLineNumber, range.startColumn, range.endLineNumber, range.endColumn);
        }
        /**
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[36/*vs/editor/common/core/editOperation*/], __M([0/*require*/,1/*exports*/,2/*vs/editor/common/core/range*/]), function (require, exports, range_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$Tr = void 0;
    class $Tr {
        static insert(position, text) {
            return {
                range: new range_1.$Mr(position.lineNumber, position.column, position.lineNumber, position.column),
                text: text,
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[12/*vs/editor/common/core/lineRange*/], __M([0/*require*/,1/*exports*/,3/*vs/base/common/errors*/,2/*vs/editor/common/core/range*/]), function (require, exports, errors_1, range_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$Nr = void 0;
    /**
    ...
    class $Nr {
        static fromRange(range) {
            return new $Nr(range.startLineNumber, range.endLineNumber);
        }
        static subtract(a, b) {
            if (!b) {
                return [a];
            ...
            if (a.startLineNumber < b.startLineNumber && b.endLineNumberExclusive < a.endLineNumberExclusive) {
                return [
                    new $Nr(a.startLineNumber, b.startLineNumber),
                    new $Nr(b.endLineNumberExclusive, a.endLineNumberExclusive)
                ];
            }
                ...
                return [new $Nr(Math.max(b.endLineNumberExclusive, a.startLineNumber), a.endLineNumberExclusive)];
            }
            else {
                return [new $Nr(a.startLineNumber, Math.min(b.startLineNumber, a.endLineNumberExclusive))];
            }
        }
        /**
            ...
            while (i1 < lineRanges1.length || i2 < lineRanges2.length) {
                ...
                if (current === null) {
                    ...
                    if (current.endLineNumberExclusive >= next.startLineNumber) {
                        // merge
                        current = new $Nr(current.startLineNumber, Math.max(current.endLineNumberExclusive, next.endLineNumberExclusive));
                    }
                    else {
                        // push
                        result.push(current);
        ...
        static ofLength(startLineNumber, length) {
            return new $Nr(startLineNumber, startLineNumber + length);
        }
        /**
         * @internal
         */
        static deserialize(lineRange) {
            return new $Nr(lineRange[0], lineRange[1]);
        }
        constructor(startLineNumber, endLineNumberExclusive) {
            if (startLineNumber > endLineNumberExclusive) {
                throw new errors_1.$bb(`startLineNumber ${startLineNumber} cannot be after endLineNumberExclusive ${endLineNumberExclusive}`);
            }
            this.startLineNumber = startLineNumber;
         ...
         */
        delta(offset) {
            return new $Nr(this.startLineNumber + offset, this.endLineNumberExclusive + offset);
        }
        /**
         ...
         */
        join(other) {
            return new $Nr(Math.min(this.startLineNumber, other.startLineNumber), Math.max(this.endLineNumberExclusive, other.endLineNumberExclusive));
        }
        toString() {
            return `[${this.startLineNumber},${this.endLineNumberExclusive})`;
        }
        ...
        intersect(other) {
            ...
            if (startLineNumber <= endLineNumberExclusive) {
                return new $Nr(startLineNumber, endLineNumberExclusive);
            }
            return undefined;
        }
        ...
        toInclusiveRange() {
            ...
            return new range_1.$Mr(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER);
        }
        toExclusiveRange() {
            return new range_1.$Mr(this.startLineNumber, 1, this.endLineNumberExclusive, 1);
        }
        mapToLineArray(f) {
            const result = [];
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[37/*vs/editor/common/core/selection*/], __M([0/*require*/,1/*exports*/,4/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/]), function (require, exports, position_1, range_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$Ur = exports.SelectionDirection = void 0;
    /**
    ...
    class $Ur extends range_1.$Mr {
        ...
        equalsSelection(other) {
            return ($Ur.selectionsEqual(this, other));
        }
        /**
        ...
        setEndPosition(endLineNumber, endColumn) {
            if (this.getDirection() === 0 /* SelectionDirection.LTR */) {
                return new $Ur(this.startLineNumber, this.startColumn, endLineNumber, endColumn);
            }
            return new $Ur(endLineNumber, endColumn, this.startLineNumber, this.startColumn);
        }
        /**
         * Get the position at `positionLineNumber` and `positionColumn`.
         */
        getPosition() {
            return new position_1.$Lr(this.positionLineNumber, this.positionColumn);
        }
        /**
         * Get the position at the start of the selection.
        */
        getSelectionStart() {
            return new position_1.$Lr(this.selectionStartLineNumber, this.selectionStartColumn);
        }
        /**
        ...
        setStartPosition(startLineNumber, startColumn) {
            if (this.getDirection() === 0 /* SelectionDirection.LTR */) {
                return new $Ur(startLineNumber, startColumn, this.endLineNumber, this.endColumn);
            }
            return new $Ur(this.endLineNumber, this.endColumn, startLineNumber, startColumn);
        }
        // ----
        /**
         ...
         */
        static fromPositions(start, end = start) {
            return new $Ur(start.lineNumber, start.column, end.lineNumber, end.column);
        }
        /**
        ...
        static fromRange(range, direction) {
            if (direction === 0 /* SelectionDirection.LTR */) {
                return new $Ur(range.startLineNumber, range.startColumn, range.endLineNumber, range.endColumn);
            }
            else {
                return new $Ur(range.endLineNumber, range.endColumn, range.startLineNumber, range.startColumn);
            }
        }
        /**
        ...
        static liftSelection(sel) {
            return new $Ur(sel.selectionStartLineNumber, sel.selectionStartColumn, sel.positionLineNumber, sel.positionColumn);
        }
        /**
         * `a` equals `b`.
         */
        ...
        static createWithDirection(startLineNumber, startColumn, endLineNumber, endColumn, direction) {
            if (direction === 0 /* SelectionDirection.LTR */) {
                return new $Ur(startLineNumber, startColumn, endLineNumber, endColumn);
            }
            return new $Ur(endLineNumber, endColumn, startLineNumber, startColumn);
        }
    }
    exports.$Ur = $Ur;
});
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[38/*vs/editor/common/core/wordCharacterClassifier*/], __M([0/*require*/,1/*exports*/,24/*vs/editor/common/core/characterClassifier*/]), function (require, exports, characterClassifier_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$4r = exports.$3r = exports.WordCharacterClass = void 0;
    ...
    class $3r extends characterClassifier_1.$1r {
    ...
    exports.$4r = once((input) => new $3r(input));
});
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[25/*vs/editor/common/core/wordHelper*/], __M([0/*require*/,1/*exports*/,17/*vs/base/common/iterator*/,7/*vs/base/common/lifecycle*/,18/*vs/base/common/linkedList*/]), function (require, exports, iterator_1, lifecycle_1, linkedList_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$Kr = exports.$Jr = exports.$Ir = exports.$Hr = exports.$Gr = void 0;
    exports.$Gr = '`~!@#$%^&*()-=+[{]}\\|;:\'",.<>/?';
    /**
    ...
    exports.$Hr = createWordRegExp();
    function $Ir(wordDefinition) {
        let result = exports.$Hr;
    ...
    exports.$Ir = $Ir;
    const _defaultConfig = new linkedList_1.$lc();
    ...
    function $Jr(value) {
        ...
        return (0, lifecycle_1.$jb)(rm);
    }
    exports.$Jr = $Jr;
    function $Kr(column, wordDefinition, text, textOffset, config) {
        if (!config) {
        ...
        if (text.length > config.maxLen) {
            ...
            return $Kr(column, wordDefinition, text, textOffset, config);
        }
        const t1 = Date.now();
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[9/*vs/editor/common/diff/algorithms/diffAlgorithm*/], __M([0/*require*/,1/*exports*/,3/*vs/base/common/errors*/,6/*vs/editor/common/core/offsetRange*/]), function (require, exports, errors_1, offsetRange_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$hX = exports.$gX = exports.$fX = exports.$eX = void 0;
    class $eX {
        static trivial(seq1, seq2) {
            return new $eX([new $fX(new offsetRange_1.$bC(0, seq1.length), new offsetRange_1.$bC(0, seq2.length))], false);
        }
        static trivialTimedOut(seq1, seq2) {
            return new $eX([new $fX(new offsetRange_1.$bC(0, seq1.length), new offsetRange_1.$bC(0, seq2.length))], true);
        }
        constructor(diffs, 
        /**
    ...
    class $fX {
        ...
        reverse() {
            return new $fX(this.seq2Range, this.seq1Range);
        }
        toString() {
            return `${this.seq1Range} <-> ${this.seq2Range}`;
        }
        join(other) {
            return new $fX(this.seq1Range.join(other.seq1Range), this.seq2Range.join(other.seq2Range));
        }
        delta(offset) {
            if (offset === 0) {
                return this;
            }
            return new $fX(this.seq1Range.delta(offset), this.seq2Range.delta(offset));
        }
    }
    exports.$fX = $fX;
    class $gX {
        static { this.instance = new $gX(); }
        isValid() {
            return true;
        }
    }
    ...
    class $hX {
        constructor(c) {
            ...
            this.b = true;
            if (c <= 0) {
                throw new errors_1.$bb('timeout must be positive');
            }
        }
        // Recommendation: Set a log-point `{this.disable()}` in the body
        isValid() {
            const valid = Date.now() - this.a < this.c;
            if (!valid && this.b) {
                this.b = false; // timeout reached
                // eslint-disable-next-line no-debugger
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[39/*vs/editor/common/diff/algorithms/joinSequenceDiffs*/], __M([0/*require*/,1/*exports*/,6/*vs/editor/common/core/offsetRange*/,9/*vs/editor/common/diff/algorithms/diffAlgorithm*/]), function (require, exports, offsetRange_1, diffAlgorithm_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$pX = exports.$oX = exports.$nX = exports.$mX = exports.$lX = exports.$kX = void 0;
    function $kX(sequence1, sequence2, sequenceDiffs) {
        let result = sequenceDiffs;
        result = $oX(sequence1, sequence2, result);
        result = $pX(sequence1, sequence2, result);
        return result;
    }
    exports.$kX = $kX;
    function $lX(sequence1, sequence2, sequenceDiffs) {
        const result = [];
        for (const s of sequenceDiffs) {
            ...
            if (s.seq1Range.start - last.seq1Range.endExclusive <= 2 || s.seq2Range.start - last.seq2Range.endExclusive <= 2) {
                result[result.length - 1] = new diffAlgorithm_1.$fX(last.seq1Range.join(s.seq1Range), last.seq2Range.join(s.seq2Range));
            }
            else {
                result.push(s);
            }
    ...
    exports.$lX = $lX;
    function $mX(sequence1, _sequence2, sequenceDiffs) {
        ...
        do {
            ...
            for (let i = 1; i < diffs.length; i++) {
                ...
                function shouldJoinDiffs(before, after) {
                    const unchangedRange = new offsetRange_1.$bC(lastResult.seq1Range.endExclusive, cur.seq1Range.start);
    ...
    exports.$mX = $mX;
    function $nX(sequence1, sequence2, sequenceDiffs) {
        let diffs = sequenceDiffs;
        if (diffs.length === 0) {
            return diffs;
        }
     ...
     */
    function $oX(sequence1, sequence2, sequenceDiffs) {
        ...
        for (let i = 1; i < sequenceDiffs.length; i++) {
            ...
            if (cur.seq1Range.isEmpty || cur.seq2Range.isEmpty) {
                ...
                if (d === length) {
                    ...
                    result[result.length - 1] = new diffAlgorithm_1.$fX(new offsetRange_1.$bC(prevResult.seq1Range.start, cur.seq1Range.endExclusive - length), new offsetRange_1.$bC(prevResult.seq2Range.start, cur.seq2Range.endExclusive - length));
                    continue;
                }
                cur = cur.delta(-d);
            }
        ...
        for (let i = 0; i < result.length - 1; i++) {
            ...
            if (cur.seq1Range.isEmpty || cur.seq2Range.isEmpty) {
                ...
                if (d === length) {
                    ...
                    result[i + 1] = new diffAlgorithm_1.$fX(new offsetRange_1.$bC(cur.seq1Range.start + length, nextResult.seq1Range.endExclusive), new offsetRange_1.$bC(cur.seq2Range.start + length, nextResult.seq2Range.endExclusive));
                    continue;
                }
                if (d > 0) {
                    cur = cur.delta(d);
    ...
    function $pX(sequence1, sequence2, sequenceDiffs) {
        ...
        for (let i = 0; i < sequenceDiffs.length; i++) {
            ...
            const seq1ValidRange = new offsetRange_1.$bC(prevDiff ? prevDiff.seq1Range.start + 1 : 0, nextDiff ? nextDiff.seq1Range.endExclusive - 1 : sequence1.length);
            const seq2ValidRange = new offsetRange_1.$bC(prevDiff ? prevDiff.seq2Range.start + 1 : 0, nextDiff ? nextDiff.seq2Range.endExclusive - 1 : sequence2.length);
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[40/*vs/editor/common/diff/algorithms/myersDiffAlgorithm*/], __M([0/*require*/,1/*exports*/,6/*vs/editor/common/core/offsetRange*/,9/*vs/editor/common/diff/algorithms/diffAlgorithm*/]), function (require, exports, offsetRange_1, diffAlgorithm_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$qX = void 0;
    /**
    ...
    */
    class $qX {
        compute(seq1, seq2, timeout = diffAlgorithm_1.$gX.instance) {
            // These are common special cases.
            // The early return improves performance dramatically.
            if (seq1.length === 0 || seq2.length === 0) {
                return diffAlgorithm_1.$eX.trivial(seq1, seq2);
            }
            ...
            loop: while (true) {
                d++;
                if (!timeout.isValid()) {
                    return diffAlgorithm_1.$eX.trivialTimedOut(seq1, seq2);
                }
            ...
            while (true) {
                ...
                if (endX !== lastAligningPosS1 || endY !== lastAligningPosS2) {
                    result.push(new diffAlgorithm_1.$fX(new offsetRange_1.$bC(endX, lastAligningPosS1), new offsetRange_1.$bC(endY, lastAligningPosS2)));
                }
                if (!path) {
                    break;
                }
            ...
            result.reverse();
            return new diffAlgorithm_1.$eX(result, false);
        }
    }
    exports.$qX = $qX;
    class SnakePath {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[41/*vs/editor/common/diff/algorithms/utils*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$iX = void 0;
    class $iX {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[42/*vs/editor/common/diff/algorithms/dynamicProgrammingDiffing*/], __M([0/*require*/,1/*exports*/,6/*vs/editor/common/core/offsetRange*/,9/*vs/editor/common/diff/algorithms/diffAlgorithm*/,41/*vs/editor/common/diff/algorithms/utils*/]), function (require, exports, offsetRange_1, diffAlgorithm_1, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$jX = void 0;
    /**
    ...
    */
    class $jX {
        compute(sequence1, sequence2, timeout = diffAlgorithm_1.$gX.instance, equalityScore) {
            if (sequence1.length === 0 || sequence2.length === 0) {
                return diffAlgorithm_1.$eX.trivial(sequence1, sequence2);
            }
            /**
             * lcsLengths.get(i, j): Length of the longest common subsequence of sequence1.substring(0, i + 1) and sequence2.substring(0, j + 1).
             */
            const lcsLengths = new utils_1.$iX(sequence1.length, sequence2.length);
            const directions = new utils_1.$iX(sequence1.length, sequence2.length);
            const lengths = new utils_1.$iX(sequence1.length, sequence2.length);
            // ==== Initializing lcsLengths ====
            for (let s1 = 0; s1 < sequence1.length; s1++) {
                for (let s2 = 0; s2 < sequence2.length; s2++) {
                    if (!timeout.isValid()) {
                        return diffAlgorithm_1.$eX.trivialTimedOut(sequence1, sequence2);
                    }
            ...
            function reportDecreasingAligningPositions(s1, s2) {
                if (s1 + 1 !== lastAligningPosS1 || s2 + 1 !== lastAligningPosS2) {
                    result.push(new diffAlgorithm_1.$fX(new offsetRange_1.$bC(s1 + 1, lastAligningPosS1), new offsetRange_1.$bC(s2 + 1, lastAligningPosS2)));
                }
...
define(__m[26/*vs/editor/common/diff/linesDiffComputer*/], __M([0/*require*/,1/*exports*/,12/*vs/editor/common/core/lineRange*/]), function (require, exports, lineRange_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$Sr = exports.$Rr = exports.$Qr = exports.$Pr = exports.$Or = void 0;
    class $Or {
        constructor(changes, 
        /**
    ...
    class $Pr {
        static inverse(mapping, originalLineCount, modifiedLineCount) {
            ...
            for (const m of mapping) {
                const r = new $Pr(new lineRange_1.$Nr(lastOriginalEndLineNumber, m.originalRange.startLineNumber), new lineRange_1.$Nr(lastModifiedEndLineNumber, m.modifiedRange.startLineNumber), undefined);
            ...
            const r = new $Pr(new lineRange_1.$Nr(lastOriginalEndLineNumber, originalLineCount + 1), new lineRange_1.$Nr(lastModifiedEndLineNumber, modifiedLineCount + 1), undefined);
            if (!r.modifiedRange.isEmpty) {
                result.push(r);
            }
            return result;
        ...
        flip() {
            return new $Pr(this.modifiedRange, this.originalRange, this.innerChanges?.map(c => c.flip()));
        }
    }
    exports.$Pr = $Pr;
    /**
    ...
    class $Rr {
        ...
        flip() {
            return new $Rr(this.modified, this.original);
        }
    }
    exports.$Rr = $Rr;
    class $Sr {
        ...
        flip() {
            return new $Sr(this.lineRangeMapping.flip(), this.changes.map(c => c.flip()));
        }
    }
    exports.$Sr = $Sr;
});
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[27/*vs/editor/common/diff/smartLinesDiffComputer*/], __M([0/*require*/,1/*exports*/,21/*vs/base/common/diff/diff*/,26/*vs/editor/common/diff/linesDiffComputer*/,5/*vs/base/common/strings*/,2/*vs/editor/common/core/range*/,10/*vs/base/common/assert*/,12/*vs/editor/common/core/lineRange*/]), function (require, exports, diff_1, linesDiffComputer_1, strings, range_1, assert_1, lineRange_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$ou = exports.$nu = void 0;
    const MINIMUM_MATCHING_CHARACTER_LENGTH = 3;
    class $nu {
        computeDiff(originalLines, modifiedLines, options) {
            const diffComputer = new $ou(originalLines, modifiedLines, {
            ...
            for (const c of result.changes) {
                ...
                if (c.originalEndLineNumber === 0) {
                    // Insertion
                    originalRange = new lineRange_1.$Nr(c.originalStartLineNumber + 1, c.originalStartLineNumber + 1);
                }
                else {
                    originalRange = new lineRange_1.$Nr(c.originalStartLineNumber, c.originalEndLineNumber + 1);
                }
                let modifiedRange;
                if (c.modifiedEndLineNumber === 0) {
                    // Deletion
                    modifiedRange = new lineRange_1.$Nr(c.modifiedStartLineNumber + 1, c.modifiedStartLineNumber + 1);
                }
                else {
                    modifiedRange = new lineRange_1.$Nr(c.modifiedStartLineNumber, c.modifiedEndLineNumber + 1);
                }
                let change = new linesDiffComputer_1.$Pr(originalRange, modifiedRange, c.charChanges?.map(c => new linesDiffComputer_1.$Qr(new range_1.$Mr(c.originalStartLineNumber, c.originalStartColumn, c.originalEndLineNumber, c.originalEndColumn), new range_1.$Mr(c.modifiedStartLineNumber, c.modifiedStartColumn, c.modifiedEndLineNumber, c.modifiedEndColumn))));
                if (lastChange) {
                    if (lastChange.modifiedRange.endLineNumberExclusive === change.modifiedRange.startLineNumber
                        ...
                        change = new linesDiffComputer_1.$Pr(lastChange.originalRange.join(change.originalRange), lastChange.modifiedRange.join(change.modifiedRange), lastChange.innerChanges && change.innerChanges ?
            ...
            (0, assert_1.$pc)(() => {
                return (0, assert_1.$qc)(changes, (m1, m2) => m2.originalRange.startLineNumber - m1.originalRange.endLineNumberExclusive === m2.modifiedRange.startLineNumber - m1.modifiedRange.endLineNumberExclusive &&
                    // There has to be an unchanged line in between (otherwise both diffs should have been joined)
                    m1.originalRange.endLineNumberExclusive < m2.originalRange.startLineNumber &&
                    m1.modifiedRange.endLineNumberExclusive < m2.modifiedRange.startLineNumber);
            });
            return new linesDiffComputer_1.$Or(changes, [], result.quitEarly);
        }
    }
    exports.$nu = $nu;
    function computeDiff(originalSequence, modifiedSequence, continueProcessingPredicate, pretty) {
        const diffAlgo = new diff_1.$mu(originalSequence, modifiedSequence, continueProcessingPredicate);
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[43/*vs/editor/common/diff/standardLinesDiffComputer*/], __M([0/*require*/,1/*exports*/,15/*vs/base/common/arrays*/,10/*vs/base/common/assert*/,28/*vs/base/common/collections*/,12/*vs/editor/common/core/lineRange*/,6/*vs/editor/common/core/offsetRange*/,4/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,9/*vs/editor/common/diff/algorithms/diffAlgorithm*/,42/*vs/editor/common/diff/algorithms/dynamicProgrammingDiffing*/,39/*vs/editor/common/diff/algorithms/joinSequenceDiffs*/,40/*vs/editor/common/diff/algorithms/myersDiffAlgorithm*/,26/*vs/editor/common/diff/linesDiffComputer*/]), function (require, exports, arrays_1, assert_1, collections_1, lineRange_1, offsetRange_1, position_1, range_1, diffAlgorithm_1, dynamicProgrammingDiffing_1, joinSequenceDiffs_1, myersDiffAlgorithm_1, linesDiffComputer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$vX = exports.$uX = exports.$tX = exports.$sX = exports.$rX = void 0;
    class $rX {
        constructor() {
            this.f = new dynamicProgrammingDiffing_1.$jX();
            this.h = new myersDiffAlgorithm_1.$qX();
        }
        computeDiff(originalLines, modifiedLines, options) {
            if (originalLines.length <= 1 && (0, arrays_1.$0e)(originalLines, modifiedLines, (a, b) => a === b)) {
                return new linesDiffComputer_1.$Or([], [], false);
            }
            if (originalLines.length === 1 && originalLines[0].length === 0 || modifiedLines.length === 1 && modifiedLines[0].length === 0) {
                return new linesDiffComputer_1.$Or([
                    new linesDiffComputer_1.$Pr(new lineRange_1.$Nr(1, originalLines.length + 1), new lineRange_1.$Nr(1, modifiedLines.length + 1), [
                        new linesDiffComputer_1.$Qr(new range_1.$Mr(1, 1, originalLines.length, originalLines[0].length + 1), new range_1.$Mr(1, 1, modifiedLines.length, modifiedLines[0].length + 1))
                    ])
                ], [], false);
            }
            const timeout = options.maxComputationTimeMs === 0 ? diffAlgorithm_1.$gX.instance : new diffAlgorithm_1.$hX(options.maxComputationTimeMs);
            ...
            const sequence1 = new $uX(srcDocLines, originalLines);
            const sequence2 = new $uX(tgtDocLines, modifiedLines);
            const lineAlignmentResult = (() => {
                if (sequence1.length + sequence2.length < 1700) {
                    // Use the improved algorithm for small files
                    return this.f.compute(sequence1, sequence2, timeout, (offset1, offset2) => originalLines[offset1] === modifiedLines[offset2]
                        ? modifiedLines[offset2].length === 0
                            ? 0.1
                            : 1 + Math.log(1 + modifiedLines[offset2].length)
                        : 0.99);
                }
                return this.h.compute(sequence1, sequence2);
            })();
            let lineAlignments = lineAlignmentResult.diffs;
            let hitTimeout = lineAlignmentResult.hitTimeout;
            lineAlignments = (0, joinSequenceDiffs_1.$kX)(sequence1, sequence2, lineAlignments);
            lineAlignments = (0, joinSequenceDiffs_1.$mX)(sequence1, sequence2, lineAlignments);
            const alignments = [];
            const scanForWhitespaceChanges = (equalLinesCount) => {
                ...
                for (let i = 0; i < equalLinesCount; i++) {
                    ...
                    if (originalLines[seq1Offset] !== modifiedLines[seq2Offset]) {
                        ...
                        const characterDiffs = this.o(originalLines, modifiedLines, new diffAlgorithm_1.$fX(new offsetRange_1.$bC(seq1Offset, seq1Offset + 1), new offsetRange_1.$bC(seq2Offset, seq2Offset + 1)), timeout, considerWhitespaceChanges);
            ...
            for (const diff of lineAlignments) {
                (0, assert_1.$pc)(() => diff.seq1Range.start - seq1LastStart === diff.seq2Range.start - seq2LastStart);
                const equalLinesCount = diff.seq1Range.start - seq1LastStart;
                scanForWhitespaceChanges(equalLinesCount);
                seq1LastStart = diff.seq1Range.endExclusive;
                seq2LastStart = diff.seq2Range.endExclusive;
                const characterDiffs = this.o(originalLines, modifiedLines, diff, timeout, considerWhitespaceChanges);
                if (characterDiffs.hitTimeout) {
                    hitTimeout = true;
                }
                for (const a of characterDiffs.mappings) {
            ...
            const changes = $sX(alignments, originalLines, modifiedLines);
            let moves = [];
            if (options.computeMoves) {
                moves = this.n(changes, originalLines, modifiedLines, srcDocLines, tgtDocLines, timeout, considerWhitespaceChanges);
            }
            ...
            return new linesDiffComputer_1.$Or(changes, moves, hitTimeout);
        }
        n(changes, originalLines, modifiedLines, hashedOriginalLines, hashedModifiedLines, timeout, considerWhitespaceChanges) {
            const moves = [];
            ...
            for (const deletion of deletions) {
                ...
                if (highestSimilarity > 0.90 && best) {
                    const moveChanges = this.o(originalLines, modifiedLines, new diffAlgorithm_1.$fX(new offsetRange_1.$bC(deletion.range.startLineNumber - 1, deletion.range.endLineNumberExclusive - 1), new offsetRange_1.$bC(best.range.startLineNumber - 1, best.range.endLineNumberExclusive - 1)), timeout, considerWhitespaceChanges);
                    const mappings = $sX(moveChanges.mappings, originalLines, modifiedLines, true);
                    insertions.delete(best);
                    moves.push(new linesDiffComputer_1.$Sr(new linesDiffComputer_1.$Rr(deletion.range, best.range), mappings));
            ...
            for (const change of changes) {
                ...
                for (let i = change.originalRange.startLineNumber; i < change.originalRange.endLineNumberExclusive - 2; i++) {
                    ...
                    original3LineHashes.add(key, { range: new lineRange_1.$Nr(i, i + 3) });
                }
            }
            const possibleMappings = [];
            changes.sort((0, arrays_1.$Kf)(c => c.modifiedRange.startLineNumber, arrays_1.$Mf));
            for (const change of changes) {
                if (excludedChanges.has(change)) {
                    continue;
                }
                ...
                for (let i = change.modifiedRange.startLineNumber; i < change.modifiedRange.endLineNumberExclusive - 2; i++) {
                    ...
                    const currentModifiedRange = new lineRange_1.$Nr(i, i + 3);
                    const nextMappings = [];
                    original3LineHashes.forEach(key, ({ range }) => {
                        for (const lastMapping of lastMappings) {
                            ...
                            if (lastMapping.originalLineRange.endLineNumberExclusive + 1 === range.endLineNumberExclusive &&
                                ...
                                lastMapping.originalLineRange = new lineRange_1.$Nr(lastMapping.originalLineRange.startLineNumber, range.endLineNumberExclusive);
                                lastMapping.modifiedLineRange = new lineRange_1.$Nr(lastMapping.modifiedLineRange.startLineNumber, currentModifiedRange.endLineNumberExclusive);
            ...
            possibleMappings.sort((0, arrays_1.$Nf)((0, arrays_1.$Kf)(m => m.modifiedLineRange.length, arrays_1.$Mf)));
            ...
            for (const mapping of possibleMappings) {
                ...
                for (const s of modifiedIntersectedSections) {
                    ...
                    const moveChanges = this.o(originalLines, modifiedLines, new diffAlgorithm_1.$fX(new offsetRange_1.$bC(originalLineRange.startLineNumber - 1, originalLineRange.endLineNumberExclusive - 1), new offsetRange_1.$bC(modifiedLineRange.startLineNumber - 1, modifiedLineRange.endLineNumberExclusive - 1)), timeout, considerWhitespaceChanges);
                    const mappings = $sX(moveChanges.mappings, originalLines, modifiedLines, true);
                    moves.push(new linesDiffComputer_1.$Sr(new linesDiffComputer_1.$Rr(originalLineRange, modifiedLineRange), mappings));
        ...
        o(originalLines, modifiedLines, diff, timeout, considerWhitespaceChanges) {
            const slice1 = new $vX(originalLines, diff.seq1Range, considerWhitespaceChanges);
            const slice2 = new $vX(modifiedLines, diff.seq2Range, considerWhitespaceChanges);
            const diffResult = slice1.length + slice2.length < 500
                ? this.f.compute(slice1, slice2, timeout)
                : this.h.compute(slice1, slice2, timeout);
            let diffs = diffResult.diffs;
            diffs = (0, joinSequenceDiffs_1.$kX)(slice1, slice2, diffs);
            diffs = coverFullWords(slice1, slice2, diffs);
            diffs = (0, joinSequenceDiffs_1.$lX)(slice1, slice2, diffs);
            diffs = (0, joinSequenceDiffs_1.$nX)(slice1, slice2, diffs);
            const result = diffs.map((d) => new linesDiffComputer_1.$Qr(slice1.translateRange(d.seq1Range), slice2.translateRange(d.seq2Range)));
    ...
    class LineRangeSet {
        ...
        addRange(range) {
            ...
            const joinRangeStartIdx = mapMinusOne(this.f.findIndex(r => r.endLineNumberExclusive >= range.startLineNumber), this.f.length);
            // idx of element after { last element that touches range or that is before range }
            const joinRangeEndIdxExclusive = (0, arrays_1.$qf)(this.f, r => r.startLineNumber <= range.endLineNumberExclusive) + 1;
            if (joinRangeStartIdx === joinRangeEndIdxExclusive) {
                // If there is no element that touches range, then joinRangeStartIdx === joinRangeEndIdxExclusive and that value is the index of the element after range
                this.f.splice(joinRangeStartIdx, 0, range);
            }
            else if (joinRangeStartIdx === joinRangeEndIdxExclusive - 1) {
                // Else, there is an element that touches range and in this case it is both the first and last element. Thus we can replace it
                const joinRange = this.f[joinRangeStartIdx];
                this.f[joinRangeStartIdx] = joinRange.join(range);
            }
            else {
                // First and last element are different - we need to replace the entire range
                const joinRange = this.f[joinRangeStartIdx].join(this.f[joinRangeEndIdxExclusive - 1]).join(range);
                this.f.splice(joinRangeStartIdx, joinRangeEndIdxExclusive - joinRangeStartIdx, joinRange);
            }
        }
        intersects(range) {
        ...
        subtractFrom(range) {
            ...
            for (let i = joinRangeStartIdx; i < joinRangeEndIdxExclusive; i++) {
                ...
                if (r.startLineNumber > startLineNumber) {
                    result.push(new lineRange_1.$Nr(startLineNumber, r.startLineNumber));
                }
                startLineNumber = r.endLineNumberExclusive;
            }
            if (startLineNumber < range.endLineNumberExclusive) {
                result.push(new lineRange_1.$Nr(startLineNumber, range.endLineNumberExclusive));
            }
            return result;
        }
    }
    ...
    function coverFullWords(sequence1, sequence2, sequenceDiffs) {
        ...
        function maybePushWordToAdditional() {
            ...
            if (Math.max(lastModifiedWord.deleted, lastModifiedWord.added) + (lastModifiedWord.count - 1) > originalLength1) {
                additional.push(new diffAlgorithm_1.$fX(lastModifiedWord.s1Range, lastModifiedWord.s2Range));
            }
            ...
            function processWord(s1Range, s2Range) {
                if (!lastModifiedWord || !lastModifiedWord.s1Range.containsRange(s1Range) || !lastModifiedWord.s2Range.containsRange(s2Range)) {
                    if (lastModifiedWord && !(lastModifiedWord.s1Range.endExclusive < s1Range.start && lastModifiedWord.s2Range.endExclusive < s2Range.start)) {
                        const s1Added = offsetRange_1.$bC.tryCreate(lastModifiedWord.s1Range.endExclusive, s1Range.start);
                        const s2Added = offsetRange_1.$bC.tryCreate(lastModifiedWord.s2Range.endExclusive, s2Range.start);
    ...
    function $sX(alignments, originalLines, modifiedLines, dontAssertStartLine = false) {
        const changes = [];
        for (const g of group(alignments.map(a => $tX(a, originalLines, modifiedLines)), (a1, a2) => a1.originalRange.overlapOrTouch(a2.originalRange)
            || a1.modifiedRange.overlapOrTouch(a2.modifiedRange))) {
            const first = g[0];
            const last = g[g.length - 1];
            changes.push(new linesDiffComputer_1.$Pr(first.originalRange.join(last.originalRange), first.modifiedRange.join(last.modifiedRange), g.map(a => a.innerChanges[0])));
        }
        (0, assert_1.$pc)(() => {
    ...
    exports.$sX = $sX;
    function $tX(rangeMapping, originalLines, modifiedLines) {
        ...
        const originalLineRange = new lineRange_1.$Nr(rangeMapping.originalRange.startLineNumber + lineStartDelta, rangeMapping.originalRange.endLineNumber + 1 + lineEndDelta);
        const modifiedLineRange = new lineRange_1.$Nr(rangeMapping.modifiedRange.startLineNumber + lineStartDelta, rangeMapping.modifiedRange.endLineNumber + 1 + lineEndDelta);
        return new linesDiffComputer_1.$Pr(originalLineRange, modifiedLineRange, [rangeMapping]);
    }
    exports.$tX = $tX;
    ...
    class $uX {
        ...
        getElement(offset) {
            return this.f[offset];
        }
        get length() {
            return this.f.length;
        }
        getBoundaryScore(length) {
            const indentationBefore = length === 0 ? 0 : getIndentation(this.h[length - 1]);
            const indentationAfter = length === this.h.length ? 0 : getIndentation(this.h[length]);
            return 1000 - (indentationBefore + indentationAfter);
        }
        getText(range) {
            return this.h.slice(range.start, range.endExclusive).join('\n');
        }
        isStronglyEqual(offset1, offset2) {
            return this.h[offset1] === this.h[offset2];
        }
    }
    exports.$uX = $uX;
    ...
    class $vX {
        constructor(lines, lineRange, considerWhitespaceChanges) {
            ...
            if (lineRange.start > 0 && lineRange.endExclusive >= lines.length) {
                lineRange = new offsetRange_1.$bC(lineRange.start - 1, lineRange.endExclusive);
            ...
            for (let i = this.lineRange.start; i < this.lineRange.endExclusive; i++) {
                ...
                for (let i = 0; i < line.length; i++) {
                    this.f.push(line.charCodeAt(i));
                }
                // Don't add an \n that does not exist in the document.
                if (i < lines.length - 1) {
                    this.f.push('\n'.charCodeAt(0));
                    this.h[i - this.lineRange.start] = this.f.length;
                }
            }
        ...
        get text() {
            return this.getText(new offsetRange_1.$bC(0, this.length));
        }
        getText(range) {
            return this.f.slice(range.start, range.endExclusive).map(e => String.fromCharCode(e)).join('');
        }
        getElement(offset) {
            return this.f[offset];
        }
        ...
        getBoundaryScore(length) {
            ...
            const prevCategory = getCategory(length > 0 ? this.f[length - 1] : -1);
            const nextCategory = getCategory(length < this.f.length ? this.f[length] : -1);
        ...
        translateOffset(offset) {
            ...
            if (this.lineRange.isEmpty) {
                return new position_1.$Lr(this.lineRange.start + 1, 1);
            }
            let i = 0;
            let j = this.h.length;
            while (i < j) {
            ...
            const offsetOfFirstCharInLine = i === 0 ? 0 : this.h[i - 1];
            return new position_1.$Lr(this.lineRange.start + i + 1, offset - offsetOfFirstCharInLine + 1 + this.n[i]);
        }
        translateRange(range) {
            return range_1.$Mr.fromPositions(this.translateOffset(range.start), this.translateOffset(range.endExclusive));
        }
        /**
        ...
        findWordContaining(offset) {
            ...
            if (!isWordChar(this.f[offset])) {
                return undefined;
            }
            // find start
            let start = offset;
            while (start > 0 && isWordChar(this.f[start - 1])) {
                start--;
            }
            // find end
            let end = offset;
            while (end < this.f.length && isWordChar(this.f[end])) {
                end++;
            }
            return new offsetRange_1.$bC(start, end);
        }
        countLinesIn(range) {
            return this.translateOffset(range.endExclusive).lineNumber - this.translateOffset(range.start).lineNumber;
        }
        isStronglyEqual(offset1, offset2) {
            return this.f[offset1] === this.f[offset2];
        }
    }
    exports.$vX = $vX;
    ...
    class LineRangeFragment {
        ...
        computeSimilarity(other) {
            ...
            const maxLength = Math.max(this.h.length, other.h.length);
            for (let i = 0; i < maxLength; i++) {
                sumDifferences += Math.abs((this.h[i] ?? 0) - (other.h[i] ?? 0));
            }
            return 1 - (sumDifferences / (this.f + other.f));
        }
    }
});
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[44/*vs/editor/common/diff/linesDiffComputers*/], __M([0/*require*/,1/*exports*/,27/*vs/editor/common/diff/smartLinesDiffComputer*/,43/*vs/editor/common/diff/standardLinesDiffComputer*/]), function (require, exports, smartLinesDiffComputer_1, standardLinesDiffComputer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$wX = void 0;
    exports.$wX = {
        getLegacy: () => new smartLinesDiffComputer_1.$nu(),
        getAdvanced: () => new standardLinesDiffComputer_1.$rX(),
    };
});
...
define(__m[45/*vs/editor/common/languages/defaultDocumentColorsComputer*/], __M([0/*require*/,1/*exports*/,29/*vs/base/common/color*/]), function (require, exports, color_1) {
    ...
    function _findHexColorInformation(range, hexValue) {
        ...
        const parsedHexColor = color_1.$8r.Format.CSS.parseHex(hexValue);
        if (!parsedHexColor) {
            return;
        }
        return {
    ...
    function _findHSLColorInformation(range, matches, isAlpha) {
        ...
        const captureGroups = match.values();
        const parsedRegex = _parseCaptureGroups(captureGroups);
        const colorEquivalent = new color_1.$8r(new color_1.$6r(parsedRegex[0], parsedRegex[1] / 100, parsedRegex[2] / 100, isAlpha ? parsedRegex[3] : 1));
        return {
            range: range,
...
define(__m[46/*vs/editor/common/languages/linkComputer*/], __M([0/*require*/,1/*exports*/,24/*vs/editor/common/core/characterClassifier*/]), function (require, exports, characterClassifier_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$aX = exports.$_W = exports.$$W = exports.State = void 0;
    var State;
    (function (State) {
    ...
    function getClassifier() {
        if (_classifier === null) {
            _classifier = new characterClassifier_1.$1r(0 /* CharacterClass.None */);
    ...
    class $_W {
        ...
        static computeLinks(model, stateMachine = getStateMachine()) {
            ...
            for (let i = 1, lineCount = model.getLineCount(); i <= lineCount; i++) {
                ...
                while (j < len) {
                    ...
                    if (state === 13 /* State.Accept */) {
                        ...
                        if (chClass === 1 /* CharacterClass.ForceTermination */) {
                            result.push($_W.a(classifier, line, i, linkBeginIndex, j));
                ...
                if (state === 13 /* State.Accept */) {
                    result.push($_W.a(classifier, line, i, linkBeginIndex, len));
                }
            }
            return result;
        }
...
define(__m[48/*vs/editor/common/model*/], __M([0/*require*/,1/*exports*/,11/*vs/base/common/objects*/]), function (require, exports, objects_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$Zt = exports.$Yt = exports.$Xt = exports.$Wt = exports.ModelConstants = exports.PositionAffinity = exports.$Vt = exports.TrackedRangeStickiness = exports.$Ut = exports.$Tt = exports.EndOfLineSequence = exports.DefaultEndOfLine = exports.EndOfLinePreference = exports.InjectedTextCursorStops = exports.MinimapPosition = exports.GlyphMarginLane = exports.OverviewRulerLane = void 0;
    /**
    ...
    class $Tt {
        ...
        equals(other) {
            return (this.tabSize === other.tabSize
                ...
                && (0, objects_1.$Hm)(this.bracketPairColorizationOptions, other.bracketPairColorizationOptions));
        }
        /**
         * @internal
         */
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[49/*vs/editor/common/model/prefixSumComputer*/], __M([0/*require*/,1/*exports*/,15/*vs/base/common/arrays*/,23/*vs/base/common/uint*/]), function (require, exports, arrays_1, uint_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$tu = exports.$su = exports.$ru = void 0;
    class $ru {
        constructor(values) {
            this.a = values;
        ...
        insertValues(insertIndex, insertValues) {
            insertIndex = (0, uint_1.$jd)(insertIndex);
        ...
        setValue(index, value) {
            index = (0, uint_1.$jd)(index);
            value = (0, uint_1.$jd)(value);
        ...
        removeValues(startIndex, count) {
            startIndex = (0, uint_1.$jd)(startIndex);
            count = (0, uint_1.$jd)(count);
            const oldValues = this.a;
            const oldPrefixSum = this.b;
        ...
        getIndexOf(sum) {
            ...
            return new $tu(mid, sum - midStart);
        }
    }
    exports.$ru = $ru;
    /**
     ...
     *
     * ({@link $ru.getIndexOf} is just  O(log n))
    */
    class $su {
        constructor(values) {
            this.a = values;
        ...
        getIndexOf(sum) {
            ...
            return new $tu(idx, sum - viewLinesAbove);
        }
        ...
        insertValues(insertIndex, insertArr) {
            this.a = (0, arrays_1.$zf)(this.a, insertIndex, insertArr);
            this.f(insertIndex);
        }
        f(index) {
            this.b = false;
...
define(__m[50/*vs/editor/common/model/mirrorTextModel*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/strings*/,4/*vs/editor/common/core/position*/,49/*vs/editor/common/model/prefixSumComputer*/]), function (require, exports, strings_1, position_1, prefixSumComputer_1) {
    ...
    class $uu {
        ...
        onEvents(e) {
            ...
            for (const change of changes) {
                this.o(change.range);
                this.p(new position_1.$Lr(change.range.startLineNumber, change.range.startColumn), change.text);
            }
            this.h = e.versionId;
            this.k = null;
        }
        l() {
            if (!this.j) {
                ...
                this.j = new prefixSumComputer_1.$ru(lineStartValues);
            }
        }
        /**
        ...
        p(position, insertText) {
            ...
            const insertLines = (0, strings_1.$yd)(insertText);
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[51/*vs/editor/common/model/textModelSearch*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/strings*/,38/*vs/editor/common/core/wordCharacterClassifier*/,4/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,48/*vs/editor/common/model*/]), function (require, exports, strings, wordCharacterClassifier_1, position_1, range_1, model_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$6B = exports.$5B = exports.$4B = exports.$3B = exports.$2B = exports.$1B = void 0;
    ...
    class $1B {
        ...
        parseSearchRequest() {
            ...
            let multiline;
            if (this.isRegex) {
                multiline = $2B(this.searchString);
            }
            else {
            ...
            let regex = null;
            try {
                regex = strings.$wd(this.searchString, this.isRegex, {
            ...
            return new model_1.$Xt(regex, this.wordSeparators ? (0, wordCharacterClassifier_1.$4r)(this.wordSeparators) : null, canUseSimpleSearch ? this.searchString : null);
        }
    }
    exports.$1B = $1B;
    function $2B(searchString) {
    ...
    exports.$2B = $2B;
    function $3B(range, rawMatches, captureMatches) {
        if (!captureMatches) {
            return new model_1.$Ut(range, null);
        }
        const matches = [];
        for (let i = 0, len = rawMatches.length; i < len; i++) {
            matches[i] = rawMatches[i];
        }
        return new model_1.$Ut(range, matches);
    }
    exports.$3B = $3B;
    ...
    class $4B {
        static findMatches(model, searchParams, searchRange, captureMatches, limitResultCount) {
            ...
            if (searchData.regex.multiline) {
                return this.b(model, searchRange, new $6B(searchData.wordSeparators, searchData.regex), captureMatches, limitResultCount);
            }
        ...
        static b(model, searchRange, searcher, captureMatches, limitResultCount) {
            ...
            while ((m = searcher.next(text))) {
                result[counter++] = $3B(this.a(model, deltaOffset, text, lfCounter, m.index, m[0]), m, captureMatches);
        ...
        static d(searchData, text, lineNumber, deltaOffset, resultLen, result, captureMatches, limitResultCount) {
            ...
            if (!captureMatches && searchData.simpleSearch) {
                ...
                while ((lastMatchIndex = text.indexOf(searchString, lastMatchIndex + searchStringLen)) !== -1) {
                    if (!wordSeparators || $5B(wordSeparators, text, textLength, lastMatchIndex, searchStringLen)) {
            ...
            const searcher = new $6B(searchData.wordSeparators, searchData.regex);
            let m;
            ...
            do {
                ...
                if (m) {
                    result[resultLen++] = $3B(new range_1.$Mr(lineNumber, m.index + 1 + deltaOffset, lineNumber, m.index + 1 + m[0].length + deltaOffset), m, captureMatches);
                    if (resultLen >= limitResultCount) {
                        return resultLen;
                    }
                }
        ...
        static e(model, searchStart, searcher, captureMatches) {
            const searchTextStart = new position_1.$Lr(searchStart.lineNumber, 1);
            const deltaOffset = model.getOffsetAt(searchTextStart);
            const lineCount = model.getLineCount();
            // We always execute multiline search over the lines joined with \n
            // This makes it that \n will match the EOL for both CRLF and LF models
            // We compensate for offset errors in `_getMultilineMatchRange`
            const text = model.getValueInRange(new range_1.$Mr(searchTextStart.lineNumber, searchTextStart.column, lineCount, model.getLineMaxColumn(lineCount)), 1 /* EndOfLinePreference.LF */);
            const lfCounter = (model.getEOL() === '\r\n' ? new LineFeedCounter(text) : null);
            searcher.reset(searchStart.column - 1);
            const m = searcher.next(text);
            if (m) {
                return $3B(this.a(model, deltaOffset, text, lfCounter, m.index, m[0]), m, captureMatches);
            }
            if (searchStart.lineNumber !== 1 || searchStart.column !== 1) {
                // Try again from the top
                return this.e(model, new position_1.$Lr(1, 1), searcher, captureMatches);
            }
            return null;
        }
        ...
        static g(searcher, text, lineNumber, fromColumn, captureMatches) {
            ...
            const m = searcher.next(text);
            if (m) {
                return $3B(new range_1.$Mr(lineNumber, m.index + 1, lineNumber, m.index + 1 + m[0].length), m, captureMatches);
            }
            return null;
        }
        ...
        static h(model, searchStart, searcher, captureMatches) {
            const matches = this.b(model, new range_1.$Mr(1, 1, searchStart.lineNumber, searchStart.column), searcher, captureMatches, 10 * LIMIT_FIND_COUNT);
            if (matches.length > 0) {
            ...
            if (searchStart.lineNumber !== lineCount || searchStart.column !== model.getLineMaxColumn(lineCount)) {
                ...
                return this.h(model, new position_1.$Lr(lineCount, model.getLineMaxColumn(lineCount)), searcher, captureMatches);
            }
            return null;
        }
        ...
        static k(searcher, text, lineNumber, captureMatches) {
            ...
            searcher.reset(0);
            while ((m = searcher.next(text))) {
                bestResult = $3B(new range_1.$Mr(lineNumber, m.index + 1, lineNumber, m.index + 1 + m[0].length), m, captureMatches);
            }
            return bestResult;
        }
    }
    ...
    function $5B(wordSeparators, text, textLength, matchStartIndex, matchLength) {
            ...
            do {
                ...
                if (matchStartIndex === this.b && matchLength === this.c) {
                    if (matchLength === 0) {
                        ...
                        if (strings.$Rd(text, textLength, this.a.lastIndex) > 0xFFFF) {
                            this.a.lastIndex += 2;
                        }
                        else {
                            this.a.lastIndex += 1;
                ...
                this.c = matchLength;
                if (!this._wordSeparators || $5B(this._wordSeparators, text, textLength, matchStartIndex, matchLength)) {
                    return m;
                }
            } while (m);
            return null;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[52/*vs/editor/common/services/unicodeTextModelHighlighter*/], __M([0/*require*/,1/*exports*/,2/*vs/editor/common/core/range*/,51/*vs/editor/common/model/textModelSearch*/,5/*vs/base/common/strings*/,10/*vs/base/common/assert*/,25/*vs/editor/common/core/wordHelper*/]), function (require, exports, range_1, textModelSearch_1, strings, assert_1, wordHelper_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.UnicodeHighlighterReasonKind = exports.$0W = void 0;
    class $0W {
        static computeUnicodeHighlights(model, options, range) {
            ...
            const searcher = new textModelSearch_1.$6B(null, regex);
            const ranges = [];
            let hasMore = false;
            let m;
            ...
            forLoop: for (let lineNumber = startLine, lineCount = endLine; lineNumber <= lineCount; lineNumber++) {
                ...
                do {
                    ...
                    if (m) {
                        ...
                        let word = (0, wordHelper_1.$Kr)(startIndex + 1, wordHelper_1.$Hr, lineContent, 0);
                        ...
                        if (highlightReason !== 0 /* SimpleHighlightReason.None */) {
                            ...
                            ranges.push(new range_1.$Mr(lineNumber, startIndex + 1, lineNumber, endIndex + 1));
                        }
                    }
                } while (m);
            }
        ...
        static computeUnicodeHighlightReason(char, options) {
            ...
            switch (reason) {
                ...
                case 3 /* SimpleHighlightReason.Ambiguous */: {
                    ...
                    const notAmbiguousInLocales = strings.$fe.getLocales().filter((l) => !strings.$fe.getInstance(new Set([...options.allowedLocales, l])).isAmbiguous(codePoint));
    ...
    function buildRegExpCharClassExpr(codePoints, flags) {
        const src = `[${strings.$od(codePoints.map((i) => String.fromCodePoint(i)).join(''))}]`;
        return src;
    }
    ...
    class CodePointHighlighter {
        constructor(b) {
            ...
            this.ambiguousCharacters = strings.$fe.getInstance(new Set(b.allowedLocales));
        }
        getCandidateCodePoints() {
            ...
            if (this.b.invisibleCharacters) {
                for (const cp of strings.$ge.codePoints) {
        ...
        shouldHighlightNonBasicASCII(character, wordContext) {
            ...
            if (wordContext) {
                for (const char of wordContext) {
                    const codePoint = char.codePointAt(0);
                    const isBasicASCII = strings.$Zd(char);
                    hasBasicASCIICharacters = hasBasicASCIICharacters || isBasicASCII;
                    if (!isBasicASCII &&
                        !this.ambiguousCharacters.isAmbiguous(codePoint) &&
                        !strings.$ge.isInvisibleCharacter(codePoint)) {
            ...
            if (this.b.invisibleCharacters) {
                ...
                if (!isAllowedInvisibleCharacter(character) && strings.$ge.isInvisibleCharacter(codePoint)) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[54/*vs/editor/common/tokenizationRegistry*/], __M([0/*require*/,1/*exports*/,8/*vs/base/common/event*/,7/*vs/base/common/lifecycle*/]), function (require, exports, event_1, lifecycle_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$cs = void 0;
    class $cs {
    ...
    exports.$cs = $cs;
    class TokenizationSupportFactoryData extends lifecycle_1.$lb {
        get isResolved() {
            return this.c;
        }
        constructor(f, g, h) {
...
define(__m[55/*vs/nls!vs/base/common/platform*/], __M([56/*vs/nls*/,57/*vs/nls!vs/editor/common/services/editorSimpleWorker*/]), function(nls, data) { return nls.create("vs/base/common/platform", data); });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[58/*vs/base/common/process*/], __M([0/*require*/,1/*exports*/,13/*vs/base/common/platform*/]), function (require, exports, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$8b = exports.$7b = exports.env = exports.cwd = void 0;
    let safeProcess;
     ...
     * environments.
     */
    exports.$7b = safeProcess.platform;
    /**
     * Provides safe access to the `arch` method in node.js, sandboxed or web
     * environments.
     * Note: `arch` is `undefined` in web
     */
    exports.$8b = safeProcess.arch;
});
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[59/*vs/base/common/path*/], __M([0/*require*/,1/*exports*/,58/*vs/base/common/process*/]), function (require, exports, process) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$kc = exports.sep = exports.$ic = exports.$hc = exports.$gc = exports.$fc = exports.$ec = exports.$dc = exports.$cc = exports.$bc = exports.$ac = exports.$_b = exports.$$b = exports.$0b = exports.$9b = void 0;
    ...
    const platformIsWin32 = (process.$7b === 'win32');
    ...
    exports.$9b = {
        ...
        join(...paths) {
            ...
            return exports.$9b.normalize(joined);
        },
        ...
        relative(from, to) {
            ...
            const fromOrig = exports.$9b.resolve(from);
            const toOrig = exports.$9b.resolve(to);
            if (fromOrig === toOrig) {
                return '';
            }
        ...
        toNamespacedPath(path) {
            ...
            const resolvedPath = exports.$9b.resolve(path);
    ...
    exports.$0b = {
        ...
        join(...paths) {
            ...
            return exports.$0b.normalize(joined);
        },
        relative(from, to) {
            validateString(from, 'from');
            validateString(to, 'to');
            ...
            from = exports.$0b.resolve(from);
            to = exports.$0b.resolve(to);
            if (from === to) {
                return '';
            }
            const fromStart = 1;
    ...
    exports.$0b.win32 = exports.$9b.win32 = exports.$9b;
    exports.$0b.posix = exports.$9b.posix = exports.$0b;
    exports.$$b = (platformIsWin32 ? exports.$9b.normalize : exports.$0b.normalize);
    exports.$_b = (platformIsWin32 ? exports.$9b.isAbsolute : exports.$0b.isAbsolute);
    exports.$ac = (platformIsWin32 ? exports.$9b.join : exports.$0b.join);
    exports.$bc = (platformIsWin32 ? exports.$9b.resolve : exports.$0b.resolve);
    exports.$cc = (platformIsWin32 ? exports.$9b.relative : exports.$0b.relative);
    exports.$dc = (platformIsWin32 ? exports.$9b.dirname : exports.$0b.dirname);
    exports.$ec = (platformIsWin32 ? exports.$9b.basename : exports.$0b.basename);
    exports.$fc = (platformIsWin32 ? exports.$9b.extname : exports.$0b.extname);
    exports.$gc = (platformIsWin32 ? exports.$9b.format : exports.$0b.format);
    exports.$hc = (platformIsWin32 ? exports.$9b.parse : exports.$0b.parse);
    exports.$ic = (platformIsWin32 ? exports.$9b.toNamespacedPath : exports.$0b.toNamespacedPath);
    exports.sep = (platformIsWin32 ? exports.$9b.sep : exports.$0b.sep);
    exports.$kc = (platformIsWin32 ? exports.$9b.delimiter : exports.$0b.delimiter);
});
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[14/*vs/base/common/uri*/], __M([0/*require*/,1/*exports*/,59/*vs/base/common/path*/,13/*vs/base/common/platform*/]), function (require, exports, paths, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$Re = exports.$Qe = exports.URI = void 0;
    ...
    class URI {
        ...
        static joinPath(uri, ...pathFragment) {
            ...
            if (platform_1.$i && uri.scheme === 'file') {
                newPath = URI.file(paths.$9b.join($Re(uri, true), ...pathFragment)).path;
            }
            else {
                newPath = paths.$0b.join(uri.path, ...pathFragment);
            }
     ...
     */
    function $Re(uri, keepDriveLetterCasing) {
        let value;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[64/*vs/base/common/worker/simpleWorker*/], __M([0/*require*/,1/*exports*/,3/*vs/base/common/errors*/,8/*vs/base/common/event*/,7/*vs/base/common/lifecycle*/,11/*vs/base/common/objects*/,13/*vs/base/common/platform*/,5/*vs/base/common/strings*/]), function (require, exports, errors_1, event_1, lifecycle_1, objects_1, platform_1, strings) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[60/*vs/nls!vs/editor/common/languages*/], __M([56/*vs/nls*/,57/*vs/nls!vs/editor/common/services/editorSimpleWorker*/]), function(nls, data) { return nls.create("vs/editor/common/languages", data); });
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[61/*vs/editor/common/languages*/], __M([0/*require*/,1/*exports*/,35/*vs/base/common/codicons*/,14/*vs/base/common/uri*/,36/*vs/editor/common/core/editOperation*/,2/*vs/editor/common/core/range*/,54/*vs/editor/common/tokenizationRegistry*/,60/*vs/nls!vs/editor/common/languages*/]), function (require, exports, codicons_1, uri_1, editOperation_1, range_1, tokenizationRegistry_1, nls_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ExternalUriOpenerPriority = exports.$us = exports.$ts = exports.InlayHintKind = exports.CommentState = exports.CommentMode = exports.CommentThreadState = exports.CommentThreadCollapsibleState = exports.Command = exports.$ss = exports.$rs = exports.SymbolKinds = exports.SymbolTag = exports.$qs = exports.$ps = exports.SymbolKind = exports.$os = exports.DocumentHighlightKind = exports.SignatureHelpTriggerKind = exports.CodeActionTriggerType = exports.$ns = exports.InlineCompletionTriggerKind = exports.CompletionTriggerKind = exports.CompletionItemInsertTextRule = exports.CompletionItemTag = exports.CompletionItemKinds = exports.CompletionItemKind = exports.$ms = exports.$ls = exports.$ks = void 0;
    class $ks {
    ...
    (function (CompletionItemKinds) {
        ...
        byKind.set(0 /* CompletionItemKind.Method */, codicons_1.$yj.symbolMethod);
        byKind.set(1 /* CompletionItemKind.Function */, codicons_1.$yj.symbolFunction);
        byKind.set(2 /* CompletionItemKind.Constructor */, codicons_1.$yj.symbolConstructor);
        byKind.set(3 /* CompletionItemKind.Field */, codicons_1.$yj.symbolField);
        byKind.set(4 /* CompletionItemKind.Variable */, codicons_1.$yj.symbolVariable);
        byKind.set(5 /* CompletionItemKind.Class */, codicons_1.$yj.symbolClass);
        byKind.set(6 /* CompletionItemKind.Struct */, codicons_1.$yj.symbolStruct);
        byKind.set(7 /* CompletionItemKind.Interface */, codicons_1.$yj.symbolInterface);
        byKind.set(8 /* CompletionItemKind.Module */, codicons_1.$yj.symbolModule);
        byKind.set(9 /* CompletionItemKind.Property */, codicons_1.$yj.symbolProperty);
        byKind.set(10 /* CompletionItemKind.Event */, codicons_1.$yj.symbolEvent);
        byKind.set(11 /* CompletionItemKind.Operator */, codicons_1.$yj.symbolOperator);
        byKind.set(12 /* CompletionItemKind.Unit */, codicons_1.$yj.symbolUnit);
        byKind.set(13 /* CompletionItemKind.Value */, codicons_1.$yj.symbolValue);
        byKind.set(15 /* CompletionItemKind.Enum */, codicons_1.$yj.symbolEnum);
        byKind.set(14 /* CompletionItemKind.Constant */, codicons_1.$yj.symbolConstant);
        byKind.set(15 /* CompletionItemKind.Enum */, codicons_1.$yj.symbolEnum);
        byKind.set(16 /* CompletionItemKind.EnumMember */, codicons_1.$yj.symbolEnumMember);
        byKind.set(17 /* CompletionItemKind.Keyword */, codicons_1.$yj.symbolKeyword);
        byKind.set(27 /* CompletionItemKind.Snippet */, codicons_1.$yj.symbolSnippet);
        byKind.set(18 /* CompletionItemKind.Text */, codicons_1.$yj.symbolText);
        byKind.set(19 /* CompletionItemKind.Color */, codicons_1.$yj.symbolColor);
        byKind.set(20 /* CompletionItemKind.File */, codicons_1.$yj.symbolFile);
        byKind.set(21 /* CompletionItemKind.Reference */, codicons_1.$yj.symbolReference);
        byKind.set(22 /* CompletionItemKind.Customcolor */, codicons_1.$yj.symbolCustomColor);
        byKind.set(23 /* CompletionItemKind.Folder */, codicons_1.$yj.symbolFolder);
        byKind.set(24 /* CompletionItemKind.TypeParameter */, codicons_1.$yj.symbolTypeParameter);
        byKind.set(25 /* CompletionItemKind.User */, codicons_1.$yj.account);
        byKind.set(26 /* CompletionItemKind.Issue */, codicons_1.$yj.issues);
        /**
         * @internal
         */
        function toIcon(kind) {
            ...
            if (!codicon) {
                ...
                codicon = codicons_1.$yj.symbolProperty;
            }
            return codicon;
        }
    ...
    class $ns {
        ...
        equals(other) {
            return range_1.$Mr.lift(this.range).equalsRange(other.range)
    ...
    function $os(thing) {
        return thing
            ...
            && range_1.$Mr.isIRange(thing.range)
            && (range_1.$Mr.isIRange(thing.originSelectionRange) || range_1.$Mr.isIRange(thing.targetSelectionRange));
    }
    exports.$os = $os;
    /**
     * A symbol kind.
     ...
     * @internal
     */
    function $qs(symbolName, kind) {
        return (0, nls_1.localize)(26, null, symbolName, exports.$ps[kind]);
    }
    exports.$qs = $qs;
    var SymbolTag;
    (function (SymbolTag) {
    ...
    (function (SymbolKinds) {
        const byKind = new Map();
        byKind.set(0 /* SymbolKind.File */, codicons_1.$yj.symbolFile);
        byKind.set(1 /* SymbolKind.Module */, codicons_1.$yj.symbolModule);
        byKind.set(2 /* SymbolKind.Namespace */, codicons_1.$yj.symbolNamespace);
        byKind.set(3 /* SymbolKind.Package */, codicons_1.$yj.symbolPackage);
        byKind.set(4 /* SymbolKind.Class */, codicons_1.$yj.symbolClass);
        byKind.set(5 /* SymbolKind.Method */, codicons_1.$yj.symbolMethod);
        byKind.set(6 /* SymbolKind.Property */, codicons_1.$yj.symbolProperty);
        byKind.set(7 /* SymbolKind.Field */, codicons_1.$yj.symbolField);
        byKind.set(8 /* SymbolKind.Constructor */, codicons_1.$yj.symbolConstructor);
        byKind.set(9 /* SymbolKind.Enum */, codicons_1.$yj.symbolEnum);
        byKind.set(10 /* SymbolKind.Interface */, codicons_1.$yj.symbolInterface);
        byKind.set(11 /* SymbolKind.Function */, codicons_1.$yj.symbolFunction);
        byKind.set(12 /* SymbolKind.Variable */, codicons_1.$yj.symbolVariable);
        byKind.set(13 /* SymbolKind.Constant */, codicons_1.$yj.symbolConstant);
        byKind.set(14 /* SymbolKind.String */, codicons_1.$yj.symbolString);
        byKind.set(15 /* SymbolKind.Number */, codicons_1.$yj.symbolNumber);
        byKind.set(16 /* SymbolKind.Boolean */, codicons_1.$yj.symbolBoolean);
        byKind.set(17 /* SymbolKind.Array */, codicons_1.$yj.symbolArray);
        byKind.set(18 /* SymbolKind.Object */, codicons_1.$yj.symbolObject);
        byKind.set(19 /* SymbolKind.Key */, codicons_1.$yj.symbolKey);
        byKind.set(20 /* SymbolKind.Null */, codicons_1.$yj.symbolNull);
        byKind.set(21 /* SymbolKind.EnumMember */, codicons_1.$yj.symbolEnumMember);
        byKind.set(22 /* SymbolKind.Struct */, codicons_1.$yj.symbolStruct);
        byKind.set(23 /* SymbolKind.Event */, codicons_1.$yj.symbolEvent);
        byKind.set(24 /* SymbolKind.Operator */, codicons_1.$yj.symbolOperator);
        byKind.set(25 /* SymbolKind.TypeParameter */, codicons_1.$yj.symbolTypeParameter);
        /**
         * @internal
         */
        function toIcon(kind) {
            ...
            if (!icon) {
                ...
                icon = codicons_1.$yj.symbolProperty;
            }
            return icon;
        }
    ...
    class $rs {
        static asEditOperation(edit) {
            return editOperation_1.$Tr.replace(range_1.$Mr.lift(edit.range), edit.text);
        }
    }
    exports.$rs = $rs;
    class $ss {
         ...
         */
        static { this.Comment = new $ss('comment'); }
        /**
         * Kind for folding range representing a import. The value of the kind is 'imports'.
         */
        static { this.Imports = new $ss('imports'); }
        /**
         * Kind for folding range representing regions (for example marked by `#region`, `#endregion`).
         * The value of the kind is 'region'.
         */
        static { this.Region = new $ss('region'); }
        /**
         * Returns a {@link $ss} for the given value.
         *
         * @param value of the kind.
         */
        static fromValue(value) {
            switch (value) {
                case 'comment': return $ss.Comment;
                case 'imports': return $ss.Imports;
                case 'region': return $ss.Region;
            }
            return new $ss(value);
        }
        /**
         * Creates a new {@link $ss}.
         *
         * @param value of the kind.
         */
        constructor(value) {
     ...
     * @internal
     */
    exports.$us = new tokenizationRegistry_1.$cs();
    /**
     * @internal
     */
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[62/*vs/editor/common/services/editorBaseApi*/], __M([0/*require*/,1/*exports*/,20/*vs/base/common/cancellation*/,8/*vs/base/common/event*/,31/*vs/base/common/keyCodes*/,14/*vs/base/common/uri*/,4/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,37/*vs/editor/common/core/selection*/,61/*vs/editor/common/languages*/,53/*vs/editor/common/standalone/standaloneEnums*/]), function (require, exports, cancellation_1, event_1, keyCodes_1, uri_1, position_1, range_1, selection_1, languages_1, standaloneEnums) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class $cX {
        ...
        static chord(firstPart, secondPart) {
            return (0, keyCodes_1.$gq)(firstPart, secondPart);
        }
    }
    exports.$cX = $cX;
    function $dX() {
        return {
            editor: undefined,
            languages: undefined,
            CancellationTokenSource: cancellation_1.$ed,
            Emitter: event_1.$8c,
            KeyCode: standaloneEnums.KeyCode,
            KeyMod: $cX,
            Position: position_1.$Lr,
            Range: range_1.$Mr,
            Selection: selection_1.$Ur,
            SelectionDirection: standaloneEnums.SelectionDirection,
            MarkerSeverity: standaloneEnums.MarkerSeverity,
            MarkerTag: standaloneEnums.MarkerTag,
            Uri: uri_1.URI,
            Token: languages_1.$ks
        };
    }
    exports.$dX = $dX;
});
...
define(__m[65/*vs/editor/common/services/editorSimpleWorker*/], __M([0/*require*/,1/*exports*/,21/*vs/base/common/diff/diff*/,14/*vs/base/common/uri*/,4/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,50/*vs/editor/common/model/mirrorTextModel*/,25/*vs/editor/common/core/wordHelper*/,46/*vs/editor/common/languages/linkComputer*/,47/*vs/editor/common/languages/supports/inplaceReplaceSupport*/,62/*vs/editor/common/services/editorBaseApi*/,19/*vs/base/common/stopwatch*/,52/*vs/editor/common/services/unicodeTextModelHighlighter*/,27/*vs/editor/common/diff/smartLinesDiffComputer*/,44/*vs/editor/common/diff/linesDiffComputers*/,11/*vs/base/common/objects*/,3/*vs/base/common/errors*/,45/*vs/editor/common/languages/defaultDocumentColorsComputer*/]), function (require, exports, diff_1, uri_1, position_1, range_1, mirrorTextModel_1, wordHelper_1, linkComputer_1, inplaceReplaceSupport_1, editorBaseApi_1, stopwatch_1, unicodeTextModelHighlighter_1, smartLinesDiffComputer_1, linesDiffComputers_1, objects_1, errors_1, defaultDocumentColorsComputer_1) {
     ...
     * @internal
     */
    class MirrorModel extends mirrorTextModel_1.$uu {
        get uri() {
            return this.d;
        }
        get eol() {
        ...
        findMatches(regex) {
            ...
            for (let i = 0; i < this.f.length; i++) {
                const line = this.f[i];
                const offsetToAdd = this.offsetAt(new position_1.$Lr(i + 1, 1));
        ...
        getWordAtPosition(position, wordDefinition) {
            const wordAtText = (0, wordHelper_1.$Kr)(position.column, (0, wordHelper_1.$Ir)(wordDefinition), this.f[position.lineNumber - 1], 0);
            if (wordAtText) {
                return new range_1.$Mr(position.lineNumber, wordAtText.startColumn, position.lineNumber, wordAtText.endColumn);
            }
            return null;
        }
        ...
        s(position) {
            if (!position_1.$Lr.isIPosition(position)) {
    ...
    class EditorSimpleWorker {
        ...
        async computeUnicodeHighlights(url, options, range) {
            ...
            return unicodeTextModelHighlighter_1.$0W.computeUnicodeHighlights(model, options, range);
        }
        // ---- BEGIN diff --------------------------------------------------------------------------
        ...
        static l(originalTextModel, modifiedTextModel, options, algorithm) {
            const diffAlgorithm = algorithm === 'advanced' ? linesDiffComputers_1.$wX.getAdvanced() : linesDiffComputers_1.$wX.getLegacy();
        ...
        async computeDirtyDiff(originalUrl, modifiedUrl, ignoreTrimWhitespace) {
            ...
            const diffComputer = new smartLinesDiffComputer_1.$ou(originalLines, modifiedLines, {
        ...
        async computeMoreMinimalEdits(modelUrl, edits, pretty) {
            ...
            edits = edits.slice(0).sort((a, b) => {
                if (a.range && b.range) {
                    return range_1.$Mr.compareRangesUsingStarts(a.range, b.range);
                }
            ...
            for (let { range, text, eol } of edits) {
                ...
                if (range_1.$Mr.isEmpty(range) && !text) {
                    // empty change
                    continue;
                }
                ...
                const changes = (0, diff_1.$lu)(original, text, pretty);
                const editOffset = model.offsetAt(range_1.$Mr.lift(range).getStartPosition());
                for (const change of changes) {
        ...
        async computeHumanReadableDiff(modelUrl, edits, options) {
            const model = this.j(modelUrl);
            if (!model) {
                return edits;
            }
            ...
            for (let { range, text, eol } of edits) {
                ...
                const diff = linesDiffComputers_1.$wX.getAdvanced().computeDiff(originalLines, modifiedLines, options);
                const start = range_1.$Mr.lift(range).getStartPosition();
                function addPositions(pos1, pos2) {
                    return new position_1.$Lr(pos1.lineNumber + pos2.lineNumber - 1, pos2.lineNumber === 1 ? pos1.column + pos2.column - 1 : pos2.column);
                }
                ...
                for (const c of diff.changes) {
                    if (c.innerChanges) {
                        for (const x of c.innerChanges) {
                            result.push({
                                range: range_1.$Mr.fromPositions(addPositions(start, x.originalRange.getStartPosition()), addPositions(start, x.originalRange.getEndPosition())),
                                text: getText(modifiedLines, x.modifiedRange).join(model.eol)
                            });
                        }
                    }
                    else {
                        throw new errors_1.$bb('The experimental diff algorithm always produces inner changes');
                    }
                }
            }
            if (typeof lastEol === 'number') {
        ...
        async computeLinks(modelUrl) {
            ...
            return (0, linkComputer_1.$aX)(model);
        }
        ...
        async computeDefaultDocumentColors(modelUrl) {
            ...
            return (0, defaultDocumentColorsComputer_1.$xX)(model);
        }
        // ---- BEGIN suggest --------------------------------------------------------------------------
        static { this.p = 10000; }
        async textualSuggest(modelUrls, leadingWord, wordDef, wordDefFlags) {
            const sw = new stopwatch_1.$4c();
        ...
        async navigateValueSet(modelUrl, range, up, wordDef, wordDefFlags) {
            ...
            const result = inplaceReplaceSupport_1.$bX.INSTANCE.navigateValueSet(range, selectionText, wordRange, word, up);
            return result;
        }
        ...
        loadForeignModule(moduleId, createData, foreignHostMethods) {
            ...
            const foreignHost = (0, objects_1.$Om)(foreignHostMethods, proxyMethodRequest);
            const ctx = {
                host: foreignHost,
                getMirrorModels: () => {
                    return this.k();
            ...
            if (this.g) {
                ...
                return Promise.resolve((0, objects_1.$Nm)(this.h));
            }
            // ESM-comment-begin
            return new Promise((resolve, reject) => {
                require([moduleId], (foreignModule) => {
                    this.h = foreignModule.create(ctx, createData);
                    resolve((0, objects_1.$Nm)(this.h));
                }, reject);
            });
            // ESM-comment-end
            // ESM-uncomment-begin
    ...
    if (typeof importScripts === 'function') {
        ...
        globalThis.monaco = (0, editorBaseApi_1.$dX)();
    }
});

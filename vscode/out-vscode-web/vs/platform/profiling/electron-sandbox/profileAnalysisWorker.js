...
define(__m[2/*vs/base/common/ternarySearchTree*/], __M([0/*require*/,1/*exports*/,7/*vs/base/common/arrays*/,8/*vs/base/common/strings*/]), function (require, exports, arrays_1, strings_1) {
    ...
    exports.$rh = exports.$qh = exports.$ph = exports.$oh = exports.$nh = void 0;
    class $nh {
        constructor() {
            this.b = '';
            this.c = 0;
    ...
    class $oh {
        ...
        cmp(a) {
            return this.e
                ? (0, strings_1.$Ed)(a, this.b, 0, a.length, this.c, this.d)
                : (0, strings_1.$Gd)(a, this.b, 0, a.length, this.c, this.d);
        }
        value() {
    ...
    class $ph {
        ...
        cmp(a) {
            return this.g
                ? (0, strings_1.$Ed)(a, this.b, 0, a.length, this.d, this.e)
                : (0, strings_1.$Gd)(a, this.b, 0, a.length, this.d, this.e);
        }
        value() {
    ...
    class $qh {
        ...
        reset(key) {
            ...
            if (this.c.path) {
                this.b = new $ph(false, !this.f(key));
    ...
    class $rh {
        static forUris(ignorePathCasing = () => false, ignoreQueryAndFragment = () => false) {
            return new $rh(new $qh(ignorePathCasing, ignoreQueryAndFragment));
        }
        static forPaths(ignorePathCasing = false) {
            return new $rh(new $ph(undefined, !ignorePathCasing));
        }
        static forStrings() {
            return new $rh(new $nh());
        }
        static forConfigKeys() {
            return new $rh(new $oh());
        }
...
define(__m[4/*vs/platform/profiling/common/profiling*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/path*/,3/*vs/platform/instantiation/common/instantiation*/]), function (require, exports, path_1, instantiation_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Utils = exports.$jF = void 0;
    exports.$jF = (0, instantiation_1.$lh)('IV8InspectProfilingService');
    var Utils;
    (function (Utils) {
        ...
        function rewriteAbsolutePaths(profile, replace = 'noAbsolutePaths') {
            for (const node of profile.nodes) {
                if (node.callFrame && node.callFrame.url) {
                    if ((0, path_1.$_b)(node.callFrame.url) || /^\w[\w\d+.-]*:\/\/\/?/.test(node.callFrame.url)) {
                        node.callFrame.url = (0, path_1.$ac)(replace, (0, path_1.$ec)(node.callFrame.url));
                    }
                }
            }
            return profile;
...
define(__m[6/*vs/platform/profiling/common/profilingModel*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.$Q9b = exports.$P9b = exports.$O9b = void 0;
    /**
    ...
    exports.$P9b = $P9b;
    const $Q9b = (aggregate, node, model, initialNode = node) => {
        let child = aggregate.children[node.locationId];
        if (!child) {
            child = new $P9b(model.locations[node.locationId], aggregate);
            aggregate.childrenSize++;
            aggregate.children[node.locationId] = child;
        }
        child.addNode(initialNode);
        if (node.parent) {
            (0, exports.$Q9b)(child, model.nodes[node.parent], model, initialNode);
        }
    };
    exports.$Q9b = $Q9b;
});
...
define(__m[9/*vs/platform/profiling/electron-sandbox/profileAnalysisWorker*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/path*/,2/*vs/base/common/ternarySearchTree*/,10/*vs/base/common/uri*/,4/*vs/platform/profiling/common/profiling*/,6/*vs/platform/profiling/common/profilingModel*/]), function (require, exports, path_1, ternarySearchTree_1, uri_1, profiling_1, profilingModel_1) {
    ...
    class ProfileAnalysisWorker {
        analyseBottomUp(profile) {
            ...
            const model = (0, profilingModel_1.$O9b)(profile);
        ...
        analyseByUrlCategory(profile, categories) {
            // build search tree
            const searchTree = ternarySearchTree_1.$rh.forUris();

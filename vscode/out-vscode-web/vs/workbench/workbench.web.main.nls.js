...
define("vs/workbench/workbench.web.main.nls", {
	...
	"vs/workbench/contrib/accessibility/browser/accessibilityConfiguration": [
		...
		"The opacity fraction (0.2 to 1.0) to use for unfocused editors and terminals. This will dim inactive views to make the focused views more obvious."
	],
	"vs/workbench/contrib/accessibility/browser/accessibilityContributions": [
		...
		"Clear Notification",
		"Clear Notification",
		"Inline Completions Accessible View",
		"Accept Completion",
		"Accept Completion"
	],
	"vs/workbench/contrib/accessibility/browser/accessibleView": [
		...
		"Disable the aria label hint to open this ({0})",
		"Add a keybinding for the command Disable Accessible View Hint to disable this hint",
		"Go to a symbol ({0})",
